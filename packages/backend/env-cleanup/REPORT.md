...
- Public endpoints move to config. When deployments disagreed on callsPerMinute the highest value was taken.
...
- everclear: be-prod used everclear.drpc.org, others + config used rpc.everclear.raas.gelato.cloud. Kept gelato; be-prod will switch.
