Generated with discovered.json: 0xea5619056b852e1cbd8b3e4c99d226ccf1c87e21

# Diff at Wed, 13 Mar 2024 10:38:02 GMT:

- author: vincfurc (<10850139+vincfurc@users.noreply.github.com>)
- current block number: 19425601
...
```diff
+   Status: CREATED
    contract sfraxFerryBridge (0x2b4864c2F2A2C275C6C66B90a2ae6BE9fA9cbE47)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract fxsFerryBridge (0x4A6d155df9Ec9A1BB3639e6B7B99E46Fb68D42f6)
    +++ description: None
```

```diff
+   Status: CREATED
    contract sfrxFerryBridge (0x5c5f05cF8528FFe925A2264743bFfEdbAB2b0FE3)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract fraxFerryBridge (0x5e1D94021484642863Ea8E7Cb4F0188e56B18FEE)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract fpisFerryBridge (0x958815f476cD07354c0BC034EE5077B20fD93003)
    +++ description: None
```

```diff
+   Status: CREATED
    contract fpiFerryBridge (0x9A576A3d39c589A861B46864C253288bcA428a6c)
    +++ description: None
```
