...
contract OptimismMintablePermitERC20Factory is ISemver, Initializable {
    ...
    /// @custom:legacy
    /// @notice Emitted whenever a new OptimismMintablePermitERC20 is created. Legacy version of the newer
    ...
    /// @notice Emitted whenever a new OptimismMintablePermitERC20 is created.
    /// @param localToken  Address of the created token on the local chain.
    ...
    ///         the OptimismMintablePermitERC20 token contract since this contract
    ///         is responsible for deploying OptimismMintablePermitERC20 contracts.
    ...
    /// @custom:legacy
    /// @notice Creates an instance of the OptimismMintablePermitERC20 contract. Legacy version of the
    ...
    /// @notice Creates an instance of the OptimismMintablePermitERC20 contract.
    /// @param _remoteToken Address of the token on the remote chain.
    /// @param _name        ERC20 name.
    /// @param _symbol      ERC20 symbol.
    /// @return Address of the newly created token.
    ...
    /// @notice Creates an instance of the OptimismMintablePermitERC20 contract, with specified decimals.
    /// @param _remoteToken Address of the token on the remote chain.
    /// @param _name        ERC20 name.
    /// @param _symbol      ERC20 symbol.
    ...
    function createOptimismMintableERC20WithDecimals(
        ...
        address localToken = address(
            new OptimismMintablePermitERC20{ salt: salt }(bridge, _remoteToken, _name, _symbol, _decimals)
        );
