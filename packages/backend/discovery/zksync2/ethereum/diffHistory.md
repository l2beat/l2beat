Generated with discovered.json: 0x8a2267463447fd34c2acde73e15936da0881e701

# Diff at Mon, 20 Jan 2025 11:08:12 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@400cfe1ca700b8b710220906f278f002c698d3c8 block: 21630311
- current block number: 21664404
...
+        "Old Governance contract for ZKsync Era allowing for proposals in form of transactions. The minimum delay is 0s."
      receivedPermissions:
+        [{"permission":"configure","target":"0xa8CB082A5a689E0d594d7da1E2d72A3D63aDc1bD","description":"set addresses (validators) that can commit, prove, exeute, revert batches through this contract."}]
    }
```
...
+        "The main contract defining the Layer 2. The operator commits blocks and provides a ZK proof which is validated by the Verifier contract and then processes transactions. During batch execution it processes L1 --> L2 and L2 --> L1 transactions."
      issuedPermissions:
+        [{"permission":"configure","target":"0xa8CB082A5a689E0d594d7da1E2d72A3D63aDc1bD","via":[]}]
    }
```
...
+        "Intermediary contract between the *Validators* and the ZKsync Era diamond that delays block execution (ie withdrawals and other L2 --> L1 messages) by 21h."
      issuedPermissions:
+        [{"permission":"configure","target":"0x0b622A2061EaccAE1c664eBC3E868b8438e03F61","via":[]}]
      receivedPermissions:
+        [{"permission":"configure","target":"0x32400084C286CF3E17e7B677ea9583e60a000324","description":"commit, prove, execute, revert batches directly in the main Diamond contract. Usually proxied through a ValidatorTimelock contract."}]
    }
```

Generated with discovered.json: 0x56ca475555a5dba72436b33ec7bf45893075ee16
