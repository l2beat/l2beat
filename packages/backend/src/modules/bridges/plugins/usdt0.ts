...
const USDT0_NETWORKS = defineNetworks('usdt0', [
  ...
  },
  {
    ...
    tokenAddress: EthereumAddress('0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9'),
  },
  {
    chain: 'optimism',
    adapter: EthereumAddress('0xF03b4d9AC1D5d1E7c4cEf54C2A313b9fe051A0aD'),
    tokenAddress: EthereumAddress('0x01bFF41798a0BcF287b996046Ca68b395DbC1071'),
  },
  {
    chain: 'unichain',
    adapter: EthereumAddress('0xc07bE8994D035631c36fb4a89C918CeFB2f03EC3'),
    tokenAddress: EthereumAddress('0x9151434b16b9763660705744891fA906F660EcC5'),
  },
  {
    chain: 'corn',
    adapter: EthereumAddress('0x3f82943338a8a76c35BFA0c1828aA27fd43a34E4'),
    tokenAddress: EthereumAddress('0xB8CE59FC3717ada4C02eaDF9682A9e934F625ebb'),
  },
  {
    chain: 'xlayer',
    adapter: EthereumAddress('0x94BCCa6bdfd6A61817Ab0E960bFedE4984505554'),
    tokenAddress: EthereumAddress('0x779Ded0c9e1022225f8E0630b35a9b54bE713736'),
  },
  {
    chain: 'ink',
