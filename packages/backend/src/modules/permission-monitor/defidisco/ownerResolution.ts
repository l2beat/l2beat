/**
 * Owner resolution logic for DefidDisco permission monitoring (backend version)
 *
 * This is a lightweight copy of resolution logic adapted for backend use.
 * Maintains the minimal integration principle by keeping DefidDisco code separate.
 */
