...
describe(decodeBatch.name, () => {
  it('decode batch with empty gas price', async () => {
    const mockTs = fs.readFileSync('src/test/data/finality-txs-polygonzkevm.txt', 'utf-8')
    ...
    expect(result[59].transactions[1]).toEqual({
      ...
      r: BigNumber.from("0x15015f155264cf125e4a001c0dfb7661c166da3b95f609cb673b952ab12d5262"),
      s: BigNumber.from("0x2a8a88b520e2c74aa7bc23a346ee81506a51f1520a8fa184802eec0fe353e69a")
    })
  })
})