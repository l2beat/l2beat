...
describe(filterDiff.name, () => {
  it('unknownContracts', () => {
    const diff: DiscoveryDiff[] = [
      { name: 'A', address: ADDRESS_A, addressType: 'Contract', diff: [{ key: 'A', after: '1' }] },
      { name: 'B', address: ADDRESS_B, addressType: 'Contract', diff: [{ key: 'B', after: '1' }] },
    ]
  ...
  it('created', () => {
    const diff: DiscoveryDiff[] = [
      { name: 'A', address: ADDRESS_A, addressType: 'Contract', type: 'created' },
    ]
  ...
  it('deleted', () => {
    const diff: DiscoveryDiff[] = [
      { name: 'A', address: ADDRESS_A, addressType: 'Contract', type: 'deleted' },
    ]
