...
// maciekzygmunt: this client should be moved to shared module but can't as uops-dashboard imports it from barrel file and it breaks at build time as it depends on node zlib-sync, so it should be rewritten to not use discord.js
