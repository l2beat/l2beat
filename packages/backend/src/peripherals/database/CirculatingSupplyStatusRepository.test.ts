...
import { CirculatingSupplyStatusRepository } from './CirculatingSupplyStatusRepository'

describe(CirculatingSupplyStatusRepository.name, () => {
  const { database } = setupDatabaseTestSuite()
  const repository = new CirculatingSupplyStatusRepository(
    database,
    Logger.SILENT,
  )
  ...
  describe(CirculatingSupplyStatusRepository.prototype.getBetween.name, () => {
