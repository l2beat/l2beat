...
-- CreateIndex
CREATE INDEX "InteropAggregationQuality_createdAt_idx"
ON "InteropAggregationQuality"("createdAt");

-- CreateIndex
CREATE INDEX "InteropAggregationQuality_isPromoted_timestamp_idx"
ON "InteropAggregationQuality"("isPromoted", "timestamp" DESC);
