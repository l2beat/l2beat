...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      <p className="mb-6 px-2 text-center font-normal text-gray-500 text-lg sm:px-16 lg:text-xl xl:px-48 dark:text-gray-400">
        Select the chain and provide the block number and the tool will compare
        overall number of transactions to user operations. By clicking the
        magnifier icon you can get the latest block number.
      </p>
