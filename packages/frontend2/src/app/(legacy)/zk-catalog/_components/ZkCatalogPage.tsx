      ...
      {props.items.map((item) => (
        <AccordionItem key={item.slug} value={item.slug}>
          <AccordionHeader asChild>
            <AccordionTrigger
              asChild
              className="group relative z-10 w-full cursor-pointer flex-col border rounded-xl border-gray-300 bg-gray-100 px-6 py-4 md:flex-row dark:border-gray-800 dark:bg-zinc-900"
            >
