  ...
  return [
    {
      ...
      answer: (
        <span>
          ...
          <OutLink href="https://ethereum-magicians.org/t/a-rollup-centric-ethereum-roadmap/4698">
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <p className="mt-4">
            Example: let&apos;s assume L2BEAT reports a TVL of 2.5 billion,
            while DefiLlama reports a TVL of 1 billion for the same Layer 2
            network (e.g., Arbitrum). This suggests that 1.5 billion worth of
            assets have been bridged (canonically or externally) or natively
            minted on Arbitrum, but are not yet being used in any dApps listed
            by DefiLlama. For instance, if you deposit 1 ETH to Optimism, L2BEAT
          ...
          <p className="mt-4">
            ...
            to different interpretations of &quot;Total Value Locked.&quot;
            L2BEAT considers the entire Ethereum ecosystem, while DefiLlama
            emphasizes assets used in dApps on individual blockchain networks.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <div>
          <p className="mt-4">
            An L2 chain can periodically &quot;commit&quot; its state to L1 by
            submitting the hash of its current state root. A state root is just
            a number, e.g: <code>0x77905a71f4b32221...</code> . We need a
            mechanism to ensure that this number corresponds to the actual L2
            state.
          </p>
          <p className="mt-4">
      ...
      answer: (
        <div>
          <p className="mt-4">
            ...
            they need to have access to all L2&apos;s transactions or its
            current state. To not introduce any additional trust assumptions, L2
          ...
          <p className="mt-4">
            ...
            <OutLink href="https://ethereum.org/en/developers/docs/data-availability/">
              page on the topic
            </OutLink>
            .
          </p>
      ...
      answer: (
        <div>
          ...
          <div className="mt-4">
            ...
            <OutLink href="https://vitalik.eth.limo/general/2021/01/05/rollup.html">
      ...
      answer: (
        <div>
          ...
          <p className="mt-4">
            ...
            <OutLink href="https://medium.com/l2beat/redefining-total-value-locked-for-l2s-756160602747">
              L2 Assets blog post
            </OutLink>
            .
          </p>
    ...
    },
    {
      ...
      answer: (
        <span>
          ...
          much information as we can about the &quot;state of L2s&quot; and
          allow the community to better understand what security assumptions are
          used to build given L2 solutions.
        </span>
      ),
    },
    {
      ...
      answer: (
        <div>
          ...
          <p className="mt-4">
            ...
            do that{' '}
            <OutLink href="https://etherscan.io/address/0xCc8D82f6ba952966E63001c7B320EEF2Ae729099">
              on etherscan
            </OutLink>
            .
          </p>
    ...
    },
    {
      ...
      answer: (
        <div>
          <p className="mt-4">
            Everything is{' '}
            <OutLink href="https://github.com/l2beat/l2beat">
              open source
            </OutLink>{' '}
            &ndash; just create a PR. If you want to add a new project you
            should read our {''}
            <OutLink href="https://github.com/l2beat/l2beat/tree/main/CONTRIBUTING.md">
          ...
          <p className="mt-4">
            ...
            Request -{' '}
            <OutLink href="https://www.notion.so/l2beat/How-to-add-milestones-0e8684a83c3c48ce8bc7b605d9c9a1bf">
              link
            </OutLink>
          </p>
        </div>
