...
and their relations, e.g. finding all related tokens (even if relations are not direct).
...
- [Automatic token ingestion](../../docs/mdbook/specs/l2b_specs/token_db/automatic_token_ingestion.md) —
  ...
  transfer table, token relations derived from transfer evidence, and CoinGecko.
