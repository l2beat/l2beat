...
export const DiscoveryContract = z.object({
  ...
  fields: z
    .record(z.string(), DiscoveryContractField)
    .default({}),
...
export const CombinedContract = DiscoveryContract.merge(ColorContract)
...
export const CommonDiscoveryConfig = DiscoveryConfig.merge(ColorConfig)
