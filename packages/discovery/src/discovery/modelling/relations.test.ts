  ...
  it('builds the relations model', () => {
    ...
    expect(relationsModel).toEqual({
      'relations.lp': [
        `
contract(
  contractA_0x000000000000000000000000000000000000ccc1,
...
permissionDescription(
  ...
  "Description of Permission 1").`,
        `
contract(
  contractB_0x000000000000000000000000000000000000ccc2,
...
contractDescription(
  ...
  "Description of ContractB").`,
        `
eoa(
  eoaA_0x000000000000000000000000000000000000eee1,
