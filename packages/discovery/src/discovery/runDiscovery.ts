...
import { printSharedModuleInfo } from '../utils/printSharedModuleInfo.js'
import type { Analysis } from './analysis/AddressAnalyzer.js'
import { TEMPLATES_PATH, TemplateService } from './analysis/TemplateService.js'
...
import { getDiscoveryEngine } from './getDiscoveryEngine.js'
import { OverwriteCacheWrapper } from './OverwriteCacheWrapper.js'
import { diffDiscovery } from './output/diffDiscovery.js'
import { printTemplatization } from './output/printTemplatization.js'
import { saveDiscoveryResult } from './output/saveDiscoveryResult.js'
import { toDiscoveryOutput } from './output/toDiscoveryOutput.js'
import type { DiscoveryOutput } from './output/types.js'
import { SQLiteCache } from './provider/SQLiteCache.js'
import { type AllProviderStats, printProviderStats } from './provider/Stats.js'
