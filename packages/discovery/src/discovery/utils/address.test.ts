...
describe(addressToBytes32.name, () => {
  it('encodes addresses correctly', () => {
    ...
    expect(addressToBytes32(ADDRESS1).length).toBe(32)
    expect(addressToBytes32(ADDRESS2).length).toBe(32)
    expect(addressToBytes32(ADDRESS3).length).toBe(32)
    expect(addressToBytes32(ADDRESS4).length).toBe(32)
    expect(addressToBytes32(ADDRESS5).length).toBe(32)
