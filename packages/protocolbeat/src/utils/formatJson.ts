// NOTE(radomski): Duplicate of shared-pure function. This is because
// shared-pure compiles down to CJS and we can't import that. It's easier to
// just copy it.
