...
export function AddressSelectionPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-coffee-900 p-4">
      <div className="w-full max-w-2xl space-y-6 rounded-xl bg-coffee-800 p-6 shadow-lg">
        <h1 className="text-center font-bold text-2xl text-white">DIFFOVERY</h1>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          <div className="flex-1">
            ...
            <input
              ...
              } bg-coffee-700 px-4 py-2 text-white transition selection:bg-autumn-300 selection:text-coffee-900 placeholder:text-coffee-200 focus:ring-2 focus:ring-autumn-300`}
            />
            {errors.addressA && (
            ...
            <select
              className="mt-2 w-full rounded-lg border border-coffee-600 bg-coffee-700 px-4 py-1 text-white transition selection:bg-autumn-300 selection:text-coffee-900 placeholder:text-coffee-200 focus:ring-2 focus:ring-autumn-300"
              name="chainId"
              id="chainId"
              value={chainA}
              onChange={(e) => {
          ...
          >
            <IconSwap className="size-6 text-white" />
          </button>
        ...
        <button
          onClick={handleDiff}
          className="w-full rounded-lg bg-aux-blue px-4 py-3 font-medium text-white shadow-md transition hover:bg-aux-purple focus:outline-none focus:ring-2 focus:ring-autumn-300 focus:ring-offset-2"
        >
          DIFF
        </button>
      </div>
