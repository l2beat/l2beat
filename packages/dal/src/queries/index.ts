...
import { getSummedByTimestampWithProjectsRangesTvsValuesQuery } from './tvl/getSummedByTimestampWithProjectsRangesTvsValuesQuery'
...
export const queries = {
  ...
  getSummedByTimestampWithProjectsRangesTvsValuesQuery,
}
