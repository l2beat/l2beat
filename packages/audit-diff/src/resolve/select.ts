...
import type { AuditedUnitVersion } from '../evidence/index.js'
 ...
 *
 * 1. Newest → oldest, the first version whose comparable hash equals the
 *    deployed one wins: `identical`.
