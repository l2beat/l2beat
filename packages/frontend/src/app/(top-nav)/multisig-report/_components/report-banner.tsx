...
export function ReportBanner() {
  return (
    <div className="from-gray-250 to-gray-450 md:bg-linear-to-r mb-10 mt-8 flex max-h-fit flex-col overflow-hidden rounded-md bg-transparent md:my-12 md:grid md:grid-cols-2">
      <div className="mx-0 my-8 flex flex-col justify-center md:mx-12">
        ...
        <div className="text-primary text-2xl font-medium leading-tight md:text-5xl md:text-black md:dark:text-black">
