...
export function ScalingCostsTables(props: Props) {
  ...
  if (props.type === 'recategorised') {
    ...
    return (
      <>
        <Controls entries={[...filteredEntries.rollups, ...filteredEntries.validiumsAndOptimiums]} className="mt-6" />
...
function Controls({ entries, className }: { entries: ScalingCostsEntry[], className?: string }) {
  ...
  return <div className={cn("flex flex-col gap-2 lg:flex-row lg:justify-between", className)}>
