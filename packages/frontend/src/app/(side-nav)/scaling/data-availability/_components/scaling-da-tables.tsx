...
type Props = {
  ...
  type: 'recategorised'
  entries: ReturnType<typeof groupByMainCategories<ScalingDataAvailabilityEntry>>
}
...
export function ScalingDaTables(props: Props) {
  ...
  if (props.type === 'recategorised') {
    ...
    return (
      <>
        <ScalingDaFilters items={[...filteredEntries.rollups, ...filteredEntries.validiumsAndOptimiums]} />
        <DirectoryTabs className="mt-6" defaultValue="rollups">
          ...
          <DirectoryTabsContent value="rollups">
            <ScalingDataAvailabilityTable entries={filteredEntries.rollups} rollups />
