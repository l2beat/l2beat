...
import type { Layer2sTvsTableRow } from '../../utils/toTableRows'
import { TotalValueSecuredCell } from './TotalValueSecuredCell'
import { ValueSecuredCell } from './ValueSecuredCell'

const columnHelper = createColumnHelper<Layer2sTvsTableRow>()

export const getLayer2sTvsColumns = (
