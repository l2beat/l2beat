import { assertUnreachable, formatNumber } from '@l2beat/shared-pure'
...
export type L2CostsTableEntry = L2CostsEntry & {
  data: CostsData
}
...
const columnHelper = createColumnHelper<L2CostsTableEntry>()

export function getL2CostsColumns(metric: CostsMetric) {
  return [
