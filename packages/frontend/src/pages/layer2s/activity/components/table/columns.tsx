...
type Layer2sActivityTableEntry = Layer2sActivityEntry & {
  data:
    | {
        isSynced: boolean
        pastDayCount: {
...
const columnHelper = createColumnHelper<Layer2sActivityTableEntry>()

export const getLayer2sActivityColumns = (
