...
import { ProjectLayer2sRosette } from './Layer2sProjectRosette'
import { ProjectLayer2sStats } from './Layer2sProjectStats'

interface Props {
  project: ProjectLayer2sEntry
}

export function ProjectLayer2sSummary({ project }: Props) {
    ...
    >
      <div className="flex">
        <div className="w-full">
          <ProjectLayer2sStats project={project} />
          ...
          >
              ...
              <Tooltip>
                <TooltipTrigger className="w-full cursor-pointer" asChild>
                  <ConditionalLink
                    ...
                    href={
                      project.header.tvs
                        ? `/layer2s/projects/${project.slug}/tvs-breakdown`
                        : undefined
                    }
                  >
                    <TokenBreakdown
            ...
            <div>
              ...
              <CustomLink
                href={`/layer2s/projects/${project.slug}/tvs-breakdown`}
        ...
        <ProjectLayer2sRosette project={project} size="small" />
      </div>
...
function InteropMetrics({
  ...
  interop: NonNullable<ProjectLayer2sEntry['header']['interop']>
}) {
  const headlineStats = [
    {
