...
import { ProjectLayer2sSummary } from './components/Layer2sProjectSummary'

interface Props extends AppLayoutProps {
  projectEntry: ProjectLayer2sEntry
  queryState: DehydratedState
}

export function Layer2sProjectPage({
  projectEntry,
  queryState,
  ...props
}: Props) {
            ...
            <div className="relative z-0 max-md:bg-surface-primary">
              ...
              <div className="grid-cols-[minmax(0,_1fr)_180px] gap-x-6 lg:grid">
                ...
                <div className="row-start-2">
                  <ProjectLayer2sSummary project={projectEntry} />
