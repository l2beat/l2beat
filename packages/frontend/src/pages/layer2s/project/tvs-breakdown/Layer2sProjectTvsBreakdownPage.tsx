...
import type { Layer2sProjectTvsBreakdown } from '~/server/features/layer2s/project/getLayer2sProjectTvsBreakdown'
import type { ChartRange } from '~/utils/range/range'
import { Layer2sRwaRestrictedTokensContextProvider } from '../../components/Layer2sRwaRestrictedTokensContext'
...
interface Props extends AppLayoutProps, Layer2sProjectTvsBreakdown {
  defaultRange: ChartRange
}

export function Layer2sProjectTvsBreakdownPage({
  project,
  dataTimestamp,
  entries,
  project7dData,
