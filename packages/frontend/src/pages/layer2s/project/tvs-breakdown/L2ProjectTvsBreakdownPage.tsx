...
import type { L2ProjectTvsBreakdown } from '~/server/features/layer2s/project/getL2ProjectTvsBreakdown'
import type { ChartRange } from '~/utils/range/range'
import { L2RwaRestrictedTokensContextProvider } from '../../components/L2RwaRestrictedTokensContext'
...
interface Props extends AppLayoutProps, L2ProjectTvsBreakdown {
  defaultRange: ChartRange
}

export function L2ProjectTvsBreakdownPage({
  project,
  dataTimestamp,
  entries,
  project7dData,
