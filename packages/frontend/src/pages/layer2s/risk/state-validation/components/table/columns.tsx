...
function defenderAdvantageLine(
  da: L2RiskStateValidationOptimisticEntry['defenderAdvantage'],
): string | undefined {
...
function getTvsColumns<T extends CommonL2Entry & { tvs: TvsData }>(
...
const validityColumnHelper =
  createColumnHelper<L2RiskStateValidationValidityEntry>()

export const l2RiskStateValidationValidityColumns = [
  ...
  ...getTvsColumns(validityColumnHelper),
]

const optimisticColumnHelper =
  createColumnHelper<L2RiskStateValidationOptimisticEntry>()

export const l2RiskStateValidationOptimisticColumns = [
  ...getL2CommonProjectColumns(
  ...
  ...getTvsColumns(optimisticColumnHelper),
]

const noProofsColumnHelper =
  createColumnHelper<L2RiskStateValidationNoProofsEntry>()

export const l2RiskStateValidationNoProofsColumns = [
  ...getL2CommonProjectColumns(
  ...
  ...getTvsColumns(noProofsColumnHelper),
]
