...
function defenderAdvantageLine(
  da: Layer2sRiskStateValidationOptimisticEntry['defenderAdvantage'],
): string | undefined {
...
function getTvsColumn<T extends CommonLayer2sEntry & { tvs: TvsData }>(
...
const validityColumnHelper =
  createColumnHelper<Layer2sRiskStateValidationValidityEntry>()

export const layer2sRiskStateValidationValidityColumns = [
...
const optimisticColumnHelper =
  createColumnHelper<Layer2sRiskStateValidationOptimisticEntry>()

export const layer2sRiskStateValidationOptimisticColumns = [
  ...getLayer2sCommonProjectColumns(
...
const noProofsColumnHelper =
  createColumnHelper<Layer2sRiskStateValidationNoProofsEntry>()

export const layer2sRiskStateValidationNoProofsColumns = [
  ...getLayer2sCommonProjectColumns(
