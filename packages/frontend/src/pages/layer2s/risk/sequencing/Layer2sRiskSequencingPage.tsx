...
import { Layer2sRiskSequencingTable } from './components/table/Layer2sRiskSequencingTable'
...
export function Layer2sRiskSequencingPage({
  entries,
  inclusionDelayComparison,
  ...props
}: Props) {
    ...
    <AppLayout {...props}>
      <SideNavLayout>
        ...
        <TableSortingProvider initialSort={{ id: '#', desc: false }}>
          <Layer2sRiskSequencingTable entries={entries} />
