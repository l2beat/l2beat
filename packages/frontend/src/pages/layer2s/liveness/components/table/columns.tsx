...
import type { Layer2sLivenessTableEntry } from './toTableEntry'

const columnHelper = createColumnHelper<Layer2sLivenessTableEntry>()

export function getLayer2sLivenessColumns(hideProofSystem?: boolean) {
  return compact([
    ...getLayer2sCommonProjectColumns(
      columnHelper,
      (row) => `/layer2s/projects/${row.slug}#liveness`,
    ),
    columnHelper.group({
      id: 'data',
      ...
      cell: (ctx) => {
        ...
        return (
          <AnomalyIndicator
            ...
            href={`/layer2s/projects/${entry.slug}#liveness`}
          />
        )
      },
      meta: {
