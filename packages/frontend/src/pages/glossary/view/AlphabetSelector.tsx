  ...
  return (
    <a
      ...
      className={cn(
        ...
        'data-[selected]:border-pink-900 data-[selected]:dark:border-pink-200 data-[selected]:bg-purple-300 data-[selected]:dark:bg-neutral-700',
        href && 'dark:hover:bg-zinc-800 hover:bg-gray-100',
        !href &&
