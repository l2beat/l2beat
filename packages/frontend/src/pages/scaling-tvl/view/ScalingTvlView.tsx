...
interface UpcomingTableViewProps {
  items: ScalingTvlViewEntry[]
  rows: RowConfig<ScalingTvlViewEntry>
}

function UpcomingTableView({ items, rows }: UpcomingTableViewProps) {
  const columns: ColumnConfig<ScalingTvlViewEntry>[] = [
    {
      name: '#',
      alignCenter: true,
...
function ArchivedTableView({ items, rows }: ArchivedTableViewProps) {
  const columns: ColumnConfig<ScalingTvlViewEntry>[] = [
    {
      name: '#',
      alignCenter: true,
