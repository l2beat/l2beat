...
import { CROP_CRITERIA, type CropCriteria } from '../content'

export function CropsSection() {
  return (
    <section className="mt-8 md:mt-12">
      <SectionHeading
        title="The four crops, and where the bar sits"
        description="Each crop is judged on its own. These are the bars the evaluations already in the garden have been held to."
      />
