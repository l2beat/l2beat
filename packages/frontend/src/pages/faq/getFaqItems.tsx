          ...
          <p className="mt-4">
            <UnorderedList>
              ...
              <li>
                ...
                assets that use some external blockchain as their main ledger
                and are bridged to L2 via a non-canonical bridge. Tokens are
                locked on their native ledger and the bridge is minting on L2 an
                IOU representation of that token.
              </li>
              <li>
                <Strong>Natively Minted Value (NMV) </Strong>is the value of
                assets that use an L2 as their ledger and are minted directly on
                the L2. Note that for some tokens (omnichain tokens) their
                ledger is distributed across many blockchains and they can be
                moved to L2 via a burn-mint bridge.
              </li>
            </UnorderedList>
          </p>
        </div>
