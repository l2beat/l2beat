    ...
    answer: (
      <div>
        <p className="mt-4">
          ...
          committed towards becoming trust minimized L2s. Our goal is to provide
          the community with the most up-to-date information about the state of
          these projects and to provide insights and guidance for them to become
    ...
    answer: (
      <div>
        <p className="mt-4">
          ...
          reconstruct the state is not made available by the operators of the
          offchain DA solution, funds are at risk.
        </p>
      </div>
    ),
  },
    ...
    answer: (
      <div>
        <p className="mt-4">
          ...
          historical reasons. We introduced them when the L2 space was still in
          its infancy and we wanted to provide a comprehensive overview of the
          space. We will continue to track these projects to provide the
          community with a broader perspective on the state of the space and to
          provide tools to evaluate the different tradeoffs between the various
          solutions.
        </p>
      </div>
    ),
