...
export function DonateFundingSources(props: DonateFundingSourcesProps) {
  return (
    <section id="funding-sources" className="mt-16 md:mt-20">
      <div className="rounded-lg md:bg-gray-100 md:dark:bg-zinc-900 md:p-8">
        <a
          className="mb-6 font-bold text-2xl md:text-3xl md:leading-normal"
      ...
      <div className="mt-4 overflow-x-auto pb-3">
        <table>
          <thead>
            <tr className="h-14 border-b border-b-gray-200 text-left text-gray-50 text-sm dark:border-b-gray-800">
          ...
          <tbody>
            {props.items.map((item, i) => {
              return (
                <tr
                  className="h-14 border-b border-b-gray-200 text-base dark:border-b-gray-800 last:border-b-0"
                  key={i}
                >
