          ...
          <div className="relative z-10 mt-6">
            ...
            <div className="mt-2 flex flex-col gap-2 md:flex-row md:flex-wrap">
              {props.networks.map((network) => (
                <Link
                  key={network.name}
                  className="flex w-full justify-center gap-1.5 rounded-lg border border-gray-400 bg-gray-100 py-3 transition-colors md:w-max dark:border-zinc-500 dark:bg-zinc-800 dark:hover:bg-zinc-900 hover:bg-gray-200 md:px-3 md:py-1"
