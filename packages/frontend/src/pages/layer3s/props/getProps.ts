...
export function getProps(
  ...
  const { tvlApiResponse, activityApiResponse, verificationStatus, manuallyVerifiedContracts } = pagesData
  ...
  return {
    props: {
      ...
      projectDetails: getProjectDetails(project, verificationStatus, manuallyVerifiedContracts),
