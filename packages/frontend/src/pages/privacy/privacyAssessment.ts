...
export const PRIVACY_ASSESSMENT = {
  ...
  rosetteTooltip: `${PRIVACY_ADVERSARIES_TOOLTIP} The right half of the rosette holds one slice per adversary, the left half the protocol risks: trusted setup, exit window and reproducibility. Hover it for the verdict behind every slice.`,
} as const
