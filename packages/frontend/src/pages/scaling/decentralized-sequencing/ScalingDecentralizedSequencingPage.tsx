...
import { DecentralizedSequencingExplainer } from './components/DecentralizedSequencingExplainer'
...
export function ScalingDecentralizedSequencingPage({
  ...
  return (
    <AppLayout {...props}>
      <SideNavLayout>
        <MainPageHeader description="Compare projects where transaction ordering is handled by a decentralized sequencer or validator set. These guarantees are probabilistic and differ from deterministic forced-inclusion mechanisms on a host chain like Ethereum.">
          Decentralized Sequencing
        </MainPageHeader>
        <DecentralizedSequencingExplainer />
