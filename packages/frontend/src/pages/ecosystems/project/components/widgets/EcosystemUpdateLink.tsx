  ...
  return (
    ...
    >
      <div className="rounded-sm bg-surface-primary px-4 py-5">
        ...
        <p className="group-hover:-translate-y-2 origin-left font-bold text-label-value-20 transition-all ease-in-out group-hover:translate-x-4 group-hover:scale-125">
