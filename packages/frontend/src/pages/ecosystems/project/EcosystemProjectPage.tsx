...
import { EcosystemDisplayControlsContextProvider } from '~/components/table/display/contexts/EcosystemDisplayControlsContext'
  ...
  return (
    <AppLayout {...props}>
      <HydrationBoundary state={queryState}>
        <EcosystemDisplayControlsContextProvider
          initialValues={{
            ...
            <div className="relative z-0 max-md:px-4" data-hide-overflow-x>
              ...
              <div>
                <EcosystemPageHeader
                  ...
                  hasRwaRestrictedTvs={ecosystem.hasRwaRestrictedTvs}
                />
                <main className="my-(--ecosystem-spacing) grid grid-cols-12 gap-(--ecosystem-spacing)">
                  ...
                  <EcosystemsActivityChart
                    ...
                    name={ecosystem.name}
                    entries={ecosystem.liveProjects}
                    allL2ProjectsUops={ecosystem.allL2Projects.uops}
                    ecosystemMilestones={ecosystem.ecosystemMilestones}
                    className="col-span-12 md:col-span-6"
                  />
                  ...
                  <div className="col-span-12 grid grid-rows-2 gap-(--ecosystem-spacing) max-lg:hidden md:col-span-6">
                    ...
                    <EcosystemLearnMoreLink
                      ...
                      href={ecosystem.links.learnMore}
                      headlineText={
                        ecosystem.banners.secondBanner?.headlineText
                      }
