...
export async function getLayer2sRiskDaEntries() {
  const [
    tvs,
...
export interface Layer2sRiskDaEntry extends CommonLayer2sEntry {
  proofSystem: ProjectScalingProofSystem | undefined
  dataAvailability: (ProjectScalingDa & {
    daHref?: Layer2sRiskDaEntryHref
  })[]
...
function getLayer2sRiskDaEntry(
  project: Project<
    'scalingInfo' | 'statuses' | 'scalingDa' | 'display',
    'customDa' | 'contracts'
  >,
  risks: Layer2sRiskDaEntry['risks'] | undefined,
...
): Layer2sRiskDaEntry['risks'] | undefined {
...
interface Layer2sRiskDaEntryHref {
  summary: string
...
function getDaHref(
  ...
  daLayers: Project<'daLayer'>[],
): Layer2sRiskDaEntryHref | undefined {
