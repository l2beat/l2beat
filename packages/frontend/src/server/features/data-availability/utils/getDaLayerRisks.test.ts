...
describe(getDaLayerRisks.name, () => {
  ...
  it('works with ProjectCustomDa type', () => {
    ...
    expect(result.economicSecurity?.sentiment).toBe('good')
  })
})
