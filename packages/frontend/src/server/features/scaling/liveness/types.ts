...
export const LivenessTimeRange = v.enum(['30d', '90d', 'max'] as const)
...
// TODO(radomski): there is intersection in @l2beat/validate yet
//const LivenessDetails = v.union([
//  v.record(LivenessTimeRange, LivenessDataPoint.optional()),
//  v.object({ syncedUntil: v.number() }),
//])
