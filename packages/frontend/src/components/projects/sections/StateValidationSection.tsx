    ...
    <ProjectSection {...sectionProps}>
      ...
      <div className="flex flex-col gap-6">
        {stateValidation.description && (
          <>
            <Markdown className="text-gray-850 text-paragraph-15 md:text-paragraph-16 dark:text-gray-400">
              {stateValidation.description}
            </Markdown>
            <HorizontalSeparator />
          </>
...
function Category({ category }: CategoryProps) {
  ...
  return (
    <div>
      ...
      <Markdown className="mt-2 text-gray-850 text-paragraph-15 md:text-paragraph-16 dark:text-gray-400">
