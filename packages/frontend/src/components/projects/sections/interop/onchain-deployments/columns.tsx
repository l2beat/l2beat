...
import type { InteropTokenRelationsDeployment } from '~/server/features/layer2s/interop/token/getInteropTokenRelationsGraph'
...
export type DeploymentRow = InteropTokenRelationsDeployment & BasicTableRow
    ...
    cell: (ctx) => {
      ...
      return (
        <ProjectIconList
          projects={minters}
          dialog={{
            title: 'Minting bridges',
            description: 'Search for a bridge minting this deployment',
            searchPlaceholder: 'Start typing to find a bridge...',
            emptyText: 'No bridges found.',
          }}
        />
      )
    },
