...
const TooltipContent = ({
  ...
  <TooltipPrimitive.Content
    ...
    className={cn(
      'bg-white insight:bg-[#1F1F38] dark:bg-neutral-700',
      'text-left text-sm font-normal normal-case leading-tight text-gray-700 insight:!text-white dark:text-white',
