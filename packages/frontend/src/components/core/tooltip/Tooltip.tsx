...
const tooltipContentVariants = cva(
  'fade-in-0 zoom-in-95 data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-110 origin-[--radix-tooltip-content-transform-origin] animate-in rounded-lg bg-surface-primary p-3 text-left font-medium text-paragraph-13 text-primary normal-case shadow-popover data-[state=closed]:animate-out max-sm:max-w-[100vw] dark:bg-header-secondary',
  {
    variants: {
      fitContent: {
