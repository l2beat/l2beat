...
const DirectoryTabsTrigger = ({
  ...
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=inactive]:bg-surface-tertiary dark:data-[state=inactive]:bg-linear-to-t dark:data-[state=inactive]:bg-transparent dark:data-[state=inactive]:from-surface-primary/35 dark:data-[state=inactive]:to-surface-primary/75',
      'dark:data-[state=inactive]:text-secondary dark:data-[state=inactive]:hover:text-primary',
