...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-gray-200 text-sm font-medium leading-none data-[state=open]:hover:bg-gray-400 sidebar:!bg-surface-primary sidebar:data-[state=open]:hover:!bg-surface-secondary dark:bg-zinc-700 dark:data-[state=open]:hover:bg-slate-600',
      'transition-colors',
      className,
    )}
    {...props}
