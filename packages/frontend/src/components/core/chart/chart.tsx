    ...
    <ChartContext.Provider value={{ meta }}>
      <div
        ...
        className={cn(
          ...
          "flex aspect-video justify-center text-xs [&_.recharts-sector]:outline-none [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-surface]:outline-none",
          // Tooltip cursor line
