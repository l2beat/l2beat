...
const popoverTriggerClasses = cn(
  'group !rounded-lg inline-flex cursor-pointer select-none items-center gap-1.5 whitespace-pre bg-surface-primary px-3 py-1 font-medium text-xs leading-none md:text-sm',
...
const PopoverContent = ({
  ...
  <PopoverPrimitive.Content
    ...
    className={cn(
      'z-110 rounded-lg border-none p-2 shadow-popover outline-none',
      'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 glass-panel glass-content origin-[--radix-popover-content-transform-origin] data-[state=closed]:animate-out data-[state=open]:animate-in',
      className,
    )}
    {...props}
  />
