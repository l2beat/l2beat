...
export function getScalingFinalityColumnsConfig() {
  const columns: ColumnConfig<ScalingFinalityViewEntry>[] = [
    ...
    },
    {
      ...
      tooltip:
        "The average time it would take for an L2 transaction to be finalized on the L1. It's assumed that transaction data batches are submitted sequentially. Please note, this does not take into account L1 reorgs.",
    },
  ]
  return columns
}
