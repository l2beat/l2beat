...
function SelectedValue<T extends string>({
  ...
  return (
    <button
      ...
      className="flex h-8 cursor-pointer select-none items-center justify-center gap-1.5 whitespace-pre rounded-lg bg-surface-secondary px-2.5 text-base font-semibold text-brand outline-none transition-colors hover:bg-surface-tertiary"
    >
