...
export function ReportBanner() {
  return (
    <div className="md:grid-cols-2 mt-8 mb-10 flex max-h-fit flex-col overflow-hidden rounded-md bg-transparent from-gray-250 to-gray-450 md:my-12 md:grid md:bg-gradient-to-r">
