export function NoBridgeGrisiniDetailsPlaceholder() {
  return (
    <div className="w-[264px] h-[278px] text-center bg-zinc-100 dark:bg-zinc-900 items-center justify-center flex flex-col rounded-lg gap-3 p-4">
      <svg
        width="40"
        height="40"
        viewBox="0 0 40 40"
