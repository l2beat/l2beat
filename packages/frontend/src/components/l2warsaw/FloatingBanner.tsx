  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col justify-center px-4 pb-8 pt-9 xs:px-7 sm:px-11">
        ...
        <a
          className="w-full rounded-md bg-pink-900 py-[8px] text-center text-base font-bold text-white transition-all hover:bg-pink-200/60 dark:bg-pink-200 dark:text-black"
