...
export function ArcologyIcon(props: SVGAttributes<SVGElement>) {
  return (
<svg width="24" height="20.3" version="1.1" viewBox="0 0 24 20.3" xmlns="http://www.w3.org/2000/svg" aria-label="arbitrum logo" {...props}>
 <defs>
 ...
 <g transform="matrix(.58626 0 0 -.62978 -88.678 153.04)" clipPath="url(#clipPath14)">
