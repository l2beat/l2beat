...
export function OverflowWrapper({
  ...
  return (
    ...
    >
      <div
        className={cn(
          '-left-px pointer-events-none absolute inset-y-0 z-10 w-6 bg-gradient-to-r opacity-0 transition-opacity group-data-[arrow-left-visible=true]/overflow-wrapper:pointer-events-auto group-data-[arrow-left-visible=true]/overflow-wrapper:opacity-100',
          !within &&
      ...
      <div
        className={cn(
          '-right-px pointer-events-none absolute inset-y-0 z-10 w-6 bg-gradient-to-l opacity-0 transition-opacity group-data-[arrow-right-visible=true]/overflow-wrapper:pointer-events-auto group-data-[arrow-right-visible=true]/overflow-wrapper:opacity-100',
          !within &&
            'from-white via-white dark:from-neutral-900 dark:via-neutral-900',
          within === 'nav-tabs' &&
            'from-gray-100 via-gray-100 dark:from-gray-950 dark:via-gray-950',
