...
export function ScrollToTopButton(props: Props) {
  return (
    <button
      ...
      className="fixed -bottom-12 right-8 flex size-12 items-center justify-center rounded-lg bg-pink-900 transition-[bottom,background-color] ease-out hover:bg-fuchsia-700 data-[visible]:bottom-8 dark:bg-pink-200 dark:hover:bg-purple-450"
    >
