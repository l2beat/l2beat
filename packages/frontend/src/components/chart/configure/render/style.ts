...
export function getCBVStyle(): CanvasFillStrokeStyles['fillStyle'] {
  return '#7E41CC'
}

export function getEBVStyle(): CanvasFillStrokeStyles['fillStyle'] {
  return '#FFC107'
}

export function getNMVStyle(): CanvasFillStrokeStyles['fillStyle'] {
  return '#FF46C0'
}
