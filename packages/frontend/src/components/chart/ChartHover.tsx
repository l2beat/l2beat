  ...
  return (
    <div data-role="chart-hover" className="ChartHover hidden">
      ...
      <div
        ...
        className="absolute z-30 p-2 border border-current bg-white dark:bg-black shadow-sm text-right text-sm h-[76px] select-none pointer-events-none flex flex-col justify-center items-end"
      >
