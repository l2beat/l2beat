...
export function ChartEmptyState() {
  return (
    <div className="absolute inset-0 -z-1 flex select-none flex-col items-center justify-center gap-4 bg-gradient-to-t from-white opacity-0 transition-opacity duration-200 group-data-[state=empty]/chart:z-30 group-data-[state=empty]/chart:opacity-100 dark:from-neutral-900">
