...
export function ChartNoDataState() {
  ...
  return (
    <div className="absolute inset-0 z-30  flex select-none flex-col items-center justify-center gap-4 bg-gradient-to-t from-white text-center duration-200 dark:from-neutral-900">
