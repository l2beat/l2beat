  ...
  return (
    ...
    >
      <path
        ...
        className={sentimentToFillColor(
    ...
    <>
      ...
      >
        ...
        <path
          ...
          className={cx(
            sentimentToFillColor(risks.sequencerFailure, isUpcoming),
        ...
        <path
          ...
          className={cx(
            sentimentToFillColor(risks.stateValidation, isUpcoming),
            'Rosette-Slice focus:outline-none',
          )}
          data-rosette="state-validation"
        />
        <path
          ...
          className={cx(
            sentimentToFillColor(risks.dataAvailability, isUpcoming),
            'Rosette-Slice focus:outline-none',
          )}
          data-rosette="data-availability"
        />
        <path
          ...
          className={cx(
            sentimentToFillColor(risks.upgradeability, isUpcoming),
            'Rosette-Slice focus:outline-none',
          )}
          data-rosette="upgradeability"
        />
        <path
          ...
          className={cx(
            sentimentToFillColor(risks.validatorFailure, isUpcoming),
            'Rosette-Slice focus:outline-none',
          )}
          data-rosette="validator-failure"
        />
