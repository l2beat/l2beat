...
import { risksToImagePizzas } from './real-elements/images'
...
export function RealPizzaRosetteIcon({
  ...
  const { sliceHoverPaths } = risksToPizzas(values, selectRisk)
  ...
  return (
    <>
      ...
      {risksToImagePizzas(values, selectedRisk, containerSize)}
    </>
  )
}
