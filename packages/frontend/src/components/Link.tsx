  ...
  return (
    <a
      ...
      className={classNames(
        ...
        'data-[state=highlighted]:before:border',
        'data-[state=highlighted]:before:border-dashed data-[state=highlighted]:before:border-yellow-250 data-[state=highlighted]:before:bg-yellow-250 data-[state=highlighted]:before:bg-opacity-10 data-[state=highlighted]:before:content-[""]',
        className,
      )}
