  ...
  return (
    <div className="ExpandableContainer">
      ...
      >
        ...
        <div className="ExpandableContainerContentGradient pointer-events-none absolute inset-x-0 bottom-0 h-8 bg-gradient-to-b from-transparent to-white dark:to-black "></div>
      </div>
