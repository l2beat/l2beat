import { DetailedTvlApiResponse, ProjectId, TvlApiResponse } from '@l2beat/shared-pure'

export function getIncludedProjects<
  T extends { id: ProjectId; isUpcoming?: boolean; type: 'bridge' | 'layer2' },
>(projects: T[], tvlApiResponse: TvlApiResponse | DetailedTvlApiResponse, buildAllProjectPages = false) {
