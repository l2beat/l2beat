...
export function printApiInfo(tvlApiResponse: TvlApiResponse | DetailedTvlApiResponse) {
  console.debug('\n', 'TVL')
  ...
  function printTvl(label: string, charts: TvlApiResponse['combined'] | DetailedTvlApiResponse['combined']) {
