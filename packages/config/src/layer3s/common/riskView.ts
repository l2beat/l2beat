...
export const UPCOMING_RISK_VIEW: Layer3RiskView = makeBridgeCompatible({
...
export const UNDER_REVIEW_RISK_VIEW: Layer3RiskView = makeBridgeCompatible({
