...
import type { ProjectCrops, ProjectScalingInfo } from '../../types'
import type { CropsAttestationsMeta } from '../cropsApi'
import type {
  CropsApiInput,
  CropsApiInputProject,
} from '../generateCropsApiFiles'

// Plain fixtures for the API generator tests: contracts, a proxy with an
// implementation, a permission holder, a shared contract, a project without a
// page, and an attested and an unattested project.
...
export const UNISWAP: CropsApiInputProject = {
  id: 'uniswapv3',
  slug: 'uniswap-v3',
  name: 'Uniswap V3',
  crops: ALL_GOOD,
...
export const OTHER: CropsApiInputProject = {
  id: 'other',
  slug: 'other',
  name: 'Other',
  crops: ONE_BAD,
...
export const FIXTURE_INPUT: CropsApiInput = {
