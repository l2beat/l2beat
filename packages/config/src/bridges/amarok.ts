...
export const amarok: Bridge = {
  ...
  contracts: {
    addresses: [
      {
        ...discovery.getContractDetails('ConnextBridge'),
        description:
      ...
      {
        ...discovery.getContractDetails('RootManager'),
        description:
      ...
      {
        ...discovery.getContractDetails('ArbitrumHubConnector'),
        description:
