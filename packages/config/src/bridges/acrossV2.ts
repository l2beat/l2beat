...
export const acrossV2: Bridge = {
  ...
  riskView: {
    validation: {
      ...
      description: 'Optimistic Oracle on Ethereum is used to assert that an action happened on the destination chain.',
    },
    ...
    destinationToken: {
      value: 'Native',
      description: 'Received tokens are those previously transferred using native chain bridge.'
    }
  },
  technology: {
    category: 'Swap',
    ...
    addresses: [
      {
        address: '0xc186fA914353c44b2E33eBE05f21846F1048bEda',
        name: 'HubPool',
        description: 'Escrow contract for ERC20 tokens and administration of other contracts.',
      },
      {
