Generated with discovered.json: 0x69f5deb7c770522b7d1b793d5d4aa7df034c8e35

# Diff at Mon, 17 Mar 2025 16:49:21 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 763803
...
-        {"permission":"interact","from":"0xf369f78E3A0492CC4e96a90dae0728A38498e9c7","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs."}
...
-        {"address":"0x9eC0253E4174a14C0536261888416451A407Bf79"}
    }
```
...
-        {"address":"0x9eC0253E4174a14C0536261888416451A407Bf79"}
      receivedPermissions:
-        [{"permission":"upgrade","from":"0x340487b92808B84c2bd97C87B590EE81267E04a7","via":[{"address":"0x9eC0253E4174a14C0536261888416451A407Bf79"}]},{"permission":"upgrade","from":"0x87799989341A07F495287B1433eea98398FD73aA","via":[{"address":"0x9eC0253E4174a14C0536261888416451A407Bf79"}]},{"permission":"upgrade","from":"0x88e03D41a6EAA9A0B93B0e2d6F1B34619cC4319b","via":[{"address":"0x9eC0253E4174a14C0536261888416451A407Bf79"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x9eC0253E4174a14C0536261888416451A407Bf79"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"upgrade","from":"0x340487b92808B84c2bd97C87B590EE81267E04a7"},{"permission":"upgrade","from":"0x87799989341A07F495287B1433eea98398FD73aA"},{"permission":"upgrade","from":"0x88e03D41a6EAA9A0B93B0e2d6F1B34619cC4319b"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x340487b92808B84c2bd97C87B590EE81267E04a7"},{"permission":"upgrade","from":"0x87799989341A07F495287B1433eea98398FD73aA"},{"permission":"upgrade","from":"0x88e03D41a6EAA9A0B93B0e2d6F1B34619cC4319b"}]
    }
```
...
-        {"permission":"upgrade","from":"0x5A2b641b84b0230C8e75F55d5afd27f4Dbd59d5b"}
      receivedPermissions.6:
-        {"permission":"interact","from":"0x5A2b641b84b0230C8e75F55d5afd27f4Dbd59d5b","description":"manage addresses that are callable by EOAs and other white-/blacklists that are enforced globally on the Kinto L2."}
      receivedPermissions.5:
-        {"permission":"upgrade","from":"0xf369f78E3A0492CC4e96a90dae0728A38498e9c7"}
      receivedPermissions.4:
-        {"permission":"interact","from":"0x8a4720488CA32f1223ccFE5A087e250fE3BC5D75","description":"update the central KintoWallet implementation of all users on Kinto L2 and approve specific wallets for recovery via the turnkey recoverer."}
      receivedPermissions.3:
-        {"permission":"interact","from":"0x793500709506652Fcc61F0d2D0fDa605638D4293","description":"send tokens and ETH from the Treasury to any address without delay."}
...
```diff
    ...
    +++ description: Manages Kinto's KYC system: The KYC_PROVIDER roles responsible for the KYC status and KYC metadata of user wallets.
      issuedPermissions:
-        [{"permission":"interact","to":"0x010600ff5f36C8eF3b6Aaf2A88C2DE85C798594a","description":"permissioned to call `confirmSanction()`, which makes a temporary sanction by a KYC_PROVIDER permanent and does not grant an exit window to the affected wallet.","via":[]},{"permission":"interact","to":"0x2e2B1c42E38f5af81771e65D87729E57ABD1337a","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"interact","to":"0x2e2B1c42E38f5af81771e65D87729E57ABD1337a","description":"permissioned to call `confirmSanction()`, which makes a temporary sanction by a KYC_PROVIDER permanent and does not grant an exit window to the affected wallet.","via":[]},{"permission":"interact","to":"0x2e2B1c42E38f5af81771e65D87729E57ABD1337a","description":"transfer KYC NFTs to a different address.","via":[]},{"permission":"interact","to":"0x52F09693c9eEaA93A64BA697e3d3e43a1eB65477","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"interact","to":"0x6E09F8A68fB5278e0C33D239dC12B2Cec33F4aC7","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"interact","to":"0x6E31039abF8d248aBed57E307C9E1b7530c269E4","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"interact","to":"0x6fe642404B7B23F31251103Ca0efb538Ad4aeC07","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"interact","to":"0xacC000818e5Bbd911D5d449aA81CB5cA24024739","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"interact","to":"0xacC000818e5Bbd911D5d449aA81CB5cA24024739","description":"permissioned to call `confirmSanction()`, which makes a temporary sanction by a KYC_PROVIDER permanent and does not grant an exit window to the affected wallet.","via":[]},{"permission":"interact","to":"0xacC000818e5Bbd911D5d449aA81CB5cA24024739","description":"transfer KYC NFTs to a different address.","via":[]},{"permission":"interact","to":"0xb539019776eF803E89EC062Ad54cA24D1Fdb008a","description":"manage the KYC status of any user (sanction status and KYC metadata) and mint/burn KintoID NFTs.","via":[]},{"permission":"upgrade","to":"0x2e2B1c42E38f5af81771e65D87729E57ABD1337a","via":[]},{"permission":"upgrade","to":"0xacC000818e5Bbd911D5d449aA81CB5cA24024739","via":[]}]
    }
```
