Generated with discovered.json: 0x9e2759c38aa880890dffd7709be311cd4af488f1

# Diff at Mon, 17 Mar 2025 16:30:36 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21988484
...
+        "Kinto Security Council"
      receivedPermissions:
-        [{"permission":"interact","from":"0x5073dA9cA4810f3E0aA01c20c7d9d02C3f522e11","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability, DACs and the fastConfirmer role, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes.","via":[{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x5073dA9cA4810f3E0aA01c20c7d9d02C3f522e11","via":[{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x52EcE832AF3DF3125BbfD6423E0425dB3fA99D3F","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x6228e2FB8C561f1a5A963039Bc38Eb6D539A1A7F","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x655761AD5FC251F414D6993A73184B0669F278c8","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x7870D5398DB488c669B406fBE57b8d05b6A35e42","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0x859a53Fe2C8DA961387030E7CB498D6D20d0B2DB","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0xBFfaA85c1756472fFC37e6D172A7eC0538C14474","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0xD9041DeCaDcBA88844b373e7053B4AC7A3390D60","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]},{"permission":"upgrade","from":"0xF4Ef823D57819AC7202a081A5B49376BD28E7b3a","via":[{"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"validate","from":"0x5073dA9cA4810f3E0aA01c20c7d9d02C3f522e11","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain."}]
    }
```
...
```diff
    ...
    +++ description: Central contract for the project's configuration like its execution logic hash (`wasmModuleRoot`) and addresses of the other system contracts. Entry point for Proposers creating new Rollup Nodes (state commitments) and Challengers submitting fraud proofs (In the Orbit stack, these two roles are both held by the Validators).
      issuedPermissions.6:
-        {"permission":"upgrade","to":"0x17Eb10e12a78f986C78F973Fc70eD88072B33B7d","via":[{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]}
      issuedPermissions.5:
-        {"permission":"validate","to":"0x2bfDA59220413DEd39dD0E443620b5277EcE6348","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain.","via":[]}
      issuedPermissions.4:
-        {"permission":"validate","to":"0xe528E74302FFCF6F9F6a1c973968d98F0fDbad8f","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain.","via":[]}
      issuedPermissions.3:
-        {"permission":"validate","to":"0x64Cf65036a76E3827e448cadbc53D31EefDCE04a","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain.","via":[]}
      issuedPermissions.2:
-        {"permission":"validate","to":"0x58028fFbc25aE2e12b96276bDB125955F41D41f3","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain.","via":[]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x17Eb10e12a78f986C78F973Fc70eD88072B33B7d","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability, DACs and the fastConfirmer role, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes.","via":[{"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}]}
...
-        {"address":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"}
...
-        {"address":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"}
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x74C717C01425eb475A5fC55d2A4a9045fC9800df"},{"permission":"interact","from":"0x5073dA9cA4810f3E0aA01c20c7d9d02C3f522e11","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability, DACs and the fastConfirmer role, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes."},{"permission":"upgrade","from":"0x5073dA9cA4810f3E0aA01c20c7d9d02C3f522e11"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x5073dA9cA4810f3E0aA01c20c7d9d02C3f522e11"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"upgrade","from":"0x52EcE832AF3DF3125BbfD6423E0425dB3fA99D3F"},{"permission":"upgrade","from":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"},{"permission":"upgrade","from":"0x6228e2FB8C561f1a5A963039Bc38Eb6D539A1A7F"},{"permission":"upgrade","from":"0x655761AD5FC251F414D6993A73184B0669F278c8"},{"permission":"upgrade","from":"0x7870D5398DB488c669B406fBE57b8d05b6A35e42"},{"permission":"upgrade","from":"0x859a53Fe2C8DA961387030E7CB498D6D20d0B2DB"},{"permission":"upgrade","from":"0xBFfaA85c1756472fFC37e6D172A7eC0538C14474"},{"permission":"upgrade","from":"0xD9041DeCaDcBA88844b373e7053B4AC7A3390D60"},{"permission":"upgrade","from":"0xF4Ef823D57819AC7202a081A5B49376BD28E7b3a"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x52EcE832AF3DF3125BbfD6423E0425dB3fA99D3F"},{"permission":"upgrade","from":"0x59B851c8b1643e0735Ec3F2f0e528f3d89c3408a"},{"permission":"upgrade","from":"0x6228e2FB8C561f1a5A963039Bc38Eb6D539A1A7F"},{"permission":"upgrade","from":"0x655761AD5FC251F414D6993A73184B0669F278c8"},{"permission":"upgrade","from":"0x7870D5398DB488c669B406fBE57b8d05b6A35e42"},{"permission":"upgrade","from":"0x859a53Fe2C8DA961387030E7CB498D6D20d0B2DB"},{"permission":"upgrade","from":"0xBFfaA85c1756472fFC37e6D172A7eC0538C14474"},{"permission":"upgrade","from":"0xD9041DeCaDcBA88844b373e7053B4AC7A3390D60"},{"permission":"upgrade","from":"0xF4Ef823D57819AC7202a081A5B49376BD28E7b3a"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xF4Ef823D57819AC7202a081A5B49376BD28E7b3a","description":"Can submit transaction batches or commitments to the SequencerInbox contract on the host chain."}]
    }
```
