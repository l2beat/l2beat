  ...
  stage: getStage(
    ...
    },
    {
      ...
      additionalConsiderations: {
        short:
          'Kinto enforces the use of smart wallets and KYC by preventing arbitrary calls and new contract creation. The system ensures that KYC can be revoked only if the Security Council proactively agrees to a proposed status change by a KYC provider. Only whitelisted contracts can be called by users.',
