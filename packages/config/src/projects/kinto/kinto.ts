...
export const kinto: ScalingProject = orbitStackL2({
  ...
  display: {
    ...
    headerWarning: '[Kinto will shutdown on September 30, 2025](https://x.com/KintoXYZ/status/1964721235675537573). After this deadline, all remaining assets will be converted to USDC and a permament distribution contract will be deployed on Ethereum mainnet.',
    links: {
