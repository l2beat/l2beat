Generated with discovered.json: 0x9efe3ac3c7c8792272c8497b97b74062d627c830

# Diff at Mon, 17 Mar 2025 16:48:04 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 27584106
...
-        [{"permission":"interact","from":"0xd79005b0f06b2C518893d2Ba31f94429e555b6b1","description":"set and change address mappings."},{"permission":"upgrade","from":"0x3a314A6a3c1470Bf2854960D3Ce9D2435c7Ba794"},{"permission":"upgrade","from":"0x3D748542A3bb90952d90f99F3fbfDAD8B6756B0A"},{"permission":"upgrade","from":"0x536cf1ABfD22E61a13753c0F08613aDdF4ca0595"},{"permission":"upgrade","from":"0x769547a723783FCA36BAaf1ECcf9dfdbF6d09F38","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x88Ac5Be224B0bA925A9CA73a4FAFbA171849ec06"},{"permission":"upgrade","from":"0xA9Bc65Ff5A3106351fa92B04C91d505BcCd92Cad"},{"permission":"upgrade","from":"0xe736142a3e957660cBae61AC4bD61e5b65635140"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x3a314A6a3c1470Bf2854960D3Ce9D2435c7Ba794"},{"permission":"upgrade","from":"0x3D748542A3bb90952d90f99F3fbfDAD8B6756B0A"},{"permission":"upgrade","from":"0x536cf1ABfD22E61a13753c0F08613aDdF4ca0595"},{"permission":"upgrade","from":"0x769547a723783FCA36BAaf1ECcf9dfdbF6d09F38"},{"permission":"upgrade","from":"0x88Ac5Be224B0bA925A9CA73a4FAFbA171849ec06"},{"permission":"upgrade","from":"0xA9Bc65Ff5A3106351fa92B04C91d505BcCd92Cad"},{"permission":"upgrade","from":"0xe736142a3e957660cBae61AC4bD61e5b65635140"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xd79005b0f06b2C518893d2Ba31f94429e555b6b1","description":"set and change address mappings.","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0x3a314A6a3c1470Bf2854960D3Ce9D2435c7Ba794","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0x3D748542A3bb90952d90f99F3fbfDAD8B6756B0A","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0x536cf1ABfD22E61a13753c0F08613aDdF4ca0595","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0x769547a723783FCA36BAaf1ECcf9dfdbF6d09F38","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0x88Ac5Be224B0bA925A9CA73a4FAFbA171849ec06","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0xA9Bc65Ff5A3106351fa92B04C91d505BcCd92Cad","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]},{"permission":"upgrade","from":"0xe736142a3e957660cBae61AC4bD61e5b65635140","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xA9Bc65Ff5A3106351fa92B04C91d505BcCd92Cad"}]
    }
```
...
```diff
    ...
    +++ description: The main entry point to deposit funds from host chain to this chain. It also allows to prove and finalize withdrawals.
      issuedPermissions.1:
-        {"permission":"guard","to":"0x87Ef0aB1189F76eBCaEe736A5EB8F639a8cF156d","via":[]}
...
-        {"permission":"upgrade","to":"0x184d44C2DfB6d17C60B9Ca329b7B8630aea325Ce","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0xEAC870005Fe175eEc9365502eAEb2A6f50De1eff","via":[]}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x3a314A6a3c1470Bf2854960D3Ce9D2435c7Ba794"},{"permission":"guard","from":"0xe736142a3e957660cBae61AC4bD61e5b65635140"},{"permission":"interact","from":"0xA9Bc65Ff5A3106351fa92B04C91d505BcCd92Cad","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x536cf1ABfD22E61a13753c0F08613aDdF4ca0595"}]
    }
```
...
-        {"permission":"upgrade","to":"0x184d44C2DfB6d17C60B9Ca329b7B8630aea325Ce","via":[{"address":"0x102e24084a003feEbe57B536a3B4E29eD6AC855A"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x87Ef0aB1189F76eBCaEe736A5EB8F639a8cF156d","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x536cf1ABfD22E61a13753c0F08613aDdF4ca0595"}]
    }
```

Generated with discovered.json: 0x594daa9d65d9c084f788b8138e7d61a5d412dc00
