Generated with discovered.json: 0x29cfa18864dd951eb970c965da8d8230407d4bb9

# Diff at Mon, 17 Mar 2025 16:48:33 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 26809248
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"upgrade","to":"0x87Ef0aB1189F76eBCaEe736A5EB8F639a8cF156d","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]}
      issuedPermissions.1:
-        {"permission":"propose","to":"0xADE1F8C181934052fD1958F06B63Ef0D875803C5","via":[]}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xc2dA6Afd69F0ce69313F01c73f77E6471f06b4E4"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x9Bf9cd5aD745076b5bFb7Cc2d3b871532973C2c0","description":"set and change address mappings.","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]},{"permission":"upgrade","from":"0x520D972B4A7C1CE4d5e01bCd4349a93a8AeaEAC5","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]},{"permission":"upgrade","from":"0x52fA397D799f1CE416a2089B964Aa293c347994F","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]},{"permission":"upgrade","from":"0xc2dA6Afd69F0ce69313F01c73f77E6471f06b4E4","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]},{"permission":"upgrade","from":"0xF7Cb313CB6D146dAbB8c5E31798BDCeFc67B831b","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"propose","from":"0x520D972B4A7C1CE4d5e01bCd4349a93a8AeaEAC5"}]
    }
```
...
-        {"permission":"upgrade","to":"0x87Ef0aB1189F76eBCaEe736A5EB8F639a8cF156d","via":[{"address":"0xF5BD775557F3b8817C34Fc784971A0AF1a36DD8E"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xdC545dDC657A1E2EDA8F6cBBE382927E3C9aA6E4","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"challenge","from":"0x520D972B4A7C1CE4d5e01bCd4349a93a8AeaEAC5"},{"permission":"guard","from":"0x52fA397D799f1CE416a2089B964Aa293c347994F"},{"permission":"interact","from":"0xc2dA6Afd69F0ce69313F01c73f77E6471f06b4E4","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x9Bf9cd5aD745076b5bFb7Cc2d3b871532973C2c0","description":"set and change address mappings."},{"permission":"upgrade","from":"0x520D972B4A7C1CE4d5e01bCd4349a93a8AeaEAC5"},{"permission":"upgrade","from":"0x52fA397D799f1CE416a2089B964Aa293c347994F"},{"permission":"upgrade","from":"0xc2dA6Afd69F0ce69313F01c73f77E6471f06b4E4"},{"permission":"upgrade","from":"0xF7Cb313CB6D146dAbB8c5E31798BDCeFc67B831b","description":"upgrading the bridge implementation can give access to all funds escrowed therein."}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x520D972B4A7C1CE4d5e01bCd4349a93a8AeaEAC5"},{"permission":"upgrade","from":"0x52fA397D799f1CE416a2089B964Aa293c347994F"},{"permission":"upgrade","from":"0xc2dA6Afd69F0ce69313F01c73f77E6471f06b4E4"},{"permission":"upgrade","from":"0xF7Cb313CB6D146dAbB8c5E31798BDCeFc67B831b"}]
    }
```
