Generated with discovered.json: 0xffff3346b641d9c8d551cff8c9d89467124b7f2f

# Diff at Mon, 17 Mar 2025 16:30:24 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21802913
...
-        [{"permission":"interact","from":"0x8c5D64d10394cFa070066e70Ec19E67398b4dABE","description":"set and change address mappings."},{"permission":"upgrade","from":"0x11FE3be54aC01C13Dd985cE2BdD10eD77e1376cc"},{"permission":"upgrade","from":"0x34a9f273cbD847d49c3De015FC26c3E66825f8b2"},{"permission":"upgrade","from":"0x34C0bD5877A5Ee7099D0f5688D65F4bB9158BDE2","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x36cb65c1967A0Fb0EEE11569C51C2f2aA1Ca6f6D"},{"permission":"upgrade","from":"0x61ca43CB037aC9181d8Fa5CD0073dC314065Ccc4"},{"permission":"upgrade","from":"0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4"},{"permission":"upgrade","from":"0xa9B5Fb84B7aeAF0D51C95DB04a76B1D4738D0eC5"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x11FE3be54aC01C13Dd985cE2BdD10eD77e1376cc"},{"permission":"upgrade","from":"0x34a9f273cbD847d49c3De015FC26c3E66825f8b2"},{"permission":"upgrade","from":"0x34C0bD5877A5Ee7099D0f5688D65F4bB9158BDE2"},{"permission":"upgrade","from":"0x36cb65c1967A0Fb0EEE11569C51C2f2aA1Ca6f6D"},{"permission":"upgrade","from":"0x61ca43CB037aC9181d8Fa5CD0073dC314065Ccc4"},{"permission":"upgrade","from":"0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4"},{"permission":"upgrade","from":"0xa9B5Fb84B7aeAF0D51C95DB04a76B1D4738D0eC5"}]
    }
```
...
-        {"permission":"upgrade","to":"0xe0d7755252873c4eF5788f7f45764E0e17610508","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xe0d7755252873c4eF5788f7f45764E0e17610508","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x34a9f273cbD847d49c3De015FC26c3E66825f8b2"}]
    }
```
...
-        {"permission":"upgrade","to":"0xe0d7755252873c4eF5788f7f45764E0e17610508","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0xe0d7755252873c4eF5788f7f45764E0e17610508","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
...
-        [{"permission":"interact","to":"0x8306300ffd616049FD7e4b0354a64Da835c1A81C","description":"configure important addresses like the operator or the EtherRouter and withdraw ETH and ERC-20s from the contract (usually not escrowed here).","via":[]},{"permission":"interact","to":"0x8306300ffd616049FD7e4b0354a64Da835c1A81C","description":"pause ETH deposits / frxETH mints and withdraw ETH and ERC-20s from the contract (usually not escrowed here).","via":[]}]
      receivedPermissions:
-        [{"permission":"interact","from":"0x5E8422345238F34275888049021821E8E08CAa1f","description":"can mint frxETH tokens."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x5acAf61d339dd123e60ba450Ea38fbC49445007C","description":"set the default AMO and lending pool contracts among the registered ones and trigger the predefined rebalancing functions of the router."},{"permission":"interact","from":"0x5acAf61d339dd123e60ba450Ea38fbC49445007C","description":"withdraw all escrowed ETH and ERC-20s and configure important addresses like the operator, AMO(s) or the lending pool(s)."},{"permission":"interact","from":"0x7Bc6bad540453360F744666D625fec0ee1320cA3","description":"configure important addresses like the operator or the EtherRouter and withdraw ETH and ERC-20s from the contract (usually not escrowed here)."},{"permission":"interact","from":"0x7Bc6bad540453360F744666D625fec0ee1320cA3","description":"pause ETH deposits / frxETH mints and withdraw ETH and ERC-20s from the contract (usually not escrowed here)."}]
    }
```
...
```diff
    ...
    +++ description: Allows for time-delayed execution of transactions. Current delay is 2d.
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x5E8422345238F34275888049021821E8E08CAa1f","description":"can add and remove frxETH minters and set a new timelock address."},{"permission":"interact","from":"0xbAFA44EFE7901E04E39Dad13167D089C559c1138","description":"can withdraw all escrowed ETH, pause the contract and set user fees for minting frxETH (`submit()`)."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x5E8422345238F34275888049021821E8E08CAa1f","description":"can add and remove frxETH minters and set a new timelock address.","via":[{"address":"0x8412ebf45bAC1B340BbE8F318b928C466c4E39CA","delay":172800}]},{"permission":"interact","from":"0xbAFA44EFE7901E04E39Dad13167D089C559c1138","description":"can withdraw all escrowed ETH, pause the contract and set user fees for minting frxETH (`submit()`).","via":[{"address":"0x8412ebf45bAC1B340BbE8F318b928C466c4E39CA","delay":172800}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x8412ebf45bAC1B340BbE8F318b928C466c4E39CA","delay":172800}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4"},{"permission":"guard","from":"0x36cb65c1967A0Fb0EEE11569C51C2f2aA1Ca6f6D"},{"permission":"guard","from":"0x61ca43CB037aC9181d8Fa5CD0073dC314065Ccc4"},{"permission":"interact","from":"0x34a9f273cbD847d49c3De015FC26c3E66825f8b2","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0x8c5D64d10394cFa070066e70Ec19E67398b4dABE","description":"set and change address mappings.","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0x11FE3be54aC01C13Dd985cE2BdD10eD77e1376cc","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0x34a9f273cbD847d49c3De015FC26c3E66825f8b2","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0x34C0bD5877A5Ee7099D0f5688D65F4bB9158BDE2","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0x36cb65c1967A0Fb0EEE11569C51C2f2aA1Ca6f6D","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0x61ca43CB037aC9181d8Fa5CD0073dC314065Ccc4","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]},{"permission":"upgrade","from":"0xa9B5Fb84B7aeAF0D51C95DB04a76B1D4738D0eC5","via":[{"address":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x13Fe62cB24aEa5afd179F20D362c056c3881ABcA"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4"}]
    }
```
