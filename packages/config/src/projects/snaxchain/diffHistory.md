Generated with discovered.json: 0x6a6590aa711cb9e3ecdae938b0a5731457e1adde

# Diff at Wed, 23 Sep 2026 05:49:44 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1784563638
...
```diff
    contract DisputeGameFactory (eth:0x0fD13C7f11d95070cE5CF31BAf1aCf9355BF4578) [opstack/DisputeGameFactory] {
...
```diff
    contract L1CrossDomainMessenger (eth:0x2A4fC0E3B365052d71B9853Efd0123985559f62E) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract ProxyAdmin (eth:0x672B75103c0CbFdCC4A40737a80724f87a8A25D7) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
```diff
    contract OptimismPortal2 (eth:0x936D881b4760D5e9b6D55b774f65c509236b4743) [opstack/OptimismPortal2] {
...
```diff
    contract DelayedWETH (eth:0xa3596ceeC35c004E560f57937bD695dbd22FEFcc) [opstack/DelayedWETH] {
...
```diff
    contract L1StandardBridge (eth:0xA5fb68C24b02852e8B514E98A1014faf12547Fa5) [opstack/L1StandardBridge] {
...
```diff
    contract AddressManager (eth:0xd7BF8B8618c21F337d8eD30aC797Fa330eb94411) [opstack/AddressManager] {
...
Generated with discovered.json: 0xfd7810699b9e59ba0cd4ace98307a2c5a7489463

# Diff at Mon, 21 Sep 2026 11:24:07 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1784563638
- current timestamp: 1784563638
...
Generated with discovered.json: 0x1d323c1cd66e2c7ac2bb2d7aeaa4aa289b1ce330

# Diff at Fri, 18 Sep 2026 10:24:55 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1784563638
- current timestamp: 1784563638
...
```diff
    contract PermissionedDisputeGame (eth:0x1B780edfb393CB9f07Dcd7C699CBDF0fd663572b) [opstack/PermissionedDisputeGame] {
...
```diff
    contract AnchorStateRegistry (eth:0x1E94368370862cEf26DDb187CA44EBD74DA87Ad1) [opstack/AnchorStateRegistry] {
...
Generated with discovered.json: 0x621734232c0372cbf547aefa54a6702b155cda8a

# Diff at Mon, 20 Jul 2026 16:08:43 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@ab4290b6bc5b6a34b8b091245cd07a7a94441102 block: 1770983159
- current timestamp: 1784563638
...
+        "0xa9d49d43c1f2cd8b840b38486dff4d5c39da96d00bb42dbc0a57bb7bb2a56d0f"
      deployerAddress:
+        "eth:0xDb9Eeb4f513F759bF262739AFE2e76AC22516a9C"
    }
```

```diff
    contract L1ERC721Bridge (eth:0x45561F85e43Ac0d2258c0F0C16540ce128EA1634) [opstack/L1ERC721Bridge] {
...
```diff
    contract OptimismMintableERC20Factory (eth:0xeEC78bcEA0EfBbA6e1BE7aFc58C93b70f97d3A6A) [opstack/OptimismMintableERC20Factory] {
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@55ab80636f1e0c000e757a7a146f11035a19e9c0 block: 1768984469
- current timestamp: 1770983159
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1768984469 (main branch discovery), not current.
...
Generated with discovered.json: 0x930c68e73446812654840d2dd5f404ddcbc1ade1

# Diff at Wed, 21 Jan 2026 08:35:32 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@a72aa7d50f1dddc0c7a6eae7f60679fc94e4eabf block: 1768222405
- current timestamp: 1768984469
...
Generated with discovered.json: 0x4445b20f985701e08f1268dc38e85721d8047478

# Diff at Mon, 12 Jan 2026 12:54:45 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@557c7b7c85b0fdc7328c16902e8eb6d003abcbf3 block: 1765551151
- current timestamp: 1768222405
...
Generated with discovered.json: 0xe4b8ddf698ff86b88bd8824de823a5bbbaf0c4af

# Diff at Fri, 12 Dec 2025 16:20:07 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d2235ef7f5c90cb4a3a617fea7d52a655dc22fa1 block: 1764933876
- current timestamp: 1765551151
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764933876 (main branch discovery), not current.
...
Generated with discovered.json: 0xdd231d139fe598b3a4a23f7d1997fbac1fc4e336

# Diff at Fri, 05 Dec 2025 11:25:52 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1edf3e71cea32596658a3ea017cea9df6408b77c block: 1759480976
- current timestamp: 1764933876
...
Generated with discovered.json: 0xc42994044765c2ceb5b171b0fd8b20dd998fc806

# Diff at Tue, 04 Nov 2025 11:34:26 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1759480976
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1759480976 (main branch discovery), not current.

```diff
    contract PermissionedDisputeGame (eth:0x1B780edfb393CB9f07Dcd7C699CBDF0fd663572b) {
    +++ description: Same as FaultDisputeGame, but only two permissioned addresses are designated as proposer and challenger.
      sourceHashes.0:
...
Generated with discovered.json: 0xda8406a7b72c353cdabcef2fa88fba4955904540
