Generated with discovered.json: 0xa742a853b5de0f76e8fe3603cfe7eebc6e577ff0

# Diff at Wed, 16 Sep 2026 14:35:01 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@46c99238e8a0ab5dceba63616e2dee6b1d122281 block: 1787669007
- current timestamp: 1789569237
...
```diff
    contract UpgradeExecutor (eth:0x07390626b8Bc2C04b1D93c7D246A0629198D7868) [orbitstack/UpgradeExecutor] {
    +++ description: Central contract defining the access control permissions for upgrading the system contract implementations.
      directlyReceivedPermissions.1.from:
-        "eth:0x448Bbd134dE1B23976073aB4F2915849b2dcD73A"
+        "eth:0xB55002d2795217Fd3B91EcBb3385ba9A231E5327"
...
```diff
    contract Bridge (eth:0x383c03c4EfF819E73409DbC690755a9992393814) [orbitstack/Bridge] {
...
+        "eth:0x677ECf96DBFeE1deFbDe8D2E905A39f73Aa27B89"
      values.$pastUpgrades.1:
+        ["2026-09-08T11:59:11.000Z","0x88bcfd3a7fa65b9ee0f95f9296c16a506511cad3cc6b03552d2548cebd8dd3eb",["eth:0x677ECf96DBFeE1deFbDe8D2E905A39f73Aa27B89"]]
      values.$upgradeCount:
-        1
+        2
      values.rollup:
...
-        "Bridge"
      implementationNames.eth:0x677ECf96DBFeE1deFbDe8D2E905A39f73Aa27B89:
+        "Bridge"
    }
```

```diff
    EOA (eth:0x3ec947F2A6690a4a82E0AC59Ff0837474572CEE5) {
    +++ description: None
...
```diff
    contract Outbox (eth:0x3f373b0A7DcEe7b7bCfC16DF85CfAE18388542c9) [orbitstack/Outbox] {
...
+        "eth:0x186267690cb723d72A7EDBC002476E23D694cB33"
      values.$pastUpgrades.1:
+        ["2026-09-08T11:59:11.000Z","0x88bcfd3a7fa65b9ee0f95f9296c16a506511cad3cc6b03552d2548cebd8dd3eb",["eth:0x186267690cb723d72A7EDBC002476E23D694cB33"]]
      values.$upgradeCount:
-        1
+        2
      values.rollup:
...
-        "Outbox"
      implementationNames.eth:0x186267690cb723d72A7EDBC002476E23D694cB33:
+        "Outbox"
    }
```
...
```diff
-   Status: DELETED
    contract RollupProxy (eth:0x448Bbd134dE1B23976073aB4F2915849b2dcD73A) [orbitstack/RollupProxy_fastConfirm]
...
-        {"permission":"upgrade","from":"eth:0x448Bbd134dE1B23976073aB4F2915849b2dcD73A","role":"admin","via":[{"address":"eth:0x07390626b8Bc2C04b1D93c7D246A0629198D7868"}]}
      receivedPermissions.6:
+        {"permission":"upgrade","from":"eth:0xB55002d2795217Fd3B91EcBb3385ba9A231E5327","role":"admin","via":[{"address":"eth:0x07390626b8Bc2C04b1D93c7D246A0629198D7868"}]}
      receivedPermissions.7.from:
-        "eth:0x728B406A4809118533D96bB3b5C50712C99d8Fa5"
+        "eth:0xBA105c3F0FfAAF093614C1eFEcA0AEe7Bc1a0098"
    }
```

```diff
    contract Inbox (eth:0x672109752635177ebcb17F2C7e04575A709014BD) [orbitstack/Inbox] {
...
+        "eth:0x9C4ce5EF20F831F4e7fEcf58aAA0Cda8d3091c35"
      values.$pastUpgrades.2:
+        ["2026-09-08T11:59:11.000Z","0x88bcfd3a7fa65b9ee0f95f9296c16a506511cad3cc6b03552d2548cebd8dd3eb",["eth:0x9C4ce5EF20F831F4e7fEcf58aAA0Cda8d3091c35"]]
      values.$upgradeCount:
-        2
+        3
      implementationNames.eth:0xf3830309BdfADcC7eEEF99C2EeA879D5fA6C756C:
-        "Inbox"
      implementationNames.eth:0x9C4ce5EF20F831F4e7fEcf58aAA0Cda8d3091c35:
+        "Inbox"
    }
```

```diff
    contract SequencerInbox (eth:0x6CA2A628fb690Bd431F4aA608655ce37c66aff9d) [orbitstack/SequencerInbox] {
...
+        "eth:0xE4bE5495054fE4fa4Ea5972219484984927681E3"
      values.$pastUpgrades.3:
+        ["2026-09-08T11:59:11.000Z","0x88bcfd3a7fa65b9ee0f95f9296c16a506511cad3cc6b03552d2548cebd8dd3eb",["eth:0xE4bE5495054fE4fa4Ea5972219484984927681E3"]]
      values.$upgradeCount:
-        3
+        4
...
-        "SequencerInbox"
      implementationNames.eth:0xE4bE5495054fE4fa4Ea5972219484984927681E3:
+        "SequencerInbox"
    }
```
...
```diff
-   Status: DELETED
    contract ChallengeManager (eth:0x728B406A4809118533D96bB3b5C50712C99d8Fa5) [orbitstack/ChallengeManager]
    +++ description: Contract that allows challenging state roots. Can be called through the RollupProxy by Validators or the UpgradeExecutor.
```

```diff
    contract ProxyAdmin (eth:0x74627dd54FA6E94c87F12DBAdAEc275758f51dF9) [global/ProxyAdmin] {
    +++ description: None
...
```diff
    contract RollupEventInbox (eth:0xFd9f59554351122b231F832a0e0A1aBb0604D7fd) [orbitstack/RollupEventInbox] {
...
+        "eth:0x7b6784fbd233EDB47E11eA4e7205fC4229447662"
      values.$pastUpgrades.1:
+        ["2026-09-08T11:59:11.000Z","0x88bcfd3a7fa65b9ee0f95f9296c16a506511cad3cc6b03552d2548cebd8dd3eb",["eth:0x7b6784fbd233EDB47E11eA4e7205fC4229447662"]]
      values.$upgradeCount:
-        1
+        2
      values.rollup:
...
-        "RollupEventInbox"
      implementationNames.eth:0x7b6784fbd233EDB47E11eA4e7205fC4229447662:
+        "RollupEventInbox"
    }
```
...
```diff
+   Status: CREATED
    contract RollupProxy (eth:0xB55002d2795217Fd3B91EcBb3385ba9A231E5327) [orbitstack/RollupProxyBoLD]
    +++ description: Central contract for the project's configuration like its execution logic hash (`wasmModuleRoot`) and addresses of the other system contracts. Entry point for Proposers creating new assertions (state commitments) and Challengers submitting fraud proofs (In the Orbit stack, these two roles are both called Validators).
```

```diff
+   Status: CREATED
    contract EdgeChallengeManager (eth:0xBA105c3F0FfAAF093614C1eFEcA0AEe7Bc1a0098) [orbitstack/EdgeChallengeManager]
...
.../{.flat@1787669007 => .flat}/Bridge/Bridge.sol  |  335 +-
 ...
 17 files changed, 13174 insertions(+), 9615 deletions(-)
```

Generated with discovered.json: 0x1387a018f4588c169fc2bad06dac770701cf08e7

# Diff at Tue, 25 Aug 2026 14:44:31 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@bba6c9e66ca2dd99590b6f233fe8f6509dc767a0 block: 1786359806
- current timestamp: 1787669007
...
discovery. Values are for block 1786359806 (main branch discovery), not current.
...
Generated with discovered.json: 0x985124a45a67f597ffcc70f8614d55af6a3f198e

# Diff at Mon, 10 Aug 2026 11:04:34 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@b69b5b6595d9041cb4e6d7872e95451210cc7bd7 block: 1785996153
- current timestamp: 1786359806

## Description

RollupProxy: `stakerCount` rose from 2 to 3 as an additional validator staked.
...
Generated with discovered.json: 0xf99265f6322c3c25c47a37d1c0c06fe9e4a749fb

# Diff at Thu, 06 Aug 2026 06:04:01 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c6a2ea4e2580ecbcf392fb46cb610962936e71cb block: 1779719731
- current timestamp: 1785996153

## Description

Migrated from Gelato to Conduit as RaaS provider: the UpgradeExecutor `EXECUTOR_ROLE` moved from Gelato Multisig to Conduit Multisig 1, and the batch poster and one validator were rotated. The DA committee shrank from 2 to 1 member and `minimumAssertionPeriod` dropped 75 → 10 Ethereum blocks.
...
+        "eth:0x3ec947F2A6690a4a82E0AC59Ff0837474572CEE5"
    }
```
...
+        "eth:0x312F51C032ea949b824381acb7B3f2C712593802"
...
```diff
.../Gelato Multisig => .flat/Conduit Multisig 1}/GnosisSafe.sol           | 0
 .../Gelato Multisig => .flat/Conduit Multisig 1}/GnosisSafeProxy.p.sol    | 0
 2 files changed, 0 insertions(+), 0 deletions(-)
```

Generated with discovered.json: 0x1ded0acb1cc68504e22100f1582e0f31d6eaf30f

# Diff at Tue, 09 Jun 2026 12:43:38 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1779719731
- current timestamp: 1779719731
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1779719731 (main branch discovery), not current.

```diff
    EOA  (eth:0x29156F8dFfE8979F49E3a085dbb10477373a6051) {
    +++ description: None
...
```diff
    EOA  (eth:0xC3D92d18c9CcD418A5547C28a5c3be60E694EA3c) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
Generated with discovered.json: 0x0d9f7cbc9a3a9c3e1dfa7807337f6e15b35030ca

# Diff at Mon, 25 May 2026 14:36:45 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@6898129972dbc5b1b4f1389afaf9cb3fb7fd3380 block: 1777390991
- current timestamp: 1779719731
...
Generated with discovered.json: 0xbc2808dff5da33ec6e5923952a7f36bdf432b795

# Diff at Fri, 15 May 2026 12:36:21 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a5152b9ba7ad7f85f2af3d814f74630fcaa7c917 block: 1777390991
...
Generated with discovered.json: 0x56475a8e6ec91a6c34f00becaae58d5a23283b43

# Diff at Fri, 08 May 2026 07:51:51 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1777390991
- current timestamp: 1777390991
...
```diff
    contract SocketVault_Reya (eth:0xdFf78A949E47c1e90f3Dd6dd7Fe2Fa72B42a75f7) [N/A] {
    +++ description: None
      sourceHashes.0:
-        "0x5a961d4cd1fe9b96535b53aaf638b45677b06e22d26037a62ccf6adc9c29f79d"
+        "0x65c47409ec8362bc3e22f9ada8df802406e2d195a5a9c391e6926a758fda86fe"
    }
```
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5f335de80b3c24849b3bcc1271bae84dc6e931f7 block: 1764335253
- current timestamp: 1774433302
...
Generated with discovered.json: 0xbe5a2abbfbc92e5e586f515ce3685bd3f8445b08

# Diff at Mon, 05 Jan 2026 17:44:59 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1764335253
- current timestamp: 1764335253
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764335253 (main branch discovery), not current.
...
Generated with discovered.json: 0xdc7299ee031ade00e9e5e66ab062adee2395c4fe

# Diff at Fri, 28 Nov 2025 13:08:38 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@279d1ad356551e0a039b2400b6ca3bfd5e1e0974 block: 1756118139
- current timestamp: 1764335253
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ec4b16fd723bf2a8625a616c4b3a1119ce79fb29 block: 1756118139
...
Generated with discovered.json: 0x98f93a996a26a76330016a125e9033f465020948

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0x0098a7acbd9f72568683cbfa61a8335fa5b3b63c

# Diff at Mon, 25 Aug 2025 14:10:22 GMT:

- chain: ethereum
- author: vincfurc (<10850139+vincfurc@users.noreply.github.com>)
- comparing to: main@ad220cb66b2845d84a69889aeb34f71bc5a0a6b0 block: 1752570599
- current timestamp: 1756118139
...
Generated with discovered.json: 0x42a8061cfcf473b4c4ceba11606bdc9b2d332532
