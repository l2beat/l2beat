Generated with discovered.json: 0xadd7dcd95a149ed6a2317344eb51d4e0d5bb6227

# Diff at Mon, 17 Mar 2025 16:31:09 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21041870
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10"}]
    }
```

```diff
    contract undefined (0x0244f7204b9c554306053Cc557e14D6Cbd40a33C) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x80e73D6BfC73c567032304C3891a06c2d9954d09"}]
    }
```
...
-        [{"permission":"interact","from":"0x75D340E5BF2eAbC39A04AF4229Ce7875B4A73B03","description":"set and change address mappings."},{"permission":"upgrade","from":"0x1D89222C28C3ba471be822203998f27Df4727C0b"},{"permission":"upgrade","from":"0x3e5FaB39eD4eFB4fc29A5201059AE819f2f0418A"},{"permission":"upgrade","from":"0x4cbab69108Aa72151EDa5A3c164eA86845f18438","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x6A12432491bbbE8d3babf75F759766774C778Db4"},{"permission":"upgrade","from":"0x80e73D6BfC73c567032304C3891a06c2d9954d09"},{"permission":"upgrade","from":"0x938D0Bb4B584d4F6f793fCB7808cA2Eea15B69A8"},{"permission":"upgrade","from":"0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x1D89222C28C3ba471be822203998f27Df4727C0b"},{"permission":"upgrade","from":"0x3e5FaB39eD4eFB4fc29A5201059AE819f2f0418A"},{"permission":"upgrade","from":"0x4cbab69108Aa72151EDa5A3c164eA86845f18438"},{"permission":"upgrade","from":"0x6A12432491bbbE8d3babf75F759766774C778Db4"},{"permission":"upgrade","from":"0x80e73D6BfC73c567032304C3891a06c2d9954d09"},{"permission":"upgrade","from":"0x938D0Bb4B584d4F6f793fCB7808cA2Eea15B69A8"},{"permission":"upgrade","from":"0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10"}]
    }
```
...
-        {"permission":"upgrade","to":"0x8AC80fa0993D95C9d6B8Cb494E561E6731038941","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]}
      issuedPermissions.1:
-        {"permission":"guard","to":"0x7ef00577fAAa44D0491970D6516eB7b90EC3c80E","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    contract undefined (0x7ef00577fAAa44D0491970D6516eB7b90EC3c80E) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x3e5FaB39eD4eFB4fc29A5201059AE819f2f0418A"},{"permission":"guard","from":"0x6A12432491bbbE8d3babf75F759766774C778Db4"}]
    }
```
...
-        {"permission":"upgrade","to":"0x8AC80fa0993D95C9d6B8Cb494E561E6731038941","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]}
      issuedPermissions.1:
-        {"permission":"sequence","to":"0x0244f7204b9c554306053Cc557e14D6Cbd40a33C","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x75D340E5BF2eAbC39A04AF4229Ce7875B4A73B03","description":"set and change address mappings.","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0x1D89222C28C3ba471be822203998f27Df4727C0b","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0x3e5FaB39eD4eFB4fc29A5201059AE819f2f0418A","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0x4cbab69108Aa72151EDa5A3c164eA86845f18438","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0x6A12432491bbbE8d3babf75F759766774C778Db4","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0x80e73D6BfC73c567032304C3891a06c2d9954d09","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0x938D0Bb4B584d4F6f793fCB7808cA2Eea15B69A8","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]},{"permission":"upgrade","from":"0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x1075B29e5F7a911128C77F3989702E150C988904"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10"}]
    }
```

```diff
    contract undefined (0xC4878516C198a919566773797e24af20DfdE6272) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x80e73D6BfC73c567032304C3891a06c2d9954d09","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x6A12432491bbbE8d3babf75F759766774C778Db4","description":"can overwrite the calldata of any withdrawals in the OptimismPortal on finalization, potentially stealing the withdrawn funds or calling arbitrary contracts."}]
    }
```
...
-        {"permission":"upgrade","to":"0x8AC80fa0993D95C9d6B8Cb494E561E6731038941","via":[{"address":"0x1075B29e5F7a911128C77F3989702E150C988904"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0xB5C248B428f9b2D8E8a03eE016760145b84098a9","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
