...
export const gmnetwork: Layer2 = opStackL2({
  ...
  display: {
    ...
    description:
      'GM Network is an OP stack L2 in alt-DA mode aiming to to deepen the integration of smart, connected devices within everyday human activities by blending Artificial Intelligence with the Internet of Things.',
    links: {
