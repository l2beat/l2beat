Generated with discovered.json: 0xd5b365eaa9d287cee95c7d57c5c1d2a73aa61275

# Diff at Mon, 17 Mar 2025 16:30:55 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21184911
...
-        [{"permission":"interact","from":"0x039A3B4AF85A91626f428b8B881603b6DD1f6C4C","description":"set and change address mappings."},{"permission":"upgrade","from":"0x1adE86B9cc8a50Db747b7aaC32E8527d42c71fC1","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x39A90926306E11497EC5FE1C459910258B620edD"},{"permission":"upgrade","from":"0x5e8d351FD046Aa0b3DDA24096751996C0c397C61"},{"permission":"upgrade","from":"0x94118F86eE37Fa4Fdb266CDab1e55B8F0D6959D9"},{"permission":"upgrade","from":"0xAFc9946b25e3e93208b7E2D477680C5B6e2952be"},{"permission":"upgrade","from":"0xB77d3ea899ef38c464e19F5A6CBc5a37187DC43c"},{"permission":"upgrade","from":"0xdd80E05004f40815EaEf12ffeE69c2a8A5112aA5"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x1adE86B9cc8a50Db747b7aaC32E8527d42c71fC1"},{"permission":"upgrade","from":"0x39A90926306E11497EC5FE1C459910258B620edD"},{"permission":"upgrade","from":"0x5e8d351FD046Aa0b3DDA24096751996C0c397C61"},{"permission":"upgrade","from":"0x94118F86eE37Fa4Fdb266CDab1e55B8F0D6959D9"},{"permission":"upgrade","from":"0xAFc9946b25e3e93208b7E2D477680C5B6e2952be"},{"permission":"upgrade","from":"0xB77d3ea899ef38c464e19F5A6CBc5a37187DC43c"},{"permission":"upgrade","from":"0xdd80E05004f40815EaEf12ffeE69c2a8A5112aA5"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x039A3B4AF85A91626f428b8B881603b6DD1f6C4C","description":"set and change address mappings.","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0x1adE86B9cc8a50Db747b7aaC32E8527d42c71fC1","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0x39A90926306E11497EC5FE1C459910258B620edD","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0x5e8d351FD046Aa0b3DDA24096751996C0c397C61","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0x94118F86eE37Fa4Fdb266CDab1e55B8F0D6959D9","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0xAFc9946b25e3e93208b7E2D477680C5B6e2952be","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0xB77d3ea899ef38c464e19F5A6CBc5a37187DC43c","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]},{"permission":"upgrade","from":"0xdd80E05004f40815EaEf12ffeE69c2a8A5112aA5","via":[{"address":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0xdd80E05004f40815EaEf12ffeE69c2a8A5112aA5"}]
    }
```
...
```diff
    ...
    +++ description: The main entry point to deposit funds from host chain to this chain. It also allows to prove and finalize withdrawals.
      issuedPermissions.1:
-        {"permission":"guard","to":"0xd01De08Cc118Cc1a1b39c54c8b4ff02A8ADE63eE","via":[]}
      issuedPermissions.0.to:
-        "0x2C73A1610EE822a8C2C21eddd455e725A3334c8C"
+        "0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"
      issuedPermissions.0.via.0:
...
```diff
    contract undefined (0x3D0Bf26E60a689a7Da5EA3ddAD7371F27f7671a5) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x94118F86eE37Fa4Fdb266CDab1e55B8F0D6959D9"}]
    }
```
...
```diff
    ...
    +++ description: Contains configuration parameters such as the Sequencer address, gas limit on this chain and the unsafe block signer address.
      issuedPermissions.2:
-        {"permission":"sequence","to":"0x3D0Bf26E60a689a7Da5EA3ddAD7371F27f7671a5","via":[]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xd01De08Cc118Cc1a1b39c54c8b4ff02A8ADE63eE","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.to:
-        "0x2C73A1610EE822a8C2C21eddd455e725A3334c8C"
+        "0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"
      issuedPermissions.0.via.0:
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0xdd80E05004f40815EaEf12ffeE69c2a8A5112aA5"},{"permission":"guard","from":"0x39A90926306E11497EC5FE1C459910258B620edD"},{"permission":"guard","from":"0x5e8d351FD046Aa0b3DDA24096751996C0c397C61"},{"permission":"interact","from":"0x94118F86eE37Fa4Fdb266CDab1e55B8F0D6959D9","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"propose","to":"0x33397410000A219fa5a476c5B51032B367C77e78","via":[]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0xd01De08Cc118Cc1a1b39c54c8b4ff02A8ADE63eE","via":[]}
      issuedPermissions.0.to:
-        "0x2C73A1610EE822a8C2C21eddd455e725A3334c8C"
+        "0x161aF05fA6BdA1c6E7Ee12839d470931bA796948"
      issuedPermissions.0.via.0:
