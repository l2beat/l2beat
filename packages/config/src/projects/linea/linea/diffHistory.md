Generated with discovered.json: 0xf25ac356636d6acae42aa206af97e27056fcf279

# Diff at Fri, 18 Jul 2025 10:37:41 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- current block number: 20995949
...
```diff
+   Status: CREATED
    contract Roles (0x3886a948eA7b4053312c3aE31a13776144aA6239)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract L1Timelock (0xc808BfCBeD34D90fa9579CAa664e67B9A03C56ca)
