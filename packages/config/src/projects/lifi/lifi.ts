  ...
  interopConfig: {
    ...
    intent: {
      ...
      solverAccess: {
        ...
        description:
          'Whitelisted solvers have access to an internal API and marketplace, but solving is generally permissionless in OIF.',
      },
      settlement: {
        value: 'OIF settlement',
        description:
          'Solvers fill destination outputs, then claim source inputs after oracle proofs of the fills. Oracles are configurable by LI.FI.',
      },
    },
    plugins: [
      {
