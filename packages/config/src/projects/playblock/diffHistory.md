Generated with discovered.json: 0x0cc9c35bb733dc8dcc866235e1ee8760f1031039

# Diff at Mon, 23 Mar 2026 10:57:07 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@79c8d09002c573459ff3a2b1b9f07ec4cc530fa9 block: 1765379686
...
-        "orbitstack/RollupProxy_fastConfirm"
      sourceHashes:
-        [null,"0x86c7032e0f4b5468f1eb92c79b73ab4c7f053fc7bdfc88fdd360e2fe7baa1072"]
      description:
...
-        3
      values.VALIDATOR_AFK_BLOCKS:
-        45818
      values.validators:
-        ["arb-nova:0xB246421622FB931BdAc20B4a26816F881771Db1e"]
      fieldMeta:
-        {"minimumAssertionPeriod":{"description":"Minimum time delta between newly created nodes (stateUpdates). This is checked on `stakeOnNewNode()`. Format is number of ETHEREUM blocks, even for L3s. "},"confirmPeriodBlocks":{"description":"Challenge period. (Number of ETHEREUM blocks until a node is confirmed, even for L3s)."},"wasmModuleRoot":{"description":"Root hash of the WASM module used for execution, like a fingerprint of the L2 logic. Can be associated with ArbOS versions."},"arbOsFromWmRoot":{"description":"ArbOS version derived from known wasmModuleRoots."},"setValidatorCount":{"description":"Increments on each Validator change."},"challenges":{"description":"Emitted on createChallenge() in RollupUserLogic."}}
...
-        "upgrade"
+        "act"
      values.accessControl.ADMIN_ROLE:
-        {"adminRole":"ADMIN_ROLE","members":["arb-nova:0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"]}
      values.accessControl.EXECUTOR_ROLE:
-        {"adminRole":"ADMIN_ROLE","members":["arb-nova:0x10Fe3cb853F7ef551E1598d91436e95d41Aea45a"]}
      values.accessControl.0xa49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c21775:
+        {"adminRole":"0xa49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c21775","members":["arb-nova:0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"]}
      values.accessControl.0xd8aa0f3194971a2a116679f7c2090f6939c8d4e01a2a8d7e41d55e5351469e63:
+        {"adminRole":"0xa49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c21775","members":["arb-nova:0x10Fe3cb853F7ef551E1598d91436e95d41Aea45a"]}
      values.ADMIN_ROLE:
...
+        true
      receivedPermissions:
+        [{"permission":"upgrade","from":"arb-nova:0x04ea347cC6A258A7F65D67aFb60B1d487062A1d0","role":"admin"},{"permission":"upgrade","from":"arb-nova:0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]},{"permission":"upgrade","from":"arb-nova:0x0fF7A97caAb356c5507e5355b6819CB8b93d5591","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]},{"permission":"upgrade","from":"arb-nova:0x383eFE8D410285c5CbE1B4F296022640759aA834","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]},{"permission":"upgrade","from":"arb-nova:0xA597e0212971e65f53f288Ff1fFd26A6C8201f83","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]},{"permission":"upgrade","from":"arb-nova:0xD4FE46D2533E7d03382ac6cACF0547F336e59DC0","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]},{"permission":"upgrade","from":"arb-nova:0xe347C1223381b9Dcd6c0F61cf81c90175A7Bae77","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]},{"permission":"upgrade","from":"arb-nova:0xFF55fB76F5671dD9eB6c62EffF8D693Bb161a3ad","role":"admin","via":[{"address":"arb-nova:0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"}]}]
    }
```

```diff
    contract  (arb-nova:0x0fF7A97caAb356c5507e5355b6819CB8b93d5591) {
    +++ description: None
      name:
-        "RollupEventInbox"
+        ""
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"arb-nova:0x04ea347cC6A258A7F65D67aFb60B1d487062A1d0","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability, DACs and the fastConfirmer role, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes.","role":".owner","via":[{"address":"arb-nova:0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"arb-nova:0x04ea347cC6A258A7F65D67aFb60B1d487062A1d0","role":"admin","via":[{"address":"arb-nova:0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"arb-nova:0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9","role":".executors"}]
    }
```
...
```diff
    contract  (arb-nova:0x6c21303F5986180B1394d2C89f3e883890E2867b) {
    +++ description: None
      name:
-        "ValidatorUtils"
+        ""
...
```diff
+   Status: CREATED
    contract  (arb-nova:0x2b0E04Dc90e3fA58165CB41E2834B44A56E766aF)
    +++ description: None
```
...
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1765379686
- current timestamp: 1765379686
...
Generated with discovered.json: 0x310ba4477c59b7caec7b26965529e6edcaf10a8d

# Diff at Fri, 26 Sep 2025 13:07:27 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ec4b16fd723bf2a8625a616c4b3a1119ce79fb29 block: 1757922210
- current timestamp: 1757922210
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1757922210 (main branch discovery), not current.
...
Generated with discovered.json: 0xa9e7738c950bed49e96b18a743064461e0b02166

# Diff at Mon, 15 Sep 2025 07:47:02 GMT:

- author: vincfurc (<10850139+vincfurc@users.noreply.github.com>)
- comparing to: main@cf33a7bb38a6cf939eaca36418ac718201c99e46 block: 1742892328
- current timestamp: 1757922210
...
Generated with discovered.json: 0x8ff507df558452311d0b72de479e0d7a34f3a301

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0x1e11ab12fdc84e59eed7a8c09e01516f9f6156f5

# Diff at Thu, 28 Aug 2025 11:04:34 GMT:

- chain: nova
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@3e088e62f4c969a9884f950ac3f9027242f1f8ff block: 1742892328
- current timestamp: 1742892328
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1742892328 (main branch discovery), not current.
...
Generated with discovered.json: 0x9989c1973112ea99833cb912e5b1ab5a923cd7f9
