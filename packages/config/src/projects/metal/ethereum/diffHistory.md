Generated with discovered.json: 0x5698651da3c1e682477c3aa4940d0e8b40df4447

# Diff at Mon, 17 Mar 2025 16:30:46 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 22046067
...
+        "Optimism Guardian Multisig"
      directlyReceivedPermissions:
-        [{"permission":"guard","from":"0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956"},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0xd4b1EC0DEc3C7F12abD3ec27B7514880ae1C3a37","description":"set and change address mappings."},{"permission":"upgrade","from":"0x1aaab4E20d2e4Bb992b5BCA2125e8bd3588c8730"},{"permission":"upgrade","from":"0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426"},{"permission":"upgrade","from":"0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956"},{"permission":"upgrade","from":"0x50D700e97967F9115e3f999bDB263d69F6704680"},{"permission":"upgrade","from":"0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x7BD909970B0EEdcF078De6Aeff23ce571663b8aA"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x1aaab4E20d2e4Bb992b5BCA2125e8bd3588c8730"},{"permission":"upgrade","from":"0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426"},{"permission":"upgrade","from":"0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956"},{"permission":"upgrade","from":"0x50D700e97967F9115e3f999bDB263d69F6704680"},{"permission":"upgrade","from":"0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3"},{"permission":"upgrade","from":"0x7BD909970B0EEdcF078De6Aeff23ce571663b8aA"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426"},{"permission":"interact","from":"0x7BD909970B0EEdcF078De6Aeff23ce571663b8aA","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xd4b1EC0DEc3C7F12abD3ec27B7514880ae1C3a37","description":"set and change address mappings.","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"interact","from":"0xdE1FCfB0851916CA5101820A69b13a4E276bd81F","description":"set and change address mappings.","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]},{"permission":"upgrade","from":"0x1aaab4E20d2e4Bb992b5BCA2125e8bd3588c8730","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"upgrade","from":"0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"upgrade","from":"0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"upgrade","from":"0x50D700e97967F9115e3f999bDB263d69F6704680","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"upgrade","from":"0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"upgrade","from":"0x7BD909970B0EEdcF078De6Aeff23ce571663b8aA","via":[{"address":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"}]},{"permission":"upgrade","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x37Ff0ae34dadA1A95A4251d10ef7Caa868c7AC99"},{"permission":"act","from":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]
    }
```
...
+        "Optimism Security Council"
      receivedPermissions:
-        [{"permission":"guard","from":"0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"}]},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"}]}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x7BD909970B0EEdcF078De6Aeff23ce571663b8aA"}]
    }
```
...
Generated with discovered.json: 0xe3c4a689d73a9e80bd8f0f8d93729a99e7df34fa
