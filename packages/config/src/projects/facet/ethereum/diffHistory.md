Generated with discovered.json: 0x8a499c119ce547fe2fd6cb3a37fafbe40ea827d8

# Diff at Mon, 17 Mar 2025 16:30:21 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21678827
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0xD1e4cf142fDf7688A9f7734A5eE74d079696C5A6"},{"permission":"propose","from":"0xD1e4cf142fDf7688A9f7734A5eE74d079696C5A6"}]
    }
```
...
```diff
    contract undefined (0x314d660b083675f415cCAA9c545FeedF377d1006) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x0000000000000b07ED001607f5263D85bf28Ce4C","description":"can sign arbitrary withdrawals for users."}]
    }
```
...
-        [{"permission":"act","from":"0xb2B01DeCb6cd36E7396b78D3744482627F22C525"}]
    }
```
...
+        "Facet Multisig"
      receivedPermissions:
-        [{"permission":"guard","from":"0x8649Db4A287413567E8dc0EBe1dd62ee02B71eDD"},{"permission":"guard","from":"0xec3a1bd0B6d435Fe8A6e0de728AE87229176EA59"},{"permission":"interact","from":"0x0000000000000b07ED001607f5263D85bf28Ce4C","description":"can withdraw all funds from the bridge."},{"permission":"interact","from":"0x2D96455AAbb3206f77E7CdC8E4E5c29F76FD33aA","description":"set and change address mappings.","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]},{"permission":"interact","from":"0xC1E935F25f9c1198200ec442c6F02f1A2F04534e","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"upgrade","from":"0x8649Db4A287413567E8dc0EBe1dd62ee02B71eDD","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]},{"permission":"upgrade","from":"0x8F75466D69a52EF53C7363F38834bEfC027A2909","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]},{"permission":"upgrade","from":"0xC1E935F25f9c1198200ec442c6F02f1A2F04534e","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]},{"permission":"upgrade","from":"0xD1e4cf142fDf7688A9f7734A5eE74d079696C5A6","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]},{"permission":"upgrade","from":"0xec3a1bd0B6d435Fe8A6e0de728AE87229176EA59","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]
    }
```
...
-        {"permission":"upgrade","to":"0xb2B01DeCb6cd36E7396b78D3744482627F22C525","via":[{"address":"0xe2A3bda6CD571943DD4224d0B8872e221EB5997C"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x034B0a32395D15C0F63F3e88931Bf7e1D9627eE3","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x2D96455AAbb3206f77E7CdC8E4E5c29F76FD33aA","description":"set and change address mappings."},{"permission":"upgrade","from":"0x8649Db4A287413567E8dc0EBe1dd62ee02B71eDD"},{"permission":"upgrade","from":"0x8F75466D69a52EF53C7363F38834bEfC027A2909","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0xC1E935F25f9c1198200ec442c6F02f1A2F04534e"},{"permission":"upgrade","from":"0xD1e4cf142fDf7688A9f7734A5eE74d079696C5A6"},{"permission":"upgrade","from":"0xec3a1bd0B6d435Fe8A6e0de728AE87229176EA59"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x8649Db4A287413567E8dc0EBe1dd62ee02B71eDD"},{"permission":"upgrade","from":"0x8F75466D69a52EF53C7363F38834bEfC027A2909"},{"permission":"upgrade","from":"0xC1E935F25f9c1198200ec442c6F02f1A2F04534e"},{"permission":"upgrade","from":"0xD1e4cf142fDf7688A9f7734A5eE74d079696C5A6"},{"permission":"upgrade","from":"0xec3a1bd0B6d435Fe8A6e0de728AE87229176EA59"}]
    }
```
