...
export const optimism: ScalingProject = opStackL2({
  ...
  upgradesAndGovernance: {
    ...
    governanceInfo: {
      securityCouncil: {
        Composition:
          '**10-of-13** — Gnosis Safe with cohorts of 7 + 6, 12-month staggered terms. Token-House-elected via Agora with Optimism Foundation eligibility screening (KYC/AML, geographic and organisational diversity).',
        'Members public':
      ...
      tokenGovernance: {
        ...
        'Execution model':
          "**DAB-gated approval + 2/2 Safe signs** — DAB approves, veto window passes, then SC + Foundation Upgrade Safe co-sign the L1 transaction. Token House and Citizens' House signal/veto on-chain via Agora and Snapshot but do not directly trigger the L1 state change. No permissionless `execute()`.",
      },
    },
  },
  milestones: [
