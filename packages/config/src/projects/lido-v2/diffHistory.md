Generated with discovered.json: 0x94abedaa4b6da7d9a205892587d363027c7e48a1

# Diff at Mon, 13 Oct 2025 06:53:02 GMT:
...
```diff
+   Status: CREATED
    contract CuratedModule (eth:0x55032650b14df07b85bF18A3a3eC8E0Af2e028d5)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract SimpleDVTModule (eth:0xaE7B191A31f627b4eB1d4DaC64eaB9976995b433)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract PermissionlessGate (eth:0xcF33a38111d0B1246A3F38a838fb41D626B454f0)
    +++ description: None
```
