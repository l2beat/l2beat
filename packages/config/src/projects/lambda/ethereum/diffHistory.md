Generated with discovered.json: 0xc5a1c4ff0d1c8a66fadbcb1a8736abc59f2e3d5a

# Diff at Mon, 17 Mar 2025 16:30:37 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 20914730
...
-        [{"permission":"interact","from":"0x624808dc4A34B79B90C3c085942D2100F09A0376","description":"set and change address mappings."},{"permission":"upgrade","from":"0x01Cf2c778E56360dCd5e1396373c0Aa6ae794E2c"},{"permission":"upgrade","from":"0x2297eB8DC91f532C91c57b3fb33C06b782e9594A"},{"permission":"upgrade","from":"0x5C3D1b1334b6939e6D042BF5E15249cF86A875A4"},{"permission":"upgrade","from":"0x7288e508f56c1b4b52D2e4Fd3688a711c7cE0054"},{"permission":"upgrade","from":"0x8334f9A70294556101527bfB9bdEdeF7EB382D94"},{"permission":"upgrade","from":"0xae809d42f861A6381b0DFCf7216556e95362a7a8"},{"permission":"upgrade","from":"0xEEBd256da18d0BF20c3CEb785a0946D41A7F408F","description":"upgrading the bridge implementation can give access to all funds escrowed therein."}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x01Cf2c778E56360dCd5e1396373c0Aa6ae794E2c"},{"permission":"upgrade","from":"0x2297eB8DC91f532C91c57b3fb33C06b782e9594A"},{"permission":"upgrade","from":"0x5C3D1b1334b6939e6D042BF5E15249cF86A875A4"},{"permission":"upgrade","from":"0x7288e508f56c1b4b52D2e4Fd3688a711c7cE0054"},{"permission":"upgrade","from":"0x8334f9A70294556101527bfB9bdEdeF7EB382D94"},{"permission":"upgrade","from":"0xae809d42f861A6381b0DFCf7216556e95362a7a8"},{"permission":"upgrade","from":"0xEEBd256da18d0BF20c3CEb785a0946D41A7F408F"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"}]
    }
```
...
-        {"permission":"upgrade","to":"0xD5FDcf4ab4b682ab8D4a99fBE1b6Bd08dC83Ea40","via":[{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"},{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x864A02Ca4a40616f8995709D1B26CDe588709043","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x2297eB8DC91f532C91c57b3fb33C06b782e9594A"}]
    }
```
...
-        {"permission":"upgrade","to":"0xD5FDcf4ab4b682ab8D4a99fBE1b6Bd08dC83Ea40","via":[{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"},{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xD5FDcf4ab4b682ab8D4a99fBE1b6Bd08dC83Ea40","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x2297eB8DC91f532C91c57b3fb33C06b782e9594A"}]
    }
```

```diff
    contract undefined (0xD5FDcf4ab4b682ab8D4a99fBE1b6Bd08dC83Ea40) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x01Cf2c778E56360dCd5e1396373c0Aa6ae794E2c"},{"permission":"guard","from":"0x7288e508f56c1b4b52D2e4Fd3688a711c7cE0054"},{"permission":"interact","from":"0x624808dc4A34B79B90C3c085942D2100F09A0376","description":"set and change address mappings.","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"interact","from":"0xae809d42f861A6381b0DFCf7216556e95362a7a8","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"upgrade","from":"0x01Cf2c778E56360dCd5e1396373c0Aa6ae794E2c","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"upgrade","from":"0x2297eB8DC91f532C91c57b3fb33C06b782e9594A","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"upgrade","from":"0x5C3D1b1334b6939e6D042BF5E15249cF86A875A4","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"upgrade","from":"0x7288e508f56c1b4b52D2e4Fd3688a711c7cE0054","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"upgrade","from":"0x8334f9A70294556101527bfB9bdEdeF7EB382D94","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"upgrade","from":"0xae809d42f861A6381b0DFCf7216556e95362a7a8","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]},{"permission":"upgrade","from":"0xEEBd256da18d0BF20c3CEb785a0946D41A7F408F","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x04d59CB8f8b2BAcb8cE6912c284D10e263a0EB9f"},{"address":"0x0b489aC3516F692159E4E5cc0C4a17B11fD6a501"}]}]
    }
```

```diff
    contract undefined (0xDeC273BF31AD79ad00D619c52662f724176A12Fb) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xae809d42f861A6381b0DFCf7216556e95362a7a8"}]
    }
```
