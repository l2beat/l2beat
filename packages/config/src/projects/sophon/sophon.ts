...
export const sophon: ScalingProject = zkStackL2({
  ...
  display: {
    ...
    headerWarning:
      'Sophon has [announced the sunset of its L2](https://x.com/sophon/status/2070192257295335800). New deposits are stopped as the chain winds down. Tokens are withdrawable until at least EOY 2026.',
    description:
