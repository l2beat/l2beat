Generated with discovered.json: 0x163f64ece86c46e6240fdac7826142a4f5183092

# Diff at Mon, 17 Mar 2025 16:30:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 22046058
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"challenge","from":"0xB09DC08428C8b4EFB4ff9C0827386CDF34277996"},{"permission":"guard","from":"0x639F2AECE398Aa76b07e59eF6abe2cFe32bacb68"}]
    }
```
...
+        "Conduit Multisig 1"
      receivedPermissions:
-        [{"permission":"interact","from":"0x0b4cfc49aCc656CE6D03CB0794860Da92bE3E8ec","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0x15A52Fed1c448028A240b603dD93f2697E12Dc82","description":"set and change address mappings.","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]},{"permission":"upgrade","from":"0x0b4cfc49aCc656CE6D03CB0794860Da92bE3E8ec","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]},{"permission":"upgrade","from":"0x12d4E64E1B46d27A00fe392653A894C1dd36fb80","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]},{"permission":"upgrade","from":"0x639F2AECE398Aa76b07e59eF6abe2cFe32bacb68","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]},{"permission":"upgrade","from":"0xB09DC08428C8b4EFB4ff9C0827386CDF34277996","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]},{"permission":"upgrade","from":"0xd5e3eDf5b68135D559D572E26bF863FBC1950033","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]
    }
```

```diff
    contract undefined (0x6079e9c37b87fE06D0bDe2431a0fa309826c9b67) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x0b4cfc49aCc656CE6D03CB0794860Da92bE3E8ec"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x15A52Fed1c448028A240b603dD93f2697E12Dc82","description":"set and change address mappings."},{"permission":"upgrade","from":"0x0b4cfc49aCc656CE6D03CB0794860Da92bE3E8ec"},{"permission":"upgrade","from":"0x12d4E64E1B46d27A00fe392653A894C1dd36fb80","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x639F2AECE398Aa76b07e59eF6abe2cFe32bacb68"},{"permission":"upgrade","from":"0xB09DC08428C8b4EFB4ff9C0827386CDF34277996"},{"permission":"upgrade","from":"0xd5e3eDf5b68135D559D572E26bF863FBC1950033"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0b4cfc49aCc656CE6D03CB0794860Da92bE3E8ec"},{"permission":"upgrade","from":"0x12d4E64E1B46d27A00fe392653A894C1dd36fb80"},{"permission":"upgrade","from":"0x639F2AECE398Aa76b07e59eF6abe2cFe32bacb68"},{"permission":"upgrade","from":"0xB09DC08428C8b4EFB4ff9C0827386CDF34277996"},{"permission":"upgrade","from":"0xd5e3eDf5b68135D559D572E26bF863FBC1950033"}]
    }
```

```diff
    contract undefined (0xAF24199C29D5cc3fd298356137913A42847eA690) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"propose","from":"0xB09DC08428C8b4EFB4ff9C0827386CDF34277996"}]
    }
```
...
-        {"permission":"upgrade","to":"0x4a4962275DF8C60a80d3a25faEc5AA7De116A746","via":[{"address":"0x75a223Fb459461B9Fa61dd25109EA05522b4b492"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x1B1ecDdbd5F9601b34262Aa3Ca346209E61aA68f","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
...
Generated with discovered.json: 0x6f87df334c52b4570b4f3d24b0b7b38d1aa26772
