Generated with discovered.json: 0x5f2fb535f67e64cb9189fb7c6b6f6b06d52e8f7a

# Diff at Wed, 23 Sep 2026 05:50:36 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1781510867
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1781510867
- current timestamp: 1781510867
...
```diff
    contract ChallengeManager (eth:0xC0880Eea7Ad1B28a39344D48B411bC96f3daf60D) [orbitstack/ChallengeManager] {
...
Generated with discovered.json: 0x4a3c6ea34c041a368cbc5285055c06794b16e68c
...
Generated with discovered.json: 0x7b7200050347e78bdb05b18e5d75feffa9190506

# Diff at Tue, 09 Jun 2026 12:43:40 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1780398865
- current timestamp: 1780398865
...
```diff
    EOA  (eth:0x006F5B7E2D58fb4E53DEdaB8802FCdf2a5441DC7) {
    +++ description: None
...
```diff
    EOA  (eth:0x11f563dDbF266484Dd910A401A7e44299d80b1d5) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
```diff
    EOA  (eth:0x17F187D978664C96ffD655996a45e085c403AD8b) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0x2E8C0869C173cC07c58186E9DeEA74314635b1E2) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0x33Bf8bF5aF3579D0E2305302409A5b6b4173c779) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
```diff
    EOA  (eth:0x4ed0f98FB4c331e672653E832c55E0f9F402C228) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    contract GnosisSafeL2 (eth:0x6d9BbB2e3E7d13727deb2249E13B9D86A62CbcE0) [GnosisSafe] {
    +++ description: None
...
```diff
    EOA  (eth:0x74a0d46BA4F69cAB77A459f8B12dc531c7DaBf3C) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0x85e70D857F6Fad7AD4ffc3fC95FD0fd8C396A09D) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0x9DFaA1770bcE35EaB6a163D3cDE6cA1F3Ff7eA66) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
```diff
    EOA  (eth:0xA4f98Ac0E083C79BAB53A3895082e8a4fbf12CDe) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0xb9B2AeAe8D160a5bF9cb7FE7B2c8B58c0293FD5e) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0xc7ef93FE91D4658bb422B11C5f8Ae17ae3B86D36) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
```diff
    EOA  (eth:0xCEEAEC6b7e010fE1Ac253Ebd6f93eEBF9249Cd7e) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
Generated with discovered.json: 0xc4a25297daec02f1ee321a14407c6717491f27ed

# Diff at Tue, 02 Jun 2026 11:15:59 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@8ad83b88dd9180e282e419267cebe10e93daf01d block: 1779719792
- current timestamp: 1780398865
...
Generated with discovered.json: 0x86cd0166b942f4cf90a451fa58dbd3e91ba602f1

# Diff at Mon, 25 May 2026 14:37:45 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@6898129972dbc5b1b4f1389afaf9cb3fb7fd3380 block: 1777994333
- current timestamp: 1779719792
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1777994333 (main branch discovery), not current.
...
Generated with discovered.json: 0xb92c4a6b616d2e100162e95154151e28290eeb39

# Diff at Fri, 15 May 2026 12:37:09 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a5152b9ba7ad7f85f2af3d814f74630fcaa7c917 block: 1777994333
- current timestamp: 1777994333
...
Generated with discovered.json: 0x19dfa55c9acc2a44e4b3fec74fa9c3febcd41b54

# Diff at Fri, 08 May 2026 07:52:41 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1777994333
- current timestamp: 1777994333
...
```diff
    ...
    +++ description: Facilitates L2 to L1 contract calls: Messages initiated from L2 (for example withdrawal messages) eventually resolve in execution on L1.
      deployerAddress:
+        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
```
...
Generated with discovered.json: 0x480edea91871276d0d29d9db3ee878327713132a

# Diff at Tue, 05 May 2026 15:20:07 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c30884758a8f4ef4178d2eb572fb25911670bcff block: 1773234253
- current timestamp: 1777994333
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1773234253 (main branch discovery), not current.
...
```diff
    contract Outbox (eth:0x0b8071337dcB089478Ea740efC10904d9F359141) {
    +++ description: Facilitates L2 to L1 contract calls: Messages initiated from L2 (for example withdrawal messages) eventually resolve in execution on L1.
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
```diff
    contract ProxyAdmin (eth:0x22010F5C4c106dfBaffec780196d2F691860Ff62) {
    +++ description: None
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
```diff
    contract Bridge (eth:0x2Be65c5b58F78B02AB5c0e798A9ffC181703D3C1) {
    +++ description: Escrow contract for the project's gas token (can be different from ETH). Keeps a list of allowed Inboxes and Outboxes for canonical bridge messaging.
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
```diff
    contract SequencerInbox (eth:0x47861E0419BE83d0175818a09221B6DF2EFD7793) {
    +++ description: A sequencer (registered in this contract) can submit transaction batches or commitments here.
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
```diff
    contract RollupEventInbox (eth:0x6c8faa6b06d4bDD5Af628ac28954736a0fC0BD6b) {
    +++ description: Helper contract sending configuration data over the bridge during the systems initialization.
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
```diff
    contract ChallengeManager (eth:0xC0880Eea7Ad1B28a39344D48B411bC96f3daf60D) {
    +++ description: Contract that allows challenging state roots. Can be called through the RollupProxy by Validators or the UpgradeExecutor.
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
```diff
    contract Inbox (eth:0xE961Ef06c26D0f032F0298c97C41e648d3bb715a) {
    +++ description: Facilitates sending L1 to L2 messages like depositing ETH, but does not escrow funds.
      deployerAddress:
-        "eth:0xCB68b0b360b7A8ef37a32351794E66f5EB27f1CE"
    }
...
Generated with discovered.json: 0xfe2356c18daaf7d5c37b9ff2435b0a09df4cf492

# Diff at Tue, 05 May 2026 10:23:24 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1773234253
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@01c924f177b66fde012756076e94adb03520b757 block: 1768984480
- current timestamp: 1769514789
...
Generated with discovered.json: 0x849eff63afe29d83a409537f9cd32145ecf08c1c

# Diff at Wed, 21 Jan 2026 08:35:45 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@a72aa7d50f1dddc0c7a6eae7f60679fc94e4eabf block: 1768566204
- current timestamp: 1768984480
...
Generated with discovered.json: 0xe3d32d6fa15ee62f17021a2bea9d071f5dace946

# Diff at Fri, 16 Jan 2026 12:24:44 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5858fbf220b5dda1ab2a19f029fdd9eb700ca7fa block: 1764933927
- current timestamp: 1768566204
...
Generated with discovered.json: 0xbf0f11f0e2c6ab6e508804a7122f431b0b9d6ca0

# Diff at Mon, 05 Jan 2026 17:45:48 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1764933927
- current timestamp: 1764933927
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764933927 (main branch discovery), not current.
...
Generated with discovered.json: 0x31d2529dd225d67c077102c2e244dd46ae48ca02

# Diff at Fri, 05 Dec 2025 11:26:42 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1edf3e71cea32596658a3ea017cea9df6408b77c block: 1759481015
- current timestamp: 1764933927
...
Generated with discovered.json: 0xb9d959a5b2d2fc4a7f33f74c5c78e125e5e488a7

# Diff at Fri, 03 Oct 2025 08:44:43 GMT:

- author: vincfurc (<10850139+vincfurc@users.noreply.github.com>)
- comparing to: main@e647409961cd173771dcfcaeb808991c99e73911 block: 1756214657
- current timestamp: 1759481015
...
Generated with discovered.json: 0x9c8402b3e089acacbf565199f36ee6938859e9ad

# Diff at Fri, 26 Sep 2025 14:19:53 GMT:
...
Generated with discovered.json: 0x20e3a4a4abe7696cf0b3d5a59b377d236891042a

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0x9b44439eaeb1009d8c070a62a055940be052996f

# Diff at Tue, 26 Aug 2025 13:34:13 GMT:

- chain: ethereum
- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@e10932be0db538f3a760bbc29232375f08915af7 block: 1755853782
- current timestamp: 1756214657
...
Generated with discovered.json: 0xdbea313a1ebe6d10e13d3d6046bd3c8c945206f2
