...
export const badges = {
  ...
  Karnot: {
    display: {
      name: 'Karnot',
      description: 'This project was deployed via the rollup-as-a-service provider Karnot',
    },
    type: BadgeType.RaaS,
  },
  StarkEx: {
  ...
  Syndicate: {
    display: {
      name: 'Syndicate',
      description: 'This project was deployed via the rollup-as-a-service provider Syndicate',
    },
    type: BadgeType.RaaS,
  },
  // DA
  ...
  EVMLike: {
    display: {
      name: 'EVM-like',
      description: 'This project uses the Ethereum Virtual Machine variation to run its smart contracts and supports the Solidity programming language',
    },
    type: BadgeType.VM,
  },
  CairoVM: {
  ...
  AztecVM: {
    display: {
      name: 'AztecVM',
      description: 'This project uses the Aztec Virtual Machine to run its smart contracts and supports the Noir programming language',
    },
    type: BadgeType.VM,
  },
  MoveVM: {
    display: {
      name: 'MoveVM',
      description: 'This project uses the Move Virtual Machine to run its smart contracts and supports the Move programming language',
    },
    type: BadgeType.VM,
  },
  SolanaVM: {
  ...
  CustomVM: {
    display: {
      name: 'Custom',
      description: 'This project uses a custom-built virtual machine suitable for its own needs',
    },
    type: BadgeType.VM,
  },
  // Other
  ...
  Governance: {
    display: {
      name: 'Governance',
      description: 'This project has a decentralized governance system that votes on proposed changes',
    },
    type: BadgeType.Other,
  },
