Generated with discovered.json: 0x7fdde6f5298e40137933f0c7609a6c22ecd83554

# Diff at Mon, 31 Aug 2026 16:08:21 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@213634bdbfe31b47c124857f877cc3b9f13184f4 block: 1784283256
...
discovery. Values are for block 1784283256 (main branch discovery), not current.
...
Generated with discovered.json: 0xa8ce5241114021a6cf0776a6b65afd98ff4de10b

# Diff at Fri, 17 Jul 2026 10:15:48 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5a5b552776f13efe49c744667945e52e0a8f9718 block: 1782898692
- current timestamp: 1784283256
...
Generated with discovered.json: 0x066fe2fdb2f95ba9dff6f5e77f1bad0f96110227

# Diff at Wed, 01 Jul 2026 09:39:21 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@cfafbf3de953d9f519656c89c622fe51a04d547a block: 1778850530
- current timestamp: 1782898692
...
-        "eth:0x6463dEE3828677F6270d83d45408044fc5eDB908"
      values.wethFromGame:
-        "eth:0x70277624cdE90492231Eb23309e1251Beb18Dff5"
...
-        ""
...
+        {"permission":"upgrade","from":"eth:0x18fBb58C366e21F395DdEc7cBa0510a2D9116B47","role":"admin","via":[{"address":"eth:0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]}
...
```diff
-   Status: DELETED
    contract DelayedWETH (eth:0x70277624cdE90492231Eb23309e1251Beb18Dff5) [opstack/DelayedWETH]
    +++ description: Contract designed to hold the bonded ETH for each game. It is designed as a wrapper around WETH to allow an owner to function as a backstop if a game would incorrectly distribute funds.
```
...
+        {"permission":"upgrade","from":"eth:0x18fBb58C366e21F395DdEc7cBa0510a2D9116B47","role":"admin"}
...
.../AnchorStateRegistry/AnchorStateRegistry.sol    | 1141 +------
 ...
 .../soneium/.flat@1778850530/MIPS.sol => /dev/null | 3274 --------------------
 ...
 14 files changed, 2524 insertions(+), 10665 deletions(-)
```

Generated with discovered.json: 0xa2d8c483feba03af915150473d574db101284512
...
Generated with discovered.json: 0x29a3421c09423cc0d79606285cbfd51fd1e632e8
...
```diff
    EOA  (eth:0x6776BE80dBAda6A02B5F2095cF13734ac303B8d1) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0xd2fe4ef864b258aa852ab61853f93abefd372460

# Diff at Thu, 04 Jun 2026 17:44:46 GMT:
...
Generated with discovered.json: 0xa868259ab34ddbce6751c0a3d75ba410115b05fc

# Diff at Fri, 15 May 2026 13:11:06 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@da451cba8e944a28754be7e17bcb7555d857f312 block: 1777994278
- current timestamp: 1778850530
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1777994278 (main branch discovery), not current.
...
Generated with discovered.json: 0xa45b482d065c4ef34f2608a71d9df10f7e9ea89b

# Diff at Fri, 08 May 2026 07:52:22 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1777994278
- current timestamp: 1777994278
...
+        "0x2bd131300b48e6652e12d55e42a0bcaf468b74775bf0c31c2162950c78faa2c4"
      deployerAddress:
+        "eth:0x64bAF7f4cA69672F46ff2661213C57B1F16c4273"
    }
```

```diff
    contract AnchorStateRegistry (eth:0x4890928941e62e273dA359374b105F803329F473) [opstack/AnchorStateRegistry_post13] {
...
+        "0xe23c519b7324d6dc9132c8567ac55ae72bdf168c914d22825c7614d822364b0f"
      deployerAddress:
+        "eth:0xA0D84361a79fFFcD42C9A422441b9179A4826b3E"
    }
```

```diff
    contract DisputeGameFactory (eth:0x512A3d2c7a43BD9261d2B8E8C9c70D4bd4D503C0) [opstack/DisputeGameFactory] {
    +++ description: The dispute game factory allows the creation of dispute games, used to propose state roots and eventually challenge them.
      sourceHashes.1:
-        "0x0fdb3ea7873ad716dd0f5f9d2fdbab989f3b308066977be182ddc31d150e12f5"
+        "0x8f21dbc160582c568a2a925ddad1b2bb889a9f72bac2067c6e72d43b662ef538"
      deployerAddress:
+        "eth:0xa4d5C6aA1e328d8750eD27Dc177dC24A03656c67"
    }
```
...
```diff
    contract L1OpUSDCBridgeAdapter (eth:0xC67A8c5f22b40274Ca7C4A56Db89569Ee2AD3FAb) [circle/L1OpUSDCBridgeAdapter] {
...
+        "0xc471da5e509a676473fe81129bcb1dbe1218e82821d30b31cf149c2c003af6b1"
      deployerAddress:
+        "eth:0x448dAe9299366ff611678fdA2f3a386791C95d41"
    }
```
...
Generated with discovered.json: 0x2643d54746fafd7ffedf7ebfe27b2e0b15d9dc58

# Diff at Tue, 05 May 2026 15:19:06 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c30884758a8f4ef4178d2eb572fb25911670bcff block: 1774433216
- current timestamp: 1777994278
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1774433216 (main branch discovery), not current.
...
```diff
    contract L1ERC20TokenBridge (eth:0x2F543A7C9cc80Cc2427c892B96263098d23ee55a) {
    +++ description: Lido custom escrow for wstETH tokens that uses the canonical bridge for messaging but is governed externally.
      deployerAddress:
-        "eth:0x64bAF7f4cA69672F46ff2661213C57B1F16c4273"
    }
...
```diff
    contract ETHLockbox (eth:0x67B4de6FfA66EF201Ea6099A89cA397D56622E31) {
    +++ description: A simple escrow contract storing ETH for the canonical bridge.
      deployerAddress:
-        "eth:0x1D0519EeD308BcD49e4ebc149284F83ebC275284"
    }
...
```diff
    contract AddressManager (eth:0xB24bFEeCE1B3b7A44559F4Cbc21BeD312b130b70) {
    +++ description: Legacy contract used to manage a mapping of string names to addresses. Modern OP stack uses a different standard proxy system instead, but this contract is still necessary for backwards compatibility with several older contracts.
      deployerAddress:
-        "eth:0xa4d5C6aA1e328d8750eD27Dc177dC24A03656c67"
    }
...
```diff
    contract OptimismMintableERC20Factory (eth:0xc1047e30EFC9E172cFe7aa0219895B6a43fC415F) {
    +++ description: A helper contract that generates OptimismMintableERC20 contracts on the network it's deployed to. OptimismMintableERC20 is a standard extension of the base ERC20 token contract designed to allow the L1StandardBridge contracts to mint and burn tokens. This makes it possible to use an OptimismMintableERC20 as this chain's representation of a token on the host chain, or vice-versa.
      deployerAddress:
-        "eth:0xa4d5C6aA1e328d8750eD27Dc177dC24A03656c67"
    }
...
```diff
    contract L1OpUSDCBridgeAdapter (eth:0xC67A8c5f22b40274Ca7C4A56Db89569Ee2AD3FAb) {
    +++ description: Escrow for USDC that uses the canonical bridge for messaging but is governed externally.
      deployerAddress:
-        "eth:0x448dAe9299366ff611678fdA2f3a386791C95d41"
    }
...
Generated with discovered.json: 0x49bbb85378b625397897a3ec0ea04e37647ab5b1

# Diff at Tue, 05 May 2026 10:23:07 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1774433216
- current timestamp: 1774433216
...
Generated with discovered.json: 0xfec065f03bf843306c914ddc935d811d86304e9a

# Diff at Wed, 25 Mar 2026 10:08:02 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5f335de80b3c24849b3bcc1271bae84dc6e931f7 block: 1773160425
- current timestamp: 1774433216
...
Generated with discovered.json: 0xa3eb76c4666a8bf7a15d250241949102fd74fcdf

# Diff at Fri, 27 Feb 2026 13:25:30 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@17ff9ba367ef55b34e16f082bde7902f4760911e block: 1771495897
- current timestamp: 1772198392
...
Generated with discovered.json: 0x479c902395d1866a0e4afd7f1eac89f00ce5a006

# Diff at Thu, 19 Feb 2026 10:12:44 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@2b96f087639b90912cc82e06e34e7b0beefda5ab block: 1769272398
- current timestamp: 1771495897

## Description

Upgrade to op-contracts/v6.0.0-rc.1 (Upgrade 18 - "Cannon + Kona and Custom Gas Token v2"). Approved via Optimism governance.

AnchorStateRegistry (v3.5.0 → v3.7.0): now the central authority for game validity and anchor state management. Adds granular game validation (isGameRegistered, isGameRespected, isGameBlacklisted, isGameRetired, isGameFinalized, isGameClaimValid). Stores disputeGameFactory directly, delegates pause logic to SystemConfig.
[diff](https://disco.l2beat.com/diff/eth:0xeb69cC681E8D4a557b30DFFBAd85aFfD47a2CF2E/eth:0x36398155Cd17cfe804F69b233eDDA800DD4D5aA5)

DisputeGameFactory (v1.3.0 → v1.4.0): adds the "Creator Pattern" refactor with new `gameArgs` storage mapping and overloaded `setImplementation()` accepting CWIA args. Enables a single dispute game implementation to serve multiple game types (e.g., CANNON and CANNON_KONA) with different configuration.
[diff](https://disco.l2beat.com/diff/eth:0x74Fac1D45B98bae058F8F566201c9A81B85C7D50/eth:0xc040F392E52Cb6970CA8E110c280fE24E07C5e2c)

OptimismPortal2 (v5.1.1 → v5.2.0): adds Custom Gas Token mode enforcement (reverts on native ETH ops in CGT mode), ETHLockbox integration for ETH custody during deposits/withdrawals. Legacy getters (disputeGameFactory, disputeGameFinalityDelaySeconds, etc.) now proxy through AnchorStateRegistry.
[diff](https://disco.l2beat.com/diff/eth:0x7Cf803296662e8C72A6C1d6450572209aCF7f202/eth:0x97cEbbf8959e2A5476fbe9B98A21806Ec234609B)

SystemConfig (v3.11.0 → v3.13.1): replaces hardcoded custom gas token logic with feature flag system (`isFeatureEnabled` mapping). New state variables: daFootprintGasScalar, minBaseFee, l2ChainId, superchainConfig reference. Updated `isCustomGasToken()` and `paused()` to read from feature flags.
[diff](https://disco.l2beat.com/diff/eth:0x2fA28989fc559836E9d66dFf3010C7F7f41c65ED/eth:0xd392c27B84b1cA776528F2704BC67B82a62132d2)

Old PermissionedDisputeGame (v1.8.0) deleted, replaced by PermissionedDisputeGameV2 (v2.2.0) inheriting from FaultDisputeGameV2 with dual credit tracking (normalModeCredit/refundModeCredit), bond distribution mode system, and credit unlock mechanism.
[diff](https://disco.l2beat.com/diff/eth:0x0ddf929eeda8949CfE77b7e7e46e426E15A2D8f1/eth:0x58bf355C5d4EdFc723eF89d99582ECCfd143266A)

L1ERC721Bridge, L1CrossDomainMessenger, OptimismMintableERC20Factory also upgraded (implementation changes only).

## Watched changes

```diff
-   Status: DELETED
    contract PermissionedDisputeGame (eth:0x0ddf929eeda8949CfE77b7e7e46e426E15A2D8f1)
    +++ description: Same as FaultDisputeGame, but only two permissioned addresses are designated as proposer and challenger.
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"propose","from":"eth:0x0ddf929eeda8949CfE77b7e7e46e426E15A2D8f1","role":".proposer"}]
    }
```
...
+        "eth:0x36398155Cd17cfe804F69b233eDDA800DD4D5aA5"
      values.$pastUpgrades.2:
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0x36398155Cd17cfe804F69b233eDDA800DD4D5aA5"]]
      values.$upgradeCount:
-        2
+        3
      values.version:
...
+        {"root":"0x17ce11194e3dd58b940485ebc70141f3654183ceb2700d590a6bc57c4cc7f68c","l2SequenceNumber":5084269}
...
+        "eth:0xc040F392E52Cb6970CA8E110c280fE24E07C5e2c"
      values.$pastUpgrades.5:
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0xc040F392E52Cb6970CA8E110c280fE24E07C5e2c"]]
      values.$upgradeCount:
-        5
+        6
...
+++ severity: HIGH
      values.gameImpls.1:
-        "eth:0x0ddf929eeda8949CfE77b7e7e46e426E15A2D8f1"
...
```diff
    ...
    +++ description: Used to bridge ERC-721 tokens from host chain to this chain.
      values.$pastUpgrades.6:
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0x74f1aC50EB0BE98853805D381C884f5f9abDEcf9"]]
      values.$upgradeCount:
-        6
+        7
    }
...
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0xd392c27B84b1cA776528F2704BC67B82a62132d2"]]
      values.$upgradeCount:
-        9
+        10
      values.getAddresses.delayedWETH:
...
+        "eth:0x97cEbbf8959e2A5476fbe9B98A21806Ec234609B"
      values.$pastUpgrades.6:
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0x97cEbbf8959e2A5476fbe9B98A21806Ec234609B"]]
      values.$upgradeCount:
-        6
+        7
      values.version:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"challenge","from":"eth:0x0ddf929eeda8949CfE77b7e7e46e426E15A2D8f1","role":".challenger"}]
    }
```
...
```diff
    ...
    +++ description: Sends messages from host chain to this chain, and relays messages back onto host chain. In the event that a message sent from host chain to this chain is rejected for exceeding this chain's epoch gas limit, it can be resubmitted via this contract's replay function.
      values.$pastUpgrades.6:
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0xb686F13AfF1e427a1f993F29ab0F2E7383729FE0"]]
      values.$upgradeCount:
-        6
+        7
    }
...
-        {"permission":"challenge","from":"eth:0x0ddf929eeda8949CfE77b7e7e46e426E15A2D8f1","role":".challenger","via":[{"address":"eth:0x9BA6e03D8B90dE867373Db8cF1A58d2F7F006b3A"}]}
    }
```
...
```diff
    ...
    +++ description: A helper contract that generates OptimismMintableERC20 contracts on the network it's deployed to. OptimismMintableERC20 is a standard extension of the base ERC20 token contract designed to allow the L1StandardBridge contracts to mint and burn tokens. This makes it possible to use an OptimismMintableERC20 as this chain's representation of a token on the host chain, or vice-versa.
      values.$pastUpgrades.3:
+        ["2026-02-17T19:11:11.000Z","0xeba2fc77f814ea5de7fc0e3b1496926483d14cf8541633c04aec9d1fec8eaf9c",["eth:0x8ee6fB13c6c9a7e401531168E196Fbf8b05cEabB"]]
      values.$upgradeCount:
-        3
+        4
    }
...
Generated with discovered.json: 0xd5a6c224fa05de33678c347c47776416a6a6e665

# Diff at Fri, 13 Feb 2026 11:33:21 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@55ab80636f1e0c000e757a7a146f11035a19e9c0 block: 1769272398
- current timestamp: 1769272398
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1769272398 (main branch discovery), not current.
...
Generated with discovered.json: 0x309adac80abde6263acdfe7712ffcc31a2f48d80

# Diff at Mon, 26 Jan 2026 09:08:13 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@ac37c78dd7a10d019f852f76f0bb7435768a0edc block: 1766048336
- current timestamp: 1769272398
...
```diff
.../src/projects/soneium/.flat/SaferSafes.sol      | 3535 ++++++++++++++++++++
 1 file changed, 3535 insertions(+)
```

Generated with discovered.json: 0xcdbf34369078276ca4485903123da8eb7a9aedd5

# Diff at Thu, 18 Dec 2025 09:00:21 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6cd29a835d734750c830e20a8c0a6b2f1cef086b block: 1765551186
- current timestamp: 1766048336
...
.../GnosisSafe.sol => /dev/null                    |  959 -----------------
 ...
 .../soneium/.flat/OpFoundationUpgradeSafe/Safe.sol | 1088 ++++++++++++++++++++
 3 files changed, 1498 insertions(+), 1234 deletions(-)
```

Generated with discovered.json: 0x18926f682ff6793b5d3c2838a9953da1a2e9f08a

# Diff at Fri, 12 Dec 2025 16:20:09 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d2235ef7f5c90cb4a3a617fea7d52a655dc22fa1 block: 1764933869
- current timestamp: 1765551186
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764933869 (main branch discovery), not current.
...
Generated with discovered.json: 0x0d96638aacf28f9e3dcad0e11b3d9a0228effdfb
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@10f814ec1e4e08d34183a00c458ece2b8605dede block: 1762276338
- current timestamp: 1764324554
...
.../DisputeGameFactory/DisputeGameFactory.sol      |  47 +++++++---
 ...
 .../soneium/{.flat@1762276338 => .flat}/MIPS.sol   |  33 ++-----
