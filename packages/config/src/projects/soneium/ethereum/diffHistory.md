Generated with discovered.json: 0x8bb167a9a02757ff33a5a7273adb7725941c9516

# Diff at Mon, 17 Mar 2025 16:31:29 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21995440
...
+        "Soneium Multisig"
      receivedPermissions:
-        [{"permission":"interact","from":"0x7A8Ed66B319911A0F3E7288BDdAB30d9c0C875c3","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xB24bFEeCE1B3b7A44559F4Cbc21BeD312b130b70","description":"set and change address mappings.","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"interact","from":"0xdE1FCfB0851916CA5101820A69b13a4E276bd81F","description":"set and change address mappings.","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]},{"permission":"upgrade","from":"0x512A3d2c7a43BD9261d2B8E8C9c70D4bd4D503C0","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0x5933e323bE8896DfaCd1cD671442F27dAA10a053","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0x61f89A381E0BE13BD8Ab356cf4B7301BC97d7522","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0x7A8Ed66B319911A0F3E7288BDdAB30d9c0C875c3","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0x88e529A6ccd302c948689Cd5156C83D4614FAE92","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]},{"permission":"upgrade","from":"0x9AEA1FD851b63d57Ba4Fc556B0e0c170126C9EAf","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0xc1047e30EFC9E172cFe7aa0219895B6a43fC415F","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]},{"permission":"upgrade","from":"0xeb9bf100225c214Efc3E7C651ebbaDcF85177607","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"},{"permission":"act","from":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]
    }
```
...
```diff
    contract undefined (0x6776BE80dBAda6A02B5F2095cF13734ac303B8d1) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x7A8Ed66B319911A0F3E7288BDdAB30d9c0C875c3"}]
    }
```
...
-        {"permission":"upgrade","to":"0x5a0Aae59D09fccBdDb6C6CcEB07B7279367C3d2A","via":[{"address":"0x89889B569c3a505f3640ee1Bd0ac1D557f436D2a"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x509182eC226b3B71D36A3255A80EF0b1A9D43033","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0xB24bFEeCE1B3b7A44559F4Cbc21BeD312b130b70","description":"set and change address mappings."},{"permission":"upgrade","from":"0x512A3d2c7a43BD9261d2B8E8C9c70D4bd4D503C0"},{"permission":"upgrade","from":"0x5933e323bE8896DfaCd1cD671442F27dAA10a053"},{"permission":"upgrade","from":"0x61f89A381E0BE13BD8Ab356cf4B7301BC97d7522"},{"permission":"upgrade","from":"0x7A8Ed66B319911A0F3E7288BDdAB30d9c0C875c3"},{"permission":"upgrade","from":"0x88e529A6ccd302c948689Cd5156C83D4614FAE92"},{"permission":"upgrade","from":"0x9AEA1FD851b63d57Ba4Fc556B0e0c170126C9EAf"},{"permission":"upgrade","from":"0xc1047e30EFC9E172cFe7aa0219895B6a43fC415F"},{"permission":"upgrade","from":"0xeb9bf100225c214Efc3E7C651ebbaDcF85177607","description":"upgrading the bridge implementation can give access to all funds escrowed therein."}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x512A3d2c7a43BD9261d2B8E8C9c70D4bd4D503C0"},{"permission":"upgrade","from":"0x5933e323bE8896DfaCd1cD671442F27dAA10a053"},{"permission":"upgrade","from":"0x61f89A381E0BE13BD8Ab356cf4B7301BC97d7522"},{"permission":"upgrade","from":"0x7A8Ed66B319911A0F3E7288BDdAB30d9c0C875c3"},{"permission":"upgrade","from":"0x88e529A6ccd302c948689Cd5156C83D4614FAE92"},{"permission":"upgrade","from":"0x9AEA1FD851b63d57Ba4Fc556B0e0c170126C9EAf"},{"permission":"upgrade","from":"0xc1047e30EFC9E172cFe7aa0219895B6a43fC415F"},{"permission":"upgrade","from":"0xeb9bf100225c214Efc3E7C651ebbaDcF85177607"}]
    }
```
