Generated with discovered.json: 0x59403cbd05306b87dbd32af2ead1bbadc52b3d66

# Diff at Mon, 05 Jan 2026 17:47:51 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1741185503
- current timestamp: 1767635201
...
```diff
-   Status: DELETED
    contract DACommittee (eth:0x28780349A33eEE56bb92241bAAB8095449e24306)
...
```diff
-   Status: DELETED
    contract GpsFactRegistryAdapter (eth:0x3b1298395290Bb7924F0Fcc176DECF3B4879FE73)
...
```diff
    contract ConstantRetrieverRestricted (eth:0x5d22045DAcEAB03B158031eCB7D9d06Fad24609b) {
    +++ description: None
      name:
-        "StarkExchange"
+        "ConstantRetrieverRestricted"
      template:
-        "starkex/StarkExchangeOld"
      sourceHashes.1:
-        "0xbe79d78e7db305a3c7147712a7cca3e0f82bacad7f00a96fa6b07bc8abfe9974"
+        "0x300cc785659cf862c468706627f5432918ca5417a19994fdd263acecc47d3a9c"
      proxyType:
-        "StarkWare diamond"
+        "StarkWare proxy"
      description:
...
-        ["eth:0x29Db022dbc824b78A0dA699a77E3d177f08A1191","eth:0xfbea22FeB369DB10C0d3a2aAa8F4939E76815f12","eth:0x5524cB52490e01CBa4EB64F230CC661780cB6298","eth:0x67e198743BC19fa4757720eDd0e769f8291e1F1D","eth:0x613ee54C54D5548627064B4D648942bF3648f376","eth:0xb2ED005D0278179001a49a9969BB22BA8e98f31F","eth:0xB5353268d8d4D711a92cb838F8fEDFC2A66E50Db"]
+        "eth:0x57998F222FF4d7e51bd63E5792dc9425CF965B8c"
      values.$pastUpgrades.1:
+        ["2020-12-02T07:18:47.000Z","0xaa2d2b00a0c72056946b6c0e7e656602ded829fda99e4506c78bb6569ac55eba",["eth:0x63A995cfB3Badabe007263917024369529BaF26f"]]
...
-        "2020-12-02T07:18:47.000Z"
+        "2021-01-04T07:16:37.000Z"
...
-        "0x4ed46e53b7228bbd7a377396a6dbb032beeb1296affd055462911dd323afa3f8"
+        "0x03114bedf14370137c60d1f01792fa3a7ee2ee8f199c582569906d0ca0565b78"
      values.$pastUpgrades.16.0:
-        "2024-08-26T15:52:35.000Z"
+        "2025-03-10T10:41:47.000Z"
      values.$upgradeCount:
-        17
+        18
...
-        604800
      values.getGlobalConfigCode:
-        1
      values.getLastBatchId:
-        8564
      values.getOrderRoot:
-        "3309552268978170776772221564804201665107641742839231234298104839572394229836"
...
-        ["eth:0x3b1298395290Bb7924F0Fcc176DECF3B4879FE73"]
      values.getRollupTreeHeight:
-        31
      values.getRollupVaultRoot:
-        "207095555137602068174310225607660532858489993604082708018689543482077973596"
      values.getSequenceNumber:
-        8536
      values.getValidiumTreeHeight:
-        31
      values.getValidiumVaultRoot:
-        "1009047868236151282040797280996690986610213916141656238716572588879139716847"
      values.implementation:
-        "eth:0x29Db022dbc824b78A0dA699a77E3d177f08A1191"
+        "eth:0x57998F222FF4d7e51bd63E5792dc9425CF965B8c"
      values.isFrozen:
...
-        259200
      values.tokenAdmins:
-        ["eth:0x8fDEC5EE435501571034A78a7F3AA167185969b3","eth:0xb49e8CeD039CD6eC5881Beb29C4993031A6CcAC4"]
...
-        "4.5.3-blc"
      values.RECEIVER:
+        "eth:0x520Cf70a2D0B3dfB7386A2Bc9F800321F62a5c3a"
      values.SENDER1:
+        "eth:0xC451b0191351ce308FdFd779D73814c910FC5eCB"
      values.SENDER2:
+        "eth:0x5acAf86Db8c7e24dA9EF91a73707dfE5f076091A"
...
-        "ProxyUtils"
      implementationNames.eth:0x57998F222FF4d7e51bd63E5792dc9425CF965B8c:
+        "ConstantRetrieverRestricted"
      category:
...
```diff
    contract RhinofiAdminMultisig (eth:0xCCa5De1e10c05c50C51ac551D9182cd31aca1889) {
    +++ description: None
      receivedPermissions.0:
-        {"permission":"governStarknet","from":"eth:0x5d22045DAcEAB03B158031eCB7D9d06Fad24609b","role":".$admin"}
      receivedPermissions.1:
-        {"permission":"interact","from":"eth:0x5d22045DAcEAB03B158031eCB7D9d06Fad24609b","description":"manage the token admin role.","role":".$admin"}
...
```diff
+   Status: CREATED
    contract Proxy (eth:0x520Cf70a2D0B3dfB7386A2Bc9F800321F62a5c3a)
    +++ description: None
```
...
```diff
.../ConstantRetrieverRestricted.sol                |   37 +
 .../ConstantRetrieverRestricted}/Proxy.p.sol       |    0
 .../.flat@1741185503/DACommittee.sol => /dev/null  |  176 --
 .../GpsFactRegistryAdapter.sol => /dev/null        |   51 -
 .../OrderRegistry.sol => /dev/null                 |  226 --
 .../src/projects/deversifi/.flat/Proxy.sol         |   34 +
 .../StarkExchange/AllVerifiers.2.sol => /dev/null  |  709 -------
 .../StarkExchange/ForcedActions.5.sol => /dev/null | 1317 ------------
 .../StarkExchange/OnchainVaults.6.sol => /dev/null | 1247 -----------
 .../StarkExchange/ProxyUtils.7.sol => /dev/null    |  279 ---
 .../StarkExchange/StarkExState.4.sol => /dev/null  | 1549 --------------
 .../StarkExchange/StarkExchange.1.sol => /dev/null |  574 ------
 .../TokensAndRamping.3.sol => /dev/null            | 2161 --------------------
 13 files changed, 71 insertions(+), 8289 deletions(-)
```

Generated with discovered.json: 0x62bed18a054d56559b9e9fb4e74163c460814184

# Diff at Wed, 03 Sep 2025 15:52:04 GMT:

- author: Adrian Adamiak (<adrian@adamiak.net>)
- comparing to: main@fbfe8da4086c70042fea30347d68132d3f574015 block: 1741185503
...
Generated with discovered.json: 0xeb38a7e733d098324e771570653ec338fda67a70

# Diff at Tue, 02 Sep 2025 14:28:42 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ac83bbe73046e5a2b78d713bc6fc2c43f9d130e9 block: 1741185503
- current timestamp: 1741185503
...
Generated with discovered.json: 0x57c31d698881593451be1448a7b7fc117d94a00d

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0xe8137cd90a5be8eef31e3b24edf78461be85c1ce
