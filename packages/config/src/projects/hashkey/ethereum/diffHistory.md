Generated with discovered.json: 0xd54db7e3d9bff4a269ec22b6094907c3d650d1b3

# Diff at Mon, 17 Mar 2025 16:30:28 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21680579
...
+        "Hashkey Multisig 3"
      receivedPermissions:
-        [{"permission":"interact","from":"0x43F8DeFe3E9286D152E91BB16a248808E7247198","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: Contains configuration parameters such as the Sequencer address, gas limit on this chain and the unsafe block signer address.
      issuedPermissions.2:
-        {"permission":"interact","to":"0x29Fbda675Fa5a07B621C2C1a6E3F874C14F612F3","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.1:
-        {"permission":"sequence","to":"0x9391791f7CB74F8BFDA65edc0749efd964311b55","via":[]}
      issuedPermissions.0.to:
-        "0x441F31C4cdf772558D4EA31f3114de59aE145E7c"
+        "0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"
      issuedPermissions.0.via.0:
...
+        "Hashkey Multisig 1"
      receivedPermissions:
-        [{"permission":"interact","from":"0x679A65aD62972Ea3561F40A12e93CcA6f79F35E6","description":"set and change address mappings.","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0x0407af506d86bFA5e401099b2fC2355590638f19","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0x04Ec030f362CE5A0b5Fe2d4B4219f287C2EBDE50","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0x2171E6d3B7964fA9654Ce41dA8a8fFAff2Cc70be","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0x43F8DeFe3E9286D152E91BB16a248808E7247198","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0x4deC2aA521108d78d983c0c12656c6CF8631F2ED","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0xBb70D595147A141e268532BFEF61A8c25054d26D","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0xd4C83D93c6fAE3E0804B785F9Cf465BE95449D04","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0xd9c31D15f2c649e525C2574bC025b3CAafAaf6fe","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0xe7Aa79B59CAc06F9706D896a047fEb9d3BDA8bD3","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]},{"permission":"upgrade","from":"0xfd1255b6c09D939E7F3896A16C32CDBCD6F8B40A","via":[{"address":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x679A65aD62972Ea3561F40A12e93CcA6f79F35E6","description":"set and change address mappings."},{"permission":"upgrade","from":"0x0407af506d86bFA5e401099b2fC2355590638f19"},{"permission":"upgrade","from":"0x04Ec030f362CE5A0b5Fe2d4B4219f287C2EBDE50"},{"permission":"upgrade","from":"0x2171E6d3B7964fA9654Ce41dA8a8fFAff2Cc70be","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x43F8DeFe3E9286D152E91BB16a248808E7247198"},{"permission":"upgrade","from":"0x4deC2aA521108d78d983c0c12656c6CF8631F2ED"},{"permission":"upgrade","from":"0xBb70D595147A141e268532BFEF61A8c25054d26D"},{"permission":"upgrade","from":"0xd4C83D93c6fAE3E0804B785F9Cf465BE95449D04"},{"permission":"upgrade","from":"0xd9c31D15f2c649e525C2574bC025b3CAafAaf6fe"},{"permission":"upgrade","from":"0xe7Aa79B59CAc06F9706D896a047fEb9d3BDA8bD3"},{"permission":"upgrade","from":"0xfd1255b6c09D939E7F3896A16C32CDBCD6F8B40A"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0407af506d86bFA5e401099b2fC2355590638f19"},{"permission":"upgrade","from":"0x04Ec030f362CE5A0b5Fe2d4B4219f287C2EBDE50"},{"permission":"upgrade","from":"0x2171E6d3B7964fA9654Ce41dA8a8fFAff2Cc70be"},{"permission":"upgrade","from":"0x43F8DeFe3E9286D152E91BB16a248808E7247198"},{"permission":"upgrade","from":"0x4deC2aA521108d78d983c0c12656c6CF8631F2ED"},{"permission":"upgrade","from":"0xBb70D595147A141e268532BFEF61A8c25054d26D"},{"permission":"upgrade","from":"0xd4C83D93c6fAE3E0804B785F9Cf465BE95449D04"},{"permission":"upgrade","from":"0xd9c31D15f2c649e525C2574bC025b3CAafAaf6fe"},{"permission":"upgrade","from":"0xe7Aa79B59CAc06F9706D896a047fEb9d3BDA8bD3"},{"permission":"upgrade","from":"0xfd1255b6c09D939E7F3896A16C32CDBCD6F8B40A"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x43F8DeFe3E9286D152E91BB16a248808E7247198"}]
    }
```
...
+        "Hashkey Multisig 2"
      receivedPermissions:
-        [{"permission":"guard","from":"0xfd1255b6c09D939E7F3896A16C32CDBCD6F8B40A"}]
    }
```
...
```diff
    ...
    +++ description: This is NOT the shared SuperchainConfig contract of the OP stack Superchain but rather a local fork. It manages the `PAUSED_SLOT`, a boolean value indicating whether the local chain is paused, and `GUARDIAN_SLOT`, the address of the guardian which can pause and unpause the system.
      issuedPermissions.1:
-        {"permission":"guard","to":"0xC7fCbE26c1Db751d63869F72F782a56710f6be5A","via":[]}
      issuedPermissions.0.to:
-        "0x441F31C4cdf772558D4EA31f3114de59aE145E7c"
+        "0x7986eD289935A0F47FC434C00cDE309fE2c51f1C"
      issuedPermissions.0.via.0:
