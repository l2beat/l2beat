Generated with discovered.json: 0xa9a1fc50ab180c4712a8cc81ab9fc268636fad50

# Diff at Mon, 17 Mar 2025 16:30:07 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21084957
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x826D1B0D4111Ad9146Eb8941D7Ca2B6a44215c76"}]
    }
```
...
-        [{"permission":"interact","from":"0xE064B565Cf2A312a3e66Fe4118890583727380C0","description":"set and change address mappings."},{"permission":"upgrade","from":"0x0Ec68c5B10F21EFFb74f2A5C61DFe6b08C0Db6Cb"},{"permission":"upgrade","from":"0x3a05E5d33d7Ab3864D53aaEc93c8301C1Fa49115"},{"permission":"upgrade","from":"0x5531DcfF39EC1ec727C4c5D2fc49835368F805a9"},{"permission":"upgrade","from":"0x697402166Fbf2F22E970df8a6486Ef171dbfc524","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x6B916DcCa661d23794e78509723A6f4348564847"},{"permission":"upgrade","from":"0x826D1B0D4111Ad9146Eb8941D7Ca2B6a44215c76"},{"permission":"upgrade","from":"0x98078db053902644191f93988341E31289E1C8FE"},{"permission":"upgrade","from":"0xa230285d5683C74935aD14c446e137c8c8828438"},{"permission":"upgrade","from":"0xa45A0c7C47DB8C6e99b2d7C4939F7f7Cf69C8975"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0Ec68c5B10F21EFFb74f2A5C61DFe6b08C0Db6Cb"},{"permission":"upgrade","from":"0x3a05E5d33d7Ab3864D53aaEc93c8301C1Fa49115"},{"permission":"upgrade","from":"0x5531DcfF39EC1ec727C4c5D2fc49835368F805a9"},{"permission":"upgrade","from":"0x697402166Fbf2F22E970df8a6486Ef171dbfc524"},{"permission":"upgrade","from":"0x6B916DcCa661d23794e78509723A6f4348564847"},{"permission":"upgrade","from":"0x826D1B0D4111Ad9146Eb8941D7Ca2B6a44215c76"},{"permission":"upgrade","from":"0x98078db053902644191f93988341E31289E1C8FE"},{"permission":"upgrade","from":"0xa230285d5683C74935aD14c446e137c8c8828438"},{"permission":"upgrade","from":"0xa45A0c7C47DB8C6e99b2d7C4939F7f7Cf69C8975"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x5531DcfF39EC1ec727C4c5D2fc49835368F805a9"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x826D1B0D4111Ad9146Eb8941D7Ca2B6a44215c76"},{"permission":"guard","from":"0x0Ec68c5B10F21EFFb74f2A5C61DFe6b08C0Db6Cb"},{"permission":"interact","from":"0x5531DcfF39EC1ec727C4c5D2fc49835368F805a9","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0xE064B565Cf2A312a3e66Fe4118890583727380C0","description":"set and change address mappings.","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x0Ec68c5B10F21EFFb74f2A5C61DFe6b08C0Db6Cb","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x3a05E5d33d7Ab3864D53aaEc93c8301C1Fa49115","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x5531DcfF39EC1ec727C4c5D2fc49835368F805a9","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x697402166Fbf2F22E970df8a6486Ef171dbfc524","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x6B916DcCa661d23794e78509723A6f4348564847","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x826D1B0D4111Ad9146Eb8941D7Ca2B6a44215c76","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0x98078db053902644191f93988341E31289E1C8FE","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0xa230285d5683C74935aD14c446e137c8c8828438","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]},{"permission":"upgrade","from":"0xa45A0c7C47DB8C6e99b2d7C4939F7f7Cf69C8975","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]
    }
```
...
-        {"permission":"upgrade","to":"0x4f72ee94B8ba3Be7F886565d3583A7F636c58B05","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x4f72ee94B8ba3Be7F886565d3583A7F636c58B05","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
-        {"permission":"upgrade","to":"0x4f72ee94B8ba3Be7F886565d3583A7F636c58B05","via":[{"address":"0x364289230b8cc7d9120eF962AF37ebCFe23cE883"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x4f72ee94B8ba3Be7F886565d3583A7F636c58B05","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
