Generated with discovered.json: 0x07897bed0def416a6d73bd2829fa1632de4854bc

# Diff at Fri, 08 May 2026 07:52:28 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1771584033
...
discovery. Values are for block 1771584033 (main branch discovery), not current.
...
```diff
    contract Diamond (eth:0x410D7e4Ea1093A532eF9A7a2D5df84084B05ec24) [shared-zk-stack/Diamond] {
...
```diff
    contract ChainAdminOwnable (eth:0x86F4487949Ac2fb0d5735870f1731e879e1d9680) [shared-zk-stack/ChainAdmin] {
    +++ description: A governance proxy that lets eth:0x2bf43034b9559643e986A2fE3cE015a18247b904 act through it.
      sourceHashes.0:
...
Generated with discovered.json: 0x223ed1867b78133ef19ae4af44d3d93afaf9c93f

# Diff at Tue, 05 May 2026 10:23:13 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1771584033
- current timestamp: 1771584033
...
```diff
    contract ChainAdminOwnable (eth:0x86F4487949Ac2fb0d5735870f1731e879e1d9680) {
    +++ description: A governance proxy that lets eth:0x2bf43034b9559643e986A2fE3cE015a18247b904 act through it.
      deployerAddress:
+        "eth:0x58551793BEeDca08a861c394258E0457e48A2FCc"
    }
...
- comparing to: main@4d3bbb7da99046f2b087d4f716df0daccb09382b block: 1761642957
- current timestamp: 1765978050

## Description

Fix cataclysmic misconfig: this disco used the Diamond contract of lachain (archived)

As a result, we showed it as a rollup although it was a validium.

## Config/verification related changes

Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1761642957 (main branch discovery), not current.
...
Generated with discovered.json: 0x9b02e7046575ef41285fe82b080fb299c2d15e4f

# Diff at Tue, 04 Nov 2025 11:34:40 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1761642957
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@11b074f59e0a769fa3d144569b93ef0f7ba1e44f block: 1753944351
- current timestamp: 1753944351
...
Generated with discovered.json: 0xfd2adcd9fd7492acdc9382ae7ee22e6aa80c2052

# Diff at Wed, 03 Sep 2025 15:51:42 GMT:

- author: Adrian Adamiak (<adrian@adamiak.net>)
- comparing to: main@fbfe8da4086c70042fea30347d68132d3f574015 block: 1753944351
- current timestamp: 1753944351
...
Generated with discovered.json: 0x809ad82c8973247f42421de419dcc14a75d1d423

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0xe5d19516f0ddc6e8b68ca27a7e5017046c8b19b5

# Diff at Tue, 15 Jul 2025 10:00:36 GMT:

- chain: ethereum
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@fe7c3b2343ca7836e6a947e456ab91a6f0f6f592 block: 22896156
- current block number: 22923846
...
```diff
.../sxt/ethereum/{.flat@22896156 => .flat}/DualVerifier.sol    |  2 +-
 .../ethereum/{.flat@22896156 => .flat}/L1VerifierFflonk.sol    |  6 +++---
 .../sxt/ethereum/{.flat@22896156 => .flat}/L1VerifierPlonk.sol | 10 +++++-----
 .../{.flat@22896156 => .flat}/zkVmDiamond/AdminFacet.1.sol     |  2 +-
 .../{.flat@22896156 => .flat}/zkVmDiamond/ExecutorFacet.4.sol  |  2 +-
 .../{.flat@22896156 => .flat}/zkVmDiamond/GettersFacet.2.sol   |  2 +-
 .../{.flat@22896156 => .flat}/zkVmDiamond/MailboxFacet.3.sol   |  2 +-
...
Generated with discovered.json: 0xfc38e6edc88ddee67588c07e44bfdfdc73f7af4e
