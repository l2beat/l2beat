Generated with discovered.json: 0xa9dba448d7f91361b6fdb4166f78285bd342e89e

# Diff at Mon, 17 Mar 2025 16:30:32 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21880791
...
-        [{"permission":"upgrade","from":"0xef899e92DA472E014bE795Ecce948308958E25A2"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0xef899e92DA472E014bE795Ecce948308958E25A2"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"validateBridge2","from":"0xF6419b2d603f7D00C383FE8b43E75DD6C0C1D63e"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"interact","from":"0x5B4e223DE74ef8c3218e66EEcC541003CAB3121A","description":"change the ISM and hooks, whitelist new routes and update destination fees."},{"permission":"interact","from":"0x647C621CEb36853Ef6A907E397Adf18568E70543","description":"change the ISM and hooks, whitelist new routes and update destination fees."},{"permission":"interact","from":"0xc005dc82818d67AF737725bD4bf75435d065D239","description":"change the default ISM and hooks for this chain that are used for all connected contracts that do not override them."},{"permission":"interact","from":"0xc2495f3183F043627CAECD56dAaa726e3B2D9c09","description":"change the ISM and hooks, whitelist new routes and update destination fees."},{"permission":"interact","from":"0xc72f634784EA020b703E11e88582Beb5903792b9","description":"manage the domain -> ISM contract mapping."},{"permission":"interact","from":"0xe1De9910fe71cC216490AC7FCF019e13a34481D7","description":"change the ISM and hooks, whitelist new routes and update destination fees."},{"permission":"upgrade","from":"0x5B4e223DE74ef8c3218e66EEcC541003CAB3121A","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]},{"permission":"upgrade","from":"0x647C621CEb36853Ef6A907E397Adf18568E70543","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]},{"permission":"upgrade","from":"0xc005dc82818d67AF737725bD4bf75435d065D239","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]},{"permission":"upgrade","from":"0xc2495f3183F043627CAECD56dAaa726e3B2D9c09","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]},{"permission":"upgrade","from":"0xe1De9910fe71cC216490AC7FCF019e13a34481D7","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]}]
      directlyReceivedPermissions:
...
```diff
    ...
    +++ description: This specific Interchain Security Module (ISM) contract is a simple 't of n' module that checks that a threshold of 2 out of the [0x3ed820384Dd2Af9b937803bdE6aE5F7a5689D835,0xc72f634784EA020b703E11e88582Beb5903792b9] ISM contracts successfully verify a message.
      receivedPermissions:
-        [{"permission":"interact","from":"0xc005dc82818d67AF737725bD4bf75435d065D239","description":"verify messages for destination contracts that do not specify a custom ISM."}]
    }
```
...
```diff
    ...
    +++ description: Escrow for WBTC that is bridged from Ethereum to Eclipse.
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0x3965AC3D295641E452E0ea896a086A9cD7C6C5b6","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]}
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"upgrade","from":"0x5B4e223DE74ef8c3218e66EEcC541003CAB3121A"},{"permission":"upgrade","from":"0x647C621CEb36853Ef6A907E397Adf18568E70543"},{"permission":"upgrade","from":"0xc005dc82818d67AF737725bD4bf75435d065D239"},{"permission":"upgrade","from":"0xc2495f3183F043627CAECD56dAaa726e3B2D9c09"},{"permission":"upgrade","from":"0xe1De9910fe71cC216490AC7FCF019e13a34481D7"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x5B4e223DE74ef8c3218e66EEcC541003CAB3121A"},{"permission":"upgrade","from":"0x647C621CEb36853Ef6A907E397Adf18568E70543"},{"permission":"upgrade","from":"0xc005dc82818d67AF737725bD4bf75435d065D239"},{"permission":"upgrade","from":"0xc2495f3183F043627CAECD56dAaa726e3B2D9c09"},{"permission":"upgrade","from":"0xe1De9910fe71cC216490AC7FCF019e13a34481D7"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"upgrade","from":"0xd34FE1685c28A68Bb4B8fAaadCb2769962AE737c"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0xd34FE1685c28A68Bb4B8fAaadCb2769962AE737c"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xd34FE1685c28A68Bb4B8fAaadCb2769962AE737c","description":"change the ISM and hooks, whitelist new routes and update destination fees."},{"permission":"upgrade","from":"0xd34FE1685c28A68Bb4B8fAaadCb2769962AE737c","via":[{"address":"0x9Fca159607687AE26367d66166e680A930af0780"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x9Fca159607687AE26367d66166e680A930af0780"}]
    }
```
...
-        {"permission":"upgrade","to":"0x3965AC3D295641E452E0ea896a086A9cD7C6C5b6","via":[{"address":"0x75EE15Ee1B4A75Fa3e2fDF5DF3253c25599cc659"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x57e1787fbdCCf7516721DC621CE17C45509cc2DB","description":"verify messages for destination contracts that do not specify a custom ISM.","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xef899e92DA472E014bE795Ecce948308958E25A2","description":"change the ISM and hooks, whitelist new routes and update destination fees."},{"permission":"upgrade","from":"0xef899e92DA472E014bE795Ecce948308958E25A2","via":[{"address":"0x2FFC8e94edDda8356f6b66aa035B42b20CF24A08"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x2FFC8e94edDda8356f6b66aa035B42b20CF24A08"}]
    }
```
...
```diff
    ...
    +++ description: Escrow for apxETH that is bridged from Ethereum to Eclipse.
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0xA52Fd396891E7A74b641a2Cb1A6999Fcf56B077e","via":[{"address":"0x9Fca159607687AE26367d66166e680A930af0780"}]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: Escrow for weETHs that is bridged from Ethereum to Eclipse.
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0xCEA8039076E35a825854c5C2f85659430b06ec96","via":[{"address":"0x2FFC8e94edDda8356f6b66aa035B42b20CF24A08"}]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
