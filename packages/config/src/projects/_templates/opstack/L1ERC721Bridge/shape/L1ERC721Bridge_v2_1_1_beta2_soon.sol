...
abstract contract ERC721Bridge is Initializable {
    ...
    function __ERC721Bridge_init(CrossDomainMessenger _messenger, bytes32 _otherBridge) internal onlyInitializing {
    ...
    function bridgeERC721(address, bytes32, uint256, uint32, bytes calldata) external pure {
        ...
        //_initiateBridgeERC721(_localToken, _remoteToken, msg.sender, _tokenId, _minGasLimit, _extraData);
    }
    ...
    function bridgeERC721To(
        ...
        external
    {
        require(_to != bytes32(0), "ERC721Bridge: nft recipient cannot be address(0)");
...
contract L1ERC721Bridge is ERC721Bridge, ISemver {
    ...
    mapping(address => mapping(bytes32 => mapping(uint256 => bool))) public deposits;
    ...
    function initialize(CrossDomainMessenger _messenger, SuperchainConfig _superchainConfig) public initializer {
        ...
        __ERC721Bridge_init({ _messenger: _messenger, _otherBridge: Predeploys.L2_ERC721_BRIDGE });
    }
    ...
    function _initiateBridgeERC721(
        ...
        override
    {
        require(_remoteToken != bytes32(0), "L1ERC721Bridge: remote token cannot be address(0)");
