...
export const transporter: Bridge = {
  ...
  display: {
    ...
    description:
      'Transporter is a Token Bridge based on CCIP network.  It is a hybrid bridge that can work either as a Token Bridge or Liquidity Network depending on the requirements of tokens.\
