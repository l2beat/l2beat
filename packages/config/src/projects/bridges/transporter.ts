...
export const transporter: Bridge = {
  ...
  display: {
    ...
    description:
      'Transporter is a Token Bridge based on CCIP network',
    detailedDescription:
  ...
  technology: {
    destination: ['Ethereum', 'Arbitrum', 'Base', 'Optimism', 'Polygon', 'Gnosis Chain', 'Wemix', 'BNB Chain', 'Avalanche'],
    principleOfOperation: {
      name: 'Principle of operation',
      description:
        `Transporter is a Token Bridge based on CCIP network. CCIP network is an AMB (Arbitrary Message Passing) allowing to pass arbitrary messages that are attested by ChainLink Oracles. 
        ...
        },
{
    ...
    ], // a long list of escrows from Discovery
  },
  contracts: {
