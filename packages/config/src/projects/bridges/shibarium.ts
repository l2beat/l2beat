...
export const shibarium: Bridge = {
  ...
  display: {
    ...
    slug: 'shibarium',
    links: {
      websites: ['https://shib.io/', 'https://shibarium.shib.io'],
  ...
  contracts: {
    addresses: [
      discovery.getContractDetails('DepositManagerProxy', {
        description: 'Bridge BONE deposit manager proxy contract',
      }),
      discovery.getContractDetails('ERC20PredicateProxy', {
        description: 'ERC20 token deposit proxy contract',
      }),
      discovery.getContractDetails('EtherPredicateProxy', {
        description: 'ETH deposit proxy contract',
      }),
    ],
    risks: [],
  },
