Generated with discovered.json: 0x90ff7377696b5ed5916454bdf5188e6fa45cc5d9

# Diff at Wed, 23 Sep 2026 05:45:40 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1783433878
...
Generated with discovered.json: 0xeffe284f94d6e20aeedefcfbc005195926787aee

# Diff at Mon, 21 Sep 2026 11:23:58 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1783433878
- current timestamp: 1783433878
...
```diff
    contract Outbox (eth:0x2a3C554f212E3e0c78eaF0808f5313A10542dA2d) [orbitstack/Outbox] {
...
```diff
    contract Inbox (eth:0x37693F11f3D724E55D0B03D5F328D8202C913243) [orbitstack/Inbox] {
...
```diff
    contract RollupEventInbox (eth:0x6282197777e7c318C7209bd7059110886aa429C6) [orbitstack/RollupEventInbox] {
...
```diff
    contract Bridge (eth:0x7E31f112d340a4D0cB0e4bD82f2853089d1bF10C) [orbitstack/Bridge] {
...
```diff
    contract EdgeChallengeManager (eth:0x90f6C3e6C11959A01eDc6ea392e6f659605b4237) [orbitstack/EdgeChallengeManager] {
...
Generated with discovered.json: 0x47d120cf8f5a3fdcddf1957340f66f6f2d67fb38

# Diff at Fri, 18 Sep 2026 10:24:48 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1783433878
- current timestamp: 1783433878
...
Generated with discovered.json: 0x2055e62db9acc5d2fe07d6ffa533a9dec8991e23
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1771857552
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1771857552 (main branch discovery), not current.

```diff
    EOA  (eth:0xe2F1D1E0ACc476455044a9D053B5d667C0a2D61c) {
    +++ description: None
...
```diff
    EOA  (eth:0xfFb9B41320a47FDE7c2939BA0c1f1d58E80648FB) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
Generated with discovered.json: 0x890e3142ffb67e19fbff5fde1fcf3424577d3e3e

# Diff at Fri, 22 May 2026 15:39:31 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1b7024bc804124af9b25421eca5fac952454cb09 block: 1771857552
- current timestamp: 1771857552
...
Generated with discovered.json: 0x6a3ff5a05221a32abbe8c6489c1a87f4a23b3a86

# Diff at Fri, 15 May 2026 12:35:47 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a5152b9ba7ad7f85f2af3d814f74630fcaa7c917 block: 1771857552
- current timestamp: 1771857552
...
Generated with discovered.json: 0x4c3f9be09361c5a7f78587be8ad499e55a4d0b78

# Diff at Fri, 08 May 2026 07:51:12 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1771857552
- current timestamp: 1771857552
...
```diff
    contract wBTC Escrow (eth:0x00943b11764176C3a8323aEFCBd6fE70CFb6272d) [N/A] {
    +++ description: None
      sourceHashes.0:
...
+        "0x828d4bcb5a618e161ec9a55b456ea32fd43a3f258bab7274e74c694bc5c37455"
    }
```
...
```diff
    contract cbBTC Escrow (eth:0x957C9DC25DE6B8E46a7Fa0D081bA749DD005B54f) [N/A] {
    +++ description: None
      sourceHashes.0:
-        "0x29faf4889af43049c742ca34aeff493c079c023986c7f794a3dbfe3b1c642d09"
+        "0xf66f390c3291bc5b8725bf8fa36d64494b91e8cfb2b717b52e85adcc68dcdd50"
...
Generated with discovered.json: 0xb050338efd4cc9a377a44fafcbf2e616cf64c09c

# Diff at Tue, 05 May 2026 10:22:04 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1771857552
- current timestamp: 1771857552
...
```diff
    contract wBTC Escrow (eth:0x00943b11764176C3a8323aEFCBd6fE70CFb6272d) {
    +++ description: None
      deployerAddress:
+        "eth:0x770a2350A9DC3daa77cdab2Dd7f15Aae2A44E8C1"
    }
```

```diff
    contract RollupProxy (eth:0x09eD7e66Dd7c7129Ec3994498A521B502Ca7D61b) {
    +++ description: Central contract for the project's configuration like its execution logic hash (`wasmModuleRoot`) and addresses of the other system contracts. Entry point for Proposers creating new assertions (state commitments) and Challengers submitting fraud proofs (In the Orbit stack, these two roles are both called Validators).
      deployerAddress:
...
```diff
    contract Outbox (eth:0x2a3C554f212E3e0c78eaF0808f5313A10542dA2d) {
    +++ description: Facilitates L2 to L1 contract calls: Messages initiated from L2 (for example withdrawal messages) eventually resolve in execution on L1.
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
```

```diff
    contract Inbox (eth:0x37693F11f3D724E55D0B03D5F328D8202C913243) {
    +++ description: Facilitates sending L1 to L2 messages like depositing ETH, but does not escrow funds.
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
...
```diff
    contract SequencerInbox (eth:0x4ad144ea249A98F77e0b78104D3B6eB6cd3a76DA) {
    +++ description: A sequencer (registered in this contract) can submit transaction batches or commitments here.
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
...
```diff
    contract Governor (eth:0x515C7d8Fcb950f8b030ac08C994b37b4b8F3F7B5) {
    +++ description: None
      deployerAddress:
+        "eth:0x770a2350A9DC3daa77cdab2Dd7f15Aae2A44E8C1"
    }
...
```diff
    contract RollupEventInbox (eth:0x6282197777e7c318C7209bd7059110886aa429C6) {
    +++ description: Helper contract sending configuration data over the bridge during the systems initialization.
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
...
```diff
    contract Bridge (eth:0x7E31f112d340a4D0cB0e4bD82f2853089d1bF10C) {
    +++ description: Escrow contract for the project's gas token (can be different from ETH). Keeps a list of allowed Inboxes and Outboxes for canonical bridge messaging.
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
...
```diff
    contract UpgradeExecutor (eth:0x8672705351C81f40B55b1ac2A1998de66166d0eA) {
    +++ description: Central contract defining the access control permissions for upgrading the system contract implementations.
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
...
```diff
    contract EdgeChallengeManager (eth:0x90f6C3e6C11959A01eDc6ea392e6f659605b4237) {
    +++ description: Contract that implements the main challenge protocol logic of the fraud proof system.
      deployerAddress:
+        "eth:0x5D2af120aED72585fd24E4176dbB4B484B84e0bE"
    }
...
```diff
    contract cbBTC Escrow (eth:0x957C9DC25DE6B8E46a7Fa0D081bA749DD005B54f) {
    +++ description: None
      deployerAddress:
+        "eth:0x770a2350A9DC3daa77cdab2Dd7f15Aae2A44E8C1"
    }
...
```diff
    contract CornMultisig (eth:0xCff1ad9f09b32252171207e8525c90B18D4E2C7D) {
    +++ description: None
      deployerAddress:
+        "eth:0x770a2350A9DC3daa77cdab2Dd7f15Aae2A44E8C1"
    }
...
```diff
    contract ProxyAdmin (eth:0xEE9924C5fd94601C80fF8010f577C9f7f3C20B84) {
    +++ description: None
      deployerAddress:
+        "eth:0x23ddFc9AA09612eE0417d0655ED1076F153f915E"
    }
...
Generated with discovered.json: 0x5cb3f98dfdf8fb6cee3f1e5193602e4d8641ee7b

# Diff at Mon, 23 Feb 2026 14:40:22 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@223ad9100b05447b13e88b350a283f0fcdd967a4 block: 1753200551
- current timestamp: 1771857552
...
+        ["2026-02-20T15:54:11.000Z","0x657c22e5b9be1d565e6464915276bcc262e66aac6ba82ffa73d1de7688204981",["eth:0x17E0C5fE0dFF2AE4cfC9E96d9Ccd112DaF5c0386"]]
      values.$upgradeCount:
-        1
+        2
      values.rollup:
-        "eth:0x828C71bc1D7A34F32FfA624240633b6B7272C3D6"
+        "eth:0x09eD7e66Dd7c7129Ec3994498A521B502Ca7D61b"
...
+        ["2026-02-20T15:54:11.000Z","0x657c22e5b9be1d565e6464915276bcc262e66aac6ba82ffa73d1de7688204981",["eth:0xD210b64eD9D47Ef8Acf1A3284722FcC7Fc6A1f4e"]]
      values.$upgradeCount:
-        2
+        3
...
+        "eth:0x6F2E7F9B5Db5e4e9B5B1181D2Eb0e4972500C324"
      values.$pastUpgrades.2:
+        ["2026-02-20T15:54:11.000Z","0x657c22e5b9be1d565e6464915276bcc262e66aac6ba82ffa73d1de7688204981",["eth:0x6F2E7F9B5Db5e4e9B5B1181D2Eb0e4972500C324"]]
      values.$upgradeCount:
-        2
+        3
...
+        "eth:0x0d079b22B0B4083b9b0bDc62Bf1a4EAF4a95bDEe"
      values.$pastUpgrades.1:
+        ["2026-02-20T15:54:11.000Z","0x657c22e5b9be1d565e6464915276bcc262e66aac6ba82ffa73d1de7688204981",["eth:0x0d079b22B0B4083b9b0bDc62Bf1a4EAF4a95bDEe"]]
      values.$upgradeCount:
-        1
+        2
      values.rollup:
...
+        "eth:0x81be1Bf06cB9B23e8EEDa3145c3366A912DAD9D6"
      values.$pastUpgrades.1:
+        ["2026-02-20T15:54:11.000Z","0x657c22e5b9be1d565e6464915276bcc262e66aac6ba82ffa73d1de7688204981",["eth:0x81be1Bf06cB9B23e8EEDa3145c3366A912DAD9D6"]]
      values.$upgradeCount:
-        1
+        2
      values.rollup:
...
```diff
-   Status: DELETED
    contract ChallengeManager (eth:0xBb309FFFC24F77927d7C4eb86BaA67D8f9dC0EB8)
...
+        {"permission":"interact","from":"eth:0x09eD7e66Dd7c7129Ec3994498A521B502Ca7D61b","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability and DACs, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes.","role":".owner","via":[{"address":"eth:0x8672705351C81f40B55b1ac2A1998de66166d0eA"}]}
...
-        {"permission":"upgrade","from":"eth:0x828C71bc1D7A34F32FfA624240633b6B7272C3D6","role":"admin","via":[{"address":"eth:0x8672705351C81f40B55b1ac2A1998de66166d0eA"}]}
      receivedPermissions.8.from:
-        "eth:0xBb309FFFC24F77927d7C4eb86BaA67D8f9dC0EB8"
+        "eth:0x90f6C3e6C11959A01eDc6ea392e6f659605b4237"
    }
```
...
.../Bridge/ERC20Bridge.sol                         |  306 +-
 ...
 .../{.flat@1753200551 => .flat}/OneStepProver0.sol |  502 ++-
...
Generated with discovered.json: 0xea05fb08de8da803c54a709a841f54f428a14463

# Diff at Mon, 05 Jan 2026 17:44:10 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1753200551
...
Generated with discovered.json: 0x28a5df3b1e1be99f988f7706a112b458e4117dbd
