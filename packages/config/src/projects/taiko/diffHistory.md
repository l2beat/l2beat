Generated with discovered.json: 0x7294360f898671c631daae1bbf0a53b3c739afbe
...
```diff
    EOA (eth:0x18B4f2afe456Dc89bddE9710476dCfC62D01d656) {
    +++ description: None
      name:
-        "Drew Van der Werff Agent"
    }
```

```diff
    EOA (eth:0x1d955983044548E03DAA583B36A37cA4bdE6F556) {
    +++ description: None
      name:
-        "Halborn Agent"
    }
...
```diff
    EOA (eth:0x22aD66bcEaeff83e1461772Fa85CbeB01f0915f4) {
    +++ description: None
      name:
-        "Chainbound Agent"
    }
...
```diff
    EOA (eth:0x4236f57E9dBc238878EFac4AeF0A16D4dD06DC1A) {
    +++ description: None
      name:
-        "Nethermind Agent"
    }
...
```diff
    EOA (eth:0x93533a3511E9b0d5c17b1CBD0e1737781DEf61a6) {
    +++ description: None
      name:
-        "Toni Wahrstätter Agent"
    }
```
...
```diff
    contract Taiko Labs (eth:0xb47fE76aC588101BFBdA9E68F66433bA51E8029a) [GnosisSafe] {
    +++ description: None
      name:
...
```diff
    EOA (eth:0xc4414B079bC4A013916B3dc241555F6f505c1619) {
    +++ description: None
      name:
-        "Gattaca Agent"
    }
...
```diff
    contract Sebastian Kugler (eth:0xf1cF63589A1e012F9124182c9eAa36B5333e5f06) [GnosisSafe] {
    +++ description: None
      name:
-        "L2BEAT"
+        "Sebastian Kugler"
