Generated with discovered.json: 0x7d71d0071e5c61746c358c8b6c47eb7ffacc6a8a
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@d903624f4bbcd7c3db85ae1858dfd3303fa28c5c block: 1784193913
- current timestamp: 1784193913
...
Generated with discovered.json: 0xbae744bfcbe06e4a617daec589266f8cfb58caae

# Diff at Mon, 07 Sep 2026 08:37:54 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@25578f132c6c06c4de07ab98ad602d8239829c04 block: 1784193913
- current timestamp: 1784193913
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@24b66dabda72dfc1e4f6b250e25cdeaadeda1854 block: 1781603222
- current timestamp: 1781603222

## Description

Propagate the improved Starknet trust-chain descriptions and permissions to Paradex, which uses the same Starknet core template.

## Config/verification related changes

Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1781603222 (main branch discovery), not current.
...
+        ["866529294756877885868060719289414520147578064967782455476886832800647120452","1946969884474626573154270293480115261427695072308490075958253509832033340430","2741190170141984203224468507008497105532196084369172236871397222510074358631","755316247915403236082211219217701569888673466355003491006148202168030226084"]
...
- author: Sergey Shemyakov (<sergey.shemyakov@l2beat.com>)
- comparing to: main@f037e089ad6308d2008a0473963ba4d8780ebf9e block: 1764060007
- current timestamp: 1765880191
...
+        "1701025211190912681772481128523426351562426117847395998223683709327746845867"
      values.configHash:
-        "755316247915403236082211219217701569888673466355003491006148202168030226084"
+        "1386722975727499172783711380010899570614494177755849513051766179156263595841"
+++ description: The L2 programHash which is a hash of the L2 state machine logic. Liveness config MUST be changed in the .ts as soon as this is updated.
+++ severity: HIGH
      values.programHash:
...
- comparing to: main@fbfe8da4086c70042fea30347d68132d3f574015 block: 1755516515
