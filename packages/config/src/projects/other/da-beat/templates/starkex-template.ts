...
export function starkexDAC(template: TemplateVars): DacDaLayer {
  ...
  const layerTechnology =
    ...
    - **Committee Members**: A group of nodes responsible for storing state data associated with each Merkle root and attesting to data availability by signing claims.
