...
export const eigenDA: DaLayer = {
  ...
  technology: {
    ...
    The EigenDARollupUtils.sol library's verifyBlob() function can then used by L2s to verify that a data blob is included within a confirmed batch in the EigenDAServiceManager. 
