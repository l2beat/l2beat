...
const maxRangeDataCommitment = discovery.getContractValue(
  'BlobstreamX',
  'DATA_COMMITMENT_MAX',
)
  ...
  contracts: {
    addresses: [
      discovery.getContractDetails('BlobstreamX', {
        description: 'The BlobstreamX DA bridge. This contract is used to bridge data commitments between Celestia and Ethereum.',
      }),
      {
        name: "headerRangeVerifier",
        address: EthereumAddress('0xF33a22dFf8017813b95E5a05c9a97BaFE693001E'),
      ...
      },
      {
        ...
        address: EthereumAddress('0x037E57EF3a130CD23988a4Ed530d79d6f97a0f06'),
        description: 'Verifier contract for a single header proof. Used in the rare case in which the validator set changes by more than 2/3 in a single block.',
      },
