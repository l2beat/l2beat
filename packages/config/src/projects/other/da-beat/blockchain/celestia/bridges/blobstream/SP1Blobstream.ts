  ...
  contracts: {
    addresses: {
      ethereum: [
        ...
        ethereumDiscovery.getContractDetails(
          SP1Verifier,
        ...
        ethereumDiscovery.getContractDetails('SuccinctGateway', {
          description: `Users can interact with this contract to request proofs onchain, emitting a RequestCall event for off-chain provers to consume.`,
        }),
      ],
      arbitrum: [
        ...
        arbitrumDiscovery.getContractDetails(
          ArbitrumSP1Verifier,
          `Verifier contract for the header range [latestBlock, targetBlock] proof. A request for a header range can be at most ${arbitrumMaxRangeDataCommitment} blocks long. The proof is generated by an off-chain prover and submitted by a relayer.`,
        ),
      ...
      base: [
        ...
        baseDiscovery.getContractDetails(
          BaseSP1Verifier,
          `Verifier contract for the header range [latestBlock, targetBlock] proof. A request for a header range can be at most ${baseMaxRangeDataCommitment} blocks long. The proof is generated by an off-chain prover and submitted by a relayer.`,
        ),
