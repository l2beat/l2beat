Generated with discovered.json: 0x01acf0218c8b251e9782f6f3080833bd56f6672f

# Diff at Wed, 23 Sep 2026 05:46:25 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1775220597
...
Generated with discovered.json: 0xf3985af51427892a5749bf904b527e0d5d697280

# Diff at Mon, 21 Sep 2026 11:24:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1775220597
- current timestamp: 1775220597
...
```diff
    contract Inbox (eth:0x06084a0AC843084a1d1B8ba0f67E048e4f8f3B95) [orbitstack/Inbox] {
    +++ description: Facilitates sending L1 to L2 messages like depositing ETH, but does not escrow funds.
      sourceHashes.1:
-        "0x25984fdfffb8141859c99299fb29e7a7460732d77111e5fe23792baa99f336a3"
+        "0xb33f29d585cf178f81b64440ee9a3c598cd398ad18d2b3c6dc6c711eaf63d5e4"
      deployerAddress:
+        "eth:0xBc54708fB6C6C97086e3f6554a517DE5EF16c304"
      fieldMeta:
...
```diff
    contract Fluence Token (eth:0x236501327e701692a281934230AF0b6BE8Df3353) [N/A] {
    +++ description: None
      sourceHashes.0:
...
+        "0xde02724123ae8b01dee6b4dde77cdd90312292ed8de088e823b7f4ca44dff156"
      sourceHashes.1:
-        "0x61e2fad21e980b9ccf622271ac82b5f3dc6b103ab5d5555d56b6fb28a9366903"
+        "0xb53698873d42ac6778439144acab8cd096286531db1448ac058f6a43a7a2a998"
      deployerAddress:
+        "eth:0x568235236f039253F348F1503ce0690bA291675b"
    }
```

```diff
    contract ChallengeManager (eth:0x284696FB7BF57dB7133Fd8c9EB74f49A76b2485F) [orbitstack/ChallengeManager] {
...
```diff
    contract Outbox (eth:0x50Df2E43aDefee3b6510b637697d30e7dc155e13) [orbitstack/Outbox] {
...
```diff
    contract Sweeper (eth:0x5d436201d1fD53Dc9ECeA4268f257C6fC87c598D) [N/A] {
    +++ description: None
      deployerAddress:
+        "eth:0xBc54708fB6C6C97086e3f6554a517DE5EF16c304"
    }
...
```diff
    contract Bridge (eth:0x5E6B2D08EA7B3251fef4a244F54D508E0cBD6D3A) [N/A] {
    +++ description: None
      deployerAddress:
+        "eth:0xBc54708fB6C6C97086e3f6554a517DE5EF16c304"
    }
...
```diff
    contract UpgradeExecutor (eth:0x6BCe4c44668C77ff67730C14d2378857103F53C7) [orbitstack/UpgradeExecutor] {
...
```diff
    contract GnosisSafe (eth:0x7F629403fDCC02aD83aA5debd1D4B1548982afaC) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
-        "0xd42bbf9f7dcd3720a7fc6bdc6edfdfae8800a37d6dd4decfa0ef6ca4a2e88940"
+        "0x22c7fb8365a538c05d34b77dd9c1967d1ddb7427eda69f84989d4c56603312b7"
      deployerAddress:
+        "eth:0xBe8C3Dd6ecaDEEcCFEcC447BeDc3C15F78B1E8b0"
    }
```
...
+        "0xf88f29d444411e68fef376c8e035ef1f39314143a7b6aff952709203095663bd"
      deployerAddress:
+        "eth:0x530FE24D7Bb68C359325BDc8360B616Db99E31d9"
    }
```
...
```diff
    contract RollupProxy (eth:0xD085B74A57D1d7947B9C9f8E2d75cB6832d62d0f) [orbitstack/RollupProxy_fastConfirm] {
...
Generated with discovered.json: 0x6d538d38666fcb936f6a9a697443dab9f3668192

# Diff at Fri, 18 Sep 2026 10:24:49 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1775220597
- current timestamp: 1775220597
...
Generated with discovered.json: 0x7fae0d34013b4063f569b5a69d4bd019fbe7fe1b
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1764335280
- current timestamp: 1764335280
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764335280 (main branch discovery), not current.
...
Generated with discovered.json: 0x8db5c7414b42aa303b4990687927b7e5d8037cef

# Diff at Fri, 28 Nov 2025 13:09:08 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@279d1ad356551e0a039b2400b6ca3bfd5e1e0974 block: 1756118020
- current timestamp: 1764335280
