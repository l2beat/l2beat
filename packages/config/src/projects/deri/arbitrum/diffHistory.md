Generated with discovered.json: 0xff4291a8aed5f095f7542f67643ec1b1a8660006

# Diff at Mon, 17 Mar 2025 16:47:18 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 287770865
...
```diff
    contract undefined (0x02c903F5c76F3f00c1F659702Bd76DF30470bBEE) {
    +++ description: None
      receivedPermissions:
...
-        [{"permission":"act","from":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"permission":"interact","from":"0x846387C3D6001F74170455B1074D01f05eB3067a","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability and DACs, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes."},{"permission":"upgrade","from":"0x846387C3D6001F74170455B1074D01f05eB3067a"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x846387C3D6001F74170455B1074D01f05eB3067a"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"upgrade","from":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"},{"permission":"upgrade","from":"0x0fF7A97caAb356c5507e5355b6819CB8b93d5591"},{"permission":"upgrade","from":"0x383eFE8D410285c5CbE1B4F296022640759aA834"},{"permission":"upgrade","from":"0xA597e0212971e65f53f288Ff1fFd26A6C8201f83"},{"permission":"upgrade","from":"0xa8f6bB820eaD521cf834B7b371cFe025bdacEE99"},{"permission":"upgrade","from":"0xB155C77a440DA7c282993a89FeA609598293017A"},{"permission":"upgrade","from":"0xD4FE46D2533E7d03382ac6cACF0547F336e59DC0"},{"permission":"upgrade","from":"0xe347C1223381b9Dcd6c0F61cf81c90175A7Bae77"},{"permission":"upgrade","from":"0xe507b9EF563DB6CcFDcE270160C50b2005BeED20"},{"permission":"upgrade","from":"0xFF55fB76F5671dD9eB6c62EffF8D693Bb161a3ad"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"},{"permission":"upgrade","from":"0x0fF7A97caAb356c5507e5355b6819CB8b93d5591"},{"permission":"upgrade","from":"0x383eFE8D410285c5CbE1B4F296022640759aA834"},{"permission":"upgrade","from":"0xA597e0212971e65f53f288Ff1fFd26A6C8201f83"},{"permission":"upgrade","from":"0xa8f6bB820eaD521cf834B7b371cFe025bdacEE99"},{"permission":"upgrade","from":"0xB155C77a440DA7c282993a89FeA609598293017A"},{"permission":"upgrade","from":"0xD4FE46D2533E7d03382ac6cACF0547F336e59DC0"},{"permission":"upgrade","from":"0xe347C1223381b9Dcd6c0F61cf81c90175A7Bae77"},{"permission":"upgrade","from":"0xe507b9EF563DB6CcFDcE270160C50b2005BeED20"},{"permission":"upgrade","from":"0xFF55fB76F5671dD9eB6c62EffF8D693Bb161a3ad"}]
    }
```
...
```diff
    contract undefined (0x46A78349aBA0369D18292a285DE6d5FC5CC2de5c) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x846387C3D6001F74170455B1074D01f05eB3067a","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability and DACs, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes.","via":[{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0x0fF7A97caAb356c5507e5355b6819CB8b93d5591","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0x383eFE8D410285c5CbE1B4F296022640759aA834","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0x846387C3D6001F74170455B1074D01f05eB3067a","via":[{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xA597e0212971e65f53f288Ff1fFd26A6C8201f83","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xa8f6bB820eaD521cf834B7b371cFe025bdacEE99","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xB155C77a440DA7c282993a89FeA609598293017A","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xD4FE46D2533E7d03382ac6cACF0547F336e59DC0","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xe347C1223381b9Dcd6c0F61cf81c90175A7Bae77","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xe507b9EF563DB6CcFDcE270160C50b2005BeED20","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]},{"permission":"upgrade","from":"0xFF55fB76F5671dD9eB6c62EffF8D693Bb161a3ad","via":[{"address":"0x27C7Bfd2cC11429e9b80c443b42FDBe4754F6c91"},{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]}]
      directlyReceivedPermissions:
...
```diff
    ...
    +++ description: Central contract for the project's configuration like its execution logic hash (`wasmModuleRoot`) and addresses of the other system contracts. Entry point for Proposers creating new Rollup Nodes (state commitments) and Challengers submitting fraud proofs (In the Orbit stack, these two roles are both held by the Validators).
      issuedPermissions.2:
-        {"permission":"validate","to":"0xD217853C6A59e51dC1a48CEF21d9E53FCaA8a3f0","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain.","via":[]}
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0x46A78349aBA0369D18292a285DE6d5FC5CC2de5c","via":[{"address":"0x0611b78A42903a537BE7a2f9a8783BE39AC63cD9"}]}
...
```diff
    contract undefined (0xD217853C6A59e51dC1a48CEF21d9E53FCaA8a3f0) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"validate","from":"0x846387C3D6001F74170455B1074D01f05eB3067a","description":"Can propose new state roots (called nodes) and challenge state roots on the host chain."}]
    }
```
