Generated with discovered.json: 0xde0a9cdbcafd1e546e267028e9aa3442231aebab

# Diff at Mon, 17 Mar 2025 16:31:07 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21872580
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x29E7177837652ca00f05fbD2e8aA867d207B2EF8"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x9fDEEa19836A413C04e9672d3d09f482278e863c"},{"permission":"guard","from":"0xb6aFBB2A7299e968c9f98f8b518bD89e670a420A"},{"permission":"interact","from":"0xA80349b0D79bf3154ae54066410d20eb7B8697Ac","description":"set and change address mappings.","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"interact","from":"0xf565303B5326C8653E78e5f73a2984f6F778C9E8","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"upgrade","from":"0x29E7177837652ca00f05fbD2e8aA867d207B2EF8","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"upgrade","from":"0x2d51D580Cae0a644a5328E665c768C2A4c0E4a03","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"upgrade","from":"0x42AABA8A896ca6C987068Ac9a9112c2e4dcA4c96","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"upgrade","from":"0x9fDEEa19836A413C04e9672d3d09f482278e863c","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"upgrade","from":"0xB5984cCf496a8FC2d921A5a425Bd5F7a740BE89C","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"upgrade","from":"0xb6aFBB2A7299e968c9f98f8b518bD89e670a420A","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]},{"permission":"upgrade","from":"0xf565303B5326C8653E78e5f73a2984f6F778C9E8","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]
    }
```
...
-        {"permission":"upgrade","to":"0x2876c43B17A5750CBea5E2A3C42718374E21D5a2","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]}
      issuedPermissions.1:
-        {"permission":"propose","to":"0x1F7D2BCe97a04D2f935C62b53fE04fed373d2d17","via":[]}
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x29E7177837652ca00f05fbD2e8aA867d207B2EF8"}]
    }
```
...
```diff
    contract undefined (0x52ee324F2bCD0c5363d713eb9f62D1eE47266ac1) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xf565303B5326C8653E78e5f73a2984f6F778C9E8"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0xA80349b0D79bf3154ae54066410d20eb7B8697Ac","description":"set and change address mappings."},{"permission":"upgrade","from":"0x29E7177837652ca00f05fbD2e8aA867d207B2EF8"},{"permission":"upgrade","from":"0x2d51D580Cae0a644a5328E665c768C2A4c0E4a03","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x42AABA8A896ca6C987068Ac9a9112c2e4dcA4c96"},{"permission":"upgrade","from":"0x9fDEEa19836A413C04e9672d3d09f482278e863c"},{"permission":"upgrade","from":"0xB5984cCf496a8FC2d921A5a425Bd5F7a740BE89C"},{"permission":"upgrade","from":"0xb6aFBB2A7299e968c9f98f8b518bD89e670a420A"},{"permission":"upgrade","from":"0xf565303B5326C8653E78e5f73a2984f6F778C9E8"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x29E7177837652ca00f05fbD2e8aA867d207B2EF8"},{"permission":"upgrade","from":"0x2d51D580Cae0a644a5328E665c768C2A4c0E4a03"},{"permission":"upgrade","from":"0x42AABA8A896ca6C987068Ac9a9112c2e4dcA4c96"},{"permission":"upgrade","from":"0x9fDEEa19836A413C04e9672d3d09f482278e863c"},{"permission":"upgrade","from":"0xB5984cCf496a8FC2d921A5a425Bd5F7a740BE89C"},{"permission":"upgrade","from":"0xb6aFBB2A7299e968c9f98f8b518bD89e670a420A"},{"permission":"upgrade","from":"0xf565303B5326C8653E78e5f73a2984f6F778C9E8"}]
    }
```
...
-        {"permission":"upgrade","to":"0x2876c43B17A5750CBea5E2A3C42718374E21D5a2","via":[{"address":"0x566c7DB023111D897F16b602B2B57f0F12f7bF44"}]}
      issuedPermissions.1:
-        {"permission":"sequence","to":"0x52ee324F2bCD0c5363d713eb9f62D1eE47266ac1","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
