Generated with discovered.json: 0x7e671a892da0eadcda8a1b084569dbdcf3befcf9

# Diff at Mon, 17 Mar 2025 16:34:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21429035
...
-        {"permission":"upgrade","to":"0xE559cf25AE191566d4A2E1cd5A533475179672A0","via":[{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"},{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"}]}
      issuedPermissions.2:
-        {"permission":"challenge","to":"0x79DdF0745D14783cDC2a05624c585Ddce07F4A02","via":[]}
      issuedPermissions.1:
...
-        [{"permission":"interact","from":"0x8173904703995c6BbA59a42B8bBf8405F978758a","description":"set and change address mappings."},{"permission":"upgrade","from":"0x012f4baa6e0F5Ac4dFDF47BDdd9CF68a2B17821e"},{"permission":"upgrade","from":"0x1b396e4dC6ECB0be33CF01C5a34E1a3a7D03c378"},{"permission":"upgrade","from":"0x34bb53D7C525114A27F0FE2aF91bdDAd186abb12"},{"permission":"upgrade","from":"0x5ff88fcF8e9947f45F4cAf8FFd5231B5DdF05e0A"},{"permission":"upgrade","from":"0x7aC7e5989EaC278B7BbfeF560871a2026baD472c"},{"permission":"upgrade","from":"0xa641e14B685b5E652865e14A4fBc07e51371D124"},{"permission":"upgrade","from":"0xD1B30378CBF968E5525e8835219A5726A1e71D10","description":"upgrading the bridge implementation can give access to all funds escrowed therein."}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x012f4baa6e0F5Ac4dFDF47BDdd9CF68a2B17821e"},{"permission":"upgrade","from":"0x1b396e4dC6ECB0be33CF01C5a34E1a3a7D03c378"},{"permission":"upgrade","from":"0x34bb53D7C525114A27F0FE2aF91bdDAd186abb12"},{"permission":"upgrade","from":"0x5ff88fcF8e9947f45F4cAf8FFd5231B5DdF05e0A"},{"permission":"upgrade","from":"0x7aC7e5989EaC278B7BbfeF560871a2026baD472c"},{"permission":"upgrade","from":"0xa641e14B685b5E652865e14A4fBc07e51371D124"},{"permission":"upgrade","from":"0xD1B30378CBF968E5525e8835219A5726A1e71D10"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x7aC7e5989EaC278B7BbfeF560871a2026baD472c","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0x8173904703995c6BbA59a42B8bBf8405F978758a","description":"set and change address mappings.","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0x012f4baa6e0F5Ac4dFDF47BDdd9CF68a2B17821e","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0x1b396e4dC6ECB0be33CF01C5a34E1a3a7D03c378","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0x34bb53D7C525114A27F0FE2aF91bdDAd186abb12","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0x5ff88fcF8e9947f45F4cAf8FFd5231B5DdF05e0A","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0x7aC7e5989EaC278B7BbfeF560871a2026baD472c","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0xa641e14B685b5E652865e14A4fBc07e51371D124","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]},{"permission":"upgrade","from":"0xD1B30378CBF968E5525e8835219A5726A1e71D10","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"},{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"}]}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x7aC7e5989EaC278B7BbfeF560871a2026baD472c"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x012f4baa6e0F5Ac4dFDF47BDdd9CF68a2B17821e"}]
    }
```
...
-        {"permission":"upgrade","to":"0x666372fEfB85dA96a1a56667638321605afe95bC","via":[{"address":"0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3"},{"address":"0x38593Cce8FaB9887Ef9760f5F6aB3d6C595143cF"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x666372fEfB85dA96a1a56667638321605afe95bC","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x34bb53D7C525114A27F0FE2aF91bdDAd186abb12"},{"permission":"guard","from":"0x5ff88fcF8e9947f45F4cAf8FFd5231B5DdF05e0A"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x012f4baa6e0F5Ac4dFDF47BDdd9CF68a2B17821e"}]
    }
```
