Generated with discovered.json: 0x8885d7de3cecc4ca868b92d19da10c81277aee1d

# Diff at Wed, 23 Sep 2026 05:50:09 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1734520283
...
discovery. Values are for block 1734520283 (main branch discovery), not current.

```diff
    contract L2OutputOracle (eth:0x012f4baa6e0F5Ac4dFDF47BDdd9CF68a2B17821e) [opstack/L2OutputOracle] {
...
+        "0x6de38b49bc1a04f15ed8bf666e32170c813f9e69b7c213c6e3fdb961091ec37e"
      deployerAddress:
+        "eth:0x25A6E7c6f3d0fE89A656Fcf065614B74E55099fF"
    }
```

```diff
    contract L1ERC721Bridge (eth:0x1b396e4dC6ECB0be33CF01C5a34E1a3a7D03c378) [opstack/L1ERC721Bridge] {
...
```diff
    contract SuperchainConfig (eth:0x34bb53D7C525114A27F0FE2aF91bdDAd186abb12) [opstack/SuperchainConfigFake] {
...
```diff
    contract TBHMultisig (eth:0x48EC051349dDc7E8baBafCBfe27696ECF2A8a8B3) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
```diff
    EOA (eth:0x666372fEfB85dA96a1a56667638321605afe95bC) {
    +++ description: None
...
```diff
    contract L1CrossDomainMessenger (eth:0x807d21e416434ae92c8E5bcA4d506781aFbBa380) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract AddressManager (eth:0x8173904703995c6BbA59a42B8bBf8405F978758a) [opstack/AddressManager] {
...
```diff
    contract OptimismMintableERC20Factory (eth:0xa641e14B685b5E652865e14A4fBc07e51371D124) [opstack/OptimismMintableERC20Factory] {
...
```diff
    contract L1StandardBridge (eth:0xD1B30378CBF968E5525e8835219A5726A1e71D10) [opstack/L1StandardBridge] {
...
```diff
    EOA (eth:0xE559cf25AE191566d4A2E1cd5A533475179672A0) {
    +++ description: None
...
Generated with discovered.json: 0xb698f9cbc0ff617e0019e7033d313db4b90657ec

# Diff at Mon, 21 Sep 2026 11:24:08 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1734520283
- current timestamp: 1734520283
...
Generated with discovered.json: 0x8fd80133530017b992d649f0b8d7e85309cbe2e8

# Diff at Fri, 18 Sep 2026 10:24:58 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1734520283
- current timestamp: 1734520283
...
Generated with discovered.json: 0xa681b8bd34d24e325e74fd6432ccc5bad5e4b799

# Diff at Fri, 12 Jun 2026 10:19:06 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6a183e6009109d4e62087499f44eca4aceea9086 block: 1734520283
- current timestamp: 1734520283
...
Generated with discovered.json: 0x48c0c762b9ddfd3e78ab91a9f008196a43c50778

# Diff at Tue, 09 Jun 2026 12:43:40 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1734520283
- current timestamp: 1734520283
...
```diff
    EOA  (eth:0x68d5BBf3a01ECbB47CE38Cf64a7d6C0eA618040f) {
    +++ description: None
...
```diff
    EOA  (eth:0xe615dC682b340e00c2d80472a281CbD5A2b68ae7) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x82cbf31e51cb4bef88de04123b0239769a8087a0

# Diff at Tue, 04 Nov 2025 11:34:44 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1734520283
- current timestamp: 1734520283
...
```diff
    contract SystemConfig (eth:0x7aC7e5989EaC278B7BbfeF560871a2026baD472c) {
    +++ description: Contains configuration parameters such as the Sequencer address, gas limit on this chain and the unsafe block signer address.
      sourceHashes.1:
...
Generated with discovered.json: 0x6d48b194ceeeb2a43c8a3e91021f2dfcacd33b0c
