Generated with discovered.json: 0xf7368af6b27f347b3619c92763e1aae65dd9ec20

# Diff at Mon, 17 Mar 2025 16:30:49 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21981354
...
-        {"permission":"upgrade","to":"0xc49Ec6Bb817E17a9Ca5B738ca330db403cc74245","delay":1209600,"via":[]}
      issuedPermissions.3:
-        {"permission":"operateStarkEx","to":"0xe997ece81cb8A686206ea6042886B594Ecf6DdED","via":[]}
      issuedPermissions.2:
-        {"permission":"interact","to":"0x86ED881374a81efcc1Aa9f82cA9740B40F0FCbfe","description":"Can regsiter new tokens for deposits and withdrawals.","via":[]}
      issuedPermissions.1:
-        {"permission":"governStarknet","to":"0xc49Ec6Bb817E17a9Ca5B738ca330db403cc74245","via":[]}
...
```diff
    contract undefined (0x86ED881374a81efcc1Aa9f82cA9740B40F0FCbfe) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x3071BE11F9e92A9eb28F305e1Fa033cD102714e7","description":"Can regsiter new tokens for deposits and withdrawals."}]
    }
```
...
-        {"permission":"upgrade","from":"0x3071BE11F9e92A9eb28F305e1Fa033cD102714e7","delay":1209600}
      receivedPermissions.1:
-        {"permission":"governStarknet","from":"0x3071BE11F9e92A9eb28F305e1Fa033cD102714e7"}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"operateStarkEx","from":"0x3071BE11F9e92A9eb28F305e1Fa033cD102714e7"}]
    }
```
