Generated with discovered.json: 0x43e79b7bc089f756dee22716dbed9b999873e379

# Diff at Wed, 23 Sep 2026 05:49:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1754054742
...
Generated with discovered.json: 0xcb0ce9b0a774d0930d476a4f02dde23b9df0e0ac

# Diff at Mon, 21 Sep 2026 11:24:05 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1754054742
- current timestamp: 1754054742
...
```diff
    contract OneStepProverHostIo (eth:0x0003A96B27ce73505b43ea1b71a5aB06bec568C4) [orbitstack/OneStepProverHostIo] {
...
```diff
    contract RealFastConfirmerMultisig (eth:0x118Ab5501564F1Cfa755d0b3070874a26c1C3A50) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
```diff
    contract OneStepProverMemory (eth:0x1cD76B9C33b2e3b04D7B181399d492B3e49AD7fB) [orbitstack/OneStepProverMemory] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract OneStepProver0 (eth:0x2dCCAbE89cF76132619a9B18e9F9e48E837222b5) [orbitstack/OneStepProver0] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract ChallengeManager (eth:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d) [orbitstack/ChallengeManager] {
    +++ description: Contract that allows challenging state roots. Can be called through the RollupProxy by Validators or the UpgradeExecutor.
      sourceHashes.1:
-        "0x1a095768302d7d1c3d02375eaa3341833b4f1aaac707e1c608bce478c87cbf27"
+        "0x1eba00857f5477dbcd075b48ce8af9c74d5cb4f93a5e714dd27b3df498737e54"
      deployerAddress:
+        "eth:0xbB0385FebfD25E01527617938129A34bD497331e"
    }
```

```diff
    contract Bridge (eth:0x39D2EEcC8B55f46aE64789E2494dE777cDDeED03) [orbitstack/Bridge] {
...
```diff
    contract GatewayRouter (eth:0x490f337Ac108b2a555183f5b5fd2ee84a7F45a18) [orbitstack/GatewayRouter] {
...
```diff
    contract SwapManager (eth:0x4AC36E1Fa7daBeFEc885f30B163c571080b2c335) [N/A] {
...
+        "0xdb0553da5b3bff42fbf46949593391f6f76137766d39fab90133d9a4e42f74c6"
      deployerAddress:
...
```diff
    contract RollupEventInbox (eth:0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C) [orbitstack/RollupEventInbox] {
...
```diff
    contract StrategyManager (eth:0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8) [N/A] {
...
+        "0x0e60284eb241a2d607ed071b88433d3b04db6b0b8690c2d533d9317a2dcf8cfd"
      deployerAddress:
+        "eth:0xeB658c4Ea908aC4dAF9c309D8f883d6aD758b3A3"
    }
```
...
```diff
    contract LidoStEthStrategy (eth:0x679D4C1cC6855C57726BEA1784F578315d6431f6) [N/A] {
    +++ description: None
      sourceHashes.0:
-        "0xc18d8670e65f3ea1dc2fe9ee3114bfad504f6ee8998a9f9d6f79cc971a03814a"
+        "0x1ec8e83ed3aec7907ed3b67a2ca8d7a5ef9acd254f4cf4902566b5a9a3c5629f"
      deployerAddress:
+        "eth:0xeB658c4Ea908aC4dAF9c309D8f883d6aD758b3A3"
    }
```
...
```diff
    contract Outbox (eth:0x8592Ca44dE1D354A20F75160F5602E5933D33761) [orbitstack/Outbox] {
...
```diff
    contract UnknownVault (eth:0xB24D28B8FC6881dC3d4c088eff8c88EeC65C3164) [N/A] {
    +++ description: None
      deployerAddress:
+        "eth:0xa1bEA57d625987430Dd0DbC8A76bB1257fdd7788"
    }
```
...
```diff
    contract Bridger (eth:0xbf2F26cadbC10C4d61ac7e424D514d79a12126f8) [N/A] {
    +++ description: A Routing contract to the standard orbit stack bridge of the L2.
      sourceHashes.1:
-        "0xaeb5734c5862ad1b95a66ae767bb08920938ed5de5fd7455221098e0d37c44dd"
+        "0x8448da015a311dcc14f227a7c5b6774abda7a441a232c6d8e8e92c82e528cdc7"
      deployerAddress:
+        "eth:0xeB658c4Ea908aC4dAF9c309D8f883d6aD758b3A3"
    }
```
...
```diff
    contract OneStepProverMath (eth:0xCf4b98cFF2976E4eb579B9498f398b5bd279A6eD) [orbitstack/OneStepProverMath] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract RealStrategiesMultisig (eth:0xD47E2043C1eCbeF215D89EE667D09A7aA56823d4) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
-        "0xd42bbf9f7dcd3720a7fc6bdc6edfdfae8800a37d6dd4decfa0ef6ca4a2e88940"
+        "0x22c7fb8365a538c05d34b77dd9c1967d1ddb7427eda69f84989d4c56603312b7"
      deployerAddress:
+        "eth:0x240B5E0746eda8cBc137Fc67210532a1D2B5b82A"
    }
```

```diff
    contract UpgradeExecutor (eth:0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a) [orbitstack/UpgradeExecutor] {
...
```diff
    contract Inbox (eth:0xf538671ddd60eE54BdD6FBb0E309c491A7A2df11) [orbitstack/Inbox] {
...
```diff
    contract AssetsVault (eth:0xf985E2c73d74BefF3C8c16EFC4fa5ab4cfb62294) [N/A] {
...
```diff
    contract ERC20Gateway (eth:0xfC89B875970122E24C6C5ADd4Dea139443943ea7) [orbitstack/ERC20Gateway] {
...
Generated with discovered.json: 0x1d3d1fb3be8dfec1b3491d8b898976f52a1cfad0

# Diff at Fri, 18 Sep 2026 10:24:54 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1754054742
- current timestamp: 1754054742
...
Generated with discovered.json: 0xa9b03b3ad04b21cdcdcee407b941cb72b824bbee

# Diff at Fri, 12 Jun 2026 10:19:00 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6a183e6009109d4e62087499f44eca4aceea9086 block: 1754054742
- current timestamp: 1754054742
...
Generated with discovered.json: 0x4fa0216d5ef8ff8348a795f8d48e9c80ff580bb3

# Diff at Tue, 09 Jun 2026 12:43:38 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1754054742
- current timestamp: 1754054742
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ec4b16fd723bf2a8625a616c4b3a1119ce79fb29 block: 1754054742
- current timestamp: 1754054742
...
Generated with discovered.json: 0xaf031cdbcb7df0d04747067ac8701649937ca038

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0xfff236d42f301f30e145b5591345a719256a86a0
...
- chain: ethereum
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@fe7c3b2343ca7836e6a947e456ab91a6f0f6f592 block: 22122783
- current block number: 22923592
...
Generated with discovered.json: 0x7062abbc72acd1a1552deff6273690dd62c1fcc1

# Diff at Mon, 14 Jul 2025 12:46:00 GMT:

- chain: ethereum
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9f4300dad2f3d080cd56fa311d4a848556c74e72 block: 22122783
...
+        "eth:0x118Ab5501564F1Cfa755d0b3070874a26c1C3A50"
...
+        "eth:0x3648e2c562F00DeEA11B0b335Cf55C5EB2Df3A5F"
      implementationNames.0x118Ab5501564F1Cfa755d0b3070874a26c1C3A50:
-        "GnosisSafeProxy"
      implementationNames.0xfb1bffC9d739B8D520DaF37dF666da4C687191EA:
-        "GnosisSafeL2"
      implementationNames.eth:0x118Ab5501564F1Cfa755d0b3070874a26c1C3A50:
+        "GnosisSafeProxy"
...
```diff
    EOA  (0x240B5E0746eda8cBc137Fc67210532a1D2B5b82A) {
    +++ description: None
      address:
-        "0x240B5E0746eda8cBc137Fc67210532a1D2B5b82A"
+        "eth:0x240B5E0746eda8cBc137Fc67210532a1D2B5b82A"
    }
```
...
```diff
    EOA  (0x326FFa9E3836577C6C46b0aA5A5b223FB4a4067c) {
    +++ description: None
      address:
-        "0x326FFa9E3836577C6C46b0aA5A5b223FB4a4067c"
+        "eth:0x326FFa9E3836577C6C46b0aA5A5b223FB4a4067c"
    }
```
...
+        "eth:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d"
      values.$admin:
...
+        "eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
      values.sequencerInbox:
-        "0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
+        "eth:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
      implementationNames.0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d:
-        "TransparentUpgradeableProxy"
      implementationNames.0x02E05A9245C5853f895daDcc3A8216C953C8736B:
-        "ChallengeManager"
      implementationNames.eth:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d:
+        "TransparentUpgradeableProxy"
...
+        "eth:0xf538671ddd60eE54BdD6FBb0E309c491A7A2df11"
+++ description: Allowed to mint the gastoken on L2 and call `enqueueDelayedMessage()` on the bridge.
+++ severity: HIGH
      values.allowedDelayedInboxList.1:
-        "0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C"
+        "eth:0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C"
+++ description: Can make calls as the bridge, steal all funds.
+++ severity: HIGH
      values.allowedOutboxList.0:
-        "0x8592Ca44dE1D354A20F75160F5602E5933D33761"
+        "eth:0x8592Ca44dE1D354A20F75160F5602E5933D33761"
...
-        "0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
+        "eth:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
      implementationNames.0x39D2EEcC8B55f46aE64789E2494dE777cDDeED03:
-        "TransparentUpgradeableProxy"
      implementationNames.0xEfA1De858293593732a09c9dAA238BEC49595751:
-        "ERC20Bridge"
      implementationNames.eth:0x39D2EEcC8B55f46aE64789E2494dE777cDDeED03:
+        "TransparentUpgradeableProxy"
...
+        "eth:0x490f337Ac108b2a555183f5b5fd2ee84a7F45a18"
      values.$admin:
-        "0xB032ff02cd6425e4b816137207AA8560932180f1"
+        "eth:0xB032ff02cd6425e4b816137207AA8560932180f1"
      values.$implementation:
...
-        "0xF0b66c2d7Abb3CbbD26463a971BF62d6c4eaDE34"
+        "eth:0xF0b66c2d7Abb3CbbD26463a971BF62d6c4eaDE34"
...
-        "0x0000000000000000000000000000000000000000"
+        "eth:0x0000000000000000000000000000000000000000"
      implementationNames.0x490f337Ac108b2a555183f5b5fd2ee84a7F45a18:
-        "TransparentUpgradeableProxy"
      implementationNames.0x5Ff3feD7aad041ACe66E4ecDd7AfbCC43b6446b0:
-        "L1OrbitGatewayRouter"
      implementationNames.eth:0x490f337Ac108b2a555183f5b5fd2ee84a7F45a18:
+        "TransparentUpgradeableProxy"
...
+        "eth:0xD47E2043C1eCbeF215D89EE667D09A7aA56823d4"
      values.pendingOwner:
-        "0x0000000000000000000000000000000000000000"
+        "eth:0x0000000000000000000000000000000000000000"
      values.v3SwapRouter:
...
+        "eth:0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"
      implementationNames.0x4AC36E1Fa7daBeFEc885f30B163c571080b2c335:
-        "SwapManager"
      implementationNames.eth:0x4AC36E1Fa7daBeFEc885f30B163c571080b2c335:
+        "SwapManager"
    }
```
...
-        "0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
+        "eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
      implementationNames.0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C:
-        "TransparentUpgradeableProxy"
      implementationNames.0x302275067251F5FcdB9359Bda735fD8f7A4A54c0:
-        "ERC20RollupEventInbox"
      implementationNames.eth:0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C:
+        "TransparentUpgradeableProxy"
...
-        "0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
+        "eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
      implementationNames.0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0:
-        "TransparentUpgradeableProxy"
      implementationNames.0xaEd84B70Be8117112a5aa0d93a7fBff463A03b18:
-        "SequencerInbox"
      implementationNames.eth:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0:
+        "TransparentUpgradeableProxy"
...
+        "eth:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
      implementationNames.0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8:
-        "StrategyManager"
      implementationNames.eth:0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8:
+        "StrategyManager"
    }
```
...
-        "0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
+        "eth:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
      implementationNames.0x655756824385F8903AC8cFDa17B656cc26f7C7da:
-        "Minter"
      implementationNames.eth:0x655756824385F8903AC8cFDa17B656cc26f7C7da:
+        "Minter"
    }
```
...
+        "eth:0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0"
      implementationNames.0x679D4C1cC6855C57726BEA1784F578315d6431f6:
-        "LidoStEthStrategy"
      implementationNames.eth:0x679D4C1cC6855C57726BEA1784F578315d6431f6:
+        "LidoStEthStrategy"
    }
```
...
```diff
    EOA  (0x6bD40C6f7849160FE217D07a73E15f4ef8222283) {
    +++ description: None
      address:
-        "0x6bD40C6f7849160FE217D07a73E15f4ef8222283"
+        "eth:0x6bD40C6f7849160FE217D07a73E15f4ef8222283"
    }
```
...
```diff
    EOA  (0x7cFaD85633CD000c83Fcf99a678044dDC14125bD) {
    +++ description: None
      address:
-        "0x7cFaD85633CD000c83Fcf99a678044dDC14125bD"
+        "eth:0x7cFaD85633CD000c83Fcf99a678044dDC14125bD"
    }
```
...
-        "0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
+        "eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
      implementationNames.0x8592Ca44dE1D354A20F75160F5602E5933D33761:
-        "TransparentUpgradeableProxy"
      implementationNames.0x19431dc37098877486532250FB3158140717C00C:
-        "ERC20Outbox"
      implementationNames.eth:0x8592Ca44dE1D354A20F75160F5602E5933D33761:
+        "TransparentUpgradeableProxy"
...
-        "0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a"
+        "eth:0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a"
      implementationNames.0xB032ff02cd6425e4b816137207AA8560932180f1:
-        "ProxyAdmin"
      implementationNames.eth:0xB032ff02cd6425e4b816137207AA8560932180f1:
+        "ProxyAdmin"
    }
```
...
-        "0x0000000000000000000000000000000000000000"
+        "eth:0x0000000000000000000000000000000000000000"
      implementationNames.0xbf2F26cadbC10C4d61ac7e424D514d79a12126f8:
-        "UUPSProxy"
      implementationNames.0x977cA9732E618D32552BA16a52f258cEFadf970a:
-        "Bridger"
      implementationNames.eth:0xbf2F26cadbC10C4d61ac7e424D514d79a12126f8:
+        "UUPSProxy"
      implementationNames.eth:0x977cA9732E618D32552BA16a52f258cEFadf970a:
+        "Bridger"
    }
```
...
-        "0x655756824385F8903AC8cFDa17B656cc26f7C7da"
+        "eth:0x655756824385F8903AC8cFDa17B656cc26f7C7da"
      implementationNames.0xC0Cc5eA00cAe0894B441E3B5a3Bb57aa92F15421:
-        "Real"
      implementationNames.eth:0xC0Cc5eA00cAe0894B441E3B5a3Bb57aa92F15421:
+        "Real"
    }
```
...
+        "eth:0x9CAd81628aB7D8e239F1A5B497313341578c5F71"
      implementationNames.0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a:
-        "RollupProxy"
...
-        "RollupUserLogic"
      implementationNames.eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a:
+        "RollupProxy"
...
+        "eth:0x240B5E0746eda8cBc137Fc67210532a1D2B5b82A"
      values.$members.1:
-        "0xf16Df80dBA33bB54018F99A3679801Bc9cA14Fe0"
+        "eth:0xf16Df80dBA33bB54018F99A3679801Bc9cA14Fe0"
      values.$members.2:
-        "0x6bD40C6f7849160FE217D07a73E15f4ef8222283"
+        "eth:0x6bD40C6f7849160FE217D07a73E15f4ef8222283"
      values.$members.3:
-        "0xFbce8758DBF56d574A80fa3A6AB27275a8F1EF6A"
+        "eth:0xFbce8758DBF56d574A80fa3A6AB27275a8F1EF6A"
      values.$members.4:
-        "0x7cFaD85633CD000c83Fcf99a678044dDC14125bD"
+        "eth:0x7cFaD85633CD000c83Fcf99a678044dDC14125bD"
      implementationNames.0xD47E2043C1eCbeF215D89EE667D09A7aA56823d4:
-        "GnosisSafeProxy"
      implementationNames.0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552:
-        "GnosisSafe"
      implementationNames.eth:0xD47E2043C1eCbeF215D89EE667D09A7aA56823d4:
+        "GnosisSafeProxy"
      implementationNames.eth:0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552:
+        "GnosisSafe"
    }
...
-        "0xBeA2Bc852a160B8547273660E22F4F08C2fa9Bbb"
+        "eth:0xBeA2Bc852a160B8547273660E22F4F08C2fa9Bbb"
      implementationNames.0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a:
-        "TransparentUpgradeableProxy"
      implementationNames.0x6c21303F5986180B1394d2C89f3e883890E2867b:
-        "UpgradeExecutor"
      implementationNames.eth:0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a:
+        "TransparentUpgradeableProxy"
...
```diff
    EOA  (0xF0b66c2d7Abb3CbbD26463a971BF62d6c4eaDE34) {
    +++ description: None
      address:
-        "0xF0b66c2d7Abb3CbbD26463a971BF62d6c4eaDE34"
+        "eth:0xF0b66c2d7Abb3CbbD26463a971BF62d6c4eaDE34"
...
```diff
    EOA  (0xf16Df80dBA33bB54018F99A3679801Bc9cA14Fe0) {
    +++ description: None
      address:
-        "0xf16Df80dBA33bB54018F99A3679801Bc9cA14Fe0"
+        "eth:0xf16Df80dBA33bB54018F99A3679801Bc9cA14Fe0"
...
-        "0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
+        "eth:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
      implementationNames.0xf538671ddd60eE54BdD6FBb0E309c491A7A2df11:
-        "TransparentUpgradeableProxy"
      implementationNames.0x6C051397fee2d79ccf92d1f3c5c6547fEBD838F4:
-        "ERC20Inbox"
      implementationNames.eth:0xf538671ddd60eE54BdD6FBb0E309c491A7A2df11:
+        "TransparentUpgradeableProxy"
...
-        "0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8"
+        "eth:0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8"
      implementationNames.0xf985E2c73d74BefF3C8c16EFC4fa5ab4cfb62294:
-        "AssetsVault"
      implementationNames.eth:0xf985E2c73d74BefF3C8c16EFC4fa5ab4cfb62294:
+        "AssetsVault"
    }
```

```diff
    EOA  (0xFbce8758DBF56d574A80fa3A6AB27275a8F1EF6A) {
    +++ description: None
      address:
-        "0xFbce8758DBF56d574A80fa3A6AB27275a8F1EF6A"
+        "eth:0xFbce8758DBF56d574A80fa3A6AB27275a8F1EF6A"
...
```diff
    EOA  (0xFc1A48d5875Adc0E5f9e2805083C9c5300704BD7) {
    +++ description: None
      address:
-        "0xFc1A48d5875Adc0E5f9e2805083C9c5300704BD7"
+        "eth:0xFc1A48d5875Adc0E5f9e2805083C9c5300704BD7"
    }
```
...
-        "0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8"
+        "eth:0x5Cba18d504D4158dC1A18C5Dc6BB2a30B230DdD8"
      implementationNames.0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1:
-        "RealVault"
      implementationNames.eth:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1:
+        "RealVault"
    }
```
...
-        "0x0000000000000000000000000000000000000000"
+        "eth:0x0000000000000000000000000000000000000000"
      implementationNames.0xfC89B875970122E24C6C5ADd4Dea139443943ea7:
-        "TransparentUpgradeableProxy"
      implementationNames.0xe80b4E0ed5e92d865F4708eeE0E1564287a7D848:
-        "L1OrbitERC20Gateway"
      implementationNames.eth:0xfC89B875970122E24C6C5ADd4Dea139443943ea7:
+        "TransparentUpgradeableProxy"
...
Generated with discovered.json: 0x4796d24daa97f0bf9fdf178d66cbd65966b50796

# Diff at Fri, 04 Jul 2025 12:19:17 GMT:

- chain: ethereum
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@1f56dc47fe915564d4555300304da4d3bcbc087f block: 22122783
- current block number: 22122783
...
-        "ethereum:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
+        "eth:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
    }
```
...
-        "ethereum:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
+        "eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
...
-        "ethereum:0x118Ab5501564F1Cfa755d0b3070874a26c1C3A50"
+        "eth:0x118Ab5501564F1Cfa755d0b3070874a26c1C3A50"
      receivedPermissions.0.from:
-        "ethereum:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
+        "eth:0xc4F7B37bE2bBbcF07373F28c61b1A259dfe49d2a"
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions.0.from:
-        "ethereum:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d"
+        "eth:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d"
      directlyReceivedPermissions.1.from:
-        "ethereum:0x39D2EEcC8B55f46aE64789E2494dE777cDDeED03"
+        "eth:0x39D2EEcC8B55f46aE64789E2494dE777cDDeED03"
      directlyReceivedPermissions.2.from:
-        "ethereum:0x490f337Ac108b2a555183f5b5fd2ee84a7F45a18"
+        "eth:0x490f337Ac108b2a555183f5b5fd2ee84a7F45a18"
      directlyReceivedPermissions.3.from:
-        "ethereum:0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C"
+        "eth:0x503C5a576E2F72Ca9aD213D64bc775cbD81E0F2C"
      directlyReceivedPermissions.4.from:
-        "ethereum:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
+        "eth:0x51C4a227D59E49E26Ea07D8e4E9Af163da4c87A0"
      directlyReceivedPermissions.5.from:
-        "ethereum:0x8592Ca44dE1D354A20F75160F5602E5933D33761"
+        "eth:0x8592Ca44dE1D354A20F75160F5602E5933D33761"
      directlyReceivedPermissions.6.from:
-        "ethereum:0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a"
+        "eth:0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a"
      directlyReceivedPermissions.7.from:
-        "ethereum:0xf538671ddd60eE54BdD6FBb0E309c491A7A2df11"
+        "eth:0xf538671ddd60eE54BdD6FBb0E309c491A7A2df11"
      directlyReceivedPermissions.8.from:
-        "ethereum:0xfC89B875970122E24C6C5ADd4Dea139443943ea7"
+        "eth:0xfC89B875970122E24C6C5ADd4Dea139443943ea7"
    }
```
...
+        "eth:0xD6A4868a15d98b0BF4E9063BE707B4b89D067C3a"
      receivedPermissions.1.via.0.address:
-        "ethereum:0xB032ff02cd6425e4b816137207AA8560932180f1"
+        "eth:0xB032ff02cd6425e4b816137207AA8560932180f1"
      receivedPermissions.1.from:
-        "ethereum:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d"
+        "eth:0x369001149fe80892665a7b0c17fe8Db6BeFC7F5d"
...
```diff
    ...
    +++ description: None
      receivedPermissions.0.from:
-        "ethereum:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
+        "eth:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
      receivedPermissions.1.from:
-        "ethereum:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
+        "eth:0xFC1db08622e81b2AFd643318f6B8B79E9980A5e1"
...
```diff
    ...
    +++ description: None
      receivedPermissions.0.from:
-        "ethereum:0xbf2F26cadbC10C4d61ac7e424D514d79a12126f8"
+        "eth:0xbf2F26cadbC10C4d61ac7e424D514d79a12126f8"
    }
```
...
Generated with discovered.json: 0xa7fee26608845afc42e0b1ed043a8bb0725ee28d

# Diff at Wed, 18 Jun 2025 12:23:46 GMT:

- chain: ethereum
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a8e4f22a1441bd5040898cc3d3d62b3582942b65 block: 22122783
- current block number: 22122783
...
Generated with discovered.json: 0x4d048e40f02fa0e705751e3846f7a659133ea42b
