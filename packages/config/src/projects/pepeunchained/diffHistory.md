Generated with discovered.json: 0x2a146bffe6e3e29fd12ca6871bb4eff464883908

# Diff at Wed, 23 Sep 2026 05:48:19 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1768984444
...
discovery. Values are for block 1768984444 (main branch discovery), not current.

```diff
    contract SuperchainConfig (eth:0x11654D67e0360A82e5Badd272Ced336B80972135) [opstack/SuperchainConfigFake] {
...
+        "0x834fe6e18d4d5cf60a1c6924a1d6a88208e8381fe449791d043bd5911e404b5b"
      deployerAddress:
+        "eth:0x67BD7cb512250fA82fd9191728B5c3C6c49AD77e"
    }
```

```diff
    contract ProxyAdmin (eth:0x320E53df19662A58fF4953d62B229E9BCAAC0b49) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
```diff
    contract L1StandardBridge (eth:0x34Ef4B527DB3F4AcfAE7Fdc7Db0f9981F48Cd23F) [opstack/L1StandardBridge] {
...
```diff
    contract OptimismPortal (eth:0x384e3AE4D5efC9471201039b555EAe496b2A7240) [opstack/OptimismPortal] {
...
```diff
    contract OptimismMintableERC20Factory (eth:0x3D831FD51f80398488a2452b9Ba44eDe104e8789) [opstack/OptimismMintableERC20Factory] {
...
```diff
    contract GnosisSafe (eth:0x42d27eEA1AD6e22Af6284F609847CB3Cd56B9c64) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
```diff
    contract L1CrossDomainMessenger (eth:0x6007758DBd8c9e83e24761D248e51850Ff2612CC) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract L1ERC721Bridge (eth:0x9dd8e00Ff731FBf3dd3559578BeB518a41b16Cfe) [opstack/L1ERC721Bridge] {
...
```diff
    contract L2OutputOracle (eth:0xb9c4EA7171b588e8D4c3F63e955Cd61e5172bb92) [opstack/L2OutputOracle] {
...
```diff
    contract AddressManager (eth:0xC3BcdF5cb9AEA2cc4938C9D1AA866CF0BA6B19b5) [opstack/AddressManager] {
...
```diff
    contract SystemConfig (eth:0xF41E72f55d9bE849ecCe3b7AEe2A07Ccdadb655d) [opstack/SystemConfig] {
...
Generated with discovered.json: 0xcf4d72a068aaf8544202893a6858c74eea1725b6

# Diff at Mon, 21 Sep 2026 11:24:04 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1768984444
- current timestamp: 1768984444
...
Generated with discovered.json: 0xc5b55d20c4dd07ab8a0c18fcefe099b1ff1cef56

# Diff at Fri, 18 Sep 2026 10:24:51 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1768984444
- current timestamp: 1768984444
...
Generated with discovered.json: 0xa09f3fd0ac75289805dc55963fe1ecfece257424

# Diff at Tue, 09 Jun 2026 12:43:37 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1768984444
- current timestamp: 1768984444
...
```diff
    EOA  (eth:0x5c89b56bead2f99d41721f1D15442Fe813879587) {
    +++ description: None
      receivedPermissions.0.description:
...
```diff
    EOA  (eth:0x919B2511b2DB24Cc0C0EebE28b62a4E591579C1B) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x5f0a95cbded1c046adf56c6cbc860924386c4dc4

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0x522f4d5e1c2c1484564e5bcc9c82b4e651cd2671

# Diff at Tue, 26 Aug 2025 13:31:06 GMT:
...
Generated with discovered.json: 0x055b5d2ed5c529b6dc50f2e5f2ec0dd6127dee9c

# Diff at Tue, 12 Aug 2025 14:41:47 GMT:

- chain: ethereum
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e94498235c6c8b45d3e4bfb77316081ba540850a block: 1753682039
