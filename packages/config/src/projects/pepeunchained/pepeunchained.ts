...
export const pepeunchained: ScalingProject = opStackL2({
  ...
  display: {
    ...
    slug: 'pepeunchained',
    headerWarning:
      'The project migrated from an OP Stack to an [Arbitrum Stack chain](https://l2beat.com/scaling/projects/pepe-unchained). See [announcement](https://mirror.xyz/0x5d229f641ccA8c85F356a29A2b5D12587a216Fd2/CJvQFPuEG1eUZ8rhZLnAd2d1i5wdxuxnE0mLRxeEBhs) for details.',
    description:
