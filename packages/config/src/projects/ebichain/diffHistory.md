Generated with discovered.json: 0x76f9c0e1738e399a4d31adb0c901309363bbab3b

# Diff at Wed, 23 Sep 2026 05:46:10 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1768984373
...
discovery. Values are for block 1768984373 (main branch discovery), not current.
...
Generated with discovered.json: 0xbda23cae669a5ed42072642951a94a3b0984f8cc

# Diff at Mon, 21 Sep 2026 11:23:59 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1768984373
- current timestamp: 1768984373
...
+        {"severity":"HIGH"}
      deployerAddress:
+        "eth:0x8c41c374bE2C7A2fE9Bc0bA47894f5F17c6d1FCC"
    }
```

```diff
    contract OneStepProverHostIo (eth:0x17e7F68ce50A77e55C7834ddF31AEf86403B8010) [orbitstack/OneStepProverHostIo] {
...
```diff
    contract RollupEventInbox (eth:0x191738BDecD7f73a79F64D689cf91ef873fb4172) [orbitstack/RollupEventInbox] {
...
```diff
    contract OneStepProofEntry (eth:0x57EA090Ac0554d174AE0e2855B460e84A1A7C221) [orbitstack/OneStepProofEntry] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract OneStepProver0 (eth:0x72B166070781a552D7b95a907eF59ca05d3D5a62) [orbitstack/OneStepProver0] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract Bridge (eth:0x73CF739b0233027cd516998e177d473D0a45E037) [orbitstack/Bridge] {
...
```diff
    contract OneStepProverMemory (eth:0x8b73Ef238ADaB31EBC7c05423d243c345241a22f) [orbitstack/OneStepProverMemory] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract OneStepProverMath (eth:0x90eC62De2EB7C7512a22bD2D55926AD6bA609F38) [orbitstack/OneStepProverMath] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract RollupProxy (eth:0xaA9904D4d4261dc0f927306f3f5c74439eBa0b90) [orbitstack/RollupProxy] {
...
```diff
    contract UpgradeExecutor (eth:0xe3826907ed4f0A4F3D05d6CF5B0B8dCde91d6e0C) [orbitstack/UpgradeExecutor] {
...
```diff
    contract Inbox (eth:0xeb8307Fc8c1bEe7DfDCedf7e8c85778a81CB150f) [orbitstack/Inbox] {
...
```diff
    contract Outbox (eth:0xf2dC65BdDb21c5DCC070067434D34a342907b5aE) [orbitstack/Outbox] {
...
```diff
    contract ChallengeManager (eth:0xf39A1d1Bf489bA959ca6A0e6Fa4A1887Fe526c81) [orbitstack/ChallengeManager] {
...
Generated with discovered.json: 0x826e6c4edf0d1e66dac10bd52970556de015e04c

# Diff at Fri, 18 Sep 2026 10:24:49 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1768984373
- current timestamp: 1768984373
...
Generated with discovered.json: 0xb787167eabfb753ef0b00b29859de5623dea2320

# Diff at Tue, 09 Jun 2026 12:43:33 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1768984373
- current timestamp: 1768984373
...
```diff
    EOA  (eth:0x101d02006885979D2F32284c5847dF8616C24436) {
    +++ description: None
...
```diff
    EOA  (eth:0x11AaeeDd19D4daf99925231b982CA0A35F77d812) {
    +++ description: None
      receivedPermissions.0.permission:
-        "sequence"
+        "interact"
...
Generated with discovered.json: 0xd0088bbe3ec79a37240fd6801343945bc634235a

# Diff at Wed, 21 Jan 2026 08:34:20 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@a72aa7d50f1dddc0c7a6eae7f60679fc94e4eabf block: 1764933559
- current timestamp: 1768984373
...
Generated with discovered.json: 0x17a53d1df83357ef0f588a5b19c85cc04c4fd4a3

# Diff at Mon, 05 Jan 2026 17:44:13 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1764933559
- current timestamp: 1764933559
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764933559 (main branch discovery), not current.
...
Generated with discovered.json: 0x7558fbb9c8847af178a495b565b7ef69ecbf3a0b

# Diff at Fri, 05 Dec 2025 11:21:37 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1edf3e71cea32596658a3ea017cea9df6408b77c block: 1759480805
- current timestamp: 1764933559
