Generated with discovered.json: 0x69c1a1f285b3c42aa8e1ca9e62bb17ba893edeaa

# Diff at Wed, 23 Sep 2026 05:45:17 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1787668931
- current timestamp: 1787668931
...
discovery. Values are for block 1787668931 (main branch discovery), not current.
...
```diff
    contract ProxyAdmin (eth:0xF025D25aE360D0D33a275dF74863CCc6600E6f8E) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
-        {"addressManager":{"severity":"HIGH"},"owner":{"severity":"HIGH"}}
    }
...
Generated with discovered.json: 0xf8bdc9ba049bc8274ccd1a910dee90dd732fac87

# Diff at Mon, 21 Sep 2026 11:23:57 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1787668931
- current timestamp: 1787668931
...
```diff
    contract Outbox (eth:0x190C720892d0786BF75B77B4acD21c726ea8FDEd) [orbitstack/Outbox] {
...
Generated with discovered.json: 0x7232fed02dc0ff4287daa511ce9c78d3e3c5792c

# Diff at Fri, 18 Sep 2026 10:24:47 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1787668931
- current timestamp: 1787668931
...
Generated with discovered.json: 0x20faf4a18165fed87bb2a714a9ec70e508ae98a0

# Diff at Tue, 25 Aug 2026 14:43:16 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@bba6c9e66ca2dd99590b6f233fe8f6509dc767a0 block: 1782746581
- current timestamp: 1787668931
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1782746581 (main branch discovery), not current.
...
Generated with discovered.json: 0x1c03f0bf8229ab11080a5aa6372b81b40f570b4e
...
- comparing to: main@6a183e6009109d4e62087499f44eca4aceea9086 block: 1780654139
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1780654139 (main branch discovery), not current.
...
Generated with discovered.json: 0xc1f28bb545e9326e60e3103d76cbb7eb263fc8d6

# Diff at Tue, 09 Jun 2026 12:43:31 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1780654139
- current timestamp: 1780654139
...
```diff
    EOA  (eth:0xC5dD640885cE582464e2fCa7b169581417822e6C) {
    +++ description: None
...
```diff
    EOA  (eth:0xef6Ef32bcC96B9D94f50A51A42dB4825D6337780) {
    +++ description: None
...
Generated with discovered.json: 0xadb6c8a1061da2462a868d5816e4568c6eca51d7

# Diff at Fri, 15 May 2026 12:35:39 GMT:
