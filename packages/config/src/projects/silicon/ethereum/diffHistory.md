Generated with discovered.json: 0x55883023ca00baa38b6d0d176ac20e893ed4a732

# Diff at Mon, 17 Mar 2025 16:31:25 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21766766
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"interact","from":"0x419dcD0f72ebAFd3524b65a97ac96699C7fBebdB","description":"sole address that can force batches."}]
    }
```
...
-        [{"permission":"upgrade","from":"0x24e09Ef4F69B6058E047EE5E709B345F3cA47F3A"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x24e09Ef4F69B6058E047EE5E709B345F3cA47F3A"}]
    }
```
...
```diff
    contract undefined (0x47ed9538faA1522be7abD8a8BCAEc8d9C04Ed60D) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x419dcD0f72ebAFd3524b65a97ac96699C7fBebdB"}]
    }
```

```diff
    contract undefined (0xef5D7af5dbBeE845860E75cE8f8e8fE7F6e8dBF7) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x24e09Ef4F69B6058E047EE5E709B345F3cA47F3A","description":"manage the members of the data availability committee and the threshold for valid commitments."},{"permission":"interact","from":"0x419dcD0f72ebAFd3524b65a97ac96699C7fBebdB","description":"set core system parameters like the trusted sequencer and manage forced transactions/batches."},{"permission":"upgrade","from":"0x24e09Ef4F69B6058E047EE5E709B345F3cA47F3A","via":[{"address":"0x3F74698A4ADb075c0501DF739745ACA55Ae543a1"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x3F74698A4ADb075c0501DF739745ACA55Ae543a1"}]
    }
```
