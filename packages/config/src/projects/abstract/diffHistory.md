Generated with discovered.json: 0xc7b959d5d6ae5cf7da33f406a60ccfb60bb6c3ab

# Diff at Mon, 24 Aug 2026 10:07:16 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@8f37e0d5e19e879c5a1eeddad7a3666cb36b83ec block: 1786966176
...
Generated with discovered.json: 0x4c69b7f08a338d1733ca57eeefb29328466e0e51
...
- author: Sergey Shemyakov (<sergey.shemyakov@l2beat.com>)
- comparing to: main@57ed70b2c9af46718994f3c208ff3317bed687bf block: 1785925299
- current timestamp: 1786434343

## Description

Abstract multisig upgraded boojum verifiers to the latest version (the same as zksync Era, not yet reproduced). 
...
```diff
.../abstract/{.flat@1785925299 => .flat}/L1VerifierFflonk.sol  |  6 +++---
 .../abstract/{.flat@1785925299 => .flat}/L1VerifierPlonk.sol   | 10 +++++-----
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1785925299 (main branch discovery), not current.
...
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1771250356
- current timestamp: 1771250356
...
- author: Sergey Shemyakov (<sergey.shemyakov@l2beat.com>)
- comparing to: main@ff7d808b2d664b70015c8fab467386a14a164e23 block: 1767003412
- current timestamp: 1769510461
...
```diff
.../abstract/{.flat@1767003412 => .flat}/L1VerifierFflonk.sol     | 4 ++--
 .../abstract/{.flat@1767003412 => .flat}/L1VerifierPlonk.sol      | 8 ++++----
 2 files changed, 6 insertions(+), 6 deletions(-)
```
...
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1761640428
