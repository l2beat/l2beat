Generated with discovered.json: 0x0396a752a8aa1b4ee867297cc5c80e37fce24194

# Diff at Mon, 17 Mar 2025 16:47:01 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21829679
...
+        "Optimism Guardian Multisig"
      directlyReceivedPermissions:
-        [{"permission":"guard","from":"0x1a0ad011913A150f69f6A19DF447A0CfD9551054"},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xdE1FCfB0851916CA5101820A69b13a4E276bd81F","description":"set and change address mappings.","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]},{"permission":"interact","from":"0xEF8115F2733fb2033a7c756402Fc1deaa56550Ef","description":"set and change address mappings.","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]},{"permission":"upgrade","from":"0x1a0ad011913A150f69f6A19DF447A0CfD9551054","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]},{"permission":"upgrade","from":"0x3e2Ea9B92B7E48A52296fD261dc26fd995284631","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]},{"permission":"upgrade","from":"0x83A4521A3573Ca87f3a971B169C5A0E1d34481c3","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]},{"permission":"upgrade","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]},{"permission":"upgrade","from":"0x9E6204F750cD866b299594e2aC9eA824E2e5f95c","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]},{"permission":"upgrade","from":"0xA3cAB0126d5F504B071b81a3e8A2BBBF17930d86","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]},{"permission":"upgrade","from":"0xc52BC7344e24e39dF1bf026fe05C4e6E23CfBcFf","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"},{"permission":"act","from":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]
    }
```

```diff
    contract undefined (0x625726c858dBF78c0125436C943Bf4b4bE9d9033) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xA3cAB0126d5F504B071b81a3e8A2BBBF17930d86"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x1a0ad011913A150f69f6A19DF447A0CfD9551054","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"},{"address":"0xc6901F65369FC59fC1B4D6D6bE7A2318Ff38dB5B","condition":"not revoked by the Security Council"}]},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"},{"address":"0xc6901F65369FC59fC1B4D6D6bE7A2318Ff38dB5B","condition":"not revoked by the Security Council"}]}]
      directlyReceivedPermissions:
...
-        {"permission":"upgrade","to":"0x5a0Aae59D09fccBdDb6C6CcEB07B7279367C3d2A","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0xcA4571b1ecBeC86Ea2E660d242c1c29FcB55Dc72","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
...
-        {"permission":"upgrade","to":"0x5a0Aae59D09fccBdDb6C6CcEB07B7279367C3d2A","via":[{"address":"0xD4ef175B9e72cAEe9f1fe7660a6Ec19009903b49"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xC72aE5c7cc9a332699305E29F68Be66c73b60542","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
+        "Optimism Security Council"
      receivedPermissions:
-        [{"permission":"guard","from":"0x1a0ad011913A150f69f6A19DF447A0CfD9551054","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"}]},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"}]}]
    }
```
...
+        "Zora Multisig 1"
      receivedPermissions:
-        [{"permission":"interact","from":"0xA3cAB0126d5F504B071b81a3e8A2BBBF17930d86","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x9E6204F750cD866b299594e2aC9eA824E2e5f95c"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0xEF8115F2733fb2033a7c756402Fc1deaa56550Ef","description":"set and change address mappings."},{"permission":"upgrade","from":"0x1a0ad011913A150f69f6A19DF447A0CfD9551054"},{"permission":"upgrade","from":"0x3e2Ea9B92B7E48A52296fD261dc26fd995284631","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x83A4521A3573Ca87f3a971B169C5A0E1d34481c3"},{"permission":"upgrade","from":"0x9E6204F750cD866b299594e2aC9eA824E2e5f95c"},{"permission":"upgrade","from":"0xA3cAB0126d5F504B071b81a3e8A2BBBF17930d86"},{"permission":"upgrade","from":"0xc52BC7344e24e39dF1bf026fe05C4e6E23CfBcFf"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x1a0ad011913A150f69f6A19DF447A0CfD9551054"},{"permission":"upgrade","from":"0x3e2Ea9B92B7E48A52296fD261dc26fd995284631"},{"permission":"upgrade","from":"0x83A4521A3573Ca87f3a971B169C5A0E1d34481c3"},{"permission":"upgrade","from":"0x9E6204F750cD866b299594e2aC9eA824E2e5f95c"},{"permission":"upgrade","from":"0xA3cAB0126d5F504B071b81a3e8A2BBBF17930d86"},{"permission":"upgrade","from":"0xc52BC7344e24e39dF1bf026fe05C4e6E23CfBcFf"}]
    }
```
