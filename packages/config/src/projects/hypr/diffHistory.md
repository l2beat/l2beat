Generated with discovered.json: 0xb1670a2665b379457ea82c9869201bfd0bdc6778

# Diff at Wed, 23 Sep 2026 05:46:51 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1768984413
...
-        {"severity":"HIGH"}
      deployerAddress:
+        "eth:0x85fF341a794B43CFBDE4Ff6cEABcB9153E5707A4"
    }
```

```diff
    contract ProxyAdmin (eth:0x20D697b63d7747cF78C94ad9ee75C1436781E27E) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
```diff
    contract HyprMultisig (eth:0x28fB4D0e436874F4107948E358df3C242De06788) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
-        "0xd42bbf9f7dcd3720a7fc6bdc6edfdfae8800a37d6dd4decfa0ef6ca4a2e88940"
+        "0x22c7fb8365a538c05d34b77dd9c1967d1ddb7427eda69f84989d4c56603312b7"
      deployerAddress:
+        "eth:0x45ed27b6c656959Ea3ee4aFDf28cc43f6218b118"
    }
```

```diff
    contract L1ERC721Bridge (eth:0x2e5687010b5f62Ad0ef84370325bC91DED2724fe) [opstack/L1ERC721Bridge] {
    +++ description: Used to bridge ERC-721 tokens from host chain to this chain.
      sourceHashes.1:
-        "0x95c690f70db8f82a05347087d704333c180048757ff015d74a5b186c1b6b24ab"
+        "0x216152d20d8ba85df8aade7361544f4376c3557d2f4791403078ff924fafedd6"
      deployerAddress:
+        "eth:0x85fF341a794B43CFBDE4Ff6cEABcB9153E5707A4"
    }
```
...
```diff
    contract OptimismMintableERC20Factory (eth:0x5F67587FB3f1736a5a91C10E3EeB7cA92117177B) [opstack/OptimismMintableERC20Factory] {
...
+        "0x98d805cbde845bc002acff70aef8f1c406fae2a788f94c3ad742ccaa0ed4dc69"
      deployerAddress:
+        "eth:0x85fF341a794B43CFBDE4Ff6cEABcB9153E5707A4"
    }
```
...
Generated with discovered.json: 0xb01523dea07457cc68a1479825337ca3a336f3fc

# Diff at Mon, 21 Sep 2026 11:24:01 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1768984413
- current timestamp: 1768984413
...
Generated with discovered.json: 0x1a80794d39ea478ed31091a3d08b8b438fbf0a2c

# Diff at Fri, 18 Sep 2026 10:24:50 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1768984413
- current timestamp: 1768984413
...
Generated with discovered.json: 0x6dd2f898717a37a42fc674a5c5f36bab8755376b

# Diff at Tue, 09 Jun 2026 12:43:34 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1768984413
- current timestamp: 1768984413
...
```diff
    EOA  (eth:0x994c288de8418c8D3c5a4D21A69f35bF9641781C) {
    +++ description: None
      receivedPermissions.0.description:
...
```diff
    EOA  (eth:0xeF2169180a2eda91B695eA5e5C4f4547C013840c) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x05db4c2dc65e309133d8e619e043357ed5b031e6

# Diff at Wed, 21 Jan 2026 08:34:36 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@a72aa7d50f1dddc0c7a6eae7f60679fc94e4eabf block: 1764933659
- current timestamp: 1768984413
...
Generated with discovered.json: 0x8ed8bc801eb637de91c3283c1b4bd917452bf593

# Diff at Fri, 05 Dec 2025 11:22:16 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1edf3e71cea32596658a3ea017cea9df6408b77c block: 1759480837
- current timestamp: 1764933659
