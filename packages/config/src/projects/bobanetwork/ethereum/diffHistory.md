Generated with discovered.json: 0xb32a292369319f3693a3cbfdca45123b4f23406d

# Diff at Mon, 17 Mar 2025 16:30:08 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21428646
...
-        {"permission":"upgrade","to":"0x56121a8612474C3eB65D69a3b871f284705b9bC4","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x56121a8612474C3eB65D69a3b871f284705b9bC4","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0xbB7aD3f9CCbC94085b7F7B1D5258e59F5F068741"},{"permission":"guard","from":"0x7B02D13904D8e6E0f0Efaf756aB14Cb0FF21eE7e"},{"permission":"guard","from":"0x996ffD627901f10C80A7d4B72A12316D2e77c076"},{"permission":"interact","from":"0x158Fd5715F16Ac1F2Dc959A299B383aAaf9B59EB","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0x8376ac6C3f73a25Dd994E0b0669ca7ee0C02F089","description":"set and change address mappings.","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0x158Fd5715F16Ac1F2Dc959A299B383aAaf9B59EB","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0x4d898F66327Fa050131A17ed17a39EBeCC81f0c3","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0x7B02D13904D8e6E0f0Efaf756aB14Cb0FF21eE7e","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0x996ffD627901f10C80A7d4B72A12316D2e77c076","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0xA6Ad22bb0E73DEF40a24E510cFbc93807d8bf87e","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0xbB7aD3f9CCbC94085b7F7B1D5258e59F5F068741","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]},{"permission":"upgrade","from":"0xdc1664458d2f0B6090bEa60A8793A4E66c2F1c00","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x8376ac6C3f73a25Dd994E0b0669ca7ee0C02F089","description":"set and change address mappings."},{"permission":"upgrade","from":"0x158Fd5715F16Ac1F2Dc959A299B383aAaf9B59EB"},{"permission":"upgrade","from":"0x4d898F66327Fa050131A17ed17a39EBeCC81f0c3"},{"permission":"upgrade","from":"0x7B02D13904D8e6E0f0Efaf756aB14Cb0FF21eE7e"},{"permission":"upgrade","from":"0x996ffD627901f10C80A7d4B72A12316D2e77c076"},{"permission":"upgrade","from":"0xA6Ad22bb0E73DEF40a24E510cFbc93807d8bf87e"},{"permission":"upgrade","from":"0xbB7aD3f9CCbC94085b7F7B1D5258e59F5F068741"},{"permission":"upgrade","from":"0xdc1664458d2f0B6090bEa60A8793A4E66c2F1c00","description":"upgrading the bridge implementation can give access to all funds escrowed therein."}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x158Fd5715F16Ac1F2Dc959A299B383aAaf9B59EB"},{"permission":"upgrade","from":"0x4d898F66327Fa050131A17ed17a39EBeCC81f0c3"},{"permission":"upgrade","from":"0x7B02D13904D8e6E0f0Efaf756aB14Cb0FF21eE7e"},{"permission":"upgrade","from":"0x996ffD627901f10C80A7d4B72A12316D2e77c076"},{"permission":"upgrade","from":"0xA6Ad22bb0E73DEF40a24E510cFbc93807d8bf87e"},{"permission":"upgrade","from":"0xbB7aD3f9CCbC94085b7F7B1D5258e59F5F068741"},{"permission":"upgrade","from":"0xdc1664458d2f0B6090bEa60A8793A4E66c2F1c00"}]
    }
```
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"challenge","to":"0x56121a8612474C3eB65D69a3b871f284705b9bC4","via":[]}
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0x56121a8612474C3eB65D69a3b871f284705b9bC4","via":[{"address":"0x6e598cec2701FfAA3c06175dc3Af0317a749a0Dc"}]}
      issuedPermissions.0.permission:
-        "propose"
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0xbB7aD3f9CCbC94085b7F7B1D5258e59F5F068741"}]
    }
```
...
```diff
    contract undefined (0xe1B64045351B0B6e9821F19b39f81bc4711D2230) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x158Fd5715F16Ac1F2Dc959A299B383aAaf9B59EB"}]
    }
```
