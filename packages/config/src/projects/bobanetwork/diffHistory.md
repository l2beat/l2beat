Generated with discovered.json: 0x72c53fb463a1bdaf576c014b8bd6b6300daf3013

# Diff at Wed, 23 Sep 2026 05:45:33 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1782210040
...
```diff
    contract DelayedWETH (eth:0x7e021d19C9949109919DCb522df6BaeC1D6638a6) [opstack/DelayedWETH] {
...
```diff
    contract AddressManager (eth:0x8376ac6C3f73a25Dd994E0b0669ca7ee0C02F089) [opstack/AddressManager] {
...
Generated with discovered.json: 0x0876156449179191c32890c744c3090a91c9838f

# Diff at Mon, 21 Sep 2026 11:23:58 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1782210040
- current timestamp: 1782210040
...
Generated with discovered.json: 0xc7bdb209053c9842598fd0923ed7c8dab162f118

# Diff at Fri, 18 Sep 2026 10:24:47 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1782210040
- current timestamp: 1782210040
...
Generated with discovered.json: 0x5d24599bdaff7adcd948a2325d49120160d85b91

# Diff at Tue, 30 Jun 2026 20:24:39 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d6a4cf0104ece715f88d9597c7e158a2841e88fd block: 1782210040
- current timestamp: 1782210040
...
# Diff at Wed, 24 Jun 2026 07:49:38 GMT:
...
.../AnchorStateRegistry/AnchorStateRegistry.sol    |   58 +-
 ...
 .../.flat@1779715460/MIPS.sol => /dev/null         | 3274 ---------------
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1779715460
- current timestamp: 1779715460
...
-        {"permission":"guard","from":"eth:0x996ffD627901f10C80A7d4B72A12316D2e77c076","role":".guardian"}
      receivedPermissions.1:
+        {"permission":"interact","from":"eth:0x996ffD627901f10C80A7d4B72A12316D2e77c076","description":"Allowed to pause withdrawals. In op stack systems with a proof system, the Guardian can also blacklist dispute games and set the respected game type (permissioned / permissionless).","role":".guardian"}
    }
```

```diff
    EOA  (eth:0xA4eD58737Fc5C4861C33410c29ECb1E2AF29d960) {
    +++ description: None
...
Generated with discovered.json: 0x08af05b7f426f22733cdab84089de6550eecee09

# Diff at Thu, 04 Jun 2026 17:38:37 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@8ad83b88dd9180e282e419267cebe10e93daf01d block: 1779715460
- current timestamp: 1779715460
...
Generated with discovered.json: 0xcbe047b29d4ce06d4d63740003b4cb44a40a3556

# Diff at Mon, 25 May 2026 13:25:25 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@72abe436808adc7d485ed261c8195b84874ba5b5 block: 1778001698
- current timestamp: 1779715460

## Description

OP Stack [Upgrade 17 (op-contracts/v5.0.0)](https://github.com/ethereum-optimism/optimism/releases/tag/op-contracts%2Fv5.0.0) — adds Jovian-hardfork `minBaseFee` and `daFootprintGasScalar` config to SystemConfig, refreshes Cannon for op-program Go 1.24, and swaps in the OP-Mainnet-shared MIPS FPVM. Executed 2026-05-21 by Boba Multisig (self-operated). Implementation rotations:
- OptimismPortal2 5.0.0 → 5.1.1 — [diff](https://disco.l2beat.com/diff/eth:0x381E729FF983FA4BCEd820e7b922d79bF653B999/eth:0x7Cf803296662e8C72A6C1d6450572209aCF7f202)
- SystemConfig 3.7.0 → 3.11.0 — [diff](https://disco.l2beat.com/diff/eth:0x2bFE4A5Bd5A41e9d848d843ebCDFa15954e9A557/eth:0x2fA28989fc559836E9d66dFf3010C7F7f41c65ED) (adds `daFootprintGasScalar`, `minBaseFee`)
- DisputeGameFactory 1.2.0 → 1.3.0 — [diff](https://disco.l2beat.com/diff/eth:0x33D1e8571a85a538ed3D5A4d88f46C112383439D/eth:0x74Fac1D45B98bae058F8F566201c9A81B85C7D50) (PermissionedDisputeGame impl redeployed)
- L1CrossDomainMessenger 2.10.0 → 2.11.0 — [diff](https://disco.l2beat.com/diff/eth:0x22D12E0FAebD62d429514A65EBAe32dd316c12D6/eth:0xb686F13AfF1e427a1f993F29ab0F2E7383729FE0)
- L1StandardBridge 2.7.0 → 2.8.0 — [diff](https://disco.l2beat.com/diff/eth:0xe32B192fb1DcA88fCB1C56B3ACb429e32238aDCb/eth:0x61525EaaCDdB97D9184aFc205827E6A4fd0Bf62A)
- L1ERC721Bridge 2.8.0 → 2.9.0 — [diff](https://disco.l2beat.com/diff/eth:0x7f1d12fB2911EB095278085f721e644C1f675696/eth:0x74f1aC50EB0BE98853805D381C884f5f9abDEcf9)
- SuperchainConfig (local fork) 2.3.0 → 2.4.0 — [diff](https://disco.l2beat.com/diff/eth:0xCe28685EB204186b557133766eCA00334EB441E4/eth:0xb08Cc720F511062537ca78BdB0AE691F04F5a957)
- OptimismMintableERC20Factory 1.10.1 → 1.10.2 — [diff](https://disco.l2beat.com/diff/eth:0x5493f4677A186f64805fe7317D6993ba4863988F/eth:0x8ee6fB13c6c9a7e401531168E196Fbf8b05cEabB)
...
.../DisputeGameFactory/DisputeGameFactory.sol      |  47 ++++++--
 .../L1CrossDomainMessenger.sol                     |  83 +++++++++-----
 .../L1ERC721Bridge/L1ERC721Bridge.sol              |  24 ++--
 .../L1StandardBridge/L1StandardBridge.sol          |  24 ++--
 .../{.flat@1778001698 => .flat}/MIPS.sol           |  33 +-----
 .../OptimismMintableERC20Factory.sol               |  16 +--
 .../OptimismPortal2/OptimismPortal2.sol            |  89 ++++++++++-----
 .../PermissionedDisputeGame.sol                    |  73 ++++++------
 .../SuperchainConfig/SuperchainConfig.sol          |  26 +----
 .../SystemConfig/SystemConfig.sol                  | 125 ++++++++++++++-------
 10 files changed, 310 insertions(+), 230 deletions(-)
```

Generated with discovered.json: 0x5cf7df76d2c825019465f3d092234d6346f2e733

# Diff at Fri, 08 May 2026 07:51:09 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1778001698
- current timestamp: 1778001698
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1778001698 (main branch discovery), not current.
...
+        "0xa45ad382a1d6d1f412bc4d29b10dab422d6febb530bc164c2d2b3f836c1482bf"
      deployerAddress:
+        "eth:0x03C256F7Ae7518D0fe489F257ab4b928D37CBE16"
    }
```
...
+        "0x2fe946108f24ddfa96c7feaf21d4c6dd66c8b3f7c4cbb23e9344ea06e73e8ad5"
      deployerAddress:
+        "eth:0x1f2414D0af8741Bc822dBc2f88069c2b2907a840"
    }
```
...
+        "0x2f8e29af46c5650ed34a70b265e91860df0089aa76df54c49770ae0a0fd7c919"
      deployerAddress:
+        "eth:0xCCDEbe62f7378D5A931970A847cdf1EcFfc71C63"
    }
```
...
+        "0xe23c519b7324d6dc9132c8567ac55ae72bdf168c914d22825c7614d822364b0f"
      deployerAddress:
+        "eth:0x796dF5BaB196b84FFf10F65ac0f914E4b10DEaCd"
    }
```
...
+        "0xdfa3b1f4fa753fd7160333c8075b29324bfc8f7c0764ca98384afe6e33790856"
      deployerAddress:
+        "eth:0x1c788Ec62A67805C3276Bd4754904455431FC4f6"
    }
```

Generated with discovered.json: 0x7e990a358405ee53288f9b59277f973905af6dae

# Diff at Tue, 05 May 2026 17:22:44 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@64b89bcc30a16f751bceb5977051cc87d0d45934 block: 1774891601
- current timestamp: 1778001698
...
```diff
.../AnchorStateRegistry/AnchorStateRegistry.sol    | 1263 ++++++----
 .../DelayedWETH/DelayedWETH.sol                    |  601 ++++-
 .../DisputeGameFactory/DisputeGameFactory.sol      |  350 ++-
 .../L1CrossDomainMessenger.sol                     | 1783 +++++++++++--
 .../L1ERC721Bridge/L1ERC721Bridge.sol              |  558 +++-
 .../L1StandardBridge/L1StandardBridge.sol          |  558 +++-
 .../{.flat@1774891601 => .flat}/MIPS.sol           |  648 +++--
 .../OptimismPortal2/OptimismPortal2.sol            | 2656 ++++++++++++++------
 .../PermissionedDisputeGame.sol                    |  604 +++--
 .../SuperchainConfig/SuperchainConfig.sol          |  586 ++++-
 .../SystemConfig/SystemConfig.sol                  | 2302 ++++++++++++++++-
 11 files changed, 9646 insertions(+), 2263 deletions(-)
```
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1774891601 (main branch discovery), not current.
...
```diff
    contract AddressManager (eth:0x8376ac6C3f73a25Dd994E0b0669ca7ee0C02F089) {
    +++ description: Legacy contract used to manage a mapping of string names to addresses. Modern OP stack uses a different standard proxy system instead, but this contract is still necessary for backwards compatibility with several older contracts.
      deployerAddress:
-        "eth:0x1f2414D0af8741Bc822dBc2f88069c2b2907a840"
    }
...
Generated with discovered.json: 0xa7b13799d5a0f6fa52e6a8ce188853b0fd9d1f8c

# Diff at Tue, 05 May 2026 10:22:01 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1774891601
- current timestamp: 1774891601
...
Generated with discovered.json: 0x67dc48feab87463fbb75cbda313a84194cf7c1c3

# Diff at Mon, 30 Mar 2026 17:28:20 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@f7ea9128001c4f5cbcec9e8c1da7ffb72aff3ffe block: 1774433027
- current timestamp: 1774891601
...
.../L1CrossDomainMessenger.sol                     |  350 +++-
 ...
 .../{.flat@1774433027 => .flat}/MIPS.sol           | 1869 ++++++++++++++------
 .../OptimismPortal2/OptimismPortal2.sol            |   83 +-
 .../SystemConfig/SystemConfig.sol                  |   29 +-
 6 files changed, 1793 insertions(+), 580 deletions(-)
```

Generated with discovered.json: 0x720cb402a09b5accf300887df5474b402d182dc5

# Diff at Wed, 25 Mar 2026 10:04:53 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5f335de80b3c24849b3bcc1271bae84dc6e931f7 block: 1766406428
- current timestamp: 1774433027
...
.../AnchorStateRegistry/AnchorStateRegistry.sol    |  292 ++--
 ...
 .../{.flat@1766406428 => .flat}/MIPS.sol           |   75 +-
 .../OptimismMintableERC20Factory.sol               |   30 +-
 .../OptimismPortal2/OptimismPortal2.sol            |  439 ++++--
 .../PermissionedDisputeGame.sol                    |  267 ++--
 .../{.flat@1766406428 => .flat}/PreimageOracle.sol |  216 ++-
 .../SuperchainConfig/SuperchainConfig.sol          |    8 +-
 .../SystemConfig/SystemConfig.sol                  | 1414 +-------------------
 13 files changed, 1902 insertions(+), 2626 deletions(-)
```

Generated with discovered.json: 0xc6df86b48f6a276e970db886945aa0d57ab7c528

# Diff at Fri, 13 Feb 2026 11:33:08 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@55ab80636f1e0c000e757a7a146f11035a19e9c0 block: 1766406428
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1766406428 (main branch discovery), not current.
