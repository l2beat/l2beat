Generated with discovered.json: 0x7586c1b5dd0fa0afa39bd8c43e48bb89158b7cc9

# Diff at Mon, 17 Mar 2025 16:31:38 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21973410
...
-        {"permission":"interact","from":"0x1268cc171c54F2000402DfF20E93E60DF4c96812","description":"manage critical access control roles and the role that can upgrade the implementation.."}
      receivedPermissions.41:
-        {"permission":"interact","from":"0x283751A21eafBFcD52297820D27C1f1963D9b5b4","description":"disable the withdrawal limit."}
...
-        {"permission":"interact","from":"0xcf58536D6Fab5E59B654228a5a4ed89b13A876C2","description":"manage critical access control roles and the role that can upgrade the implementation."}
      receivedPermissions.31:
-        {"permission":"interact","from":"0xF5b6Ee2CAEb6769659f6C091D209DfdCaF3F69Eb","description":"manage critical access control roles and the role that can upgrade the implementation."}
      receivedPermissions.30:
-        {"permission":"interact","from":"0xd8E8531fdD446DF5298819d3Bc9189a5D8948Ee8","description":"manage critical access control roles and the role that can upgrade the implementation."}
...
-        {"permission":"interact","from":"0x0c5aE94f8939182F2D06097025324D1E537d5B60","description":"manage critical access control roles and the role that can upgrade the implementation."}
      receivedPermissions.27:
-        {"permission":"interact","from":"0x66ba83ba3D3AD296424a2258145d9910E9E40B7C","description":"disable the withdrawal limit."}
...
-        {"permission":"interact","from":"0x283751A21eafBFcD52297820D27C1f1963D9b5b4","description":"enable the withdrawal limit."}
...
-        {"permission":"interact","from":"0xf76e6bF9e2df09D0f854F045A3B724074dA1236B","description":"manage critical access control roles and the role that can upgrade the implementation."}
...
-        {"permission":"interact","from":"0xbb3400F107804DFB482565FF1Ec8D8aE66747605","description":"disable the withdrawal limit."}
...
-        {"permission":"upgrade","to":"0x015277f49d5dD035A5F3Ce34aD5eBfDBaCA0C6Ec","via":[]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x015277f49d5dD035A5F3Ce34aD5eBfDBaCA0C6Ec","description":"enroll new tokens, deactivate existing ones (for deposits) or block tokens from being added to the Multibridge.","via":[]}
...
-        {"permission":"upgrade","to":"0x015277f49d5dD035A5F3Ce34aD5eBfDBaCA0C6Ec","delay":259200,"via":[]}
      issuedPermissions.2:
-        {"permission":"interact","to":"0x015277f49d5dD035A5F3Ce34aD5eBfDBaCA0C6Ec","description":"disable the withdrawal limit.","via":[]}
      issuedPermissions.1:
...
```diff
    contract undefined (0x2C169DFe5fBbA12957Bdd0Ba47d9CEDbFE260CA7) {
    +++ description: None
      receivedPermissions:
...
+        "Starkware Multisig 1"
      receivedPermissions:
-        [{"permission":"governStarknet","from":"0xc662c410C0ECf747543f5bA90660f6ABeBD9C8c4","via":[{"address":"0xCA112018fEB729458b628AadC8f996f9deCbCa0c","delay":691200}]},{"permission":"upgrade","from":"0xc662c410C0ECf747543f5bA90660f6ABeBD9C8c4","via":[{"address":"0xCA112018fEB729458b628AadC8f996f9deCbCa0c","delay":691200}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xCA112018fEB729458b628AadC8f996f9deCbCa0c","delay":691200}]
    }
```
...
-        {"permission":"interact","to":"0x015277f49d5dD035A5F3Ce34aD5eBfDBaCA0C6Ec","description":"disable the withdrawal limit.","via":[]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x015277f49d5dD035A5F3Ce34aD5eBfDBaCA0C6Ec","description":"manage critical access control roles related to upgrades and set the proxy governor that can upgrade the implementation.","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.description:
...
-        {"permission":"operateStarknet","to":"0x2C169DFe5fBbA12957Bdd0Ba47d9CEDbFE260CA7","via":[]}
      issuedPermissions.2:
-        {"permission":"governStarknet","to":"0x15e8c684FD095d4796A0c0CF678554F4c1C7C361","via":[]}
...
-        "HIGH"
      directlyReceivedPermissions:
-        [{"permission":"governStarknet","from":"0xc662c410C0ECf747543f5bA90660f6ABeBD9C8c4"},{"permission":"upgrade","from":"0xc662c410C0ECf747543f5bA90660f6ABeBD9C8c4"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0xc662c410C0ECf747543f5bA90660f6ABeBD9C8c4"}]
    }
```
