Generated with discovered.json: 0x5efa039251a60174e828bee7ddfb0191112b8e10

# Diff at Wed, 23 Sep 2026 05:49:57 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1722265907
...
```diff
    contract L1CrossDomainMessenger (eth:0x15567C4FfD9109795dFf1D9A5233D10aef0738D2) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract AddressManager (eth:0x55Aec4EE11dA7d655565cCc2EB3bF21a46C94e6f) [opstack/AddressManager] {
...
```diff
    contract Swan Network Multisig (eth:0x6197f64902b9275e6815F9A5b641Ed2291A5d39c) [GnosisSafe] {
    +++ description: None
...
```diff
    contract OptimismPortal (eth:0xBa50434BC5fCC07406b1baD9AC72a4CDf776db15) [opstack/OptimismPortal] {
...
Generated with discovered.json: 0x16bebafa06c2f7ea0a62960ff100a109192022b8

# Diff at Mon, 21 Sep 2026 11:24:08 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1722265907
- current timestamp: 1722265907
...
Generated with discovered.json: 0x5d13e9a9efc01a62ff9e41dc3d76ed1fa7bb3441

# Diff at Fri, 18 Sep 2026 10:24:56 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1722265907
- current timestamp: 1722265907
...
```diff
    contract L2OutputOracle (eth:0x1c22740A0B4511E11D76434A424487862b593901) [opstack/L2OutputOracle] {
...
```diff
    contract SuperchainConfig (eth:0xadE916De67511E5C24af4174Be67143d0dA94959) [opstack/SuperchainConfigFake] {
...
Generated with discovered.json: 0xc3cd0a3e33127ba4bb9679353e493bdad34df5b1

# Diff at Tue, 09 Jun 2026 12:43:39 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1722265907
- current timestamp: 1722265907
...
```diff
    EOA  (eth:0x3FcB6E08A960EF52Ec3101A444f71A2Fd964b248) {
    +++ description: None
      receivedPermissions.0:
-        {"permission":"challenge","from":"eth:0x1c22740A0B4511E11D76434A424487862b593901","role":".challenger"}
      receivedPermissions.1:
-        {"permission":"challenge","from":"eth:0x1c22740A0B4511E11D76434A424487862b593901","role":".CHALLENGER"}
      receivedPermissions.2:
-        {"permission":"guard","from":"eth:0xadE916De67511E5C24af4174Be67143d0dA94959","role":".guardian"}
...
+        {"permission":"interact","from":"eth:0xadE916De67511E5C24af4174Be67143d0dA94959","description":"Allowed to pause withdrawals. In op stack systems with a proof system, the Guardian can also blacklist dispute games and set the respected game type (permissioned / permissionless).","role":".guardian"}
      receivedPermissions.4:
+        {"permission":"interact","from":"eth:0xBa50434BC5fCC07406b1baD9AC72a4CDf776db15","description":"Allowed to pause withdrawals. In op stack systems with a proof system, the Guardian can also blacklist dispute games and set the respected game type (permissioned / permissionless).","role":".guardian"}
...
```diff
    EOA  (eth:0xb2a5571C23d13Ce16EF3e993FbE8d225D3f67366) {
    +++ description: None
...
```diff
    EOA  (eth:0xde794bEc196832474f2F218135bFd0f7cA7fb038) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x9994362e7c6dc4993c51f6cd3739f07976d799b0

# Diff at Fri, 08 May 2026 07:52:26 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1722265907
- current timestamp: 1722265907
...
```diff
    contract L1ERC721Bridge (eth:0x1Ccf7e62889E6A93413DEAFC4e390Bd4047bDC32) [opstack/L1ERC721Bridge] {
...
```diff
    contract OptimismMintableERC20Factory (eth:0xE9614162C6128ABD7790C65D711CfC43ea842153) [opstack/OptimismMintableERC20Factory] {
...
Generated with discovered.json: 0x2a2f98ab1ba6bb4db66b58737f1b9466ea96e833
