...
export const zksyncprover: BaseProject = {
    ...
    display: {
        description: 'Plonk proving system designed by Matter Labs to prove custom predefined state transitions of ZKsync Lite.',
        links: {
    ...
    zkCatalogInfo: {
        creator: 'Matter Labs',
        techStack: {
            finalWrap: [ZK_CATALOG_TAGS.Plonk.Zksync, ZK_CATALOG_TAGS.Arithmetization.R1CS, ZK_CATALOG_TAGS.PCS.KZG, ZK_CATALOG_TAGS.curve.BN254],
        },
        proofSystemInfo: '',
        trustedSetups: [
            {
        ...
        verifierHashes: [
            {
                ...
                proofSystem: ZK_CATALOG_TAGS.Plonk.Zksync,
                knownDeployments: ['https://etherscan.io/address/0x6e95812c432f293b8045811f4b1758285ebdb206'],
            ...
            },
            {
                ...
                proofSystem: ZK_CATALOG_TAGS.Plonk.Zksync,
                knownDeployments: ['https://etherscan.io/address/0x44deda2c824458a5dfe1e363c679dea33f1ffa39'],
                verificationStatus: 'notVerified',
