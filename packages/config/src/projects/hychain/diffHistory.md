Generated with discovered.json: 0x06e53cad5d79e76d51217785607135903c3a42df

# Diff at Wed, 23 Sep 2026 05:46:49 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1767971010
...
Generated with discovered.json: 0xcbded95a3b35d0d883cd8eae16d13c0961d519f5

# Diff at Mon, 21 Sep 2026 11:24:01 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1767971010
- current timestamp: 1767971010
...
```diff
    contract Outbox (eth:0x0389E24A4Bc96518169f83F50FCDdA442dD8eAFd) [orbitstack/Outbox] {
...
```diff
    contract OneStepProverMemory (eth:0x0F680fAF68BFfe6360C5c264d7649d874AF1507A) [orbitstack/OneStepProverMemory] {
...
```diff
    contract RollupEventInbox (eth:0x617f70525Dc4D2BBbd6ADFd3781DbEAe5C8F0048) [orbitstack/RollupEventInbox] {
...
```diff
    contract Bridge (eth:0x73C6af7029E714DFf1F1554F88b79B335011Da68) [orbitstack/Bridge] {
...
```diff
    contract OneStepProver0 (eth:0x774806aaFD8B4fCdC0985DE8058D41A4e0efab0b) [orbitstack/OneStepProver0] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract HychainMultisig (eth:0x798Fa726f0B4DF564681446D051b344E3FE4a6ca) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
```diff
    contract UpgradeExecutor (eth:0x88d3f3F43Ecd46635bd9f546bE7C4d52eBc20881) [orbitstack/UpgradeExecutor] {
...
```diff
    contract RollupProxy (eth:0x8f98f9ae2f2836Ed3a628c23311Ad9976B9fBF1B) [orbitstack/RollupProxy_fastConfirm] {
...
```diff
    contract OneStepProverMath (eth:0xb6313ff423a864f1e700B4941714E8fF8Fa3954a) [orbitstack/OneStepProverMath] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract OneStepProofEntry (eth:0xD534457D005a895072E54B84DC51bAa5b11a44AC) [orbitstack/OneStepProofEntry] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract Inbox (eth:0xD6c596b7ca17870DD50D322393deCE6C2085a116) [orbitstack/Inbox] {
...
```diff
    contract OneStepProverHostIo (eth:0xe580c0338fc26fFc71C376caE6B82F9DE6e06289) [orbitstack/OneStepProverHostIo] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
...
```diff
    contract ChallengeManager (eth:0xE8AcC0E28a82a26D498f2C66B64C56B9Ef996c2e) [orbitstack/ChallengeManager] {
...
Generated with discovered.json: 0x0a9aee74b4512df9bf88be3d7fed8d0273c4c01a

# Diff at Fri, 18 Sep 2026 10:24:50 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1767971010
- current timestamp: 1767971010
...
Generated with discovered.json: 0xf9777e8c79b98ef4f184405f3e4e6aee49963b30

# Diff at Tue, 09 Jun 2026 12:43:34 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1767971010
- current timestamp: 1767971010
...
```diff
    EOA  (eth:0xC1d59449a546bA80d332De629724df8e9A9e9584) {
    +++ description: None
...
```diff
    EOA  (eth:0xf0DDa810ed19bb640f2A03e8382814e3f0D36e13) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@b319218f320edec871f10dbd490519684995e58e block: 1767696129
- current timestamp: 1767802692
...
Generated with discovered.json: 0xfed7d43d044230962edda36623091cbc7e02b96a

# Diff at Tue, 06 Jan 2026 10:43:17 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@fff3953f1ad2b8af4f603c8d3120130558677a86 block: 1767627920
- current timestamp: 1767696129
...
Generated with discovered.json: 0x00d1e3db1e16f6a6651de4d6ba8c9324933fabc1

# Diff at Mon, 05 Jan 2026 17:44:25 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1766407393
- current timestamp: 1767627920
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1766407393 (main branch discovery), not current.
