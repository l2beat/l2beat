Generated with discovered.json: 0x7358dd811c926c807a53e099b263f7fea0c92609

# Diff at Thu, 26 Feb 2026 06:37:11 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@1ebcaaf3f82908bc9d26f2fe45104052f35d6bba block: 1765784028
- current timestamp: 1772087746
...
+        "gno:0xbaB04858C4eBBb226DD12B38639e59450820536F"
    }
```

Generated with discovered.json: 0xae7732ee7053799438a2a19f25b49baaabded033
...
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@32b8d701a6373d81f08c112cf993056c2a0bb0db block: 1757940700
- current timestamp: 1757940700
...
```diff
    contract OmnibridgeFeeManager (gno:0x5dbC897aEf6B18394D845A922BF107FA98E3AC55) {
    +++ description: None
      sinceTimestamp:
+        1634245065
      sinceBlock:
...
```diff
    contract SelectorTokenGasLimitManager (gno:0x68A3674028a785A8BCE19bA81B9ab7c9942BA3ED) {
    +++ description: None
      sinceTimestamp:
+        1634246385
      sinceBlock:
...
```diff
    contract HashiManager_Gnosis (gno:0x74CACae9801bA4Fe0027Ed6F58d53797CCa7296E) {
...
```diff
    contract MultiTokenForwardingRulesManager (gno:0xd4D8c07097F9b87EcC4C1a838C4b71DBebcd2286) {
    +++ description: None
      sinceTimestamp:
+        1634246015
      sinceBlock:
...
```diff
    contract TokenFactory (gno:0xEAAE83ac10f975a6456f4C4E48c45Ea2d8e1b5d2) {
    +++ description: None
      sinceTimestamp:
+        1634244420
      sinceBlock:
...
Generated with discovered.json: 0x6329c4f55b2977bab51bd5bd0e0955f98879a1b8

# Diff at Tue, 02 Sep 2025 15:08:47 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@f5ac0f88bdc411ecf49ff6c20d5dd0db181a0c91 block: 1756805190
- current timestamp: 1756805190
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1756805190 (main branch discovery), not current.
...
Generated with discovered.json: 0xbd2818a5ad3b7631ba0db87217e404c3bdd73500
