Generated with discovered.json: 0x58c8223236e8592eac561d573e40a6647b05e2d0

# Diff at Mon, 17 Mar 2025 16:30:45 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 20927642
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"challenge","to":"0x4b1A788B20bb85eb19f8e9B69B8a584e7fA29fe5","via":[]}
      issuedPermissions.1:
-        {"permission":"propose","to":"0x853bDfF715eFeDc280C16241dD30A6d651f90aCa","via":[]}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x3Ad319BB4872F8cB75a26Ac30CC4bD2d56b67b05","description":"set and change address mappings.","via":[{"address":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]},{"permission":"upgrade","from":"0x30c789674ad3B458886BBC9abf42EEe19EA05C1D","via":[{"address":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]},{"permission":"upgrade","from":"0x3B95bC951EE0f553ba487327278cAc44f29715E5","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]},{"permission":"upgrade","from":"0x895E00269A05848F3c9889EfA677D02fF7351a5D","via":[{"address":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]},{"permission":"upgrade","from":"0x9168765EE952de7C6f8fC6FaD5Ec209B960b7622","via":[{"address":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"challenge","from":"0x30c789674ad3B458886BBC9abf42EEe19EA05C1D"},{"permission":"guard","from":"0x9168765EE952de7C6f8fC6FaD5Ec209B960b7622"},{"permission":"interact","from":"0x895E00269A05848F3c9889EfA677D02fF7351a5D","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"propose","from":"0x30c789674ad3B458886BBC9abf42EEe19EA05C1D"}]
    }
```
...
```diff
    ...
    +++ description: Contains configuration parameters such as the Sequencer address, gas limit on this chain and the unsafe block signer address.
      issuedPermissions.2:
-        {"permission":"upgrade","to":"0x3c46C05c2eba8eDd0B0f0C8B1D2fBf9fc53ea01E","via":[{"address":"0xa2DCa85BB892De55D8B262d1806114733106e8D1"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x4b1A788B20bb85eb19f8e9B69B8a584e7fA29fe5","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
...
```diff
    ...
    +++ description: The main entry point to deposit funds from host chain to this chain. It also allows to prove and finalize withdrawals.
      issuedPermissions.1:
-        {"permission":"guard","to":"0x4b1A788B20bb85eb19f8e9B69B8a584e7fA29fe5","via":[]}
      issuedPermissions.0.to:
-        "0x3c46C05c2eba8eDd0B0f0C8B1D2fBf9fc53ea01E"
+        "0xa2DCa85BB892De55D8B262d1806114733106e8D1"
      issuedPermissions.0.via.0:
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x3Ad319BB4872F8cB75a26Ac30CC4bD2d56b67b05","description":"set and change address mappings."},{"permission":"upgrade","from":"0x30c789674ad3B458886BBC9abf42EEe19EA05C1D"},{"permission":"upgrade","from":"0x3B95bC951EE0f553ba487327278cAc44f29715E5","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x895E00269A05848F3c9889EfA677D02fF7351a5D"},{"permission":"upgrade","from":"0x9168765EE952de7C6f8fC6FaD5Ec209B960b7622"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x30c789674ad3B458886BBC9abf42EEe19EA05C1D"},{"permission":"upgrade","from":"0x3B95bC951EE0f553ba487327278cAc44f29715E5"},{"permission":"upgrade","from":"0x895E00269A05848F3c9889EfA677D02fF7351a5D"},{"permission":"upgrade","from":"0x9168765EE952de7C6f8fC6FaD5Ec209B960b7622"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x895E00269A05848F3c9889EfA677D02fF7351a5D"}]
    }
```
