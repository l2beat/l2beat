Generated with discovered.json: 0x71b612352755a75e07f4b11c6ca7f9a15334df9c

# Diff at Mon, 17 Mar 2025 16:30:35 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 20920155
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"challenge","to":"0x28A227d4faF0f4f75897438E24C43EF1CDABb920","via":[]}
      issuedPermissions.1:
...
-        [{"permission":"interact","from":"0xF2C89960B6D63eC6c61dF3EA8BaFa0a02c26e8C9","description":"set and change address mappings."},{"permission":"upgrade","from":"0x0a23342520Aa8Ca963c4201801F4D3E95e731637"},{"permission":"upgrade","from":"0x622333688CC1878C7ff4205c89bDe051798788A7"},{"permission":"upgrade","from":"0x952851CecB07705A5bb483C1CE080F97e1E7491E"},{"permission":"upgrade","from":"0xBA61F25dd9f2d5f02D01B1C2c1c5F0B14c4B48A3","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0xeeCE9CD7Abd1CC84d9dfc7493e7e68079E47eA73"},{"permission":"upgrade","from":"0xF04a74899FF4c4410fAF3B5faa29B8Fd199C13DB"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0a23342520Aa8Ca963c4201801F4D3E95e731637"},{"permission":"upgrade","from":"0x622333688CC1878C7ff4205c89bDe051798788A7"},{"permission":"upgrade","from":"0x952851CecB07705A5bb483C1CE080F97e1E7491E"},{"permission":"upgrade","from":"0xBA61F25dd9f2d5f02D01B1C2c1c5F0B14c4B48A3"},{"permission":"upgrade","from":"0xeeCE9CD7Abd1CC84d9dfc7493e7e68079E47eA73"},{"permission":"upgrade","from":"0xF04a74899FF4c4410fAF3B5faa29B8Fd199C13DB"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x0a23342520Aa8Ca963c4201801F4D3E95e731637"},{"permission":"guard","from":"0xeeCE9CD7Abd1CC84d9dfc7493e7e68079E47eA73"},{"permission":"interact","from":"0x622333688CC1878C7ff4205c89bDe051798788A7","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0xF2C89960B6D63eC6c61dF3EA8BaFa0a02c26e8C9","description":"set and change address mappings.","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]},{"permission":"upgrade","from":"0x0a23342520Aa8Ca963c4201801F4D3E95e731637","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]},{"permission":"upgrade","from":"0x622333688CC1878C7ff4205c89bDe051798788A7","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]},{"permission":"upgrade","from":"0x952851CecB07705A5bb483C1CE080F97e1E7491E","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]},{"permission":"upgrade","from":"0xBA61F25dd9f2d5f02D01B1C2c1c5F0B14c4B48A3","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]},{"permission":"upgrade","from":"0xeeCE9CD7Abd1CC84d9dfc7493e7e68079E47eA73","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]},{"permission":"upgrade","from":"0xF04a74899FF4c4410fAF3B5faa29B8Fd199C13DB","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x0a23342520Aa8Ca963c4201801F4D3E95e731637"}]
    }
```
...
-        {"permission":"upgrade","to":"0x28A227d4faF0f4f75897438E24C43EF1CDABb920","via":[{"address":"0x1612F868EbA1cea65ee66bF4A7C75001b0D4065C"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0x28A227d4faF0f4f75897438E24C43EF1CDABb920","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x622333688CC1878C7ff4205c89bDe051798788A7"}]
    }
```
