Generated with discovered.json: 0x6e95ba1c913bd79c716114e5008530d4c9ff8b62

# Diff at Wed, 23 Sep 2026 05:45:42 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1789044436
...
```diff
    contract L1StandardBridge (eth:0x12a580c05466eefb2c467C6b115844cDaF55B255) [opstack/L1StandardBridge] {
...
```diff
    contract AddressManager (eth:0x19b5804B88F10262A55ac731f28A3BbC4209853a) [opstack/AddressManager] {
...
```diff
    contract L1CrossDomainMessenger (eth:0x3c01ebF22e9c111528c1E027D68944eDaB08Dfc9) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract DelayedWETH (eth:0x6A9AFfDcfeF73f66177a1386590607F444520571) [opstack/DelayedWETH] {
...
```diff
    contract ProxyAdmin (eth:0x7E54107731EC43e78DA678DFa5fB6222Ad036e03) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
-        {"addressManager":{"severity":"HIGH"},"owner":{"severity":"HIGH"}}
...
Generated with discovered.json: 0x9dafc8812ecb6f8df57e3f3872565b796eb626f6

# Diff at Mon, 21 Sep 2026 11:23:59 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1789044436
- current timestamp: 1789044436
...
Generated with discovered.json: 0x5b96a65a05bf48e0fc7501d926eb9169d5dff98a

# Diff at Fri, 18 Sep 2026 10:24:48 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1789044436
- current timestamp: 1789044436
...
```diff
    contract PermissionedDisputeGame (eth:0x924B10d37392414b0813190F01DbaF6c3322E906) [opstack/PermissionedDisputeGame] {
...
Generated with discovered.json: 0x539c1e0906decfde3b2f4cbe1add3c00a76bace3

# Diff at Thu, 10 Sep 2026 12:48:50 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@35c16d59b7fb15cd8141bb98bfd0e5a0b6c74620 block: 1785878764
- current timestamp: 1789044436
...
Generated with discovered.json: 0xb8ed37c8b48a26899d39bd1b2dc9e6f629fe5137
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5a5b552776f13efe49c744667945e52e0a8f9718 block: 1783324511
- current timestamp: 1784282889
...
Generated with discovered.json: 0x254f0ab2a8378623f7f43c0126a9baa198997a2a

# Diff at Mon, 06 Jul 2026 07:56:33 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@4572e5b954c85d78517dc66fc4a82b8ddc679e2a block: 1780925465
- current timestamp: 1783324511

## Description

Shared SuperchainConfig upgraded 2.4.0 → 2.4.2 ([diff](https://disco.l2beat.com/diff/eth:0xb08Cc720F511062537ca78BdB0AE691F04F5a957/eth:0xE4F9779ab53070a55db24dFAeFf9AF147c6ED550)). No behavioral change — `ProxyAdminOwnedBase` import moved, misleading pause-state warning removed, and 5 new unused constants added to the shared `Constants` library (forward-plumbing for OPCM tooling). Batcher rotated (`0xf99F…6FC5` → `0x2F8F…040f`). PermissionedDisputeGame redeployed to rotate proposer (`0xE1F8…E36f` → `0xAA0F…99Ab`); other params unchanged ([diff](https://disco.l2beat.com/diff/eth:0xDE6284479EA9e623C00C14CFfc04091113BcB2B8/eth:0x924B10d37392414b0813190F01DbaF6c3322E906)).
...
+        "eth:0x2F8Fd76923E2B0D0ba8F9C1a52A365CC6E7c040f"
    }
```
...
+        "eth:0x924B10d37392414b0813190F01DbaF6c3322E906"
    }
```
...
Generated with discovered.json: 0xd2ee3b07101ee6f61eddca38c9624503e6a2fafd

# Diff at Tue, 30 Jun 2026 12:25:11 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d6a4cf0104ece715f88d9597c7e158a2841e88fd block: 1780925465
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1780925465 (main branch discovery), not current.
...
Generated with discovered.json: 0xad661f856b43c1c6dcdd6cad00e8bc6ac2f9b453

# Diff at Tue, 09 Jun 2026 12:43:32 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1780925465
- current timestamp: 1780925465
...
```diff
    EOA  (eth:0xf99F2E466D35b9B2755f7bA99E34bC7D56F96FC5) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x6645e646088ff3a7024126b5a6d386df40d7e65b

# Diff at Fri, 15 May 2026 13:11:05 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@da451cba8e944a28754be7e17bcb7555d857f312 block: 1777994281
- current timestamp: 1778850529
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1777994281 (main branch discovery), not current.
...
Generated with discovered.json: 0xcec9e16881511b140aecf389a85b8436312d80ca

# Diff at Fri, 08 May 2026 07:51:13 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1777994281
- current timestamp: 1777994281
...
+        "0xf7ae1985b2a40f10b5be04fbc92266dbdb96eb67b632f0d85280d1c122f74c02"
      deployerAddress:
+        "eth:0x6508361F2e815432FAEE7931F2423c6A224f066c"
    }
```

```diff
    contract DataAvailabilityChallenge (eth:0x10E34EfE14E4D270C0f77Bf1aF01b6C832161B49) [opstack/DataAvailabilityChallenge] {
...
```diff
    contract L1ERC721Bridge (eth:0x4F4B716627D2Ba0439327Ce8B563b4443aF47Dbd) [opstack/L1ERC721Bridge] {
...
```diff
    contract OptimismMintableERC20Factory (eth:0x51A00470Eb50D758EcFF3B96DB0bF4A8e86268F4) [opstack/OptimismMintableERC20Factory] {
...
```diff
    contract Cyber Multisig 2 (eth:0x68ca4cDCb0F47457273B554E60ff8321D5C133E4) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
Generated with discovered.json: 0xfbf4a4aed49f616f3d648bc2fc893ded0e2932ea

# Diff at Tue, 05 May 2026 15:19:09 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c30884758a8f4ef4178d2eb572fb25911670bcff block: 1774433159
- current timestamp: 1777994281
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1774433159 (main branch discovery), not current.
...
```diff
    contract DataAvailabilityChallenge (eth:0x10E34EfE14E4D270C0f77Bf1aF01b6C832161B49) {
    +++ description: The DataAvailabilityChallenge contract is used to challenge the full availability of data behind commimted transaction data hashes. See the technology section for more details.
      deployerAddress:
-        "eth:0x1a76Ed328600489811F819959a74043f106CF0f9"
    }
...
```diff
    contract AddressManager (eth:0x19b5804B88F10262A55ac731f28A3BbC4209853a) {
    +++ description: Legacy contract used to manage a mapping of string names to addresses. Modern OP stack uses a different standard proxy system instead, but this contract is still necessary for backwards compatibility with several older contracts.
      deployerAddress:
-        "eth:0x1a76Ed328600489811F819959a74043f106CF0f9"
    }
...
```diff
    contract Cyber Multisig 2 (eth:0x68ca4cDCb0F47457273B554E60ff8321D5C133E4) {
    +++ description: None
      deployerAddress:
-        "eth:0xc76C563185d01284AdbC9cF5bb909162dD2F15e7"
    }
...
Generated with discovered.json: 0xbbc6073d758d3615fccdfdc861f42845596e5d98

# Diff at Tue, 05 May 2026 10:22:05 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1774433159
- current timestamp: 1774433159
...
Generated with discovered.json: 0xd9e593a431e830b3854c78e726c8a4d3f38b4f74

# Diff at Wed, 25 Mar 2026 10:07:04 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5f335de80b3c24849b3bcc1271bae84dc6e931f7 block: 1772198383
- current timestamp: 1774433159
...
Generated with discovered.json: 0x0a2958dfd45186f21169c8b82c2ee0c92067e0e7

# Diff at Fri, 27 Feb 2026 13:23:33 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@17ff9ba367ef55b34e16f082bde7902f4760911e block: 1769272322
- current timestamp: 1772198383
