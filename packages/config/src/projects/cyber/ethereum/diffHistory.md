Generated with discovered.json: 0x61db0f01140825d668fb14fa09702b746234b805

# Diff at Mon, 17 Mar 2025 16:30:11 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21235446
...
```diff
    contract undefined (0x0C883f622b4ccbF1e8ce86217998f87e6d36BCE4) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"guard","from":"0x1aeC4c3BE47C30d0BEfa7514Cf9D99EaC596959D"},{"permission":"guard","from":"0x1d59bc9fcE6B8E2B1bf86D4777289FFd83D24C99"}]
    }
```
...
```diff
    ...
    +++ description: This is NOT the shared SuperchainConfig contract of the OP stack Superchain but rather a local fork. It manages the `PAUSED_SLOT`, a boolean value indicating whether the local chain is paused, and `GUARDIAN_SLOT`, the address of the guardian which can pause and unpause the system.
      issuedPermissions.1:
-        {"permission":"guard","to":"0x0C883f622b4ccbF1e8ce86217998f87e6d36BCE4","via":[]}
      issuedPermissions.0.to:
-        "0xc2259E7Fb719411f97aBdCdf449f6Ba3B9D75398"
+        "0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"
      issuedPermissions.0.via.0:
...
-        {"permission":"upgrade","to":"0xc2259E7Fb719411f97aBdCdf449f6Ba3B9D75398","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xc76C563185d01284AdbC9cF5bb909162dD2F15e7","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
...
-        [{"permission":"interact","from":"0x19b5804B88F10262A55ac731f28A3BbC4209853a","description":"set and change address mappings."},{"permission":"upgrade","from":"0x10E34EfE14E4D270C0f77Bf1aF01b6C832161B49"},{"permission":"upgrade","from":"0x12a580c05466eefb2c467C6b115844cDaF55B255","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x1aeC4c3BE47C30d0BEfa7514Cf9D99EaC596959D"},{"permission":"upgrade","from":"0x1d59bc9fcE6B8E2B1bf86D4777289FFd83D24C99"},{"permission":"upgrade","from":"0x4F4B716627D2Ba0439327Ce8B563b4443aF47Dbd"},{"permission":"upgrade","from":"0x51A00470Eb50D758EcFF3B96DB0bF4A8e86268F4"},{"permission":"upgrade","from":"0x5D1F4bbaF6D484fA9D5D9705f92dE6063bff6055"},{"permission":"upgrade","from":"0xa669A743b065828682eE16109273F5CFeF5e676d"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x10E34EfE14E4D270C0f77Bf1aF01b6C832161B49"},{"permission":"upgrade","from":"0x12a580c05466eefb2c467C6b115844cDaF55B255"},{"permission":"upgrade","from":"0x1aeC4c3BE47C30d0BEfa7514Cf9D99EaC596959D"},{"permission":"upgrade","from":"0x1d59bc9fcE6B8E2B1bf86D4777289FFd83D24C99"},{"permission":"upgrade","from":"0x4F4B716627D2Ba0439327Ce8B563b4443aF47Dbd"},{"permission":"upgrade","from":"0x51A00470Eb50D758EcFF3B96DB0bF4A8e86268F4"},{"permission":"upgrade","from":"0x5D1F4bbaF6D484fA9D5D9705f92dE6063bff6055"},{"permission":"upgrade","from":"0xa669A743b065828682eE16109273F5CFeF5e676d"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0xa669A743b065828682eE16109273F5CFeF5e676d"}]
    }
```
...
-        {"permission":"upgrade","to":"0xc2259E7Fb719411f97aBdCdf449f6Ba3B9D75398","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]}
      issuedPermissions.1:
-        {"permission":"propose","to":"0xF2987f0A626c8D29dFB2E0A21144ca3026d6F1E1","via":[]}
      issuedPermissions.0.permission:
-        "challenge"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x19b5804B88F10262A55ac731f28A3BbC4209853a","description":"set and change address mappings.","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x10E34EfE14E4D270C0f77Bf1aF01b6C832161B49","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x12a580c05466eefb2c467C6b115844cDaF55B255","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x1aeC4c3BE47C30d0BEfa7514Cf9D99EaC596959D","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x1d59bc9fcE6B8E2B1bf86D4777289FFd83D24C99","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x4F4B716627D2Ba0439327Ce8B563b4443aF47Dbd","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x51A00470Eb50D758EcFF3B96DB0bF4A8e86268F4","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0x5D1F4bbaF6D484fA9D5D9705f92dE6063bff6055","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]},{"permission":"upgrade","from":"0xa669A743b065828682eE16109273F5CFeF5e676d","via":[{"address":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x7E54107731EC43e78DA678DFa5fB6222Ad036e03"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x10E34EfE14E4D270C0f77Bf1aF01b6C832161B49","description":"can upgrade the parameters of DA challenges like the bond size or refund percentages, potentially making challenges infeasable or insecure."},{"permission":"interact","from":"0x5D1F4bbaF6D484fA9D5D9705f92dE6063bff6055","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```

```diff
    contract undefined (0xf0748C52EDC23135d9845CDFB91279Cf61ee14b4) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x5D1F4bbaF6D484fA9D5D9705f92dE6063bff6055"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0xa669A743b065828682eE16109273F5CFeF5e676d"}]
    }
```
