Generated with discovered.json: 0x8c4ad6bdd0cf1e52749ad13c835baa88b7af8b9f

# Diff at Wed, 23 Sep 2026 05:46:37 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1743924767
- current timestamp: 1743924767
...
discovery. Values are for block 1743924767 (main branch discovery), not current.

```diff
    contract ProxyAdmin (eth:0x081A54442Af40a26Ae453Da0F044a49Aa3314453) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
```diff
    contract L1StandardBridge (eth:0x2321F7982Af3cBbA1Ab9D426ae7fe595E1CF427C) [opstack/L1StandardBridge] {
...
```diff
    contract OptimismMintableERC20Factory (eth:0x34B4AcC9e4523Cc6bbfC367B9034121c447b4083) [opstack/OptimismMintableERC20Factory] {
...
```diff
    contract L2OutputOracle (eth:0x53C64d7c9a28911203Ba4BE2a6cA58254184920a) [opstack/L2OutputOracle] {
...
```diff
    contract L1ERC721Bridge (eth:0x6345b54426A5B80A377d07C97672331Bda3432e6) [opstack/L1ERC721Bridge] {
...
```diff
    contract SystemConfig (eth:0x8C467dAC40f01DFA83666F39108992a0635faeD9) [opstack/SystemConfig] {
...
```diff
    contract SuperchainConfig (eth:0xB83831efA1Cc1bFF0c29ed0d8df1943F834442A0) [opstack/SuperchainConfigFake] {
...
```diff
    contract AddressManager (eth:0xCD749A3e59543B31658b725136Ef3616bE7001bc) [opstack/AddressManager] {
...
```diff
    contract DataAvailabilityChallenge (eth:0xd1fe2EEb5637b0F78BfcEd9186ebE716aC73DEb6) [opstack/DataAvailabilityChallenge] {
...
```diff
    contract OptimismPortal (eth:0xd2726bde3D07645faf5aD7cCF15C94817B3556D6) [opstack/OptimismPortal] {
...
```diff
    contract L1CrossDomainMessenger (eth:0xea6390d969aacd4BA217F6b4614dDAE4bdDb1B3B) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract GmMultisig (eth:0xf040a7A04e914E1b4383C04359D03Ab5F12E7828) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
Generated with discovered.json: 0xcd32f4b55672731d8bc010d5b52bea896915024b

# Diff at Mon, 21 Sep 2026 11:24:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1743924767
- current timestamp: 1743924767
...
Generated with discovered.json: 0x9db164ecc6f8b1eb3d848e736e00be1483227e6e

# Diff at Fri, 18 Sep 2026 10:24:49 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1743924767
- current timestamp: 1743924767
...
Generated with discovered.json: 0x6530ee74b7cfd3c89ff4361b1b7d6d402d393b27

# Diff at Tue, 09 Jun 2026 12:43:34 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1743924767
- current timestamp: 1743924767
...
```diff
    EOA  (eth:0x4d9D11fF877aCD0918CF467B14cE4C3d8F1b97d9) {
    +++ description: None
...
```diff
    EOA  (eth:0x4FACE9ec6237C04a22d434989Beb30b43055886D) {
    +++ description: None
      receivedPermissions.0.description:
...
```diff
    EOA  (eth:0xA1D6a47973D55FD4F6432B370CE5381fB24A3094) {
    +++ description: None
      receivedPermissions.0.description:
...
```diff
    EOA  (eth:0xd668A64E69ef82026deB46491BFCd28ba14024C8) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x42a44dc5e877599f4c8d614a03be0424a42b9fbd
