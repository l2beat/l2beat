Generated with discovered.json: 0x987665cb1fb9cbb6b2e9f0ff052a662c4541b70e

# Diff at Mon, 17 Mar 2025 16:30:48 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21716626
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"challenge","from":"0x759894Ced0e6af42c26668076Ffa84d02E3CeF60"}]
    }
```
...
-        {"permission":"upgrade","to":"0xF101f7f59A348c1F971A2BC64fdBdA58c7bBD887","via":[{"address":"0x31110622D6CA24c9FF307d6ae1715F16E47F16A0"}]}
      issuedPermissions.6:
-        {"permission":"sequence","to":"0xf834ffbeb6bB3F4841afc6b5FB40B94cd580fa23","description":"Actors allowed to commit transaction batches and propose state roots","via":[]}
      issuedPermissions.5:
...
-        {"permission":"sequence","to":"0x34E387B37d3ADEAa6D5B92cE30dE3af3DCa39796","description":"Actors allowed to commit transaction batches and propose state roots","via":[]}
      issuedPermissions.1:
-        {"permission":"sequence","to":"0xa59B26DB10C5Ca26a97AA2Fd2E74CB8DA9D1EB65","description":"Actors allowed to commit transaction batches and propose state roots","via":[]}
...
-        [{"permission":"upgrade","from":"0x0Dc417F8AF88388737c5053FF73f345f080543F7"},{"permission":"upgrade","from":"0x1C1Ffb5828c3A48B54E8910F1c75256a498aDE68"},{"permission":"upgrade","from":"0x3931Ade842F5BB8763164bDd81E5361DcE6cC1EF"},{"permission":"upgrade","from":"0x44c28f61A5C2Dd24Fc71D7Df8E85e18af4ab2Bd8"},{"permission":"upgrade","from":"0x7497756ADA7e656aE9f00781aF49Fc0fD08f8A8a"},{"permission":"upgrade","from":"0x759894Ced0e6af42c26668076Ffa84d02E3CeF60"},{"permission":"upgrade","from":"0xc5Fa3b8968c7FAbEeA2B530a20b88d0C2eD8abb7"},{"permission":"upgrade","from":"0xDc71366EFFA760804DCFC3EDF87fa2A6f1623304"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0Dc417F8AF88388737c5053FF73f345f080543F7"},{"permission":"upgrade","from":"0x1C1Ffb5828c3A48B54E8910F1c75256a498aDE68"},{"permission":"upgrade","from":"0x3931Ade842F5BB8763164bDd81E5361DcE6cC1EF"},{"permission":"upgrade","from":"0x44c28f61A5C2Dd24Fc71D7Df8E85e18af4ab2Bd8"},{"permission":"upgrade","from":"0x7497756ADA7e656aE9f00781aF49Fc0fD08f8A8a"},{"permission":"upgrade","from":"0x759894Ced0e6af42c26668076Ffa84d02E3CeF60"},{"permission":"upgrade","from":"0xc5Fa3b8968c7FAbEeA2B530a20b88d0C2eD8abb7"},{"permission":"upgrade","from":"0xDc71366EFFA760804DCFC3EDF87fa2A6f1623304"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x0Dc417F8AF88388737c5053FF73f345f080543F7","description":"Actors allowed to commit transaction batches and propose state roots"}]
    }
```
...
-        {"permission":"challenge","to":"0x03FD36AEd3b2597aA79bb5f543f3a0eAf9DEB0FA","via":[]}
      issuedPermissions.30:
-        {"permission":"challenge","to":"0xd11f9c4F5d9b1feC2d14581d3674066442B68772","via":[]}
      issuedPermissions.29:
-        {"permission":"challenge","to":"0x0092bC49078f130D27e70dBeee441E227280B97D","via":[]}
      issuedPermissions.28:
-        {"permission":"challenge","to":"0xf50A81C771AD3237aeA2FD18E4ee8055CC4Cd2B9","via":[]}
      issuedPermissions.27:
-        {"permission":"challenge","to":"0x95417708f67f4a5dF1A447efe40c6C74e38Ab832","via":[]}
      issuedPermissions.26:
-        {"permission":"challenge","to":"0x4Ee3690901157bE86A33371bEc1e5021A10Ba47C","via":[]}
      issuedPermissions.25:
-        {"permission":"challenge","to":"0x74204e3801E9394848AbDBAd6f378d0b11e9a091","via":[]}
      issuedPermissions.24:
-        {"permission":"challenge","to":"0x95C373754C66feF1Eb2dbb6934aF821C551D9738","via":[]}
      issuedPermissions.23:
-        {"permission":"challenge","to":"0xB822319ab7848b7cC4537c8409e50f85BFb04377","via":[]}
      issuedPermissions.22:
-        {"permission":"challenge","to":"0xC4db900F76293042349448D1Ba30F71518325Bb3","via":[]}
      issuedPermissions.21:
-        {"permission":"challenge","to":"0xc8F7DaeF4b49c1593cC3996aB2afa8B56e00fcF8","via":[]}
      issuedPermissions.20:
-        {"permission":"challenge","to":"0xE48eA86dCdE15E28624E5De9d6D3738fc52B6bFe","via":[]}
      issuedPermissions.19:
-        {"permission":"challenge","to":"0x5c6E1011cd3b5d7D2937c098b8F61d6B3d1aee7e","via":[]}
      issuedPermissions.18:
-        {"permission":"challenge","to":"0xDF063FAEb46de1b4336bC70Da7175f16aB4A7272","via":[]}
      issuedPermissions.17:
-        {"permission":"challenge","to":"0xF2FF0509520fAf35B511074466A509e00d73C307","via":[]}
      issuedPermissions.16:
-        {"permission":"challenge","to":"0x323a78C1c910b282dE98a557d735628A02E00983","via":[]}
      issuedPermissions.15:
-        {"permission":"challenge","to":"0xC412B4e6399F694CfF21D038d225373Fd6596811","via":[]}
      issuedPermissions.14:
-        {"permission":"challenge","to":"0x8C0cFFcBAb44c7aB6e96EB607c49188dE99a17Cd","via":[]}
      issuedPermissions.13:
-        {"permission":"challenge","to":"0x71C10870dC38E54d987C22e96aB32b46cc08564F","via":[]}
      issuedPermissions.12:
-        {"permission":"challenge","to":"0xbD9f4fdC48a9A8c7eA1075CFDf4F3bd365d50Bab","via":[]}
      issuedPermissions.11:
-        {"permission":"challenge","to":"0x234aCb24b1DeeA7f6c7530b8c29a6378bA21e1D0","via":[]}
      issuedPermissions.10:
-        {"permission":"challenge","to":"0x92C4d5d9CaDD1aF74080DE7aa078434007F710Bb","via":[]}
      issuedPermissions.9:
-        {"permission":"challenge","to":"0xbfd62b7915da8c19C701FD13237b555Ad38C4b4C","via":[]}
      issuedPermissions.8:
-        {"permission":"challenge","to":"0x77B29534738E3F0F297d36635d7884965C7c8cE1","via":[]}
      issuedPermissions.7:
-        {"permission":"challenge","to":"0xF6Ee30269dB1854987cA6812E1ff66c3A5F660Fd","via":[]}
      issuedPermissions.6:
-        {"permission":"challenge","to":"0x6D7cC6C62CD6CcdaC482E82aA7A3763926e93854","via":[]}
      issuedPermissions.5:
-        {"permission":"challenge","to":"0xb4A20D473e8C378aE742a8017DD67756a358eAB6","via":[]}
      issuedPermissions.4:
-        {"permission":"challenge","to":"0xcA00091a35d0b546A15d000F8bCeDA56255EE4D0","via":[]}
      issuedPermissions.3:
-        {"permission":"challenge","to":"0x9Ac29D4f41A139D9b7be32C2906Df9f86FA51b2b","via":[]}
      issuedPermissions.2:
-        {"permission":"challenge","to":"0x1721D3Ae2d68E3Dd32525400Ed2a29060F1300c6","via":[]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x611e4B24e89bC524Fc06f73b6FD02bE3Ec73d6Db","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
...
+        "Morph Multisig 2"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x759894Ced0e6af42c26668076Ffa84d02E3CeF60"},{"permission":"interact","from":"0x759894Ced0e6af42c26668076Ffa84d02E3CeF60","description":"can pause and unpause, override any batch, revert batch, update proof window, update challengers, modify verifiers"},{"permission":"interact","from":"0xc5Fa3b8968c7FAbEeA2B530a20b88d0C2eD8abb7","description":"can pause and unpause"}]
    }
```
