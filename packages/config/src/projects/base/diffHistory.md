Generated with discovered.json: 0xac5a3fc9d328ced9a9d38db4745d78420b82ec9b
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1785226129
- current timestamp: 1785226129
...
+        {"severity":"HIGH"}
      fieldMeta.GUARDIAN:
+        {"severity":"MEDIUM"}
      fieldMeta.incidentResponder:
+        {"severity":"MEDIUM"}
      fieldMeta.pauseExpiryFmt:
+        {"severity":"HIGH"}
      fieldMeta.guardian:
+        {"severity":"MEDIUM"}
      fieldMeta.INCIDENT_RESPONDER:
+        {"severity":"MEDIUM"}
    }
```
...
Generated with discovered.json: 0x1f98086683f57666b1174b4d03de686b02ed4667

# Diff at Fri, 18 Sep 2026 10:24:47 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1785226129
- current timestamp: 1785226129
...
- comparing to: main@66fa629d20cb3eebcd8a566401e5b4f335fafdf2 block: 1785226129
- current timestamp: 1785226129
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@223ad9100b05447b13e88b350a283f0fcdd967a4 block: 1770994155
- current timestamp: 1771857552

## Description

SystemConfig minBaseFee increased from 2,000,000 to 5,000,000 (2.5x increase).
...
Generated with discovered.json: 0xa46e06817bdd23a01cfdc26ceac7ccdae4872b35

# Diff at Fri, 13 Feb 2026 14:50:21 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@e1a04313e06de62db68bde894bcda2e7a6630a45 block: 1770329869
- current timestamp: 1770994155
...
```diff
    ...
    +++ description: A helper contract that generates OptimismMintableERC20 contracts on the network it's deployed to. OptimismMintableERC20 is a standard extension of the base ERC20 token contract designed to allow the L1StandardBridge contracts to mint and burn tokens. This makes it possible to use an OptimismMintableERC20 as this chain's representation of a token on the host chain, or vice-versa.
      values.$pastUpgrades.5:
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0x8ee6fB13c6c9a7e401531168E196Fbf8b05cEabB"]]
      values.$upgradeCount:
-        5
+        6
    }
...
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0xc040F392E52Cb6970CA8E110c280fE24E07C5e2c"]]
      values.$upgradeCount:
-        4
+        5
...
+++ severity: HIGH
      values.gameImpls.0:
-        "eth:0x979Cb7E329bA213fB9d6c5F7771eC6a3109BDC93"
+        "eth:0x6dDBa09bc4cCB0D6Ca9Fc5350580f74165707499"
+++ severity: HIGH
      values.gameImpls.1:
-        "eth:0x6f8c1Ea88CB410571739d36EB00811B250574cB2"
+        "eth:0x58bf355C5d4EdFc723eF89d99582ECCfd143266A"
...
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0x97cEbbf8959e2A5476fbe9B98A21806Ec234609B"]]
      values.$upgradeCount:
-        9
+        10
      values.version:
...
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0x74f1aC50EB0BE98853805D381C884f5f9abDEcf9"]]
      values.$upgradeCount:
-        7
+        8
    }
...
```diff
-   Status: DELETED
    contract PermissionedDisputeGame (eth:0x6f8c1Ea88CB410571739d36EB00811B250574cB2)
    +++ description: Same as FaultDisputeGame, but only two permissioned addresses are designated as proposer and challenger.
```
...
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0xd392c27B84b1cA776528F2704BC67B82a62132d2"]]
      values.$upgradeCount:
-        13
+        14
...
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0xb686F13AfF1e427a1f993F29ab0F2E7383729FE0"]]
      values.$upgradeCount:
-        8
+        9
    }
...
+        "eth:0x36398155Cd17cfe804F69b233eDDA800DD4D5aA5"
      values.$pastUpgrades.1:
+        ["2026-02-10T16:49:59.000Z","0x7407256ae44170125b2d82c71f0d03cb6ade3c2268e8cd33dcb07fe259fbfd0b",["eth:0x36398155Cd17cfe804F69b233eDDA800DD4D5aA5"]]
      values.$upgradeCount:
-        1
+        2
      values.version:
...
+        {"root":"0x9a37fe32cd2b49385bec0236b7b5c2177e71176bb306d19a49a8a77651ce2cd0","l2SequenceNumber":36233266}
...
```diff
-   Status: DELETED
    contract FaultDisputeGame (eth:0x979Cb7E329bA213fB9d6c5F7771eC6a3109BDC93)
    +++ description: Logic of the dispute game. When a state root is proposed, a dispute game contract is deployed. Challengers can use such contracts to challenge the proposed state root.
```
...
Generated with discovered.json: 0x03aea88fb2472d0587a315f05e1cc64d801e8b36

# Diff at Fri, 13 Feb 2026 11:33:07 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@55ab80636f1e0c000e757a7a146f11035a19e9c0 block: 1770329869
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1770329869 (main branch discovery), not current.
...
- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6cd29a835d734750c830e20a8c0a6b2f1cef086b block: 1765550303
- current timestamp: 1766048031
...
.../GnosisSafe.sol => /dev/null                    |  959 -----------------
 ...
 .../base/.flat/OpFoundationUpgradeSafe/Safe.sol    | 1088 ++++++++++++++++++++
 3 files changed, 1498 insertions(+), 1234 deletions(-)
```

Generated with discovered.json: 0x3776919069c1548f798ddd9ce74ff2e96b6d8cc3

# Diff at Fri, 12 Dec 2025 16:19:48 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d2235ef7f5c90cb4a3a617fea7d52a655dc22fa1 block: 1765358732
- current timestamp: 1765550303
...
L1Block - setL1BlockValuesJovian() that introduces daFootprintGasScalar  (400 default value)
https://disco.l2beat.com/diff/base:0xFf256497D61dcd71a9e9Ff43967C13fdE1F72D12/base:0x3Ba4007f5C922FBb33C454B41ea7a1f11E83df2C

Already templatized (minimal diff):

OptimismMintableERC20Factory
https://disco.l2beat.com/diff/eth:0x5493f4677A186f64805fe7317D6993ba4863988F/eth:0x8ee6fB13c6c9a7e401531168E196Fbf8b05cEabB

L1StandardBridge
https://disco.l2beat.com/diff/eth:0xe32B192fb1DcA88fCB1C56B3ACb429e32238aDCb/eth:0x61525EaaCDdB97D9184aFc205827E6A4fd0Bf62A

DisputeGameFactory
https://disco.l2beat.com/diff/eth:0x33D1e8571a85a538ed3D5A4d88f46C112383439D/eth:0x74Fac1D45B98bae058F8F566201c9A81B85C7D50

OptimismPortal2
https://disco.l2beat.com/diff/eth:0x381E729FF983FA4BCEd820e7b922d79bF653B999/eth:0x7Cf803296662e8C72A6C1d6450572209aCF7f202

L1ERC721Bridge
https://disco.l2beat.com/diff/eth:0x7f1d12fB2911EB095278085f721e644C1f675696/eth:0x74f1aC50EB0BE98853805D381C884f5f9abDEcf9
...
+        "base:0x3Ba4007f5C922FBb33C454B41ea7a1f11E83df2C"
      values.$pastUpgrades.2:
+        ["2025-12-02T16:00:01.000Z","0xcd60191626fa3124e7031235c52f0adf6be545ebbd7cf55641bd9dabcbedaf6a",["base:0x3Ba4007f5C922FBb33C454B41ea7a1f11E83df2C"]]
      values.$upgradeCount:
-        2
+        3
      values.version:
...
-        "L1Block"
      implementationNames.base:0x3Ba4007f5C922FBb33C454B41ea7a1f11E83df2C:
+        "L1Block"
    }
```
...
+        "eth:0x8ee6fB13c6c9a7e401531168E196Fbf8b05cEabB"
      values.$pastUpgrades.4:
+        ["2025-12-01T15:58:23.000Z","0x9b9aa2d8e857e1a28e55b124e931eac706b3ae04c1b33ba949f0366359860993",["eth:0x8ee6fB13c6c9a7e401531168E196Fbf8b05cEabB"]]
      values.$upgradeCount:
-        4
+        5
      values.version:
...
+        ["2025-12-01T15:58:23.000Z","0x9b9aa2d8e857e1a28e55b124e931eac706b3ae04c1b33ba949f0366359860993",["eth:0x74Fac1D45B98bae058F8F566201c9A81B85C7D50"]]
      values.$upgradeCount:
-        3
+        4
+++ severity: HIGH
...
+        "eth:0x7Cf803296662e8C72A6C1d6450572209aCF7f202"
      values.$pastUpgrades.8:
+        ["2025-12-01T15:58:23.000Z","0x9b9aa2d8e857e1a28e55b124e931eac706b3ae04c1b33ba949f0366359860993",["eth:0x7Cf803296662e8C72A6C1d6450572209aCF7f202"]]
      values.$upgradeCount:
-        8
+        9
      values.version:
...
+        ["2025-12-01T15:58:23.000Z","0x9b9aa2d8e857e1a28e55b124e931eac706b3ae04c1b33ba949f0366359860993",["eth:0x74f1aC50EB0BE98853805D381C884f5f9abDEcf9"]]
      values.$upgradeCount:
-        6
+        7
      values.version:
...
+        ["2025-12-01T15:58:23.000Z","0x9b9aa2d8e857e1a28e55b124e931eac706b3ae04c1b33ba949f0366359860993",["eth:0x2fA28989fc559836E9d66dFf3010C7F7f41c65ED"]]
      values.$upgradeCount:
-        12
+        13
      values.version:
...
+        "eth:0xb686F13AfF1e427a1f993F29ab0F2E7383729FE0"
      values.$pastUpgrades.7:
+        ["2025-12-01T15:58:23.000Z","0x9b9aa2d8e857e1a28e55b124e931eac706b3ae04c1b33ba949f0366359860993",["eth:0xb686F13AfF1e427a1f993F29ab0F2E7383729FE0"]]
      values.$upgradeCount:
-        7
+        8
      values.version:
...
.../DisputeGameFactory/DisputeGameFactory.sol      |  47 +++++++---
 ...
 .../base/{.flat@1764322933 => .flat}/MIPS.sol      |  33 ++-----
 ...
 11 files changed, 328 insertions(+), 199 deletions(-)
```
...
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1761757489
