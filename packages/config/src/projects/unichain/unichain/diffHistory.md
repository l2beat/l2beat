Generated with discovered.json: 0xddac09c67fb5343576c634dc853386d4f215baf8

# Diff at Thu, 03 Apr 2025 13:52:56 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@390dc72872cb4dce4017ada9ab709f2c51c936e3 block: 9916035
- current block number: 16835938
...
```diff
    contract  (0x4200000000000000000000000000000000000011) {
    +++ description: None
      name:
-        "SequencerFeeVault"
+        ""
...
```diff
    contract  (0x4200000000000000000000000000000000000019) {
    +++ description: None
      name:
-        "BaseFeeVault"
+        ""
...
```diff
    contract  (0x420000000000000000000000000000000000001A) {
    +++ description: None
      name:
-        "L1FeeVault"
+        ""
...
Generated with discovered.json: 0x6cedeb0546d46784e6a118aac4cdc10aaf5e7f2f
