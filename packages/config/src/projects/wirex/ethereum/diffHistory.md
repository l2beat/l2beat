Generated with discovered.json: 0xb33589cd15e95f7deea560762c83ac67acaee9d5

# Diff at Mon, 17 Mar 2025 16:38:19 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21766767
...
-        [{"permission":"upgrade","from":"0x755e9A5B4BAEFc78Bb82BA7E6d2386CCB2F238a5"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x755e9A5B4BAEFc78Bb82BA7E6d2386CCB2F238a5"}]
    }
```
...
```diff
    contract undefined (0x49a191471F248f7c86cA29477e6E969970BaEAdA) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x78253E2E6120164bd826668A4C96Db20f78A94c9"}]
    }
```
...
```diff
    ...
    +++ description: The main system contract defining the pay-chain Layer 2 logic. Entry point for sequencing batches.
      issuedPermissions:
-        [{"permission":"interact","to":"0xecEA75e2854FD52b0aE5C51C88f5eA8e2eC4bf9A","description":"set core system parameters like the trusted sequencer and manage forced transactions/batches.","via":[]},{"permission":"interact","to":"0xecEA75e2854FD52b0aE5C51C88f5eA8e2eC4bf9A","description":"sole address that can force batches.","via":[]},{"permission":"sequence","to":"0x49a191471F248f7c86cA29477e6E969970BaEAdA","via":[]}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"upgrade","from":"0x755e9A5B4BAEFc78Bb82BA7E6d2386CCB2F238a5","via":[{"address":"0x2B966b9824c11f274aa39f2f72cF25C4b47c3A78"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x2B966b9824c11f274aa39f2f72cF25C4b47c3A78"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"interact","from":"0x755e9A5B4BAEFc78Bb82BA7E6d2386CCB2F238a5","description":"manage the members of the data availability committee and the threshold for valid commitments."},{"permission":"interact","from":"0x78253E2E6120164bd826668A4C96Db20f78A94c9","description":"set core system parameters like the trusted sequencer and manage forced transactions/batches."},{"permission":"interact","from":"0x78253E2E6120164bd826668A4C96Db20f78A94c9","description":"sole address that can force batches."}]
    }
```
