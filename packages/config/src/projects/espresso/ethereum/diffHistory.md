Generated with discovered.json: 0xd146700b55bee144c452768db173c01c3724f9b9

# Diff at Mon, 17 Mar 2025 16:30:17 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21372994
...
-        {"permission":"upgrade","from":"0x95Ca91Cea73239b15E5D2e5A74d02d6b5E0ae458"}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x95Ca91Cea73239b15E5D2e5A74d02d6b5E0ae458","description":"can call newFinalizedState() to prove the latest HotShot state."}]
    }
```
...
```diff
    ...
    +++ description: The DA bridge contract that stores and verifies HotShot state commitments on Ethereum.
      issuedPermissions.2:
-        {"permission":"interact","to":"0x4fD0Ac6922Da5C96b6f94202EcE60E8fE3bF3947","description":"can call newFinalizedState() to prove the latest HotShot state.","via":[]}
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0x34F5af5158171Ffd2475d21dB5fc3B311F221982","via":[]}
