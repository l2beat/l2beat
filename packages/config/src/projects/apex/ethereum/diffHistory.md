Generated with discovered.json: 0x982e859e22b2c14ec8fb5f88c87dd8d84fadd9a6

# Diff at Mon, 17 Mar 2025 16:30:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21981180
...
-        {"permission":"upgrade","from":"0xe53A6eD882Eb3f90cCe0390DDB04c876C5482E6b","delay":1209600}
      receivedPermissions.1:
-        {"permission":"governStarknet","from":"0xe53A6eD882Eb3f90cCe0390DDB04c876C5482E6b"}
...
```diff
    contract undefined (0x552aA2EBA4B0c5b9B8b4b22507189a7af4198169) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"operateStarknet","from":"0xe53A6eD882Eb3f90cCe0390DDB04c876C5482E6b"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xA1D5443F2FB80A5A55ac804C948B45ce4C52DCbb","description":"Can regsiter new tokens for deposits and withdrawals."},{"permission":"interact","from":"0xe53A6eD882Eb3f90cCe0390DDB04c876C5482E6b","description":"Can regsiter new tokens for deposits and withdrawals."},{"permission":"operateStarknet","from":"0xA1D5443F2FB80A5A55ac804C948B45ce4C52DCbb"},{"permission":"operateStarknet","from":"0xe53A6eD882Eb3f90cCe0390DDB04c876C5482E6b"}]
    }
```

```diff
    contract undefined (0x78e802d42Bbc1834f962A11B54e0F8e07f52d4Fb) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"operateStarknet","from":"0xA1D5443F2FB80A5A55ac804C948B45ce4C52DCbb"}]
    }
```
...
-        {"permission":"upgrade","to":"0xC532d2976209A56DdF4a99B844130f7c0daCa7B6","delay":1209600,"via":[]}
      issuedPermissions.6:
-        {"permission":"governStarknet","to":"0xef75e1199B0599BA823b7770AcE8eb34864a1D55","via":[]}
      issuedPermissions.5:
...
-        {"permission":"upgrade","from":"0xA1D5443F2FB80A5A55ac804C948B45ce4C52DCbb","delay":1209600}
      receivedPermissions.1:
-        {"permission":"governStarknet","from":"0xA1D5443F2FB80A5A55ac804C948B45ce4C52DCbb"}
      receivedPermissions.0.permission:
-        "interact"
+        "upgrade"
      receivedPermissions.0.description:
...
-        {"permission":"operateStarknet","to":"0x5751a83170BeA11fE7CdA5D599B04153C021f21A","via":[]}
      issuedPermissions.2:
-        {"permission":"governStarknet","to":"0x53c6Ec9640761c669B800088F097E01A8207Ac8b","via":[]}
      issuedPermissions.1:
