...
+        2
      values.messageNonce:
-        "1766847064778384329583297500742918515827483896875618958121606201292621299"
+        "1766847064778384329583297500742918515827483896875618958121606201292621308"
      values.version:
-        "2.1.1-beta.1"
+        "2.2.1"
...
```diff
    contract GasPriceOracle (ink:0x420000000000000000000000000000000000000F) [N/A] {
    +++ description: None
      template:
...
-        155796532
+        143141664
      values.getL1FeeUpperBound:
+        [1689230840,1689230840,1689230840,1689230840,1689230840]
      values.getOperatorFee:
+        [0,0,0,0,0]
...
+        "GasPriceOracle"
      errors:
+        {"getL1FeeUpperBound":"Processing error occurred.","getOperatorFee":"Processing error occurred.","overhead":"Processing error occurred.","scalar":"Processing error occurred."}
    }
```

```diff
    contract L2StandardBridge (ink:0x4200000000000000000000000000000000000010) [N/A] {
    +++ description: None
      template:
...
```diff
    contract SequencerFeeVault (ink:0x4200000000000000000000000000000000000011) [N/A] {
    +++ description: None
      template:
...
```diff
    contract L2ERC721Bridge (ink:0x4200000000000000000000000000000000000014) [N/A] {
    +++ description: None
      template:
...
```diff
    contract L1Block (ink:0x4200000000000000000000000000000000000015) [N/A] {
    +++ description: None
      template:
...
+        8337334
      values.hash:
-        "0xfb441da87b857dca3c05443df6425d7c262f30144db080a5a69bd5da5be82dda"
+        "0x2633655513261e28378d80a35739a561353b41c6169d89e516f542397ff393ab"
      values.number:
-        25436795
+        25508937
...
```diff
    contract L2ToL1MessagePasser (ink:0x4200000000000000000000000000000000000016) [N/A] {
    +++ description: None
      template:
...
+        "1.2.0"
      values.messageNonce:
+        "1766847064778384329583297500742918515827483896875618958121606201292622360"
...
```diff
    contract OptimismMintableERC721Factory (ink:0x4200000000000000000000000000000000000017) [N/A] {
    +++ description: None
      template:
...
```diff
    contract L2ProxyAdmin (ink:0x4200000000000000000000000000000000000018) [N/A] {
    +++ description: None
      template:
...
-        [{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000007","role":"admin"},{"permission":"upgrade","from":"ink:0x420000000000000000000000000000000000000F","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000010","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000011","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000012","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000013","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000014","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000015","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000016","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000017","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000018","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000019","role":"admin"},{"permission":"upgrade","from":"ink:0x420000000000000000000000000000000000001A","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000020","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000021","role":"admin"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000007","role":"admin"},{"permission":"upgrade","from":"ink:0x420000000000000000000000000000000000000F","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000010","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000011","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000012","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000013","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000014","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000015","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000016","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000017","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000018","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000019","role":"admin"},{"permission":"upgrade","from":"ink:0x420000000000000000000000000000000000001A","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000020","role":"admin"},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000021","role":"admin"}]
    }
```
...
```diff
    contract BaseFeeVault (ink:0x4200000000000000000000000000000000000019) [N/A] {
    +++ description: None
      template:
...
```diff
    contract BaseFeeVault (ink:0x420000000000000000000000000000000000001A) [N/A] {
    +++ description: None
      template:
-        "opstack/Layer2/BaseFeeVault"
      sourceHashes.1:
...
```diff
    contract SchemaRegistry (ink:0x4200000000000000000000000000000000000020) [N/A] {
    +++ description: None
      template:
...
```diff
    contract EAS (ink:0x4200000000000000000000000000000000000021) [N/A] {
    +++ description: None
      template:
-        "opstack/Layer2/EAS"
      sourceHashes.1:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000007","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x420000000000000000000000000000000000000F","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000010","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000011","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000012","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000013","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000014","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000015","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000016","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000017","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000018","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000019","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x420000000000000000000000000000000000001A","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000020","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]},{"permission":"upgrade","from":"ink:0x4200000000000000000000000000000000000021","role":"admin","via":[{"address":"ink:0x4200000000000000000000000000000000000018"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"ink:0x4200000000000000000000000000000000000018","role":".owner"}]
    }
```
...
.../BaseFeeVault.sol                               | 1084 ++++-
 ...
 15 files changed, 9880 insertions(+), 3434 deletions(-)
```
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@cfafbf3de953d9f519656c89c622fe51a04d547a block: 1779198841
- current timestamp: 1782898474
...
+        {"permission":"upgrade","from":"eth:0x57b4C29DAee99a28E6E86778b499361294c134eA","role":"admin","via":[{"address":"eth:0xd56045E68956FCe2576E680c95a4750cf8241f79"}]}
...
```diff
-   Status: DELETED
    contract DelayedWETH (eth:0x6Cbd14DA021e39A7895Ae151Ac72eCc9023e87F6) [opstack/DelayedWETH]
...
```diff
-   Status: DELETED
    contract DelayedWETH (eth:0x71CC5E57cE659e8E2cc78F86b14BDDCb626691Fd) [opstack/DelayedWETH]
    +++ description: Contract designed to hold the bonded ETH for each game. It is designed as a wrapper around WETH to allow an owner to function as a backstop if a game would incorrectly distribute funds.
```

```diff
    contract L1StandardBridge (eth:0x88FF1e5b602916615391F55854588EFcBB7663f0) [opstack/L1StandardBridge] {
...
+        {"permission":"upgrade","from":"eth:0x57b4C29DAee99a28E6E86778b499361294c134eA","role":"admin"}
...
-        "eth:0x6463dEE3828677F6270d83d45408044fc5eDB908"
      values.wethFromGame:
-        "eth:0x6Cbd14DA021e39A7895Ae151Ac72eCc9023e87F6"
...
Generated with discovered.json: 0x876d533c5b180e828d08342a149e402b8edbe9b7

# Diff at Tue, 30 Jun 2026 20:24:40 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d6a4cf0104ece715f88d9597c7e158a2841e88fd block: 1779198841
- current timestamp: 1779198841
...
discovery. Values are for block 1779198841 (main branch discovery), not current.
...
Generated with discovered.json: 0xaa8db3bec442c1b633731429c6b2a1c1a3fbd5cf

# Diff at Fri, 12 Jun 2026 10:18:51 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6a183e6009109d4e62087499f44eca4aceea9086 block: 1779198841
- current timestamp: 1779198841
...
```diff
    contract BaseFeeVault (ink:0x4200000000000000000000000000000000000019) [opstack/Layer2/BaseFeeVault] {
...
```diff
    contract BaseFeeVault (ink:0x420000000000000000000000000000000000001A) [opstack/Layer2/BaseFeeVault] {
    +++ description: Collects EIP-1559 base fees, which are withdrawable to the FeesCollector on L1.
      category:
+        {"name":"Non-Critical","priority":0}
    }
...
Generated with discovered.json: 0xd2d53d0899830109297b787aade11043e1fa445b

# Diff at Tue, 09 Jun 2026 12:43:35 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1779198841
- current timestamp: 1779198841
...
```diff
    EOA  (eth:0x500d7Ea63CF2E501dadaA5feeC1FC19FE2Aa72Ac) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x27dc2e5e8cb3277f739792ab56bad866823f8402

# Diff at Thu, 04 Jun 2026 17:40:55 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@8ad83b88dd9180e282e419267cebe10e93daf01d block: 1779198841
- current timestamp: 1779198841
...
Generated with discovered.json: 0x0c80861edf16b62944cb0fdb05596f69585ce0a1

# Diff at Wed, 20 May 2026 10:24:41 GMT:
...
Generated with discovered.json: 0xa66ccdb54bcf5a1d0adb84769629d0bd42ea8405

# Diff at Fri, 15 May 2026 13:31:28 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@da451cba8e944a28754be7e17bcb7555d857f312 block: 1777994261
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1777994261 (main branch discovery), not current.
...
Generated with discovered.json: 0xcc7efe1e759ad77265c4d658381aeaa320bdfc91

# Diff at Fri, 15 May 2026 12:35:59 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a5152b9ba7ad7f85f2af3d814f74630fcaa7c917 block: 1777994261
- current timestamp: 1777994261
...
Generated with discovered.json: 0xc833d4116ed5bd5b0fe2f5184d5b88f01b388d9a

# Diff at Fri, 08 May 2026 07:51:25 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1777994261
- current timestamp: 1777994261
...
```diff
    contract DisputeGameFactory (eth:0x10d7B35078d3baabB96Dd45a9143B94be65b12CD) [opstack/DisputeGameFactory] {
...
```diff
    contract AnchorStateRegistry (eth:0xEe018bAf058227872540AC60eFbd38b023d9dAe2) [opstack/AnchorStateRegistry_post13] {
...
```diff
    contract OptimismMintableERC20Factory (ink:0x4200000000000000000000000000000000000012) [opstack/Layer2/OptimismMintableERC20Factory] {
...
```diff
    contract L1BlockNumber (ink:0x4200000000000000000000000000000000000013) [opstack/Layer2/L1BlockNumber] {
...
```diff
    contract L2ProxyAdmin (ink:0x4200000000000000000000000000000000000018) [opstack/Layer2/L2ProxyAdmin] {
...
Generated with discovered.json: 0xbbedb5da6f94c3e9b175a3788c9f59eccfec6309

# Diff at Tue, 05 May 2026 15:18:48 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c30884758a8f4ef4178d2eb572fb25911670bcff block: 1777390955
- current timestamp: 1777994261
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1777390955 (main branch discovery), not current.
...
```diff
    contract AddressManager (eth:0x9b7C9BbD6d540A8A4dEDd935819fC4408Ba71153) {
    +++ description: Legacy contract used to manage a mapping of string names to addresses. Modern OP stack uses a different standard proxy system instead, but this contract is still necessary for backwards compatibility with several older contracts.
      deployerAddress:
-        "eth:0x0125aeb5fF473De23ab72454B2bbC45613Ff3bd7"
    }
...
```diff
    contract OptimismMintableERC20Factory (eth:0xA8B389A82e088b164cD03230e900980CcED34d29) {
    +++ description: A helper contract that generates OptimismMintableERC20 contracts on the network it's deployed to. OptimismMintableERC20 is a standard extension of the base ERC20 token contract designed to allow the L1StandardBridge contracts to mint and burn tokens. This makes it possible to use an OptimismMintableERC20 as this chain's representation of a token on the host chain, or vice-versa.
      deployerAddress:
-        "eth:0x0125aeb5fF473De23ab72454B2bbC45613Ff3bd7"
    }
...
```diff
    contract ETHLockbox (eth:0xbd4AbB321138e8Eddc399cE64E66451294325a14) {
    +++ description: A simple escrow contract storing ETH for the canonical bridge.
      deployerAddress:
-        "eth:0x1D0519EeD308BcD49e4ebc149284F83ebC275284"
    }
...
```diff
    contract L2CrossDomainMessenger (ink:0x4200000000000000000000000000000000000007) {
    +++ description: The L2CrossDomainMessenger (L2xDM) contract sends messages from L2 to L1, and relays messages from L1 onto L2 with a system tx. In the event that a message sent from L2 to L1 is rejected for exceeding the L1 gas limit, it can be resubmitted via this contract’s replay function.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract L2StandardBridge (ink:0x4200000000000000000000000000000000000010) {
    +++ description: The L2StandardBridge contract is the main entry point to deposit or withdraw ERC20 tokens from L2 to L1. This contract can store any token.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract OptimismMintableERC20Factory (ink:0x4200000000000000000000000000000000000012) {
    +++ description: Factory contract to create bridge compliant ERC20 IOU token representations of bridged L1 ERC20 tokens.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract L1BlockNumber (ink:0x4200000000000000000000000000000000000013) {
    +++ description: Simple contract that returns the latest L1 block number.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract L2ERC721Bridge (ink:0x4200000000000000000000000000000000000014) {
    +++ description: The L2ERC721Bridge contract is the main entry point to deposit or withdraw ERC721 tokens from L2 to L1. This contract can store any token.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract L2ToL1MessagePasser (ink:0x4200000000000000000000000000000000000016) {
    +++ description: Contract used internally by the L2CrossDomainMessenger to send messages to L1, including withdrawals. It can also be used directly as a low-level interface.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract OptimismMintableERC721Factory (ink:0x4200000000000000000000000000000000000017) {
    +++ description: Factory contract to create bridge compliant ERC721 IOU token representations of bridged L1 ERC721 tokens.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract L2ProxyAdmin (ink:0x4200000000000000000000000000000000000018) {
    +++ description: Administration contract for other contract proxies.
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract SchemaRegistry (ink:0x4200000000000000000000000000000000000020) {
    +++ description: Contracts to register schemas for the Ethereum Attestation Service (EAS).
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
```diff
    contract EAS (ink:0x4200000000000000000000000000000000000021) {
    +++ description: Contract containing the main logic for the Ethereum Attestation Service (EAS).
      deployerAddress:
-        "ink:0x0000000000000000000000000000000000000000"
    }
...
Generated with discovered.json: 0x3d40f51096f657a253706de154ea7ae974bdc994

# Diff at Tue, 05 May 2026 10:22:15 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1777390955
- current timestamp: 1777390955
...
Generated with discovered.json: 0x8d1223b18c371f508674f1590bc7db5cf006051a

# Diff at Tue, 28 Apr 2026 15:44:52 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@0695512a70f7175257fb7756eb2008702d3f0dc5 block: 1774433178
- current timestamp: 1777390955

## Description

Gelato Multisig (`eth:0xBeA2Bc85...`) member rotation: 5 signers removed (`0x349f3839`, `0xB65540bB`, `0x58edE8C6`, `0x28bB9385`, `0x5bE3E96C`), 1 added (`0x6a0A93Cd`). Threshold dropped 4→3 and total signers 9→5 (44% → 60%). Shared multisig — same change observed on `ethernity`, `lisk`, `everclear`, `reya`, and `educhain` (arb1).
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@17ff9ba367ef55b34e16f082bde7902f4760911e block: 1770912803
...
```diff
-   Status: DELETED
    contract PermissionedDisputeGame (eth:0x467E6a8D6916E7394F9715b4DE9339ee36887382)
    +++ description: Same as FaultDisputeGame, but only two permissioned addresses are designated as proposer and challenger.
```
...
+        {"root":"0x10c839264195b6b897892b2d8949004bcb6005a9c712b41651aaf1a68c004d21","l2SequenceNumber":19265297}
