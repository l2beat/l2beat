Generated with discovered.json: 0xfa52b034e7e2fb354ef0f075d8032ae3e43498a4

# Diff at Mon, 17 Mar 2025 16:29:53 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 22045124
...
discovery. Values are for block 22045124 (main branch discovery), not current.
...
-        [{"permission":"act","from":"0xB524735356985D2f267FA010D681f061DfF03715"}]
    }
```
...
```diff
+   Status: CREATED
    contract DonationBox (0x0d57392895Db5aF3280e9223323e20F3951E81B1)
    +++ description: None
```
