Generated with discovered.json: 0xb5f0ed479b0e91cbd5602bf3a526343563879606

# Diff at Thu, 09 Apr 2026 13:54:34 GMT:

- author: Sergey Shemyakov (<sergey.shemyakov@l2beat.com>)
- current timestamp: 1775742806
...
```diff
+   Status: CREATED
    contract TornadoTrees (eth:0x43a3bE4Ae954d9869836702AFd10393D3a7Ea417)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract TornadoTrees (eth:0x527653eA119F3E6a1F5BD18fbF4714081D7B31ce)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract  (eth:0x6234c4C2734D2B246AE074492F402D8f58ff3226)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract TornadoProxy (eth:0x722122dF12D4e14e13Ac3b6895a86e84145b6967)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract  (eth:0x83584f83f26aF4eDDA9CBe8C730bc87C364b28fe)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract TornadoProxy (eth:0x905b63Fff465B9fFBF41DeA908CEb12478ec7601)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract  (eth:0xbFA347D89Ac54F7C2De2433458cb98A85fc03CEd)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract  (eth:0xD82ed8786D7c69DC7e052F7A542AB047971E73d2)
    +++ description: None
```
