...
// For demo purposes I hardcode tickers here. All addresses are on Ethereum.
// It's dirty and hacky, in the prod version this should be solved by token db
export const TICKERS: Record<string, { ticker: string; decimals: number }> = {
  '0x6B175474E89094C44Da98b954EedeAC495271d0F': { ticker: 'DAI', decimals: 18 },
  '0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643': { ticker: 'cDAI', decimals: 8 },
  '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48': { ticker: 'USDC', decimals: 6 },
  '0xdAC17F958D2ee523a2206206994597C13D831ec7': { ticker: 'USDT', decimals: 6 },
  ...
  '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599': { ticker: 'WBTC', decimals: 8 },
