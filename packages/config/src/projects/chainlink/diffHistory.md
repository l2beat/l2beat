Generated with discovered.json: 0x2612669f0da7217ca32c5bf16fd487d41a089e6c
...
- current timestamp: 1785754257

## Description

Initial discovery of the Chainlink ETH/USD, stETH/USD and rETH/ETH price feeds.
...
```diff
+   Status: CREATED
    contract ChainlinkAuthorizedForwarder (eth:0xe9E4D87B0e7f97dd622439c26605b3b038c276C4) [ChainlinkAuthorizedForwarder]
    +++ description: A Chainlink authorized forwarder that an oracle node uses to submit its signed reports onchain. It relays calls from its own authorized sender keys to a fixed target and holds no funds or price logic of its own.
```
