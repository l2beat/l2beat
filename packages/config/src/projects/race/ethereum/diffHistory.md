Generated with discovered.json: 0x0e500c0962feffce4971e86e132e6459e9bc7ca9

# Diff at Mon, 17 Mar 2025 16:31:04 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21242938
...
-        {"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x8bF8442d49d52377d735a90F19657a29f29aA83c"},{"permission":"guard","from":"0x0485Ca8A73682B3D3f5ae98cdca1E5b512E728e9"},{"permission":"guard","from":"0xCB73B7348705a9F925643150Eb00350719380FF8"}]
    }
```
...
+        "Race Multisig 1"
      receivedPermissions:
-        [{"permission":"interact","from":"0x3d2BdE87466Cae97011702D2C305fd40EEBbbF0a","description":"set and change address mappings.","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0x0485Ca8A73682B3D3f5ae98cdca1E5b512E728e9","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0x0f33D824d74180598311b3025095727BeA61f219","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0x1d1c4C89AD5FF486c3C67E3DD84A22CF05420711","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0x680969A6c58183987c8126ca4DE6b59C6540Cd2a","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0x8bF8442d49d52377d735a90F19657a29f29aA83c","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0xCB73B7348705a9F925643150Eb00350719380FF8","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]},{"permission":"upgrade","from":"0xCf6A32dB8b3313b3d439CE6909511c2c3415fa32","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x8bF8442d49d52377d735a90F19657a29f29aA83c"}]
    }
```
...
-        {"permission":"upgrade","to":"0x5A669B2193718F189b0576c0cdcedfEd6f40F9Ea","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x2E7B9465B25C081c07274A31DbD05C6146f67961","via":[]}
      issuedPermissions.0.permission:
-        "propose"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    contract undefined (0x8CDa8351236199AF7532baD53D683Ddd9B275d89) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xCf6A32dB8b3313b3d439CE6909511c2c3415fa32"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x3d2BdE87466Cae97011702D2C305fd40EEBbbF0a","description":"set and change address mappings."},{"permission":"upgrade","from":"0x0485Ca8A73682B3D3f5ae98cdca1E5b512E728e9"},{"permission":"upgrade","from":"0x0f33D824d74180598311b3025095727BeA61f219"},{"permission":"upgrade","from":"0x1d1c4C89AD5FF486c3C67E3DD84A22CF05420711"},{"permission":"upgrade","from":"0x680969A6c58183987c8126ca4DE6b59C6540Cd2a","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x8bF8442d49d52377d735a90F19657a29f29aA83c"},{"permission":"upgrade","from":"0xCB73B7348705a9F925643150Eb00350719380FF8"},{"permission":"upgrade","from":"0xCf6A32dB8b3313b3d439CE6909511c2c3415fa32"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x0485Ca8A73682B3D3f5ae98cdca1E5b512E728e9"},{"permission":"upgrade","from":"0x0f33D824d74180598311b3025095727BeA61f219"},{"permission":"upgrade","from":"0x1d1c4C89AD5FF486c3C67E3DD84A22CF05420711"},{"permission":"upgrade","from":"0x680969A6c58183987c8126ca4DE6b59C6540Cd2a"},{"permission":"upgrade","from":"0x8bF8442d49d52377d735a90F19657a29f29aA83c"},{"permission":"upgrade","from":"0xCB73B7348705a9F925643150Eb00350719380FF8"},{"permission":"upgrade","from":"0xCf6A32dB8b3313b3d439CE6909511c2c3415fa32"}]
    }
```
...
+        "Race Multisig 3"
      receivedPermissions:
-        [{"permission":"interact","from":"0xCf6A32dB8b3313b3d439CE6909511c2c3415fa32","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
-        {"permission":"upgrade","to":"0x5A669B2193718F189b0576c0cdcedfEd6f40F9Ea","via":[{"address":"0x9B3C6D1d33F1fd82Ebb8dFbE38dA162B329De191"}]}
      issuedPermissions.1:
-        {"permission":"interact","to":"0xBac1ad52745162c0aA3711fe88Df1Cc67034a3B9","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system.","via":[]}
      issuedPermissions.0.permission:
-        "sequence"
+        "upgrade"
      issuedPermissions.0.to:
