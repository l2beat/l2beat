Generated with discovered.json: 0x3e91eef1d4bdb67535d6c88350be384ebbd6d35b

# Diff at Mon, 17 Mar 2025 16:30:42 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 22046064
...
```diff
    contract undefined (0x03e820562ffd2e0390787caD706EaF1FF98C2608) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"propose","from":"0x1145E7848c8B64c6cab86Fd6D378733385c5C3Ba"}]
    }
```
...
-        {"permission":"upgrade","to":"0x4a4962275DF8C60a80d3a25faEc5AA7De116A746","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]}
      issuedPermissions.1:
-        {"permission":"propose","to":"0x03e820562ffd2e0390787caD706EaF1FF98C2608","via":[]}
      issuedPermissions.0.permission:
-        "challenge"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    contract undefined (0x14e4E97bDc195d399Ad8E7FC14451C279FE04c8e) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x0e4C4CDd01ceCB01070E9Fdfe7600871e4ae996e"}]
    }
```
...
-        [{"permission":"interact","from":"0xC845F9C4004EB35a8bde8ad89C4760a9c0e65CAB","description":"set and change address mappings."},{"permission":"upgrade","from":"0x08Dea366F26C25a08C8D1C3568ad07d1e587136d"},{"permission":"upgrade","from":"0x0e4C4CDd01ceCB01070E9Fdfe7600871e4ae996e"},{"permission":"upgrade","from":"0x1145E7848c8B64c6cab86Fd6D378733385c5C3Ba"},{"permission":"upgrade","from":"0x61E44dC0dae6888B5a301887732217d5725B0bFf","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x6CC3268794c5d3E3d9d52adEfC748B59d536cb22"},{"permission":"upgrade","from":"0x85eA9c11cf3D4786027F7FD08F4406b15777e5f8"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x08Dea366F26C25a08C8D1C3568ad07d1e587136d"},{"permission":"upgrade","from":"0x0e4C4CDd01ceCB01070E9Fdfe7600871e4ae996e"},{"permission":"upgrade","from":"0x1145E7848c8B64c6cab86Fd6D378733385c5C3Ba"},{"permission":"upgrade","from":"0x61E44dC0dae6888B5a301887732217d5725B0bFf"},{"permission":"upgrade","from":"0x6CC3268794c5d3E3d9d52adEfC748B59d536cb22"},{"permission":"upgrade","from":"0x85eA9c11cf3D4786027F7FD08F4406b15777e5f8"}]
    }
```
...
+        "Conduit Multisig 1"
      receivedPermissions:
-        [{"permission":"interact","from":"0x0e4C4CDd01ceCB01070E9Fdfe7600871e4ae996e","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"interact","from":"0xC845F9C4004EB35a8bde8ad89C4760a9c0e65CAB","description":"set and change address mappings.","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]},{"permission":"upgrade","from":"0x08Dea366F26C25a08C8D1C3568ad07d1e587136d","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]},{"permission":"upgrade","from":"0x0e4C4CDd01ceCB01070E9Fdfe7600871e4ae996e","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]},{"permission":"upgrade","from":"0x1145E7848c8B64c6cab86Fd6D378733385c5C3Ba","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]},{"permission":"upgrade","from":"0x61E44dC0dae6888B5a301887732217d5725B0bFf","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]},{"permission":"upgrade","from":"0x6CC3268794c5d3E3d9d52adEfC748B59d536cb22","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]},{"permission":"upgrade","from":"0x85eA9c11cf3D4786027F7FD08F4406b15777e5f8","via":[{"address":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x35d5D43271548c984662d4879FBc8e041Bc1Ff93"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"challenge","from":"0x1145E7848c8B64c6cab86Fd6D378733385c5C3Ba"},{"permission":"guard","from":"0x85eA9c11cf3D4786027F7FD08F4406b15777e5f8"}]
    }
```
...
Generated with discovered.json: 0xd2425bb395f3d42f28c52bff72b5726d97be9aea
