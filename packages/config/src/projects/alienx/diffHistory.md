Generated with discovered.json: 0x038b9211242f2db4cdc6ef83b1047be0d28141f5

# Diff at Wed, 23 Sep 2026 05:45:13 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1787668918
...
```diff
    contract ProxyAdmin (eth:0x123C1E324BC742295B4278B41C4E33831C77655C) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
Generated with discovered.json: 0x9b6e055a8e657c841a9ae5ed58863b408118da75

# Diff at Mon, 21 Sep 2026 11:23:56 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1787668918
- current timestamp: 1787668918
...
```diff
    contract RollupEventInbox (eth:0x01c1Be00BA202332a1A9244D2C36f51B8C2aA84b) [orbitstack/RollupEventInbox] {
...
```diff
    contract Bridge (eth:0x69aB55146Bc52A0b31F74dBDc527b8B7e9c7C27c) [orbitstack/Bridge] {
...
```diff
    contract Inbox (eth:0x7b0159484f5cb4F3D4bb496A2eD7A01F409e70D1) [orbitstack/Inbox] {
...
```diff
    contract OneStepProofEntry (eth:0x922597A6c219d65A3b96e647644A0412056611b3) [orbitstack/OneStepProofEntry] {
...
```diff
    contract Outbox (eth:0xCA2AA2AA53C2225849Cc711FD472E4D2bFcD634b) [orbitstack/Outbox] {
...
```diff
    contract UpgradeExecutor (eth:0xD4972734Ed659c03ca3e476e06Fc6f016397dfD4) [orbitstack/UpgradeExecutor] {
...
```diff
    contract GatewayRouter (eth:0xeA685ba6f0C3ec5e7891C17CfFBD009EbAdC9E49) [orbitstack/GatewayRouter] {
...
Generated with discovered.json: 0x42b29c48000171ee3e473d724991695ae52f76a0

# Diff at Fri, 18 Sep 2026 10:24:47 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1787668918
- current timestamp: 1787668918
...
```diff
    contract OneStepProverMemory (eth:0x188299D522A701bDDA1B4c1d6C5687B603D3DD50) [orbitstack/OneStepProverMemory] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      critical:
+        true
    }
...
```diff
    contract ChallengeManager (eth:0x19a6Ffc45dDe55D93c99114ddC3b277025e5fDf3) [orbitstack/ChallengeManager] {
...
```diff
    contract ERC20Gateway (eth:0x5625d2a46fc582b3e6dE5288D9C5690B20EBdb8D) [orbitstack/ERC20Gateway] {
...
```diff
    contract OneStepProverMath (eth:0x783A59456380EF449966aEe3bfb7d2e916d2770B) [orbitstack/OneStepProverMath] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      critical:
+        true
    }
...
```diff
    contract OneStepProverHostIo (eth:0x93F64468FF52Ba8b92ca574284E960EE8E4ecD76) [orbitstack/OneStepProverHostIo] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      critical:
+        true
    }
...
```diff
    contract OneStepProver0 (eth:0xF855e31B8C51097B0DFbf2147239CB7c471A8431) [orbitstack/OneStepProver0] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      critical:
+        true
    }
...
Generated with discovered.json: 0x4518c210fe3a18c7e73523370082f0dbc6f189c5
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1773160438
...
```diff
    EOA  (eth:0x58480e2A163BA83282A11231134263bc1D7a79e9) {
    +++ description: None
...
```diff
    EOA  (eth:0xB4cD58Be1C64AA42deA0C58f7482462EE250b88F) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
Generated with discovered.json: 0x86242553c97095a1e3684394186f9098885d41c6

# Diff at Fri, 22 May 2026 15:38:10 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1b7024bc804124af9b25421eca5fac952454cb09 block: 1773160438
- current timestamp: 1773160438
...
Generated with discovered.json: 0x5af3b7af85fa49b05669d9f319aeef016013e753

# Diff at Fri, 15 May 2026 12:35:38 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a5152b9ba7ad7f85f2af3d814f74630fcaa7c917 block: 1773160438
- current timestamp: 1773160438
...
Generated with discovered.json: 0x80f9601e898b84efe0fbbd09d0c29c4f8667341d

# Diff at Fri, 08 May 2026 07:51:02 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1773160438
- current timestamp: 1773160438
...
```diff
    contract AlienXMultisig (eth:0x32f6CAE58A89aA7c91D736Bb1100E377C570bb27) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ec4b16fd723bf2a8625a616c4b3a1119ce79fb29 block: 1746690827
- current timestamp: 1746690827
...
Generated with discovered.json: 0x5bf971eca3bbf87a28791ec3e6ac1ac8b3788d2f

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0x7a265982207a75094b90bb1750d84d1035ac94b7
