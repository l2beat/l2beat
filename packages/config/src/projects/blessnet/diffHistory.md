...
Increase stake requirement (for Arbitrum validators).
...
Increase stake requirement (for Arbitrum validators) by 50%.
...
Initial discovery of a standard Arbitrum Stack Optimium with 3/3 DAC and 3/3 fastconfirmer MS.
