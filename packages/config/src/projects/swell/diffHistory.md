Generated with discovered.json: 0x058105e05102596f00f6b281ffa8705d0765e56e

# Diff at Wed, 23 Sep 2026 05:49:59 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1786359739
...
```diff
    contract AddressManager (eth:0xa54a84f17c2180148c762D79bC57BdfF7FdAFC8A) [opstack/AddressManager] {
...
- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1786359739
- current timestamp: 1786359739
...
Generated with discovered.json: 0x05b9757a5ce81ec0f0991be5d546a1f1b567b5db
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5a5b552776f13efe49c744667945e52e0a8f9718 block: 1783324414
- current timestamp: 1784283289
...
Generated with discovered.json: 0x5999128d45ab2b68231a77abe29c1ceb53b0ad40

# Diff at Mon, 06 Jul 2026 07:54:58 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@4572e5b954c85d78517dc66fc4a82b8ddc679e2a block: 1781176909
- current timestamp: 1783324414
...
Generated with discovered.json: 0x111e8ebfa8f1807e5540213a99d5dc96c905626f

# Diff at Tue, 30 Jun 2026 20:24:47 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d6a4cf0104ece715f88d9597c7e158a2841e88fd block: 1781176909
- current timestamp: 1781176909
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1781176909 (main branch discovery), not current.
...
Generated with discovered.json: 0x663c6e68f4271708d1b640845105ca573c987edf

# Diff at Thu, 11 Jun 2026 11:23:23 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@91b2eba1ff9c1c8341d0eaf6594dac4179405ef6 block: 1780925482
- current timestamp: 1781176909
...
+        "eth:0x0c54D3c298c598b0cd5102529B75f51D4c00cf00"
    }
```

Generated with discovered.json: 0x04e88cef3acdd8e17a428de683a5676968190166

# Diff at Tue, 09 Jun 2026 12:43:39 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1780925482
- current timestamp: 1780925482
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1780925482 (main branch discovery), not current.
...
```diff
    EOA  (eth:0x37804a4f63Ab1dCf96A48B1DCE8c03492f539fE9) {
    +++ description: None
      receivedPermissions.0.description:
...
Generated with discovered.json: 0x69358a0cec293275cc47d95bf40f561f682d7dae

# Diff at Mon, 08 Jun 2026 13:32:33 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@7b249a098f7367cb0ead3d881bbc57b408521134 block: 1778850530
- current timestamp: 1780925482

## Description

SystemConfig `batcherHash` rotated.
...
Generated with discovered.json: 0xc5b9e014dafff28f055d52466ac902b88f754a21

# Diff at Thu, 04 Jun 2026 17:45:20 GMT:
...
Generated with discovered.json: 0x47abac07f74095b089834e09edc25054b87a5044

# Diff at Fri, 15 May 2026 13:11:10 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@da451cba8e944a28754be7e17bcb7555d857f312 block: 1777994295
- current timestamp: 1778850530
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1777994295 (main branch discovery), not current.
...
Generated with discovered.json: 0xba0ed0510a634f0d61cd8838f7f343ec0f2a899d

# Diff at Fri, 08 May 2026 07:52:27 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1777994295
- current timestamp: 1777994295
...
```diff
    contract Swell Multisig (eth:0x06F7fB1C74147e34Fce04a6828c7BF809B038d0E) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
```diff
    ...
    +++ description: None
      deployerAddress:
+        "eth:0xC951CEEcc2ae6fa2F51A9153Ee02a020C130e91d"
    }
```
...
```diff
    contract OptimismMintableERC20Factory (eth:0xc2b228cd433eBaE788DE287EDE2abE55B3F3F603) [opstack/OptimismMintableERC20Factory] {
...
+        "0x40e05a5687c31241ba914eeb7831d870e410c699c2cc59094759947e8d4148fa"
      deployerAddress:
+        "eth:0xaf994551f4f940224825F54F810ed5439651E5f9"
    }
```
...
Generated with discovered.json: 0xade5b854ec88bc456806d59900072a5958f2cede

# Diff at Tue, 05 May 2026 15:19:23 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c30884758a8f4ef4178d2eb572fb25911670bcff block: 1774433223
- current timestamp: 1777994295
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1774433223 (main branch discovery), not current.
...
```diff
    contract Swell Multisig (eth:0x06F7fB1C74147e34Fce04a6828c7BF809B038d0E) {
    +++ description: None
      deployerAddress:
-        "eth:0xa8AC7D03BEb92Fa3E6030AEB21629D00Ffb66dD7"
    }
...
```diff
    contract AddressManager (eth:0xa54a84f17c2180148c762D79bC57BdfF7FdAFC8A) {
    +++ description: Legacy contract used to manage a mapping of string names to addresses. Modern OP stack uses a different standard proxy system instead, but this contract is still necessary for backwards compatibility with several older contracts.
      deployerAddress:
-        "eth:0xC951CEEcc2ae6fa2F51A9153Ee02a020C130e91d"
    }
...
```diff
    contract L1ERC20TokenBridge (eth:0xecf3376512EDAcA4FBB63d2c67d12a0397d24121) {
    +++ description: Escrow for custom external tokens that use the canonical bridge for messaging but are governed externally.
      deployerAddress:
-        "eth:0xaf994551f4f940224825F54F810ed5439651E5f9"
    }
...
Generated with discovered.json: 0xaf161c3a32f4ca55b93da853ea5e421bfd044309

# Diff at Tue, 05 May 2026 10:23:12 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1774433223
- current timestamp: 1774433223
...
Generated with discovered.json: 0xab752ef7261e84943b5ca17be60cfa39d422a78f

# Diff at Wed, 25 Mar 2026 10:08:10 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@5f335de80b3c24849b3bcc1271bae84dc6e931f7 block: 1773160431
- current timestamp: 1774433223
...
Generated with discovered.json: 0xc1e9a300438b710aae8efd55bf8bbfaefa443ccc

# Diff at Fri, 27 Feb 2026 14:00:28 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@17ff9ba367ef55b34e16f082bde7902f4760911e block: 1770804703
- current timestamp: 1772198393
...
- current timestamp: 1769513833

## Description

SaferSafes module (LivenessModule + TimelockGuard combined) added to OpFoundationUpgradeSafe and OpFoundationOperationsSafe. This provides liveness checks where a fallback owner can challenge and take over if Safe owners are unresponsive, plus optional timelock delays for transaction scheduling.
...
```diff
.../src/projects/swell/.flat/SaferSafes.sol        | 3535 ++++++++++++++++++++
 1 file changed, 3535 insertions(+)
```

Generated with discovered.json: 0xaa71d171a1bb59181fdbc0e9694f2460e1cd2b69

# Diff at Thu, 18 Dec 2025 09:00:56 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6cd29a835d734750c830e20a8c0a6b2f1cef086b block: 1765551289
- current timestamp: 1766048362
...
.../GnosisSafe.sol => /dev/null                    |  959 -----------------
 ...
 .../swell/.flat/OpFoundationUpgradeSafe/Safe.sol   | 1088 ++++++++++++++++++++
 3 files changed, 1498 insertions(+), 1234 deletions(-)
```

Generated with discovered.json: 0xd7ce8523172ee8997603733f4bd8f29f3c6efcbf

# Diff at Fri, 12 Dec 2025 16:20:18 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d2235ef7f5c90cb4a3a617fea7d52a655dc22fa1 block: 1764324829
- current timestamp: 1765551289
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764324829 (main branch discovery), not current.
...
Generated with discovered.json: 0x1e9784fcfdabb1b411c58a0e61f63fc65c294031

# Diff at Fri, 28 Nov 2025 10:15:12 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@10f814ec1e4e08d34183a00c458ece2b8605dede block: 1761223245
- current timestamp: 1764324829
...
.../DisputeGameFactory/DisputeGameFactory.sol      |  47 +++++++---
 ...
 .../swell/{.flat@1761223245 => .flat}/MIPS.sol     |  33 ++-----
...
Generated with discovered.json: 0x3f08eef10746ea008da2c957bad470749562c147

# Diff at Tue, 04 Nov 2025 11:34:39 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1761223245
- current timestamp: 1761223245
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1761223245 (main branch discovery), not current.
...
Generated with discovered.json: 0x7df5496690c71526e74fa0e3b813126aeedf31d9

# Diff at Mon, 03 Nov 2025 17:53:53 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6b72018cd9706ce7cba8ec489b67d7193f34dc20 block: 1761223245
- current timestamp: 1761223245
...
```diff
    ...
    +++ description: None
      receivedPermissions:
+        [{"permission":"challenge","from":"eth:0x29C1b9aEec152503F417722Eca91Da7B170301A9","role":".challenger"}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
+        [{"permission":"propose","from":"eth:0x29C1b9aEec152503F417722Eca91Da7B170301A9","role":".proposer"}]
    }
```
