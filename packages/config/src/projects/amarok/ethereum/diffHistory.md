Generated with discovered.json: 0x5030da3fe2e7322b8bdb5582be8c91167997cacb

# Diff at Mon, 17 Mar 2025 16:30:00 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 21629064
...
-        [{"permission":"act","from":"0x4d50a469fc788a3c0CdC8Fd67868877dCb246625"}]
    }
```
...
```diff
    ...
    +++ description: None
      issuedPermissions.1:
-        {"permission":"upgrade","to":"0xCFbFaC74C26F8647cBDb8c5caf80BB5b32E43134","via":[{"address":"0xeD5cF41b0fD6A3C564c17eE34d9D26Eafc30619b"}]}
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"upgrade","from":"0x75bA5Af8EFFDCFca32E1e288806d54277D1fde99","via":[{"address":"0xeD5cF41b0fD6A3C564c17eE34d9D26Eafc30619b"}]},{"permission":"upgrade","from":"0xaBcC9b596420A9E9172FD5938620E265a0f9Df92","via":[{"address":"0xeD5cF41b0fD6A3C564c17eE34d9D26Eafc30619b"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xeD5cF41b0fD6A3C564c17eE34d9D26Eafc30619b"}]
    }
```
