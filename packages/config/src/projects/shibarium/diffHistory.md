Generated with discovered.json: 0x99de3ec29cf01f82e0e9e661d6d423bea2bce0c0
...
- comparing to: main@6a183e6009109d4e62087499f44eca4aceea9086 block: 1772615972
...
Generated with discovered.json: 0x238cc378a7ba937c4a5bd491a522792e10b4ae90

# Diff at Thu, 28 May 2026 13:09:28 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@66dc249f7108a6fbf8b6581aed0b7625deeebb2a block: 1772615972
- current timestamp: 1772615972
...
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1772615972
- current timestamp: 1772615972
...
```diff
    contract Merkle (eth:0x32262DDD01fFF9bb367586317A5e40Dbe2bCcbe2) {
    +++ description: None
      deployerAddress:
+        "eth:0x80Cc222EA02F4334F67e9E55E7412fed62599004"
    }
...
```diff
    contract ExitNFT (eth:0x7ad7f98f229c5C1EA5161bEd952c3007DBE1F307) {
    +++ description: NFTs used to represent a withdrawal in the withdrawal PriorityQueue (Only used for tokens initially deposited via DepositManager).
      deployerAddress:
+        "eth:0x80Cc222EA02F4334F67e9E55E7412fed62599004"
    }
...
```diff
    contract ERC721Predicate (eth:0x9df56e63CD340F0f3D811dd2aAAEEa42ec27D5a3) {
    +++ description: None
      deployerAddress:
+        "eth:0x80Cc222EA02F4334F67e9E55E7412fed62599004"
    }
...
```diff
    contract RLPReader (eth:0xc107664eeEEA2c84e51D56F1B7a479EbCf9541c4) {
    +++ description: None
      deployerAddress:
+        "eth:0x80Cc222EA02F4334F67e9E55E7412fed62599004"
    }
...
```diff
    contract ERC20Predicate (eth:0xdaF14950155DF895E9D0fd2521D05477d26F462c) {
    +++ description: None
      deployerAddress:
+        "eth:0x80Cc222EA02F4334F67e9E55E7412fed62599004"
    }
