Generated with discovered.json: 0xbd118a92e34b5c918843f4e6f7f0dec7ddc11873

# Diff at Mon, 17 Mar 2025 16:48:09 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 25215421
...
+        "Conduit Multisig 3"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x88dBaaeCDa265241a1BABe4A0ce69ad4957da8a2"},{"permission":"guard","from":"0xb765Df9d2925a82678F4B7bc60eF5294c1604514"},{"permission":"interact","from":"0x5416B7421c42B9218B29f688C47a46020c23cF0d","description":"set and change address mappings.","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]},{"permission":"interact","from":"0xa096dD38362bd2cE3C696474329989960722A7Fd","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."},{"permission":"upgrade","from":"0x88dBaaeCDa265241a1BABe4A0ce69ad4957da8a2","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]},{"permission":"upgrade","from":"0xa096dD38362bd2cE3C696474329989960722A7Fd","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]},{"permission":"upgrade","from":"0xb765Df9d2925a82678F4B7bc60eF5294c1604514","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]},{"permission":"upgrade","from":"0xBbea8Cc549702F67cc082d2cAA9842Ba3767536B","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x5416B7421c42B9218B29f688C47a46020c23cF0d","description":"set and change address mappings."},{"permission":"upgrade","from":"0x88dBaaeCDa265241a1BABe4A0ce69ad4957da8a2"},{"permission":"upgrade","from":"0xa096dD38362bd2cE3C696474329989960722A7Fd"},{"permission":"upgrade","from":"0xb765Df9d2925a82678F4B7bc60eF5294c1604514"},{"permission":"upgrade","from":"0xBbea8Cc549702F67cc082d2cAA9842Ba3767536B","description":"upgrading the bridge implementation can give access to all funds escrowed therein."}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x88dBaaeCDa265241a1BABe4A0ce69ad4957da8a2"},{"permission":"upgrade","from":"0xa096dD38362bd2cE3C696474329989960722A7Fd"},{"permission":"upgrade","from":"0xb765Df9d2925a82678F4B7bc60eF5294c1604514"},{"permission":"upgrade","from":"0xBbea8Cc549702F67cc082d2cAA9842Ba3767536B"}]
    }
```
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"upgrade","to":"0x7dCe2FEE5e30EFf298cD3d9B92649f00EBDfc104","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]}
      issuedPermissions.1:
-        {"permission":"propose","to":"0xfB04981fa938f03b82B4Ca8F5B1FAAA1A547306B","via":[]}
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0xa096dD38362bd2cE3C696474329989960722A7Fd"}]
    }
```
...
-        {"permission":"upgrade","to":"0x7dCe2FEE5e30EFf298cD3d9B92649f00EBDfc104","via":[{"address":"0x85519ecD4E4c59E62B68dB2082dB1F5c75da1E15"}]}
      issuedPermissions.1:
-        {"permission":"sequence","to":"0x9C5657Fd52b200b3fE7652ADF20659ec071DD8b0","via":[]}
      issuedPermissions.0.permission:
-        "interact"
+        "upgrade"
      issuedPermissions.0.to:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"propose","from":"0x88dBaaeCDa265241a1BABe4A0ce69ad4957da8a2"}]
    }
```
