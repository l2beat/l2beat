  ...
  zkCatalogInfo: {
    ...
    verifierHashes: [
      ...
      // },
      {
        ...
        1. Tweak the OS to accept high amount of memory
        ...
        1. Install node, npm, python deps
        ...
        1. Prepare fast build constant tree tool and fflonk setup
        ...
        1. Prepare and launch setup (zkevm-proverjs). This step is quite long, it takes approximately 4.5 hours.
