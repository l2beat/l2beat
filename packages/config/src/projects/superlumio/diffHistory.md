Generated with discovered.json: 0x6a7d6464d657fc14e0bc79e349b6c07cd6d7d4b7

# Diff at Wed, 23 Sep 2026 05:49:54 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1784563664
...
```diff
    contract L1CrossDomainMessenger (eth:0x6c10d7e5750b21729Eb863Cf89E5b48850E6d97D) [opstack/L1CrossDomainMessenger] {
...
```diff
    contract OptimismPortal2 (eth:0x9C93982cb4861311179aE216d1B7fD61232DE1f0) [opstack/OptimismPortal2] {
...
```diff
    contract AddressManager (eth:0x9cF613c19371eFf26c94c0d4F62197d2C0ab60bc) [opstack/AddressManager] {
...
```diff
    contract ProxyAdmin (eth:0xA6b2b6B6E621482aF877F304D46B94123a942Ae9) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
```diff
    contract L1StandardBridge (eth:0xdB5C6b73CB1c5875995a42D64C250BF8BC69a8bc) [opstack/L1StandardBridge] {
...
```diff
    contract DisputeGameFactory (eth:0xEe136B6087070d35D98b1bb1B33C3a00D907F0c1) [opstack/DisputeGameFactory] {
...
```diff
    contract DelayedWETH (eth:0xf8f9625a95b8fCbED76d1De537B71035997E44c8) [opstack/DelayedWETH] {
...
```diff
    contract SystemConfig (eth:0xFb252d6199AEfeE6938a1c57213AAd96ecD2650c) [opstack/SystemConfig] {
...
Generated with discovered.json: 0x209b4b1155d88547be84226428ccff78ea4eacf0

# Diff at Mon, 21 Sep 2026 11:24:07 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1784563664
- current timestamp: 1784563664
...
Generated with discovered.json: 0x3ffc67841e01bec8632c09427a4efeb32ed53a0a

# Diff at Fri, 18 Sep 2026 10:24:56 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1784563664
- current timestamp: 1784563664
...
```diff
    contract AnchorStateRegistry (eth:0x0225304877a2C700f8f03BC50344467FCf8271BF) [opstack/AnchorStateRegistry] {
...
```diff
    contract PermissionedDisputeGame (eth:0x542102Bb35C32ADa5D72cB791295d97574A71C84) [opstack/PermissionedDisputeGame] {
...
Generated with discovered.json: 0xd6776ea608cc919b7c273cb68d4e1ac552b7dc60

# Diff at Mon, 20 Jul 2026 16:09:04 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@ab4290b6bc5b6a34b8b091245cd07a7a94441102 block: 1770983165
- current timestamp: 1784563664

## Description

Conduit Multisig 1 (shared with polynomial, superlumio, snaxchain and other Conduit chains) rotated: 1 signer added, 4 removed, threshold 4/13 → 4/10. Separately, shared Conduit SuperchainConfig upgraded 2.4.0 → 2.4.2 ([diff](https://disco.l2beat.com/diff/eth:0xb08Cc720F511062537ca78BdB0AE691F04F5a957/eth:0xE4F9779ab53070a55db24dFAeFf9AF147c6ED550)), no behavioral change.
...
+        "0xa9d49d43c1f2cd8b840b38486dff4d5c39da96d00bb42dbc0a57bb7bb2a56d0f"
      deployerAddress:
+        "eth:0xd0087AE44a28f1eAb9F373fB206BFb6a1Cd31db9"
    }
```

```diff
    contract L1ERC721Bridge (eth:0x9bF59F099d4306B52C7624c90B6d5FD75ab8513b) [opstack/L1ERC721Bridge] {
...
+        "0x37437c2cd98d19d2cd859e63299380c94775e0e033c1b9805e043d80578af63b"
      usedTypes.0.arg.621:
+        "AggregateVerifier"
      usedTypes.0.arg.8:
+        "FaultDisputeGame"
...
```diff
    contract OptimismMintableERC20Factory (eth:0xccc6Fc5B866D34a7A4C40455a3cCfaa0cbFc145B) [opstack/OptimismMintableERC20Factory] {
...
+        "0x862931773e9b89dbdc42cb3023b5cc111c8eb2556d1e4e9de359405b3a621f55"
      deployerAddress:
+        "eth:0xd0087AE44a28f1eAb9F373fB206BFb6a1Cd31db9"
    }
```
...
Generated with discovered.json: 0xeaa241c0b125ac8a2f9057176861d0b2329c6c11

# Diff at Fri, 13 Feb 2026 11:47:09 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@55ab80636f1e0c000e757a7a146f11035a19e9c0 block: 1768984472
- current timestamp: 1770983165

## Description

Conduit Multisig 1: new member added, threshold now 4 of 13 (31%).

DisputeGameFactory: template updated with new fields for gameArgs decoding (config-related, no on-chain changes).
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1768984472 (main branch discovery), not current.
...
Generated with discovered.json: 0x612941480ff75bda94ea502bcadf4ac828800fe3

# Diff at Wed, 21 Jan 2026 08:35:36 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@a72aa7d50f1dddc0c7a6eae7f60679fc94e4eabf block: 1768222426
- current timestamp: 1768984472
...
Generated with discovered.json: 0x86517b697d1df805bfcd01a3b7aa7fa434b76cd6

# Diff at Mon, 12 Jan 2026 12:55:21 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@557c7b7c85b0fdc7328c16902e8eb6d003abcbf3 block: 1765551224
- current timestamp: 1768222426
...
Generated with discovered.json: 0xed3207efa2711c7b4372f2fe5575aa7778c52835

# Diff at Fri, 12 Dec 2025 16:20:14 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@d2235ef7f5c90cb4a3a617fea7d52a655dc22fa1 block: 1764933892
- current timestamp: 1765551224
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1764933892 (main branch discovery), not current.
...
Generated with discovered.json: 0xc4d795bf712ffd25c8f7c43e938c79a97c5e3ad2

# Diff at Fri, 05 Dec 2025 11:26:11 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@1edf3e71cea32596658a3ea017cea9df6408b77c block: 1759830334
- current timestamp: 1764933892
...
Generated with discovered.json: 0x475700ff41939b9aacbb2fd23103675ade2a42cb

# Diff at Tue, 04 Nov 2025 11:34:37 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1759830334
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1759830334 (main branch discovery), not current.

```diff
    contract PermissionedDisputeGame (eth:0x542102Bb35C32ADa5D72cB791295d97574A71C84) {
    +++ description: Same as FaultDisputeGame, but only two permissioned addresses are designated as proposer and challenger.
      sourceHashes.0:
...
Generated with discovered.json: 0x11c2eafbaf57084fd56f403fe6c7d13a82548f3c
