...
OPSuccinctL2OutputOracle rotated SP1 verification keys: `aggregationVkey` → `0x0022379400ea3157...`, `rangeVkeyCommitment` → `0x08666bcf03c2240b...`. Likely corresponds to [mantle-xyz/op-succinct@v2.2.0](https://github.com/mantle-xyz/op-succinct/tree/v2.2.0) (commit `5e70004dce9bb8fef765ee4d066f162360944c6f`); new program hash entries added as `notVerified` pending regeneration.
