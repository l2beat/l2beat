Generated with discovered.json: 0x6fbd3ed72085196488646e967b43fb4d7e21023a

# Diff at Wed, 23 Sep 2026 05:50:01 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1787669021
- current timestamp: 1787669021
...
discovery. Values are for block 1787669021 (main branch discovery), not current.

```diff
    contract ProxyAdmin (eth:0xe8606A55d105EF857F187C32Ae0E9a168aF8F497) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
Generated with discovered.json: 0x8eea47787ea416e473b58652abb9127df25a926d

# Diff at Mon, 21 Sep 2026 11:24:08 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1787669021
- current timestamp: 1787669021
...
```diff
    contract UpgradeExecutor (eth:0x44Ec40D86b4643Bd5110ED07BE188F8473Ad2d3a) [orbitstack/UpgradeExecutor] {
...
```diff
    contract GatewayRouter (eth:0x5F00446D785421d65B50c192D7129e3C3906438A) [orbitstack/GatewayRouter] {
...
```diff
    contract RollupEventInbox (eth:0x9f1045201f8b9D0b12f6d1e40e8B8e6c047A81E3) [orbitstack/RollupEventInbox] {
...
```diff
    contract Bridge (eth:0xa104C0426e95a5538e89131DbB4163d230C35f86) [orbitstack/Bridge] {
...
```diff
    contract Outbox (eth:0xB360b2f57c645E847148d7C479b7468AbF6F707d) [orbitstack/Outbox] {
...
```diff
    contract Inbox (eth:0xEa83E8907C89Bc0D9517632f0ba081972E328631) [orbitstack/Inbox] {
...
Generated with discovered.json: 0xbb3c578e8c07f3f66a69576855cbe8c852349984

# Diff at Fri, 18 Sep 2026 10:24:57 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1787669021
- current timestamp: 1787669021
...
```diff
    contract ChallengeManager (eth:0x73cfa0F6ae141212115657ad91Ad918E5d34d882) [orbitstack/ChallengeManager] {
...
```diff
    contract ERC20Gateway (eth:0xB4968C66BECc8fb4f73b50354301c1aDb2Abaa91) [orbitstack/ERC20Gateway] {
...
Generated with discovered.json: 0x31e95b824eaf69f1f706fadb00cebbcbf9e7a935

# Diff at Tue, 25 Aug 2026 14:44:45 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@bba6c9e66ca2dd99590b6f233fe8f6509dc767a0 block: 1779719759
- current timestamp: 1787669021
...
Generated with discovered.json: 0x9c46b3edd3625c80f58686995cb346ae5db7c601
...
- comparing to: main@a5152b9ba7ad7f85f2af3d814f74630fcaa7c917 block: 1773059569
...
Generated with discovered.json: 0xa5f6b218ae27f4bacf62bb0ba7e1f545d982ca99

# Diff at Fri, 08 May 2026 07:52:28 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1773059569
- current timestamp: 1773059569
...
```diff
    contract CalderaMultisig (eth:0xa4C325e25215C1fB2405EB28d81d2dFdbfC8D24C) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
Generated with discovered.json: 0xe5fc85b0f44acb5f8357d1c3882c62e37c08407e

# Diff at Tue, 05 May 2026 10:23:13 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@b6437082b3ea8fb0d97f4474b1c3452a1ce271b0 block: 1773059569
- current timestamp: 1773059569
...
```diff
    ...
    +++ description: Central contract for the project's configuration like its execution logic hash (`wasmModuleRoot`) and addresses of the other system contracts. Entry point for Proposers creating new Rollup Nodes (state commitments) and Challengers submitting fraud proofs (In the Orbit stack, these two roles are both held by the Validators).
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
```
...
```diff
    contract GatewayRouter (eth:0x5F00446D785421d65B50c192D7129e3C3906438A) {
    +++ description: This routing contract maps tokens to the correct escrow (gateway) to be then bridged with canonical messaging.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    contract ChallengeManager (eth:0x73cfa0F6ae141212115657ad91Ad918E5d34d882) {
    +++ description: Contract that allows challenging state roots. Can be called through the RollupProxy by Validators or the UpgradeExecutor.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    contract RollupEventInbox (eth:0x9f1045201f8b9D0b12f6d1e40e8B8e6c047A81E3) {
    +++ description: Helper contract sending configuration data over the bridge during the systems initialization.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    contract Bridge (eth:0xa104C0426e95a5538e89131DbB4163d230C35f86) {
    +++ description: Escrow contract for the project's gas token (can be different from ETH). Keeps a list of allowed Inboxes and Outboxes for canonical bridge messaging.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    ...
    +++ description: None
      deployerAddress:
+        "eth:0x615682E7ae61a1458B2507Da1CD3BAC3eED7B7dF"
    }
```

```diff
    contract Outbox (eth:0xB360b2f57c645E847148d7C479b7468AbF6F707d) {
    +++ description: Facilitates L2 to L1 contract calls: Messages initiated from L2 (for example withdrawal messages) eventually resolve in execution on L1.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    contract ERC20Gateway (eth:0xB4968C66BECc8fb4f73b50354301c1aDb2Abaa91) {
    +++ description: Escrows deposited ERC-20 assets for the canonical Bridge. Upon depositing, a generic token representation will be minted at the destination. Withdrawals are initiated by the Outbox contract.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    contract ProxyAdmin (eth:0xe8606A55d105EF857F187C32Ae0E9a168aF8F497) {
    +++ description: None
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
```diff
    contract Inbox (eth:0xEa83E8907C89Bc0D9517632f0ba081972E328631) {
    +++ description: Facilitates sending L1 to L2 messages like depositing ETH, but does not escrow funds.
      deployerAddress:
+        "eth:0xa9d1C9D877F235C21d803e4a0b81F8ca6C4c83AC"
    }
...
- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@279d1ad356551e0a039b2400b6ca3bfd5e1e0974 block: 1756118197
- current timestamp: 1764335299
