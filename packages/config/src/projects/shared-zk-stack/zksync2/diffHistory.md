Generated with discovered.json: 0x2cd242f352267e69e4e6bd4d5c92fade384dbd3c

# Diff at Mon, 17 Mar 2025 16:47:03 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@83c6f5a675a7a6512e7a8af5c777ef32d60dc946 block: 57469400
...
discovery. Values are for block 57469400 (main branch discovery), not current.
...
```diff
    ...
    +++ description: A token governance contract that allows token holders to create and vote on proposals. At least 21M tokens are necessary to start a proposal and a 630M quorum of voted tokens must be met to succeed. The accepted token is 0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E.
      receivedPermissions:
-        [{"permission":"interact","from":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","delay":259200}]},{"permission":"interact","from":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","description":"cancel queued transactions."},{"permission":"interact","from":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","description":"execute transactions that are ready."},{"permission":"interact","from":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","description":"propose transactions."}]
      directlyReceivedPermissions:
...
-        [{"permission":"interact","to":"0x76705327e682F2d96943280D99464Ab61219e34f","description":"cancel queued transactions.","via":[]},{"permission":"interact","to":"0x76705327e682F2d96943280D99464Ab61219e34f","description":"execute transactions that are ready.","via":[]},{"permission":"interact","to":"0x76705327e682F2d96943280D99464Ab61219e34f","description":"manage all access control roles and change the minimum delay.","via":[{"address":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8"}]},{"permission":"interact","to":"0x76705327e682F2d96943280D99464Ab61219e34f","description":"propose transactions.","via":[]}]
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8","description":"manage all access control roles and change the minimum delay."}]
    }
```
...
-        [{"permission":"interact","to":"0x10560f8B7eE37571AD7E3702EEb12Bc422036E89","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","delay":259200}]},{"permission":"interact","to":"0x10560f8B7eE37571AD7E3702EEb12Bc422036E89","description":"cancel queued transactions.","via":[]},{"permission":"interact","to":"0x10560f8B7eE37571AD7E3702EEb12Bc422036E89","description":"execute transactions that are ready.","via":[]},{"permission":"interact","to":"0x10560f8B7eE37571AD7E3702EEb12Bc422036E89","description":"propose transactions.","via":[]}]
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x3E21c654B545Bf6236DC08236169DcF13dA4dDd6","delay":259200,"description":"manage all access control roles and change the minimum delay."}]
    }
```
...
```diff
    ...
    +++ description: A token governance contract that allows token holders to create and vote on proposals. At least 21M tokens are necessary to start a proposal and a 630M quorum of voted tokens must be met to succeed. The accepted token is 0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E.
      receivedPermissions:
-        [{"permission":"interact","from":"0xC3e970cB015B5FC36edDf293D2370ef5D00F7a19","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0xC3e970cB015B5FC36edDf293D2370ef5D00F7a19","delay":259200}]},{"permission":"interact","from":"0xC3e970cB015B5FC36edDf293D2370ef5D00F7a19","description":"cancel queued transactions."},{"permission":"interact","from":"0xC3e970cB015B5FC36edDf293D2370ef5D00F7a19","description":"execute transactions that are ready."},{"permission":"interact","from":"0xC3e970cB015B5FC36edDf293D2370ef5D00F7a19","description":"propose transactions."}]
      directlyReceivedPermissions:
...
```diff
    ...
    +++ description: The ZK token contract on ZKsync Era. Mintable through access control roles. Used for voting in the ZK stack governance system.
      issuedPermissions.2:
-        {"permission":"interact","to":"0xb83FF6501214ddF40C91C9565d095400f3F45746","description":"grant the MINTER_ROLE to arbitrary addresses, thus controlling the minting of the ZK token.","via":[{"address":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200}]}
      issuedPermissions.1:
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0xb83FF6501214ddF40C91C9565d095400f3F45746","description":"cancel proposals while they are pending (after having been proposed) or active (during the voting period)."},{"permission":"interact","from":"0xEEEa739a8b6fB1b8f703E23C9Be03CeeA643b160","description":"cancel proposals while they are pending (after having been proposed) or active (during the voting period)."}]
    }
```
...
```diff
    ...
    +++ description: Main Governance contract allowing for token voting (simple majority) with the ZK token through delegates. This contract is used for protocol upgrade proposals (ZIPs) that start on ZKsync Era, go through Ethereum Layer 1 and can - from there - target all L1 and L2 contracts. At least 21M ZK tokens are necessary to start a proposal and a 630M quorum of voted tokens must be met to succeed.
      receivedPermissions:
-        [{"permission":"interact","from":"0x085b8B6407f150D62adB1EF926F7f304600ec714","description":"cancel queued transactions."},{"permission":"interact","from":"0x085b8B6407f150D62adB1EF926F7f304600ec714","description":"execute transactions that are ready."},{"permission":"interact","from":"0x085b8B6407f150D62adB1EF926F7f304600ec714","description":"manage all access control roles and change the minimum delay.","via":[{"address":"0x085b8B6407f150D62adB1EF926F7f304600ec714"}]},{"permission":"interact","from":"0x085b8B6407f150D62adB1EF926F7f304600ec714","description":"propose transactions."},{"permission":"interact","from":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8","description":"cancel queued transactions."},{"permission":"interact","from":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8","description":"execute transactions that are ready."},{"permission":"interact","from":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8","description":"manage all access control roles and change the minimum delay.","via":[{"address":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8"}]},{"permission":"interact","from":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8","description":"propose transactions."}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x085b8B6407f150D62adB1EF926F7f304600ec714"},{"permission":"act","from":"0x3701fB675bCd4A85eb11A2467628BBe193F6e6A8"}]
    }
```
...
-        [{"permission":"upgrade","from":"0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E","via":[{"address":"0xdB1E46B448e68a5E35CB693a99D59f784aD115CC"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xdB1E46B448e68a5E35CB693a99D59f784aD115CC"}]
    }
```
...
-        [{"permission":"interact","to":"0x711ea620AB29f41AbC6596a15981e14ce58C97c9","description":"cancel proposals while they are pending (after having been proposed) or active (during the voting period).","via":[]},{"permission":"interact","to":"0xcd2753Bd3829dfeC575AFC3816d4899CD103C62D","description":"make direct proposals without owning ZK tokens. In propose-guarded mode, this address is the ONLY allowed proposer. Propose-guarded mode is currently set to false.","via":[]}]
      receivedPermissions:
-        [{"permission":"interact","from":"0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E","description":"grant the MINTER_ROLE to arbitrary addresses, thus controlling the minting of the ZK token.","via":[{"address":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200}]},{"permission":"interact","from":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200}]},{"permission":"interact","from":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","description":"cancel queued transactions."},{"permission":"interact","from":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","description":"execute transactions that are ready."},{"permission":"interact","from":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","description":"propose transactions."}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200}]
    }
```
...
-        [{"permission":"interact","to":"0xEEEa739a8b6fB1b8f703E23C9Be03CeeA643b160","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0xC9E442574958f96C026DeF9a50C3236cab17428a","delay":259200}]},{"permission":"interact","to":"0xEEEa739a8b6fB1b8f703E23C9Be03CeeA643b160","description":"cancel queued transactions.","via":[]},{"permission":"interact","to":"0xEEEa739a8b6fB1b8f703E23C9Be03CeeA643b160","description":"execute transactions that are ready.","via":[]},{"permission":"interact","to":"0xEEEa739a8b6fB1b8f703E23C9Be03CeeA643b160","description":"propose transactions.","via":[]}]
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0xC9E442574958f96C026DeF9a50C3236cab17428a","delay":259200,"description":"manage all access control roles and change the minimum delay."}]
    }
```
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"upgrade","from":"0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E"}]
    }
```
...
-        [{"permission":"interact","to":"0xb83FF6501214ddF40C91C9565d095400f3F45746","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200}]},{"permission":"interact","to":"0xb83FF6501214ddF40C91C9565d095400f3F45746","description":"cancel queued transactions.","via":[]},{"permission":"interact","to":"0xb83FF6501214ddF40C91C9565d095400f3F45746","description":"execute transactions that are ready.","via":[]},{"permission":"interact","to":"0xb83FF6501214ddF40C91C9565d095400f3F45746","description":"propose transactions.","via":[]}]
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E","description":"grant the MINTER_ROLE to arbitrary addresses, thus controlling the minting of the ZK token."},{"permission":"interact","from":"0xe5d21A9179CA2E1F0F327d598D464CcF60d89c3d","delay":259200,"description":"manage all access control roles and change the minimum delay."}]
    }
```
...
-        [{"permission":"interact","to":"0x711ea620AB29f41AbC6596a15981e14ce58C97c9","description":"cancel proposals while they are pending (after having been proposed) or active (during the voting period).","via":[]}]
      receivedPermissions:
-        [{"permission":"interact","from":"0xC9E442574958f96C026DeF9a50C3236cab17428a","delay":259200,"description":"manage all access control roles and change the minimum delay.","via":[{"address":"0xC9E442574958f96C026DeF9a50C3236cab17428a","delay":259200}]},{"permission":"interact","from":"0xC9E442574958f96C026DeF9a50C3236cab17428a","description":"cancel queued transactions."},{"permission":"interact","from":"0xC9E442574958f96C026DeF9a50C3236cab17428a","description":"execute transactions that are ready."},{"permission":"interact","from":"0xC9E442574958f96C026DeF9a50C3236cab17428a","description":"propose transactions."}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0xC9E442574958f96C026DeF9a50C3236cab17428a","delay":259200}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E","description":"control all roles in the ZkToken access control, including the minter roles."}]
    }
```
