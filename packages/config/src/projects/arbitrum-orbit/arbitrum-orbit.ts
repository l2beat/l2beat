...
export const arbitrumOrbit: BaseProject = {
  ...
  display: {
    description: 'The Arbitrum Stack is a network of Arbitrum chains.',
    links: {
  ...
  milestones: [
    {
      ...
      description:
        'Arbitrum Foundation announces the launch of the Arbitrum Stack.',
      type: 'general',
    },
    {
  ...
  ecosystemConfig: {
    ...
    token: {
      ...
      description:
        'ARB is the governance token for the Arbitrum ecosystem. It is used for voting on protocol upgrades, treasury allocations, and other governance decisions across the network of Arbitrum chains.',
    },
  },
}
