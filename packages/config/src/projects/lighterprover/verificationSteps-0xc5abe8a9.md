The verification process below is based on the `build_circuits.sh` [script](https://github.com/elliottech/lighter-prover/blob/642cca8e1d4853cdcbb21eed4f15c04bbd154ce4/build_circuits.sh) in the lighter-prover repo. It consumed around 100 GiB of memory at the peak, so we recommend rerunning it on a machine with 128 GiB of RAM.
...
cd lighter-prover
git checkout 642cca8e1d4853cdcbb21eed4f15c04bbd154ce4
