Generated with discovered.json: 0x2eea0bdb4556b8eddcbc6954f27bd1055a99780b

# Diff at Wed, 23 Sep 2026 05:47:31 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1734957965
...
Generated with discovered.json: 0xe24568d144be1c16e5d019cf267852de4b49a1e4

# Diff at Mon, 21 Sep 2026 11:24:02 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1734957965
- current timestamp: 1734957965
...
```diff
    contract Outbox (arb1:0x1526DAacDAf3EE81E5ae087E0DA8677E8c677CE5) [orbitstack/Outbox] {
    +++ description: Facilitates L2 to L1 contract calls: Messages initiated from L2 (for example withdrawal messages) eventually resolve in execution on L1.
      deployerAddress:
+        "arb1:0x5e31608B400F45846043E93747D72A1a02c5a2f5"
      fieldMeta:
...
```diff
    contract ChallengeManager (arb1:0x211C9893653Aea2088E34765e7039617E95fD8fD) [orbitstack/ChallengeManager] {
    +++ description: Contract that allows challenging state roots. Can be called through the RollupProxy by Validators or the UpgradeExecutor.
      sourceHashes.1:
-        "0x58a6261c83c2766f749641902ad6fdb695ea189d2747f073b57a8f35b9a547e5"
+        "0x72ed0e123083a10eef0939ecb6899f4fbda72b467caa37db25448ce083def16d"
      deployerAddress:
+        "arb1:0x5e31608B400F45846043E93747D72A1a02c5a2f5"
    }
```
...
```diff
    contract ERC20Gateway (arb1:0x4fF3E70f30f0394Ad62428751Fe3858740595908) [orbitstack/ERC20Gateway] {
...
```diff
    contract OneStepProverMemory (arb1:0x526a6E634aD36bB0007c4422586c135F1F9B525a) [orbitstack/OneStepProverMemory] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
-        "0x731b4466319a83c95ce227d1a6c85aa03864f5d2bed03bda186843033a8b8d61"
+        "0x13ab817e67a0680a82db07e445e215447f8dd5e73fe768fd279d90db12ba3fb0"
      deployerAddress:
...
```diff
    contract Bridge (arb1:0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44) [orbitstack/Bridge] {
    +++ description: Escrow contract for the project's gas token (can be different from ETH). Keeps a list of allowed Inboxes and Outboxes for canonical bridge messaging.
      sourceHashes.1:
-        "0xb920455f1e366c7a89719abdd8d8174e4e7d353f2d4b7dea11b0571bf9526eae"
+        "0xee14083a0b352490f5722c13dd14921389ef859f1789815b19964e628a4d1bad"
...
```diff
    contract OneStepProver0 (arb1:0x800dA62bE6626127F71B34E795286C34C04D6712) [orbitstack/OneStepProver0] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
-        "0x20330713abbbcf0219ef7d1c0aa3a6ede1b421f14c9d21b25c973e54fb75f5df"
+        "0x40fa649159c7f695ddbdf6201ca7c6b1d8bb8b3b294e5cfac30cd8551ec996eb"
      deployerAddress:
+        "arb1:0x7A9D9dAdDd745897c06e8664E1DC2702B6E6f341"
    }
```
...
```diff
    contract Inbox (arb1:0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F) [orbitstack/Inbox] {
    +++ description: Facilitates sending L1 to L2 messages like depositing ETH, but does not escrow funds.
      sourceHashes.1:
-        "0x99872d99b7163c705118e0a168f99728c3c7089581779077707271cdaad30be3"
+        "0xb43394330c77456a88b2e4a30aa59f48ece4d33f987fa757b82a10827b3e2cb3"
      deployerAddress:
+        "arb1:0x5e31608B400F45846043E93747D72A1a02c5a2f5"
      fieldMeta:
...
```diff
    contract GatewayRouter (arb1:0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf) [orbitstack/GatewayRouter] {
...
```diff
    contract OneStepProofEntry (arb1:0xb20107bfB36D3B5AcA534aCAfbd8857b10b402a8) [orbitstack/OneStepProofEntry] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
-        "0xf3479c667d20b1c17ea2573dc7fe09e4315a3e20bc09d31bc92603520cc962cc"
+        "0x017970e6e1d77ee334ff45848114ade0209d7c4960e3585b73d52e90f3deaa89"
      deployerAddress:
+        "arb1:0x7A9D9dAdDd745897c06e8664E1DC2702B6E6f341"
      fieldMeta:
...
```diff
    contract RollupProxy (arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e) [orbitstack/RollupProxy] {
...
+        "0x51ce6bf680f5b36c0120cbff0d73a95937c6e02256074f12257dead0f042b230"
...
+        "0x2cc916f2eb90ce56fac766b51bcd6c7d00c3206dd36ced242c4941113e999a54"
...
```diff
    contract RollupEventInbox (arb1:0xc40e1DdDDc4837e63Bfb21EF34d3Ca4A6c78fD15) [orbitstack/RollupEventInbox] {
...
```diff
    contract OneStepProverHostIo (arb1:0xc555b2F1D559Fbb854569b33640990D178F94747) [orbitstack/OneStepProverHostIo] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
-        "0x5b0a5e16100b7e163dcf39dc6a9034f12a7bad7a475cdffc73054b937be0683d"
+        "0x894bb53dab85fcacd34782be5a3c2804a8203dc5cd9f44845e314e3dd8503774"
      deployerAddress:
+        "arb1:0x7A9D9dAdDd745897c06e8664E1DC2702B6E6f341"
    }
```
...
```diff
    contract OneStepProverMath (arb1:0xe8709022B9C9D7347856c75910fe07e10C904446) [orbitstack/OneStepProverMath] {
    +++ description: One of the modular contracts used for the last step of a fraud proof, which is simulated inside a WASM virtual machine.
      sourceHashes.0:
-        "0xb2555ede3dfe7d6df28bd96d12a0113b658c213c7ce4e34fa539df7497bc51a1"
+        "0x22d2c6cc08caa5b975100584550a01298f1a0c5f039957010c2c58d0a1fe7577"
      deployerAddress:
+        "arb1:0x7A9D9dAdDd745897c06e8664E1DC2702B6E6f341"
    }
```

Generated with discovered.json: 0xa334d858f25296bd5e019311bfcaf03289147916

# Diff at Fri, 18 Sep 2026 10:24:50 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1734957965
- current timestamp: 1734957965
...
Generated with discovered.json: 0x086fc525e7c2c98fefc59470f530703b647c5e11

# Diff at Fri, 12 Jun 2026 10:18:52 GMT:

- author: Luca Donno (<donnoh99@gmail.com>)
- comparing to: main@6a183e6009109d4e62087499f44eca4aceea9086 block: 1734957965
- current timestamp: 1734957965
...
```diff
    EOA  (arb1:0x5e31608B400F45846043E93747D72A1a02c5a2f5) {
    +++ description: None
...
Generated with discovered.json: 0xd73f1535de123916b3c11dc8ad0378e5742edc79

# Diff at Tue, 09 Jun 2026 12:43:35 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ae67a38d37457ad735e5d55080d2e5479d5df7dc block: 1734957965
- current timestamp: 1734957965
...
```diff
    EOA  (arb1:0xd987004738Ae33732ecf68613b1b7aFd1df7C11c) {
    +++ description: None
...
```diff
    EOA  (arb1:0xfc48f0786b3fA7353F63Acc40973857554A51cA2) {
    +++ description: None
      receivedPermissions.0.permission:
-        "validate"
+        "interact"
...
Generated with discovered.json: 0xa54723325efc69a5d031263783f0a7cd18e080e3

# Diff at Mon, 05 Jan 2026 17:44:31 GMT:

- author: vincfurc (<vincfurc@users.noreply.github.com>)
- comparing to: main@c679543996c33dd4145a38ea0d7fccd3b24d8951 block: 1734957965
- current timestamp: 1734957965
...
```diff
    contract RollupProxy (arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e) {
    +++ description: Central contract for the project's configuration like its execution logic hash (`wasmModuleRoot`) and addresses of the other system contracts. Entry point for Proposers creating new Rollup Nodes (state commitments) and Challengers submitting fraud proofs (In the Orbit stack, these two roles are both held by the Validators).
...
Generated with discovered.json: 0x4b7848d6f93984f00f46d4db705f68e3fa397952

# Diff at Fri, 26 Sep 2025 12:50:04 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@ec4b16fd723bf2a8625a616c4b3a1119ce79fb29 block: 1734957965
- current timestamp: 1734957965
...
Generated with discovered.json: 0xce876fb317644986d6054ec5859511aa4eea5e10

# Diff at Mon, 01 Sep 2025 10:01:10 GMT:

Merge mark

Generated with discovered.json: 0xe37bebaf4246d0f238fcaa289b7d97d9e1ec4fbe

# Diff at Mon, 14 Jul 2025 12:44:18 GMT:

- chain: arbitrum
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9f4300dad2f3d080cd56fa311d4a848556c74e72 block: 287771362
...
+        "arb1:0x1526DAacDAf3EE81E5ae087E0DA8677E8c677CE5"
      values.$admin:
...
+        "arb1:0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44"
      values.l2ToL1Sender:
-        "0x0000000000000000000000000000000000000000"
+        "arb1:0x0000000000000000000000000000000000000000"
      values.rollup:
-        "0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
+        "arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
      implementationNames.0x1526DAacDAf3EE81E5ae087E0DA8677E8c677CE5:
-        "TransparentUpgradeableProxy"
      implementationNames.0x13BE515E44Eefaf3eBEFAD684F1FBB574Ac0A494:
-        "Outbox"
      implementationNames.arb1:0x1526DAacDAf3EE81E5ae087E0DA8677E8c677CE5:
+        "TransparentUpgradeableProxy"
...
+        "arb1:0x211C9893653Aea2088E34765e7039617E95fD8fD"
      values.$admin:
-        "0x29994207C5AeDc83F27c5dc16E468f328832d42d"
+        "arb1:0x29994207C5AeDc83F27c5dc16E468f328832d42d"
      values.$implementation:
...
+        "arb1:0xb20107bfB36D3B5AcA534aCAfbd8857b10b402a8"
      values.resultReceiver:
-        "0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
+        "arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
      values.sequencerInbox:
-        "0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
+        "arb1:0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
      implementationNames.0x211C9893653Aea2088E34765e7039617E95fD8fD:
-        "TransparentUpgradeableProxy"
      implementationNames.0x5cA988F213EfbCB86ED7e2AACB0C15c91e648f8d:
-        "ChallengeManager"
      implementationNames.arb1:0x211C9893653Aea2088E34765e7039617E95fD8fD:
+        "TransparentUpgradeableProxy"
      implementationNames.arb1:0x5cA988F213EfbCB86ED7e2AACB0C15c91e648f8d:
+        "ChallengeManager"
    }
```
...
+        "arb1:0x4D0D8724ff2303A1679689a9Cc8e2A62f821e0E3"
      implementationNames.0x29994207C5AeDc83F27c5dc16E468f328832d42d:
-        "ProxyAdmin"
      implementationNames.arb1:0x29994207C5AeDc83F27c5dc16E468f328832d42d:
+        "ProxyAdmin"
    }
```

```diff
    EOA  (0x460E0a28a1DcE5a15811C3F5775D1e8fd0a08278) {
    +++ description: None
      address:
-        "0x460E0a28a1DcE5a15811C3F5775D1e8fd0a08278"
+        "arb1:0x460E0a28a1DcE5a15811C3F5775D1e8fd0a08278"
    }
```
...
-        "0x5e31608B400F45846043E93747D72A1a02c5a2f5"
+        "arb1:0x5e31608B400F45846043E93747D72A1a02c5a2f5"
      implementationNames.0x4D0D8724ff2303A1679689a9Cc8e2A62f821e0E3:
-        "TransparentUpgradeableProxy"
      implementationNames.0x660ea1675F7323dC3Ba0c8dDFB593225Eb01E3C1:
-        "UpgradeExecutor"
      implementationNames.arb1:0x4D0D8724ff2303A1679689a9Cc8e2A62f821e0E3:
+        "TransparentUpgradeableProxy"
...
-        "0x76df9F5004F38aC74D0cE664027a1E718AA45E97"
+        "arb1:0x76df9F5004F38aC74D0cE664027a1E718AA45E97"
      values.inbox:
-        "0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F"
+        "arb1:0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F"
      values.l2BeaconProxyFactory:
-        "0xcEF5F518d69F0DAf71b8Daa27B570FC48eE51bC8"
+        "arb1:0xcEF5F518d69F0DAf71b8Daa27B570FC48eE51bC8"
      values.router:
-        "0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf"
+        "arb1:0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf"
      values.whitelist:
-        "0x0000000000000000000000000000000000000000"
+        "arb1:0x0000000000000000000000000000000000000000"
      implementationNames.0x4fF3E70f30f0394Ad62428751Fe3858740595908:
-        "TransparentUpgradeableProxy"
      implementationNames.0x1d720642e63cB0f50be637e16E0f78B2D1b93f16:
-        "L1ERC20Gateway"
      implementationNames.arb1:0x4fF3E70f30f0394Ad62428751Fe3858740595908:
+        "TransparentUpgradeableProxy"
...
+        "arb1:0x526a6E634aD36bB0007c4422586c135F1F9B525a"
      implementationNames.0x526a6E634aD36bB0007c4422586c135F1F9B525a:
-        "OneStepProverMemory"
      implementationNames.arb1:0x526a6E634aD36bB0007c4422586c135F1F9B525a:
+        "OneStepProverMemory"
    }
```
...
+        "arb1:0xc40e1DdDDc4837e63Bfb21EF34d3Ca4A6c78fD15"
...
-        "0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
+        "arb1:0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
      implementationNames.0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44:
-        "TransparentUpgradeableProxy"
      implementationNames.0xB23214f241bdEb275f7dCBfbb1EA79349101d4B0:
-        "Bridge"
      implementationNames.arb1:0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44:
+        "TransparentUpgradeableProxy"
...
```diff
    EOA  (0x76df9F5004F38aC74D0cE664027a1E718AA45E97) {
    +++ description: None
      address:
-        "0x76df9F5004F38aC74D0cE664027a1E718AA45E97"
+        "arb1:0x76df9F5004F38aC74D0cE664027a1E718AA45E97"
...
+        "arb1:0x800dA62bE6626127F71B34E795286C34C04D6712"
      implementationNames.0x800dA62bE6626127F71B34E795286C34C04D6712:
-        "OneStepProver0"
      implementationNames.arb1:0x800dA62bE6626127F71B34E795286C34C04D6712:
+        "OneStepProver0"
    }
```
...
-        "0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
+        "arb1:0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
      implementationNames.0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F:
-        "TransparentUpgradeableProxy"
      implementationNames.0x8f6406781cC955398C45a48DcEfeEBDb2c8e2CaA:
-        "Inbox"
      implementationNames.arb1:0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F:
+        "TransparentUpgradeableProxy"
      implementationNames.arb1:0x8f6406781cC955398C45a48DcEfeEBDb2c8e2CaA:
+        "Inbox"
    }
```
...
-        "0x0000000000000000000000000000000000000000"
+        "arb1:0x0000000000000000000000000000000000000000"
      implementationNames.0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf:
-        "TransparentUpgradeableProxy"
      implementationNames.0x9c84a387930853D963892D299153B0d5840dc1F5:
-        "L1GatewayRouter"
      implementationNames.arb1:0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf:
+        "TransparentUpgradeableProxy"
...
+        "arb1:0xc555b2F1D559Fbb854569b33640990D178F94747"
      values.proverMath:
-        "0xe8709022B9C9D7347856c75910fe07e10C904446"
+        "arb1:0xe8709022B9C9D7347856c75910fe07e10C904446"
      values.proverMem:
-        "0x526a6E634aD36bB0007c4422586c135F1F9B525a"
+        "arb1:0x526a6E634aD36bB0007c4422586c135F1F9B525a"
      implementationNames.0xb20107bfB36D3B5AcA534aCAfbd8857b10b402a8:
-        "OneStepProofEntry"
      implementationNames.arb1:0xb20107bfB36D3B5AcA534aCAfbd8857b10b402a8:
+        "OneStepProofEntry"
    }
```
...
+        "arb1:0xfc48f0786b3fA7353F63Acc40973857554A51cA2"
...
+        "arb1:0x2b0E04Dc90e3fA58165CB41E2834B44A56E766aF"
      implementationNames.0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e:
-        "RollupProxy"
...
-        "RollupUserLogic"
      implementationNames.arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e:
+        "RollupProxy"
      implementationNames.arb1:0xEe9E5546A11Cb5b4A86e92DA05f2ef75C26E4754:
+        "RollupAdminLogic"
      implementationNames.arb1:0x0aE4dD666748bF0F6dB5c149Eab1D8aD27820A6A:
+        "RollupUserLogic"
    }
```
...
+        "arb1:0xd987004738Ae33732ecf68613b1b7aFd1df7C11c"
      values.bridge:
-        "0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44"
+        "arb1:0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44"
      values.reader4844:
...
-        "0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
+        "arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
      implementationNames.0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653:
-        "TransparentUpgradeableProxy"
      implementationNames.0x18ed2d5bF7c5943bFd20a2995b9879E30c9E8dDa:
-        "SequencerInbox"
      implementationNames.arb1:0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653:
+        "TransparentUpgradeableProxy"
      implementationNames.arb1:0x18ed2d5bF7c5943bFd20a2995b9879E30c9E8dDa:
+        "SequencerInbox"
    }
```
...
-        "0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
+        "arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
      implementationNames.0xc40e1DdDDc4837e63Bfb21EF34d3Ca4A6c78fD15:
-        "TransparentUpgradeableProxy"
      implementationNames.0xF40C24bA346aA459ED28e196D4A46Cf17174bD6C:
-        "RollupEventInbox"
      implementationNames.arb1:0xc40e1DdDDc4837e63Bfb21EF34d3Ca4A6c78fD15:
+        "TransparentUpgradeableProxy"
...
-        "0xc555b2F1D559Fbb854569b33640990D178F94747"
+        "arb1:0xc555b2F1D559Fbb854569b33640990D178F94747"
      implementationNames.0xc555b2F1D559Fbb854569b33640990D178F94747:
-        "OneStepProverHostIo"
      implementationNames.arb1:0xc555b2F1D559Fbb854569b33640990D178F94747:
+        "OneStepProverHostIo"
    }
```

```diff
    EOA  (0xcEF5F518d69F0DAf71b8Daa27B570FC48eE51bC8) {
    +++ description: None
      address:
-        "0xcEF5F518d69F0DAf71b8Daa27B570FC48eE51bC8"
+        "arb1:0xcEF5F518d69F0DAf71b8Daa27B570FC48eE51bC8"
...
-        "0xe8709022B9C9D7347856c75910fe07e10C904446"
+        "arb1:0xe8709022B9C9D7347856c75910fe07e10C904446"
      implementationNames.0xe8709022B9C9D7347856c75910fe07e10C904446:
-        "OneStepProverMath"
      implementationNames.arb1:0xe8709022B9C9D7347856c75910fe07e10C904446:
+        "OneStepProverMath"
    }
```
...
Generated with discovered.json: 0xb80b2170b645b4d367e07e936c6568af1cdc1e3f

# Diff at Fri, 04 Jul 2025 12:19:06 GMT:

- chain: arbitrum
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@1f56dc47fe915564d4555300304da4d3bcbc087f block: 287771362
- current block number: 287771362
...
-        "arbitrum:0x1526DAacDAf3EE81E5ae087E0DA8677E8c677CE5"
+        "arb1:0x1526DAacDAf3EE81E5ae087E0DA8677E8c677CE5"
      directlyReceivedPermissions.1.from:
-        "arbitrum:0x211C9893653Aea2088E34765e7039617E95fD8fD"
+        "arb1:0x211C9893653Aea2088E34765e7039617E95fD8fD"
      directlyReceivedPermissions.2.from:
-        "arbitrum:0x4D0D8724ff2303A1679689a9Cc8e2A62f821e0E3"
+        "arb1:0x4D0D8724ff2303A1679689a9Cc8e2A62f821e0E3"
      directlyReceivedPermissions.3.from:
-        "arbitrum:0x4fF3E70f30f0394Ad62428751Fe3858740595908"
+        "arb1:0x4fF3E70f30f0394Ad62428751Fe3858740595908"
      directlyReceivedPermissions.4.from:
-        "arbitrum:0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44"
+        "arb1:0x59E088d827CB7983Cd0CC64312E472D7cc8a4F44"
      directlyReceivedPermissions.5.from:
-        "arbitrum:0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F"
+        "arb1:0x80de5c4ccDfb7b6a250A9588C2d80F62a2B7d13F"
      directlyReceivedPermissions.6.from:
-        "arbitrum:0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf"
+        "arb1:0x817C8Da480bC6b42a5FA88A26e9eD8c0c03968Cf"
      directlyReceivedPermissions.7.from:
-        "arbitrum:0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
+        "arb1:0xB9450b512Fd3454e9C1a2593C5DF9E71344b5653"
      directlyReceivedPermissions.8.from:
-        "arbitrum:0xc40e1DdDDc4837e63Bfb21EF34d3Ca4A6c78fD15"
+        "arb1:0xc40e1DdDDc4837e63Bfb21EF34d3Ca4A6c78fD15"
    }
```
...
```diff
    ...
    +++ description: Central contract defining the access control permissions for upgrading the system contract implementations.
      directlyReceivedPermissions.0.from:
-        "arbitrum:0x29994207C5AeDc83F27c5dc16E468f328832d42d"
+        "arb1:0x29994207C5AeDc83F27c5dc16E468f328832d42d"
      directlyReceivedPermissions.1.from:
-        "arbitrum:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
+        "arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
      directlyReceivedPermissions.2.from:
-        "arbitrum:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
+        "arb1:0xb75A0a5812303cBB198d4f0BcA7CA38f17b8783e"
...
Generated with discovered.json: 0x551adc94ab7010fe1326f535301bca7caa3f65f7

# Diff at Wed, 18 Jun 2025 12:22:02 GMT:

- chain: arbitrum
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@a8e4f22a1441bd5040898cc3d3d62b3582942b65 block: 287771362
- current block number: 287771362
...
Generated with discovered.json: 0xb04c05b214f5f4b7ef0adc043c64ff060310215a
