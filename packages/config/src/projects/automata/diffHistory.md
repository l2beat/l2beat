Generated with discovered.json: 0x607a63d0b801ff657e931900bde64eb157629381

# Diff at Wed, 23 Sep 2026 05:45:23 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@2e9174e8edc4a3b646f958a1d6e0d4360abec40d block: 1784039829
...
discovery. Values are for block 1784039829 (main branch discovery), not current.

```diff
    contract Automata Multisig 1 (eth:0x03eC1C43434E2f910A2fb984906cd2470fdb39c8) [GnosisSafe] {
    +++ description: None
...
```diff
    contract ProxyAdmin (eth:0x7617f4a55d62b9EE49578D9C90593e58E607415F) [global/ProxyAdmin] {
    +++ description: None
      fieldMeta:
...
```diff
    contract AddressManager (eth:0xF1C911e0c1E6dd08c8a7C80c9890e2037e0504c6) [opstack/AddressManager] {
...
Generated with discovered.json: 0xd0eb08638e10e0ffb54ec2a3de6ff480006314e4

# Diff at Mon, 21 Sep 2026 11:23:57 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@231e4a5828ee5ff5a863f7b80215466ca39a5b1e block: 1784039829
- current timestamp: 1784039829
...
Generated with discovered.json: 0x923c8e21112a95c0be4b11425881fce363264f31

# Diff at Fri, 18 Sep 2026 10:24:47 GMT:

- author: sekuba (<29250140+sekuba@users.noreply.github.com>)
- comparing to: main@e2faf827d006bceee5fb0904599ba325066c7674 block: 1784039829
- current timestamp: 1784039829
...
Generated with discovered.json: 0x233aafd2cd9977cdb38b10bb04b6d4a0420a4a88
...
- comparing to: main@488d190650457a1fba9b18a83f14a17ab8b2c84c block: 1773160400
...
```diff
    contract DataAvailabilityChallenge (eth:0x08c5DCDD5e46d31CC1591ee15b084663507597f3) [opstack/DataAvailabilityChallenge] {
    +++ description: The DataAvailabilityChallenge contract is used to challenge the full availability of data behind commimted transaction data hashes. See the technology section for more details.
      sourceHashes.1:
-        "0x61fee1dc963816dc535a7c3634947d11e5adf660665a8996c384ba8d74c0aab2"
+        "0x792536105c65a74aae9d01d4b764d7213c3394dccdc68e3a63a4597af1653a69"
    }
```

```diff
    contract Automata Multisig 2 (eth:0x5E2FC552288857cfE709C398Ecac448314dE1320) [GnosisSafe] {
    +++ description: None
      sourceHashes.1:
...
```diff
    contract OptimismMintableERC20Factory (eth:0xa74b7baF04867E62B7824268e96144E503A23666) [opstack/OptimismMintableERC20Factory] {
...
- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@9ff7b62a511791b99f61b604fb6b56e4ea223bb0 block: 1743923255
- current timestamp: 1743923255
...
Following changes come from updates made to the config file,
or/and contracts becoming verified, not from differences found during
discovery. Values are for block 1743923255 (main branch discovery), not current.
