  ...
  config: {
    escrows: [
      discovery.getEscrowDetails({
        ...
        // BE is also registered for spot trading, but its CoinGecko listing
        // does not expose usable price history yet.
        tokens: [
          'ETH',
          'USDG',
          'AAPL',
        ...
        description:
          'Main Lighter contract on Robinhood Chain. It escrows USDG used as margin as well as ETH and Robinhood tokenized equities and ETFs used for spot trading, and credits the corresponding balances inside Lighter.',
      }),
    ],
  },
  riskView: {
