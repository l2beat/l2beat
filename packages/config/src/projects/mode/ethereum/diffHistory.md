Generated with discovered.json: 0xa6474e5636ea0dedc2414a0fb018d60ffbce8778
...
+        "Optimism Guardian Multisig"
      directlyReceivedPermissions:
-        [{"permission":"guard","from":"0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07"},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"challenge","from":"0x4317ba146D4933D889518a3e5E11Fe7a53199b04"}]
    }
```
...
```diff
    ...
    +++ description: Contains a list of proposed state roots which Proposers assert to be a result of block execution. Currently only the PROPOSER address can submit new state roots.
      issuedPermissions.2:
-        {"permission":"propose","to":"0x674F64D64Ddc198db83cd9047dF54BF89cCD0ddB","via":[]}
      issuedPermissions.1:
-        {"permission":"challenge","to":"0x309Fe2536d01867018D120b40e4676723C53A14C","via":[]}
      issuedPermissions.0.to:
-        "0x5a0Aae59D09fccBdDb6C6CcEB07B7279367C3d2A"
+        "0x470d87b1dae09a454A43D1fD772A561a03276aB7"
      issuedPermissions.0.via.0:
...
```diff
    ...
    +++ description: None
      directlyReceivedPermissions:
-        [{"permission":"interact","from":"0x50eF494573f28Cad6B64C31b7a00Cdaa48306e15","description":"set and change address mappings."},{"permission":"upgrade","from":"0x2901dA832a4D0297FF0691100A8E496626cc626D"},{"permission":"upgrade","from":"0x4317ba146D4933D889518a3e5E11Fe7a53199b04"},{"permission":"upgrade","from":"0x5e6432F18Bc5d497B1Ab2288a025Fbf9D69E2221"},{"permission":"upgrade","from":"0x69216395A62dFb243C05EF4F1C27AF8655096a95"},{"permission":"upgrade","from":"0x735aDBbE72226BD52e818E7181953f42E3b0FF21","description":"upgrading the bridge implementation can give access to all funds escrowed therein."},{"permission":"upgrade","from":"0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07"}]
      receivedPermissions:
+        [{"permission":"upgrade","from":"0x2901dA832a4D0297FF0691100A8E496626cc626D"},{"permission":"upgrade","from":"0x4317ba146D4933D889518a3e5E11Fe7a53199b04"},{"permission":"upgrade","from":"0x5e6432F18Bc5d497B1Ab2288a025Fbf9D69E2221"},{"permission":"upgrade","from":"0x69216395A62dFb243C05EF4F1C27AF8655096a95"},{"permission":"upgrade","from":"0x735aDBbE72226BD52e818E7181953f42E3b0FF21"},{"permission":"upgrade","from":"0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07"}]
    }
```
...
+        "Conduit Multisig 1"
      receivedPermissions:
-        [{"permission":"interact","from":"0x5e6432F18Bc5d497B1Ab2288a025Fbf9D69E2221","description":"it can update the preconfer address, the batch submitter (Sequencer) address and the gas configuration of the system."}]
    }
```
...
```diff
    ...
    +++ description: None
      receivedPermissions:
-        [{"permission":"interact","from":"0x50eF494573f28Cad6B64C31b7a00Cdaa48306e15","description":"set and change address mappings.","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"interact","from":"0xdE1FCfB0851916CA5101820A69b13a4E276bd81F","description":"set and change address mappings.","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]},{"permission":"upgrade","from":"0x2901dA832a4D0297FF0691100A8E496626cc626D","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"upgrade","from":"0x4317ba146D4933D889518a3e5E11Fe7a53199b04","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"upgrade","from":"0x5e6432F18Bc5d497B1Ab2288a025Fbf9D69E2221","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"upgrade","from":"0x69216395A62dFb243C05EF4F1C27AF8655096a95","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"upgrade","from":"0x735aDBbE72226BD52e818E7181953f42E3b0FF21","description":"upgrading the bridge implementation can give access to all funds escrowed therein.","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"upgrade","from":"0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07","via":[{"address":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"}]},{"permission":"upgrade","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]}]
      directlyReceivedPermissions:
-        [{"permission":"act","from":"0x470d87b1dae09a454A43D1fD772A561a03276aB7"},{"permission":"act","from":"0x543bA4AADBAb8f9025686Bd03993043599c6fB04"}]
    }
```
...
-        "HIGH"
      receivedPermissions:
-        [{"permission":"propose","from":"0x4317ba146D4933D889518a3e5E11Fe7a53199b04"}]
    }
```
...
```diff
    contract undefined (0x99199a22125034c808ff20f377d91187E8050F2E) {
    +++ description: None
      receivedPermissions:
-        [{"permission":"sequence","from":"0x5e6432F18Bc5d497B1Ab2288a025Fbf9D69E2221"}]
    }
```
...
+        "Optimism Security Council"
      receivedPermissions:
-        [{"permission":"guard","from":"0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"}]},{"permission":"guard","from":"0x95703e0982140D16f8ebA6d158FccEde42f04a4C","via":[{"address":"0x09f7150D8c019BeF34450d6920f6B3608ceFdAf2"}]}]
    }
```
...
Generated with discovered.json: 0x2fa2aebc36fdbfa8a18321a6a1c594fd47bbc322
