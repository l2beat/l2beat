...
const SIMPLE_BOOTLOADER = (version: string) => ({
  title: `Simple bootloader Cairo program ${version}`,
  description:
...
1. Install the rust toolchain (the \`nightly-2025-09-15\` toolchain is auto-selected by \`rust-toolchain.toml\`)
...
Note: \`cargo prove vkey --elf <path-to-elf-file>\` prints a different SP1 vkey representation for this program, not the \`hash_bytes()\` program hash used here.
  ...
  '160268921359133235574810995023520895391777547407923205700393332203861498631':
    {
      ...SIMPLE_BOOTLOADER('StarkWare_GpsStatementVerifier_2024_10'),
      programUrl:
