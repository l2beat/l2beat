...
Note: \`cargo prove vkey --elf <path-to-elf-file>\` prints a different SP1 vkey representation for this program, not the \`hash_bytes()\` program hash used here.
  ...
  '0x0063d017f049d215e2cda7f7826d7c1a8176a678203d6f74a731fc331cc16377': {
    ...OP_SUCCINCT_AGG_BLOBS,
    programUrl:
      'https://github.com/mantle-xyz/op-succinct/tree/v2.2.4-mainnet.5-rc1/programs/aggregation',
    proverSystemProject: ProjectId('sp1hypercube'),
    verificationStatus: 'notVerified',
  },
  '0x1dc938274cd550224002662e765b50c838b6fcb3234308b847ece2ce0e4a5631': {
    ...OP_SUCCINCT_RANGE_BLOBS,
    programUrl:
      'https://github.com/mantle-xyz/op-succinct/tree/v2.2.4-mainnet.5-rc1/programs/range/ethereum',
    proverSystemProject: ProjectId('sp1hypercube'),
    verificationStatus: 'notVerified',
  },
