...
import { ProjectRiskViewEntry, Sentiment } from './ProjectRisk'
import { ProjectRiskView } from './ProjectRiskView'

export function makeBridgeCompatible(
  entry: Omit<ProjectRiskView, 'sourceUpgradeability'>,
): ProjectRiskView {
  return {
    ...entry,
...
export const UPCOMING_RISK_VIEW: ProjectRiskView = makeBridgeCompatible({
...
export const UNDER_REVIEW_RISK_VIEW: ProjectRiskView = makeBridgeCompatible({
