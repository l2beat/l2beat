...
const STARKEX_BLOCKLIST: ScalingProjectTechnologyChoice = {
  name: 'Blocklist',
  description:
    'The BlockAdmin (see Permissions section) can add addresses to a Blocklist, preventing the finalization of their withdrawal on L1. This effectively locks the blocked partys funds in the bridge escrow on L1, in case the withdrawal had been already initiated on L2.',
