...
export const zkfair: Layer2 = {
  ...
  display: {
    ...
    description:
      'ZKFair is the first community Validium based on Polygon CDK and Celestia DA. In its current implementation it is not using Celestia Blobstream bridge, meaning that Ethereum bridge does not have assurance that data has really been posted to Celestia.',
    purpose: 'Universal',
    category: 'Validium',
