...
export const kroma: Layer2 = {
    ...
    display: {
        ...
        slug: 'kroma',
        description:
            'Kroma aims to develop a Universal ZK Rollup on the Ethereum Network. \
            Currently, Kroma operates as an Optimistic Rollup with ZK Fault Proof, utilizing zkEVM. \
        ...
        links: {
            ...
            apps: ['https://kroma.network/bridge/', 'https://uniswap.sepolia.kroma.network/#/swap/'],
