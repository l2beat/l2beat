...
export const HOMEPAGE_MILESTONES: Milestone[] = [
  {
    ...
    description:
      'zkSync is live, bringing scalable payments using zkRollup technology.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Aztec is live, bringing private and scalable transactions using zkRollup technology.',
  },
  {
    name: 'Optimistic Rollup (universal)',
    ...
    description:
      'Arbitrum became first publicly open universal rollup based on optimistic architecture.',
  },
  {
