...
export const HOMEPAGE_MILESTONES: Milestone[] = [
  ...
  {
    name: 'First trustless Optimistic Rollup (for payments)',
  ...
  {
    name: 'First generalized Optimistic Rollup with fraud proofs',
  ...
  {
    name: 'First privacy-focused Zk Rollup (for payments)',
  ...
  {
    name: 'First permissionless, generalized Optimistic Rollup',
  ...
  {
    name: 'First generalized zkRollup',
