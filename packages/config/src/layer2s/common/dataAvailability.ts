...
const ON_CHAIN: Layer2TechnologyChoice = {
...
const ON_CHAIN_CANONICAL: Layer2TechnologyChoice = {
...
const STARKEX_ON_CHAIN: Layer2TechnologyChoice = {
  name: 'All data required for proofs is published on chain',
  description:
...
const STARKNET_ON_CHAIN: Layer2TechnologyChoice = {
...
const GENERIC_OFF_CHAIN: Layer2TechnologyChoice = {
...
const ANYTRUST_OFF_CHAIN: Layer2TechnologyChoice = {
  ...GENERIC_OFF_CHAIN,
  description:
...
const STARKEX_OFF_CHAIN: Layer2TechnologyChoice = {
  ...GENERIC_OFF_CHAIN,
  description:
...
const PLASMA_OFF_CHAIN: Layer2TechnologyChoice = {
  ...GENERIC_OFF_CHAIN,
  description:
