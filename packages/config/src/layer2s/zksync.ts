  ...
  milestones: [
    {
      ...
      description: 'zkSync is live, bringing trustless, scalable payments to Ethereum using zkRollup technology.'
    },
    {
      name: 'zkEVM alpha',
      link: 'https://blog.matter-labs.io/baby-alpha-has-arrived-5b10798bc623',
      date: new Date('2022-10-28'),
      description: 'Deployment of the system to mainnet, for the testing purposes.'
    },
  ],
}
