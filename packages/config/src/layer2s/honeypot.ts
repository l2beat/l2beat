...
export const honeypot: Layer2 = {
  ...
  stateDerivation: {
    nodeSoftware: `It's Cartesi node software, soruce code can be found [here](https://github.com/cartesi/rollups/tree/v1.0.2/offchain).`,
    compressionScheme: 'No compression is used.',
    genesisState:
      'The genesis state is derived from the Honeypot Cartesi Machine template, which can be found within the [Honeypot server Docker image](https://hub.docker.com/layers/cartesi/honeypot/main-server-mainnet/images/sha256-9067ebcf3d915e8091aba45bd231a328a7ac260924d85387137ed133f3e240ac) at `/var/opt/cartesi/machine-snapshots/0_0`. Alternatively, you can recreate it by following the build procedure outlined in the [Honeypot GitHub Repository](https://github.com/cartesi/honeypot#building-machine-to-deploy).',
    dataFormat:
