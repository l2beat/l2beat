...
export const bobanetwork: Layer2 = {
  ...
  display: {
    ...
    description:
      'Boba is an L2 Ethereum scaling & augmenting solution built by the Enya team as core contributors to the Boba Foundation.',
    detailedDescription:
      'Boba is an EVM-compatible Optimistic Rollup chain \
