...
export const xchain: Layer2 = {
  ...
  display: {
    ...
    slug: 'xchain',
    description:
      'XCHAIN is an upcoming Layer 2 Network Leveraging Polygon zkEVM Supernets',
      purpose: 'DEX Chain',
      category: 'Validium',
      links: {
        websites: ['https://idex.io/'],
        apps: ['https://exchange.idex.io/polygon/trading/IDEX-USDC/'],
        documentation: ['https://medium.com/idex/the-all-new-idex-a-quick-recap-b27df4cd981b'],
        explorers: [
          ''
        ],
        repositories: [''],
