...
export const dydx: Layer2 = {
  ...
  milestones: [
    ...
    },
    {
      ...
      description: 'Independent foundation, headquartered in Zug, Switzerland, was created to participate in propelling the Protocol into the future.'
    },
    {
      name: 'dYdX v4 announcement',
      link: 'https://dydx.exchange/blog/dydx-chain',
      date: new Date('2022-06-22'),
      description: 'dYdX V4 will be developed as a standalone blockchain based on the Cosmos SDK and Tendermint Proof-of-stake consensus protocol.'
    },
  ],
}
