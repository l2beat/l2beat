...
const discovery = new ProjectDiscovery('opbnb')
...
export const opbnb: Layer2 = {
  ...
  display: {
    ...
    description:
      'opBNB is a high-performance L2 solution on the BSC network, powered by the OP Stack. It aims to reduce the cost of the transaction and improve the user experience of the DApp. opBNB is part of the BNB Chain ecosystem',
    purpose: 'general',
    provider: 'OP Stack',
    category: 'Optimistic Rollup',
    links: {
      websites: ['https://www.bnbchain.org/en'],
      apps: ['https://www.bnbchain.org/en'],
      documentation: ['https://docs.aevo.xyz/'],
      explorers: ['https://opbnbscan.com/'],
      repositories: ['https://github.com/bnb-chain/opbnb'],
      socialMedia: ['https://twitter.com/BNBChain'],
    },
      ...
      sources: [
        {
          ...
          references: [
            'https://bscscan.com/address/0x7e2419F79c9546B9A0E292Fd36aC5005ffed5495',
          ],
        },
      ],
    },
      ...
      sources: [
        {
          ...
          references: [
            'https://bscscan.com/address/0x0d61A015BAeF63f6740afF8294dAc278A494f6fA',
          ],
        },
      ],
    },
  ...
  technology: {
    stateCorrectness: {
      ...
      references: [
        {
          text: 'L2OutputOracle.sol - BSCScan source code',
          href: 'https://bscscan.com/address/0x0d61A015BAeF63f6740afF8294dAc278A494f6fA#code',
        },
      ],
    },
    dataAvailability: {
      ...
      references: [
        {
          ...
          href: 'https://github.com/bnb-chain/opbnb/blob/develop/specs/derivation.md#batch-submission',
        },
        {
          text: 'BatchInbox - BSCScan address',
          href: 'https://bscscan.com/address/0xff00000000000000000000000000000000000204',
        },
        {
          text: 'OptimismPortal.sol',
          href: 'https://bscscan.com/address/0x7e2419F79c9546B9A0E292Fd36aC5005ffed5495',
        },
      ],
    },
    operator: {
      ...
      references: [
        {
          ...
          href: 'https://bscscan.com/address/0x0d61A015BAeF63f6740afF8294dAc278A494f6fA#codeF1#L30',
        },
      ],
    },
    forceTransactions: {
  ...
  knowledgeNuggets: [
    ...
    {
      title: 'opBNB: Providing Low Gas Fees For Mass Web3 Adoption',
      url: 'https://www.bnbchain.org/en/blog/opbnb-providing-low-gas-fees-for-mass-web3-adoption',
      thumbnail: NUGGETS.THUMBNAILS.MODULAR_ROLLUP,
    },
  ...
  milestones: [
    {
      name: 'opBNB Mainnet Launch',
      link: 'https://docs.bnbchain.org/opbnb-docs/docs/build-on-opbnb/getting-started',
      date: '2023-09-13T00:00:00.00Z',
      description:
        'opBNB opened the mainnet to the public.',
    },
  ],
}
