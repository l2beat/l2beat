Generated with discovered.json: 0x6fbb901b0d088a17f7a0aabe38a619bb3d8e6b04

# Diff at Mon, 10 Mar 2025 08:28:09 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@78bcb6383f4f7e8dd3a6cfb20645e1e526af32ba block: 56755451
...
```diff
+   Status: CREATED
    contract ProtocolUpgradeHandler_l2Alias (0xA08b9912416E8aDc4D9C21Fae1415d3318A129A8)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract Guardians_l2Alias (0xe788e09324F8bb3cc64f009973693f751C33b999)
    +++ description: None
```
