Generated with discovered.json: 0x50d359a96983eee5226f993ea1cf3763c540a8fb

# Diff at Mon, 10 Mar 2025 08:26:54 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@78bcb6383f4f7e8dd3a6cfb20645e1e526af32ba block: 21744139
...
```diff
+   Status: CREATED
    contract undefined (0x38B9cf22343C417C99e9AF4Aee06897ff1A85cDd)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract EOAVault5 (0x873089bC765a1C0AFAd48e34fCd305d17D81be87)
    +++ description: None
```

```diff
+   Status: CREATED
    contract undefined (0x894107B7b5051409f279E8300774B2f62Febe057)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract undefined (0xbDCaAa95202A56D0c688CEE2E1260fAB2F6e4fF7)
    +++ description: None
```

```diff
+   Status: CREATED
    contract EOAVault3 (0xD2238E8c085E5059F8DFC52256530210bc7250F6)
    +++ description: None
```

```diff
+   Status: CREATED
    contract undefined (0xdd37184C6BF02Aea66Ed3eCb8fcccfeADF801609)
    +++ description: None
```

Generated with discovered.json: 0xf3b4ef173bd6e2cb48bb68edcc04e7f592890564
