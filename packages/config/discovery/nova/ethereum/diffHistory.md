Generated with discovered.json: 0x8254c183a35915113113ff17b08c29d1160be678

# Diff at Thu, 13 Feb 2025 16:08:43 GMT:
...
+        {"permission":"interact","from":"0xFb209827c58283535b744575e11953DCC4bEAD88","description":"Pause and unpause and set important roles and parameters in the system contracts: Can delegate Sequencer management to a BatchPosterManager address, manage data availability and DACs, set the Sequencer-only window, introduce an allowList to the bridge and whitelist Inboxes/Outboxes."}
      directlyReceivedPermissions.7:
+        {"permission":"interact","from":"0xE6841D92B0C345144506576eC13ECf5103aC7f49","description":"update the minimum delay of the timelock."}
...
-        "0x5613AF0474EB9c528A34701A5b1662E3C8FA0678"
+        "0x171a2624302775eF943f4f62E76fd22A6813d7c4"
    }
```
...
+        {"permission":"upgrade","from":"0xE27d4Ed355e5273A3D4855c8e11BC4a8d3e39b87","via":[{"address":"0xE4d0Ba69d082Fdf6f51b8fc8F92c19bF00B1a1B4"}]}
      receivedPermissions.2:
+        {"permission":"upgrade","from":"0x83215480dB2C6A7E56f9E99EF93AB9B36F8A3DD5","via":[{"address":"0x0ea6999172c1B4563695F76A52de73c848587b17"}]}
...
+        {"permission":"act","from":"0xF32e5B5Ad94c0c0F83E0023b0AC48A93A8a2a428"}
      directlyReceivedPermissions.2:
+        {"permission":"act","from":"0xE4d0Ba69d082Fdf6f51b8fc8F92c19bF00B1a1B4"}
      directlyReceivedPermissions.1.from:
...
+        {"permission":"interact","from":"0x211E1c4c7f1bF5351Ac850Ed10FD68CFfCF6c21b","description":"Add/remove batchPosters (Sequencers)."}
...
+        {"permission":"upgrade","from":"0xD4B80C3D7240325D18E645B49e6535A3Bf95cc58","via":[{"address":"0x71D78dC7cCC0e037e12de1E50f5470903ce37148"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.24:
+        {"permission":"upgrade","from":"0xc8C3194eD3BE7B2393fEfE811a2Cc39297442c0B","via":[{"address":"0x171a2624302775eF943f4f62E76fd22A6813d7c4"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.23:
+        {"permission":"upgrade","from":"0xC840838Bc438d73C16c2f8b22D2Ce3669963cD48","via":[{"address":"0xa8f7DdEd54a726eB873E98bFF2C95ABF2d03e560"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.22:
+        {"permission":"upgrade","from":"0xc4448b71118c9071Bcb9734A0EAc55D18A153949","via":[{"address":"0x71D78dC7cCC0e037e12de1E50f5470903ce37148"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.21:
+        {"permission":"upgrade","from":"0xC1Ebd02f738644983b6C4B2d440b8e77DdE276Bd","via":[{"address":"0x71D78dC7cCC0e037e12de1E50f5470903ce37148"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.20:
+        {"permission":"upgrade","from":"0xC12BA48c781F6e392B49Db2E25Cd0c28cD77531A","via":[{"address":"0x171a2624302775eF943f4f62E76fd22A6813d7c4"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.19:
+        {"permission":"upgrade","from":"0xB2535b988dcE19f9D71dfB22dB6da744aCac21bf","via":[{"address":"0xa8f7DdEd54a726eB873E98bFF2C95ABF2d03e560"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.18:
+        {"permission":"upgrade","from":"0xA59075221b50C598aED0Eae0bB9869639513af0D","via":[{"address":"0x71D78dC7cCC0e037e12de1E50f5470903ce37148"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.17:
+        {"permission":"upgrade","from":"0x8315177aB297bA92A06054cE80a67Ed4DBd7ed3a","via":[{"address":"0x554723262467F125Ac9e1cDFa9Ce15cc53822dbD"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.16:
+        {"permission":"upgrade","from":"0x760723CD2e632826c38Fef8CD438A4CC7E7E1A40","via":[{"address":"0x554723262467F125Ac9e1cDFa9Ce15cc53822dbD"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
      receivedPermissions.15:
+        {"permission":"upgrade","from":"0x667e23ABd27E623c11d4CC00ca3EC4d0bD63337a","via":[{"address":"0x554723262467F125Ac9e1cDFa9Ce15cc53822dbD"},{"address":"0x3ffFbAdAF827559da092217e474760E2b2c3CeDd"}]}
...
```diff
+   Status: CREATED
    contract Bridge (0x011B6E24FfB0B5f5fCc564cf4183C5BBBc96D515)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract ProxyAdmin (0x171a2624302775eF943f4f62E76fd22A6813d7c4)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract ChallengeFactory (0x1E13BB8cF5F44c4c7fC585797336eAaE3935113C)
    +++ description: None
```

```diff
+   Status: CREATED
    contract RollupAdminFacet (0x3CcB27FD59398a015a1eb465582A934fbF318214)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract NodeFactory (0x4442a659aaa27eEDdf0A5d6eF7659290E92F678C)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract OutboxEntry (0x45D74F59B097b80bdB672425215649011C314c24)
    +++ description: None
```

```diff
+   Status: CREATED
    contract SequencerInbox (0x4c6f947Ae67F572afa4ae0730947DE7C874F95Ef)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract OutboxEntry (0x620d02560D5588baFe3EC32621c546Fd5D425aa4)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract OutboxEntry (0x805CF2B6CCb8d286cDaDE69CBfa31FD0cC3e9d47)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract Rollup (0xC12BA48c781F6e392B49Db2E25Cd0c28cD77531A)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract OutboxEntry (0xc60e9B083FC8E2517cf6E5B9efC940B233277f8C)
    +++ description: None
```

```diff
+   Status: CREATED
    contract RollupEventBridge (0xc8C3194eD3BE7B2393fEfE811a2Cc39297442c0B)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract RollupUserFacet (0xDBE5c009095169D3de4a8D1C70E319fE647A3DBf)
    +++ description: None
```
