Generated with discovered.json: 0x60d785b5bcf219524b5e51eb6ddb0993c705f5fb

# Diff at Mon, 10 Mar 2025 12:39:55 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@f6da90223c6b91864899f5bf128309f4edb196f1 block: 21394291
...
```diff
+   Status: CREATED
    contract undefined (0x4e3FE240B50A445fc6137a6363aC3593Af173b8a)
    +++ description: None
```
...
```diff
+   Status: CREATED
    contract LoopringOwner (0xacD3A62F3eED1BfE4fF0eC8240d645c1F5477F82)
    +++ description: None
```
...
Generated with discovered.json: 0xb44fdeea21553dbc79a36caef3f2a87021e318c0
