Generated with discovered.json: 0x2eb7dba054286098a638030fc7b08c113470b60e

# Diff at Mon, 10 Mar 2025 08:26:50 GMT:

- author: Mateusz Radomski (<radomski.main@protonmail.com>)
- comparing to: main@78bcb6383f4f7e8dd3a6cfb20645e1e526af32ba block: 21387141
...
```diff
+   Status: CREATED
    contract FirstAnvilAddress (0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266)
    +++ description: None
```

```diff
+   Status: CREATED
    contract undefined (0xFcF75295f242C4E87203Abb5d7C9BbEda90a8895)
    +++ description: None
```

Generated with discovered.json: 0x07f1b2fb2b8c1a0523f86172090937438980737a
