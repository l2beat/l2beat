...
export function Step7Report() {
  ...
  return (
    <div className="step">
      <div className="intro">
        <h2>📊 Step 7 · Report and questions — next iteration</h2>
        <p className="lead">
          ...
          (base facts, program, derived relations) and at the{' '}
          <code>souffle</code> command line, so its answers can be traced back
          through steps 6 → 4 → 3 → 1 the same way you just did by hand.
        </p>
      </div>
