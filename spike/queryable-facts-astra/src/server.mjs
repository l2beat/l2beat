...
const assets = { '/': ['index.html', 'text/html'], '/app.js': ['app.js', 'text/javascript'], '/id-labels.js': ['id-labels.js', 'text/javascript'], '/ast-tree.js': ['ast-tree.js', 'text/javascript'], '/style.css': ['style.css', 'text/css'] }
let busy = false
...
const server = createServer(async (req, res) => {
  try {
    ...
    if (req.method === 'POST' && path === '/api/run') {
      ...
      if (busy) return send(res, 409, { error: 'A pipeline run is already in progress.' })
      busy = true
      try {
        const chunks = []
        let size = 0
